...
<jsp:include page="/hs/includes/global/left_calendar.jsp" />
    ...
    <TR>
        ...
        <TR>
            ...
            <P><B>Please check your email.<BR/>
            You need to activate your account to log in. Your activation code is being emailed to you.
            Follow the instructions in the email to activate your account.</B></P>
