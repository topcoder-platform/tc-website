...
<!--        jsp:include page="/hs/includes/login/login_mod.jsp-->
...
<P>For more information about TopCoder High School and the competitions, <A HREF="/hs/home/how_hs_compete.jsp">click here:</A></P></TD>
</TR>
</TABLE>
<HR WIDTH="100%" SIZE="1" color="#cccccc"/>           
 ...
 <jsp:include page="/hs/includes/global/sponsor_right.jsp" />
...
<jsp:include page="/hs/includes/resources/right_resources.jsp" /><BR/><BR/><IMG SRC="/i/hs/right_bottom_elements.gif" WIDTH="225" HEIGHT="66" ALT="" BORDER="0"></TD>	
	</TR>
</TABLE>
</TD></TR></TABLE>
...
<TR>
    ...
    <TD VALIGN="baseline" WIDTH="100%">
            <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
             <TR>
			 	<TD ALIGN="left" HEIGHT="44" WIDTH="40"><IMG SRC="/i/hs/frame_foot_left.gif" WIDTH="40" HEIGHT="44" ALT="" BORDER="0"></TD>
				<TD BACKGROUND="/i/hs/frame_1pix_bg_foot.gif" HEIGHT="44" WIDTH="100%">&nbsp;</TD>
				<TD ALIGN="left" HEIGHT="44" WIDTH="436"><IMG SRC="/i/hs/frame_foot_right.gif" WIDTH="436" HEIGHT="44" BORDER="0"></TD>
             </TR>
            </TABLE>
            </TD>
