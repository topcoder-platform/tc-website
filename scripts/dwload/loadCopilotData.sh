...
nohup java  -cp $CP com.topcoder.shared.util.sql.DBUtilityLauncher com.topcoder.utilities.dwload.CopilotDataLoadUtility -xmlfile copilotDataLoadingTool.xml $@ > ./copilotDataLoadingTool.out 2>&1 &
tail -f copilotDataLoadingTool.out
