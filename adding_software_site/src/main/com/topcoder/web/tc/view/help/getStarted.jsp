...
<ul>
<li>
<a name="software"></a><span class="bodySubtitle">What software will you need to install?</span> - 
...
<li>
<a name="running"></a><span class="bodySubtitle">Running the TopCoder Arena as an Applet or by using Java Web Start</span> - 
...
<li>
<a name="firewall"></a><span class="bodySubtitle">Local Firewall and Network Considerations</span> - 
The following port access will be necessary in order to run the TopCoder Arena:<br/><br/>

Outbound access to www.topcoder.com on port 5001<br/>

While using HTTP Tunneling, you will need access to arena.topcoder.com on port 80<br/><br/>
</li>
<li>
<a name="tunneling"></a><span class="bodySubtitle">HTTP Tunneling</span> - 
