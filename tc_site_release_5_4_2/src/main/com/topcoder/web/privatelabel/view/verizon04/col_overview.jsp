...
<table border="0" cellspacing="0" cellpadding="0" class="black"  width="100%">
 ...
 <%-- Verizon logo --%>
        <td width="147" bgcolor="#000000" rowspan="2" valign="top"> <A href="http://www.verizon.com"> <img src="/i/events/verizon04/logo_black_147.gif" width="147" height="140" border="0"/></A></td>
    ...
    <tr>
      <td bgcolor="#CC0001" width="589" height="99" colspan="2" valign="top">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="440" height="99" colspan=2 valign="top" align="right" background="/i/events/verizon04/verizon04_logo.jpg">
		<img src="/i/events/verizon04/banner_angle.gif" alt="" width="30" height="99"></td>
                <td width="146" height="99" valign="middle"><A href="http://www.topcoder.com"><img src="/i/events/verizon04/pbtc2.gif" alt="Contest Powered by TopCoder" height="45" width="146" border="0"></A></td>
            </tr>
        </table>
      </td>
   </tr>
...
<%-- Left Column Begins --%>
        <td valign="top" class="dkGrey" width="146">
            <table width="146" border="0" cellpadding="0" cellspacing="11" class="dkGrey">
                <tr>
                    <td width="124" class="white" align="center"><img src="/i/events/verizon04/contestlinks.gif" width="124" height="19" border="0" alt="Contest Links">
            ...
            <table width="427" border="0" cellpadding="0" cellspacing="0">
                <tr valign="top">
                    <td width="427" class="bodyCopy">
                        ...
                        Registration for the Verizon Coding Challenge opens on October 27th and closes on October 30th, 2004.  Be sure to register early, as only the first 500 eligible individuals to
