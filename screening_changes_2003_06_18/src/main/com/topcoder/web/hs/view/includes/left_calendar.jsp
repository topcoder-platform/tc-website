<!--Small Calendar Starts-->
            <table width="170" bgcolor="#1B2E5D" cellspacing="0" cellpadding="0" border="0">
                <tr> 
                    <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td class="titlesidenav" width="100%">&#160;May 2003 Match Dates</td></tr>
                        </table>
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td id="calendarBlankMini">&#160;</td>
                                <td id="calendarBlankMini">&#160;</td>
                                <td id="calendarSRMMini"><a href="?module=Static&amp;d1=schedule&amp;d2=sched_may_2003" class="calendarSRMMini">1</a></td>
                            ...
                            <tr> 
                                ...
                                <td id="calendarSRMMini"><a href="?module=Static&amp;d1=schedule&amp;d2=sched_may_2003" class="calendarSRMMini">8</a></td>
                            ...
                            <tr> 
                                ...
                                <td id="calendarSRMMini"><a href="?module=Static&amp;d1=schedule&amp;d2=sched_may_2003" class="calendarSRMMini">20</a></td>
