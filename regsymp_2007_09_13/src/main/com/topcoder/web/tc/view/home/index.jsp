        ...
        <tr>
            <td class="homeBigPromo">
               ...
               --%>
                ...
                <%-- SRM SPONSOR 
                <map name="mm">
                <area shape="rect" alt="" coords="1,1,264,95" href="/tc?module=MatchDetails&rd=10780" />
                <area shape="rect" alt="" coords="1,106,264,135" href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=sponsorpatrons&d4=lilly" />
                </map>
                <img src="/i/home/srm365_lilly.png" alt="SRM 365 brought to you by Eli Lilly" border="0" style="display:block;" usemap="#mm"/>
                --%>
