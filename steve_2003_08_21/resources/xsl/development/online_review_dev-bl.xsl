...
<!-- Technologies -->
						...
						Documentation for this project is provided in the <a class="statText" href="/i/development/downloads/Online_Review_Design.jar">Online Review Design Distribution</a>.  The business logic developer is responsible for all classes highlighted in red.
						</p>
