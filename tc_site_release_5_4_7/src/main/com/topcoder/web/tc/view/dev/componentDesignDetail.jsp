...
<p>
    ...
    <br/><br/>
    <span class=bigRed>NOTE: Registering for this component will affect your <A class=bigRed href="/tc?module=Static&d1=dev&d2=support&d3=desReliability">Reliability
        Rating</A></span>
    <% } %>
