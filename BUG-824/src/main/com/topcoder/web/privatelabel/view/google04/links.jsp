...
<!-- Overview tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=overview">Overview</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- Schedule tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=schedule">Schedule</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- Rules tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=rules">Rules</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- Registration tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=reg_closed">Registration</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- FAQ tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=faq">FAQ</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- Advancers tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=advancers">Advancers</a> &nbsp;|&nbsp;
            <% } %>
...
<!-- Practice Arena  tab -->
            ...
            <% } else { %>
                  <a href="/pl/?module=Static&d1=google04&d2=arena">Competition Arena</a>
            <% } %>
</font>