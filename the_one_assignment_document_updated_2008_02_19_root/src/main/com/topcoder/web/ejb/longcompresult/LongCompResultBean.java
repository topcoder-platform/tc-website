...
public class LongCompResultBean extends BaseEJB {
    ...
    public double getPointTotal(long roundId, long coderId, String dataSource) throws RowNotFoundException {
    ...
    public boolean getAttended(long roundId, long coderId, String dataSource) throws RowNotFoundException {
