...
<img src="/i/events/truveo/interface/magnify.png" alt="" onmouseover="postPopUpText('globalPopupText','View submission'); popUp(this,'globalPopup');" onmouseout="popHide()"/>
</a>
</td>
<td class="valueC"<c:if test="${newRank==submission.rank}"> id="fade<%=col++%>"</c:if>>
...
<img src="/i/events/truveo/interface/btnMoveUpNA.png" alt="Move up"/>
</div>
<div align="center" style="margin: 2px;">
<img src="/i/events/truveo/interface/btnMoveDownNA.png" alt="Move down"/>
</div>
</td>
<td colspan="2" class="valueC"<c:if test="${newRank==submission.rank}"> id="fade<%=col++%>"</c:if>>
<div align="center">
<img src="/i/events/truveo/interface/btnMoveToTopNA.png" alt="Move to top"/>
</div>
</td>
</c:when>
<c:otherwise>
...
<img src="/i/events/truveo/interface/btnMoveUp.png" alt="Move up" />
</a>
</c:otherwise>
</c:choose>
</div>
...
<c:otherwise>
<a href="#" onclick="changeRank(${submission.rank+1}, ${submission.id});return false;" onfocus="this.blur();" style="display: block;">
<img src="/i/events/truveo/interface/btnMoveDown.png" alt="Move down" />
</a>
</c:otherwise>
</c:choose>
</div>
...
<img src="/i/events/truveo/interface/btnMoveToTop.png" alt="Move to top" />
</a>
</c:otherwise>
</c:choose>
</div>
...
<img src="/i/events/truveo/interface/btnRemove.png" alt="Remove" />
</a>
</div>
</td>
</c:otherwise>
