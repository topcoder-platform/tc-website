                    ...
                    <rsc:iterator list="<%=contests%>" id="resultRow">
                        <tr class="<%=even?"light":"dark"%>">
                            ...
                            <td class="value">
                                ...
                                <a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=Static&amp;d1=tournaments&amp;d2=tco08&amp;d3=truveo&amp;d4=description"><img src="/i/tournament/tco08/emblem.png" alt="" onmouseover="popUp(this,'popTCO08')" onmouseout="popHide()" style="display: block; margin: 4px;"/></a>
                                <% } else { %>
                                &nbsp;
                                <% } %>
                            </td>
...
--%>
                            ...
                            <td class="valueC" nowrap="nowrap">
                                ...
                                <a href="${sessionInfo.servletPath}?module=ViewSubmission&amp;<%=Constants.CONTEST_ID%>=<rsc:item name="contest_id" row="<%=resultRow%>"/>" onfocus="this.blur();"><img src="/i/events/truveo/interface/btnSubmitOrganize.png" alt="Submit &amp; Organize" style="margin: 6px 0px 6px 0px;"/></a>
                                <% } else { %>
                                <a href="${sessionInfo.servletPath}?module=ViewRegistration&amp;<%=Constants.CONTEST_ID%>=<rsc:item name="contest_id" row="<%=resultRow%>"/>" onfocus="this.blur();"><img src="/i/events/truveo/interface/btnRegister.png" alt="Register" style="margin: 6px 0px 6px 0px;"/></a>
                                <% } %>
