...
<head>
    ...
    <script language="javascript" type="text/javascript">
        <!--
<%--        var passed = "I am happy to inform you that your TopCoder Aolicq submission has passed screening and will enter " +
                    ...
                    "Best of luck to you at the Aolicq!";
--%>
            var passed="I am happy to inform you that your TopCoder Aolicq submission has passed screening and will be presented to the client.\n\n" +
        ...
        var failed = "Unfortunately, your TopCoder Aolicq submission has failed screening for the following reason(s):\n\n" +
<%--
