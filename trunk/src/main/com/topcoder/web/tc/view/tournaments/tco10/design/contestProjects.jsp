...
<tco10:pageSetup title="TCO 10 : Design Competition Projects" area="design" menu="leaderboard"/>
                                ...
                                <c:forEach items="${contestProjects}" var="project">
                                    <tr>
                                        ...
                                        <td class="first last alignText">
                                            ...
                                            |
                                            <a href="${sessionInfo.servletPath}?module=ProjectDetails&amp;eid=3432&amp;ct=476&amp;pj=${project.map['project_id']}">
                                                results
                                            </a>
                                            <c:if test="${project.map['is_complete'] != 0}">
                                                |
