...
<p>Design distribution is an archive with the skeleton of the directory structure for your submission. Design distribution is available through the <a href="http://<%=ApplicationServer.FORUMS_SERVER_NAME%>/?module=Category&categoryID=<%=Constants.TCS_FORUMS_ROOT_CATEGORY_ID%>">Software Forums</A> -the first message on the design forum for your component contains the distribution archive. Most of the items in there are for developers - the only items in there related to the design are the build script and the requirements specification. Extract the archive to a directory of your choice. All your deliverables will go into the "docs" subdirectory of this directory.</p>
