...
Each match will contain a single problem. The problem statement will indicate both the question presented to the contestant as well as how submissions will be scored. When contestants submit their solution, it will immediately be put on a queue for system testing. Once system testing is complete, the competitor will be assigned a score that will be viewable on TopCoder's website. Each competitor may submit as many times as they choose during each competition, however competitors may only submit once per hour.  Additionally, if a competitor has a pending submission on the testing queue it must finish testing before they may submit again. 
<br><br>
