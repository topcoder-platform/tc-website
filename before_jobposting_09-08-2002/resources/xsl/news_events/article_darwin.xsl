...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
				<TR>
					...
					<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#FFFFFF">
						...
						The IT professionals have some thinking to do as well. It is going to be much tougher for an employer to give them bonuses like in the past, and even their pay may be too high. They are going to have to get used to less pay, probably not for any less work. The job functions aren't likely to change and may even increase Ð if the company is cutting people, it is going to put more work on their shoulders. They just have to reset their expectations.<BR/><BR/>
						</TD></TR>
					</TABLE>
		<P><BR/></P>
					</TD>
