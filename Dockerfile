FROM 811668436784.dkr.ecr.us-east-1.amazonaws.com/tc-website:base_v4
...
COPY [ "jbossserverconfig/run.conf" , "jbossserverconfig/start.sh", "tc_cache.jar", "resources.zip", "lib.zip", "topcoder.jar", "jbossserverconfig/packagedeploy.sh", "/data/tc-website/"]
