...
announced that fellow Stanford University student <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> had won the 2002 Sun Microsystems and TopCoder 
Collegiate Challenge on Saturday April 20, at the University Park Hotel @ MIT in Cambridge, MA.
</P>

<P>
The reaction of <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, however, was more of relief than of exuberance.  That's because after finishing 
in a tie for ninth at the 2001 Collegiate Challenge, and the runner-up position in the 2001 Invitational, 
<A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> had finally climbed to the top of the TopCoder mountain.
</P>

<P>
"It's really nice to win after making the semifinals in last year's Collegiate Challenge and Invitational," 
said <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>.  "My adrenaline was flowing, and I really got absorbed in the problems.  I was able to block 
...
<P>
At the welcome reception, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, the assumed favorite due to his tournament experience and overall 
...
<P>
The next morning at 11am, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, showing no signs of jet lag, let all of the competitors and attendees know 
that he meant business.  In the most impressive performance of the tournament, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> submitted code for all 
three problems, and easily won his room with 1114.91 final points.  That point total was the highest of the 
Collegiate Challenge.  <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> also had the largest margin of victory, 548.32, and was the only competitor 
...
<P>
<A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> used a bit of strategy in the Finals, attempting to code the Level Two problem first, rather than 
...
problem, and <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> was still compiling and testing his initial problem, some spectators thought <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> 
had made a grave mistake.  "The Level Two problem was very technical.  I had to be careful because it was 
easy to make an error."  <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> finally submitted the Level Two problem for 274.20 points, and then opened 
the Level Three problem.  When asked about his strategy for opening the Level Two problem first, and then 
going for the Level Three problem, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> responded, "Even if it took a little longer to code, the Level 
...
malpt and derkuci, and a very quick system test, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> finally took his place among TopCoder royalty.
</P>

<P>
"I am very happy for <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>," said 2001 TopCoder Invitational champion and friend, <A HREF="/tc?module=MemberProfile&amp;cr=114443" CLASS="bodyGeneric">jonmac</A>.  
...
<P>
When informed that <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> had won the Collegiate Challenge, Hector Garcia-Molina, Chairman of 
Stanford's Department of Computer Science, replied, "I am delighted to hear that <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> won 
...
<P>
Ken Griffey, Jr. Barry Bonds.  Brett Hull. <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>.  Think the four of them don't have anything 
in common?  Well you'd be wrong if you did.  While Griffey, Bonds and Hull are all products of 
fathers who were professional athletes, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> is the son of two parents who were programmers.  
Although TopCoder is only a year old, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> started preparing himself for these type of 
competitions 15 years ago.  <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> began his coding at the age of six.  "My parents didn't push me, 
but rather assisted me and showed me how to do cool things," said <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>. "My first code was in BASIC 
...
<P>
Years later, the parents of <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> continue to see the fruits of their labor and love.  
"My parents often check the results of my competitions on the TopCoder website."
</P>

<P>
<A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> came to the United States from South Africa in 1999, following his graduation from 
high school.  And although his family settled in Colorado, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> decided to attend California's 
...
lifestyle, practice most certainly is, and according to <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, competing in TopCoder's twice-weekly 
...
<A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, being that he is one of the TopCoder originals, becoming a member on April 3, 2001.  
...
<P>
<A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> has competed in 71 of the 80 Single Round Matches, winning a total of $16,314.  Coupled with 
the $5,750 he won at the 2001 Collegiate Challenge, the $25,000 from the 2001 Invitational, and his 
most recent $100,000 victory, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> has won a total of $147,064, the most of any TopCoder member.  
Besides winning the 2002 Collegiate Challenge, <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> is TopCoder's most prolific Single Round 
...
<P>
The reasons <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> wins so much?  He rarely makes mistakes, as his Submission Accuracy 
...
<P>
As far as what the future holds for <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, it's a good bet that you'll find him if you log 
onto TopCoder during an upcoming Single Round Match.  "I'll keep competing so I don't get rusty."
</P>

<P>
If you do happen to see him in person, don't bother asking for a loan.  <A HREF="/index?t=tournaments&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A> has plans for 
