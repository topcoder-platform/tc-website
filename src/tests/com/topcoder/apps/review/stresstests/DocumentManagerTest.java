...
public class DocumentManagerTest extends AbstractStressTest {
    ...
    Worker getWorker(int count, int type, Object[] params) {
        switch (type) {
            case 0: return new DocumentWorker1(count, params);
            case 1: return new DocumentWorker2(count, params);
            case 2: return new DocumentWorker3(count, params);
            case 3: return new DocumentWorker4(count, params);
            case 4: return new DocumentWorker5(count, params);
            case 5: return new DocumentWorker6(count, params);
            case 6: return new DocumentWorker7(count, params);
            case 7: return new DocumentWorker8(count, params);
            case 8: return new DocumentWorker9(count, params);
            case 9: return new DocumentWorker10(count, params);
            case 10: return new DocumentWorker11(count, params);
            case 11: return new DocumentWorker12(count, params);
            case 12: return new DocumentWorker13(count, params);
            case 13: return new DocumentWorker14(count, params);
            case 14: return new DocumentWorker15(count, params);
            case 15: return new DocumentWorker16(count, params);
        }
        return null;
    }
