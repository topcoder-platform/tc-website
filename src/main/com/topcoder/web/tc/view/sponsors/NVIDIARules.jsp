...
<%-- Center Column Begins --%>
        ...
        <p>The Coding Phase is a timed event where all competitors are presented with the same problem statement. The criteria for scoring will be provided in the problem statement and may be different from standard marathon matches. During the Competition, each competitor may submit one of two types of submissions: an Example Submission or a Full Submission.</p>
        ...
        <table cellpadding="0" cellspacing="0" class="stat" width="90%" align="center">
            <tbody>
                ...
                <tr class="light">
                    ...
                    <td class="value C">September 14, 2008<br />1:00 EDT</td>
                    <td class="value R">September 25, 2008<br />1:00 EDT</td>
                </tr>
                <tr class="dark">
                    <td class="value">Competition 2</td>
                    <td class="value C">TBD<br />1:00 EDT</td>
                    <td class="value R">TBD<br />1:00 EDT</td>
                </tr>
                <tr class="light">
