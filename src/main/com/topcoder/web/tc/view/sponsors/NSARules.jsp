...
<%-- Center Column Begins --%>
        ...
        <div align="center"><img src="/i/sponsor/nsa/nsa_logo.jpg" border="0px" alt="NSA Logo" /><br /><br />
        	...
        	<h3 style="border-bottom: 1px dashed #999999; padding-bottom: 15px; margin-bottom: 15px;">Next competition starts January 20, 2010!&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.topcoder.com/longcontest/?module=ViewPractice" style="text-decoration: underline;">Practice Now</a></h3>
        </div>
        ...
        <p><span class="bigTitle">About the Competition</span></p>
        <p><span class="bodySubtitle">When to start the Competition Round</span><br />
TopCoder members must register for the competition round. Registration may occur at any time from December 2, 2009 13:00 GMT/UTC -5 to December 16, 2009 at 13:00 GMT/UTC -5. All competitors who have registered for the competition round will immediately be given access to the competition problem statement for that round. The competition round will begin on December 2, 2009 at 13:00 GMT/UTC -5 which is the earliest time that any member will be given access to the problem statement.        
        <p><span class="bodySubtitle">Upon Entering a Marathon Match</span><br />
			All competitors registered for a specific Marathon Match will see a Submit option for that event. Clicking the Submit link will take you to a page that will allow you to paste in a solution, select the proper language and either submit (for compilation and testing) or save your code. When the Submit button is selected, the code will be immediately compiled. Any compilation messages or errors will be shown in the Messages Area. If the compilation was successful, the submission will then be placed on a queue for automated testing. Example test cases will not be tested. When your submission has been processed, you will receive an email indicating such and your place in the standings will be adjusted accordingly. During the submission phase, overall ranking and provisional score are the only pieces of information that will be made available. A given competitor will only be allowed to submit once every 2 hours. Additionally, if a competitor has a pending submission on the testing queue it must finish testing before they may submit again.</p>
        ...
        <p><span class="bodySubtitle">Choice of Law and Forum</span><br />
			These Terms are governed by the laws of the State of Connecticut. You hereby agree to submit to the exclusive jurisdiction of the courts of the State of Connecticut. To the extent that applicable laws have mandatory application to these Terms or give you the right to bring action in any other courts, the above limitations may not apply to you. Use of TopCoder's website(s) and participation in projects posted on TopCoder's website(s) are unauthorized in any jurisdiction that does not give full effect to all provisions of these Terms.</p>
        ...
        <p><span class="bodySubtitle">Other</span><br />
            ...
            <p>A winners list of coder handles for all competitions will be available on the web site at <a href="http://www.topcoder.com">http://www.topcoder.com</a> displayed for at least 3 months after the end of the competition.
              <p>TopCoder may assign, novate or subcontract any or all of its rights and obligations under these rules and regulations at any time.
              <p>This competition is brought to you by TopCoder, Inc., 95 Glastonbury Blvd, Glastonbury, CT 06033.
              <p>If you have any questions regarding these Terms, contact us at <a href="mailto: service@topcoder.com">service@topcoder.com</a>
              <p>&nbsp;</p>
