...
<%-- Center Column Begins --%>
        ...
        <div align="center"><img src="/i/sponsor/nsa/nsa_logo.jpg" border="0px" alt="NSA Logo" /><br /><br />
        	...
        	<h3 style="border-bottom: 1px dashed #999999; padding-bottom: 15px; margin-bottom: 15px;">Next Competition Begins February 17, 2010!&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.topcoder.com/longcontest/?module=ViewPractice" style="text-decoration: underline;">Practice Now</a></h3>
        </div>
...
TopCoder members must register for the competition round. Registration may occur at any time during the two week competition round. All competitors who have registered for the competition round will immediately be given access to the competition problem statement for that round. The next competition round will begin on January 20, 2010 at 13:00 GMT/UTC -5 which is the earliest time that any member will be given access to the problem statement.         <p><span class="bodySubtitle">Upon Entering a Marathon Match</span><br />
