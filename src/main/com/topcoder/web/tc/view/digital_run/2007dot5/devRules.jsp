...
<br><br>
Each component posted for a development competition will carry a "placement point" value equivalent to the prize money for the component. <A href="/tc?module=Static&d1=digital_run&d2=2007dot5&d3=desOverview">Placement Points</A> will be awarded based on the number of submissions that pass review. By registering for any development competition, a competitor agrees to the items outlined on each component's Project Overview page, including the Eligibility requirements and the Terms of Work, and the completion of all paperwork required by TopCoder.
<br><br>
