...
The remaining $42,000 will be distributed among the top half of point-getters (all competitors tied for the last spot included), and will be allocated based on the value of each placement point.
<br><br>
