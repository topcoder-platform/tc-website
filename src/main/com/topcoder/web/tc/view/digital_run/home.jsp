    ...
    <div id="pageSpacer">
        ...
        <div id="contestTypes">
            ...
            <div class="designColumn">
                ...
                <div>
                    <a href="/dr?module=ViewLeaderBoard&amp;tid=2072">Leaderboards</a>
                </div>
                <div class="prizeLine">
                    <span class="money">
            ...
            <div class="developmentColumn">
                ...
                <div>
                    <a href="/dr?module=ViewLeaderBoard&amp;tid=2073">Leaderboards</a>
                </div>
                <div class="prizeLine">
                    <span class="money">
            ...
            <div class="studioColumn">
                ...
                <div>
                    <a href="http://<%=ApplicationServer.STUDIO_SERVER_NAME%>/dr?module=ViewLeaderBoard&amp;tid=2074">Leaderboards</a>
                </div>
                <div class="prizeLine">
                    <span class="money">
