...
<br><br>
<span class="bigRed">Please note: For Stage 3 (November 3, 2006 - February 1, 2007), Design Cup prizes have been doubled! See below for the updated prize amounts.
<br><br>
<strong>Top Five Stage Prizes</strong><br>
<strong>1st</strong> - $50,000<br>
<strong>2nd</strong> - $20,000<br>
<strong>3rd</strong> - $14,000<br>
...
The remaining $28,000 <span class="bigRed">($56,000 for Stage 3)</span> will be distributed among the top 1/3 of point-getters (all people tied for the last spot will be included), and will be allocated based on the value of each placement point.  
<br><br>
For example:<br>
A total of 120 designers accumulate placement points during the Stage.  We will sum the total number of placement points accumulated by the top 40 designers and divide $28,000 <span class="bigRed">($56,000 for Stage 3)</span> by that number to find the dollar per placement point bonus that is available to those 40 designers.  If the total placement points of those 40 designers are 7,000, then each point is worth $4 ($28,000/7,000 = $4 per placement point).  Each of the top 40 designers, including the top 5, will receive $4 for each placement point received during the Stage.  In addition, the top 5 point-getters each Stage will receive the Top Five Stage prizes outlined above.
<br><br>
