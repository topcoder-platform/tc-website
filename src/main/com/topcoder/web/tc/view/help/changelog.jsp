...
<p>
    5.8.8 - 2007.03.xx
    <ul>
        <%--<li>Bugfix: Rboard payments were generated by default with on-hold Pending AD status. There was also another addition to be able to switch on/off this default</li>--%>
