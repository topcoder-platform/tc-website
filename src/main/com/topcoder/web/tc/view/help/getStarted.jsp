...
<!-- Center Column Begins -->
		...
		<p><span class="bodySubtitle">Become a TopCoder Member</span><br/>
        ...
        <a name="howtorun"></a>
		<p><span class="bodySubtitle">How to Run the TopCoder Arena</span><br/>
		
		<ul>
		<li>
        <a name="whatsoftware"></a>
			<p><span class="bodySubtitle">What software will you need to install?</span><br/>
			In order to run the TopCoder Arena, you will need to install a Java runtime environment that is at least version 1.3.  Most browser software will recognize the existence of a Java runtime on your machine, and utilize the latest version in order to run the Arena as an applet. The latest version of the JRE (Java Runtime Environment) can be downloaded from <A href="http://java.sun.com/products/plugin">Sun's website</A>. If you have the Sun 1.3 or 1.4 JRE or JDK installed on your machine, you already have the plug-in software installed. We recommend installing the JRE 1.4 environment, which is the most current version available. Once the plug-in (or the 1.3/1.4 environment) has been downloaded and installed, you will not need to perform these steps in the future. The download for the JRE version 1.4, which includes the plug-in software, is over 10MB. This means the download may take some time to complete. Remember, this download only needs to be completed once. Completing the previous steps will also satisfy all prerequisites in order to run the TopCoder Arena from within your browser. Installing the 1.3/1.4 Java Runtime will also allow you to run the TopCoder competition Arena from within Java Web Start (although Java Web Start will need to be installed separately).  The TopCoder competition software exists as a signed .jar file, which will request full access to your local machine.  This is so that certain elements of the Arena (i.e. cut and paste, writing to the local file system, etc.) will function properly.
		</li>
		<li>
        <a name="runningarena"></a>
			<p><span class="bodySubtitle">Running the TopCoder Arena as an Applet or by using Java Web Start</span><br/>
			Many TopCoder members prefer to run the TopCoder Arena as an application, rather than an Applet.  In some cases, this can provide greater stability.  Java Web Start (JWS) will facilitate this process, checking for new versions of the software each time the Arena is run.  In order to use JWS, you may first need to install the <A href="http://java.sun.com/products/javawebstart/">JWS software</A>.  If JWS is already installed, the following link will install and run the TopCoder Arena as an application on your machine:
			http://www.topcoder.com/contest/arena/ContestAppletProd.jnlp
		</li>
		<li>
        <a name="localfirewall"></a>
			<p><span class="bodySubtitle">Local Firewall and Network Considerations</span><br/>
        ...
        <a name="httptunneling"></a>
			<p><span class="bodySubtitle">HTTP Tunneling</span><br/>
        ...
        <a name="loggingin"></a>
		<p><span class="bodySubtitle">Logging in to the TopCoder Arena</span><br/>
		...
		<p><span class="bodySubtitle">General Usage and the Various Lobbies</span><br/>
        ...
        <a name="generalchat"></a>
			<p><span class="bodySubtitle">General Chat</span><br/>
		...
		<li>
        <a name="replyto"></a>
			<p><span class="bodySubtitle">ReplyTo</span><br/>
		...
		<li>
        <a name="whisper"></a>
			<p><span class="bodySubtitle">Whisper</span><br/>
		...
		<li>
        <a name="admin"></a>
			<p><span class="bodySubtitle">Admin</span><br/>
		...
		<li>
        <a name="autochat"></a>
			<p><span class="bodySubtitle">Auto-Enhanced Chat</span><br/>
		...
		<li>
        <a name="emoting"></a>
			<p><span class="bodySubtitle">Emoting</span><br/>
		...
		<p><span class="bodySubtitle">Other Members in the Arena</span><br/>

		<ul>
		<li>
        <a name="getinfo"></a>
			<p><span class="bodySubtitle">Getting Information about another Member</span><br/>
		...
		<li>
        <a name="findmember"></a>
			<p><span class="bodySubtitle">Finding Another Member</span><br/>
		...
		<li>
        <a name="seemembers"></a>
			<p><span class="bodySubtitle">Seeing Who's in the Arena</span><br/>
		...
		<p><span class="bodySubtitle">Moving Around</span><br/>
		...
		<p><span class="bodySubtitle">The Leader Board</span><br/>
