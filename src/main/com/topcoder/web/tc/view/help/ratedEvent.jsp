...
<!-- Center Column Begins -->
		...
		<br/><br/>
		In addition to SRMs, TopCoder holds two advancement tournaments (the TopCoder Open and the TopCoder Collegiate Challenge) each year.  Advancement tournaments are elimination tournaments and generally have a substantially prize purse involved.  Each round of a tournament will affect the ratings of all participants, so they are also considered "rated events".  For 
		</p>
		...
		<p><span class="bodySubtitle">11 Rating Changes</span><br/>
		...
		<p><span class="bodySubtitle">12 Web Site Statistics</span><br/>
		...
		<a name="problems"></a>
		<p><span class="bodySubtitle">13 Problems in the Practice Rooms</span><br/>
		...
		<a name="donotagree"></a>
		<p><span class="bodySubtitle">14 What if You Do Not Agree with the Results?</span><br/>
		...
		<a name="cheating"></a>
		<p><span class="bodySubtitle">17 Cheating at TopCoder</span><br/>
		...
		<p><span class="bodySubtitle">19 TopCoder Arena Plug-ins</span><br/>
