...
<%@ page import="com.topcoder.web.tc.TCO11Constants" %>

<%@ include file="../includes/taglibs.jsp" %>

<tco11:pageSetup title="TCO 11 : Studio Competition Leaderboard" area="studio" menu="advancers" subMenu="leaderboard"/>
                                                ...
                                                <c:choose>
                                                    <c:when test="${(not empty resultRow.submissionId) and (resultRow.submissionId > 0)}">
                                                        <a href="${DOWNLOAD_SUBMISSION_URL}${resultRow.submissionId}">
                                                            <img src="/i/tournament/tco11/magnify.png" alt="View submission" title="View submission" />
                                                        </a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        &nbsp;
