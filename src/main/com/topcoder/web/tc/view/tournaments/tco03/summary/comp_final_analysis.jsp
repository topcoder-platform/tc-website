...
<html>
<head>
<title>2003 TopCoder Open sponsored by Intel&#174;  - Summary - Component Final Round Problem Anaylsis</title>
...
<jsp:include page="../tco03Sublinks.jsp" >
   ...
   <jsp:param name="selectedTab" value="comp_final"/>
            ...
            <p class="terciary">
                <a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=summary&d4=comp_final">Play-by-Play</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=summary&d4=comp_final_photos">Photos</a>&nbsp;&nbsp;|&nbsp;&nbsp;Problem Analysis
            </p>
            ...
            <table border="0" cellspacing="2" cellpadding="0" class="pointsTable">
                    ...
                    <td class="points">xxx</td>
                </tr>
                               			
                    <tr>
                    <td class="pointsLabel">Submission Rate</td>
                    <td class="points">x / x  (xx.xx%) </td>
                </tr>
                    ...
                    <td class="pointsLabel">handle</b> for xxx.xx points</td>
                </tr>
            </table>
            </blockquote>
