...
<%--      <li class="stop"><a href="/tc?module=TCO07ViewRegistrants&ct=sponsortrack"<% if (tabLev1.equals("algorithm") && tabLev2.equals("registrants")) {%> class="navHighlight"<% } %>><div>Registrants</div></a></li>--%>
        <li class="stop"><a href="/tc?module=Static&d1=tournaments&d2=tco07&d3=sponsortrack&d4=qualification"<% if (tabLev1.equals("sponsortrack") && tabLev2.equals("qualification")) {%> class="navHighlight"<% } %>><div>Qualification Advancers</div></a></li>
        <li class="stop"><a href="/tc?module=Static&d1=tournaments&d2=tco07&d3=sponsortrack&d4=advOverview"<% if (tabLev1.equals("sponsortrack") && tabLev2.equals("advancers")) {%> class="navHighlight"<% } %>><div>Advancers Overview</div></a></li>
