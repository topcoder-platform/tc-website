...
<p class=bigTitle>Important Information Requested</p>
<span class=bodySubtitle>Please read all instructions carefully before proceeding.</span><br/>


<h2>Travel Information - please submit as soon as possible (we appreciate a quick response)</h2>
...
<p>
    A hotel room will be confirmed for your arrival on November 14 and departure on November 18, 2006.
    The check-in time is 4:00PM and check out time is 11:00AM. If you have any special requests, please indicate
    them on the travel form below. The cost of your sleeping room and applicable taxes will be charged to the
...
<p>TopCoder will secure airline reservations based upon your registration information and will email a travel itinerary
    to you by Thursday, November 9th. Please be advised that once airlines tickets are confirmed, any changes are
    subject to penalty fees at your own expense.</p>
...
<p>
    ...
    board upon your arrival at the airport will be indicated on your agenda.
</p>
...
<tr>
    <td class="sidebarText" colspan="2">
        ...
        Guests are invited to attend the TCCC06 and TopCoder can help make travel and lodging arrangements. However,
