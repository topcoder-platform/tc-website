...
<tco10:pageSetup title="TCO 11 : Registration" area="overview"/>
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <form name="terms" method="post" action="/tco11">
                            ...
                            <div align="center">
                                ...
                                <iframe width="600" height="300" marginwidth="5"
                                        src="/tc?module=Static&amp;d1=tournaments&amp;d2=tco11&amp;d3=termsContent&${TERMS_OF_USE_ID}=${event.terms.id}"></iframe>
                                </p>
                            </div>
                            <div align="center">
                                <p>
