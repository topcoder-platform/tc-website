...
<tco11:pageSetup title="TCO 11 : Design Competition" area="design" menu="description"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Welcome to the TCO10 Design Competition!</h2><!-- page title -->
                            ...
                            <p>When is the competition? <tco11:designStaticPageLink page="schedule">See the schedule.</tco11:designStaticPageLink><br />
                                It is important for you to read the <tco11:overviewStaticPageLink page="rules">official rules and regulations</tco11:overviewStaticPageLink> for important details. Also, you must read through the specific rules for the <tco11:designStaticPageLink page="rules">Design Competition.</tco11:designStaticPageLink><br />
