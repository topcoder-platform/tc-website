...
<tco11:pageSetup title="TCO 11 : Marathon Competition Rules" area="marathon" menu="rules"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Marathon Competition Official Rules and Regulations</h2><!-- page title -->
                            ...
                            <p>The Marathon Competition is part of the Tournament, and by participating in this Marathon Competition, you agree to these <tco11:marathonStaticPageLink page="rules">rules.</tco11:marathonStaticPageLink></p>
