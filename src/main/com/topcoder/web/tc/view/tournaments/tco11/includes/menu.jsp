...
<div id="menu">
    ...
    <ul>
        <li class="${overviewClass} first overview">
            ...
            <tco11:overviewStaticPageLink page="overview" styleClass="${overviewClass}">
        ...
        <li class="${algorithmClass} algorithm">
            ...
            <tco11:algorithmStaticPageLink page="description" styleClass="${algorithmClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                Algorithm
            </tco11:algorithmStaticPageLink>
        </li>
        <li class="${designClass} design">
            <span class="topIcon orange"></span><!--  item top sign -->
            <tco11:designStaticPageLink page="description" styleClass="${designClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                Design
            </tco11:designStaticPageLink>
        </li>
        <li class="${developmentClass} development">
            <span class="topIcon green"></span><!--  item top sign -->
            <tco11:developmentStaticPageLink page="description" styleClass="${developmentClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                Development
            </tco11:developmentStaticPageLink>
        </li>
        <li class="${marathonClass} marathon">
            <span class="topIcon blue"></span><!--  item top sign -->
            <tco11:marathonStaticPageLink page="description" styleClass="${marathonClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                Marathon
        ...
        <li class="${moddashClass} moddash">
            <span class="topIcon green"></span><!--  item top sign -->
            <tco11:moddashStaticPageLink page="description" styleClass="${moddashClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                ModDash
            </tco11:moddashStaticPageLink>
        </li>
        <li class="${studioClass} studio">
            <span class="topIcon orange"></span><!--  item top sign -->
            <tco11:studioStaticPageLink page="description" styleClass="${studioClass}">
                <span class="itemIcon"></span><!-- item photo -->
                <span class="itemText"></span><!-- item text content -->
                Studio
            </tco11:studioStaticPageLink>
        </li>
