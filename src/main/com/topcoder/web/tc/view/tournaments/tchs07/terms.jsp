            ...
            <form name="terms" method="POST" action="${sessionInfo.servletPath}">
                ...
                <p align="center">
                    <tc-webtag:errorIterator id="err" name="<%=RegistrationBase.IN_COLLEGE%>"><span class="bigRed">${err}
                        <br/></span></tc-webtag:errorIterator>
                    Are you enrolled full time at a college or university? <tc-webtag:listSelect name='<%=RegistrationBase.IN_COLLEGE%>' size="<%=RegistrationBase.YES_NO_ANSWERS.size()%>" list="<%=RegistrationBase.YES_NO_ANSWERS%>"/>
                </p>

                <p align="center">
                    <tc-webtag:errorIterator id="err" name="<%=RegistrationBase.IN_HIGH_SCHOOL%>"><span class="bigRed">${err}
                        <br/></span></tc-webtag:errorIterator>
                    Are you enrolled full time at a secondary school? <tc-webtag:listSelect name='<%=RegistrationBase.IN_HIGH_SCHOOL%>' size="<%=RegistrationBase.YES_NO_ANSWERS.size()%>" list="<%=RegistrationBase.YES_NO_ANSWERS%>"/>
                </p>
