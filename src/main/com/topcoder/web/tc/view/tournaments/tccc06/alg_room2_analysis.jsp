...
<br /><br />
andrewzta <tc-webtag:handle coderId="11829284" context="algorithm"/> was not far behind though and, going into the challenge phase, there was the unprecedented possibility of a coder failing to advance despite solving all three problems.  As the challenge phase started, <tc-webtag:handle coderId="262056" context="algorithm"/> was far enough of ahead of third place <tc-webtag:handle coderId="20286298" context="algorithm"/> that he was almost certain to advance unless one of his problems failed.
<br /><br />
The challenge phase proved fairly tame, compared to round 1, which foreshadowed a relatively uneventful system test.  In the end, the top 6 remained unchanged, meaning that <tc-webtag:handle coderId="26205" context="algorithm"/> and <tc-webtag:handle coderId="11829284" context="algorithm"/> advanced to the finals, while <tc-webtag:handle coderId="20286298" context="algorithm"/>, <tc-webtag:handle coderId="8357090" context="algorithm"/>, <tc-webtag:handle coderId="20635649" context="algorithm"/>, and <tc-webtag:handle coderId="310723" context="algorithm"/> will have to fight it out in the wildcard room.
<br /><br />
