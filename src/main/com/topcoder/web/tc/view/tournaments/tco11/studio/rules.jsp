...
<tco11:pageSetup title="TCO 11 : Studio Competition Rules" area="studio" menu="rules"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Studio Design Competition Official Rules and Regulations</h2><!-- page title -->
                            ...
                            <p>The Studio Design Competition is part of the Tournament, and by participating in this Studio Design Competition, you agree to these <tco11:studioStaticPageLink page="rules">rules.</tco11:studioStaticPageLink></p>
