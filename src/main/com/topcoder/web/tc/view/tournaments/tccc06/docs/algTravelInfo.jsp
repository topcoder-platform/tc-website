...
<p>
    ...
    <%--            <p>
        ...
        various card games, etc.). We hope many of you will take this opportunity to spend some time
        together outside of the tournament.
    </p>--%>

<p>
    A hotel room will be confirmed for your arrival on May 2 and departure on May 6, 2006. The check-in time is 3:00PM
    and check out time is 11:00AM. If you have any special requests, please indicate them on the travel form below. The
    cost of your sleeping room and applicable taxes will be charged to the TopCoder master account. You will be
    required, however, to provide a credit card upon check-in for any incidental expenses.
</p>

<p>
    <b>At the TCO06, you will be sharing a hotel room with another competitor.</b> Please fill in the
...
<p>
    TopCoder will secure airline reservations based upon your registration information and will email a travel itinerary
    to you by Thursday, April 27, 2006. Please be advised that once airlines tickets are confirmed, any changes are
    subject to penalty fees at your own expense. TopCoder will provide travel arrangements for each competitor up to a
    cost of $1,500 per person. (That is, if a contestant's airfare is greater than $1,500, the difference between the
    cost of the airfare and $1,500 will be deducted from the contestant's total TCO prize money won. If the contestant's
    total TCO prize money is not sufficient to cover the additional costs, the contestant will be responsible for
    remitting to TopCoder the remainder of the cost.) The flight reserved by and paid for by TopCoder is for arrival on
    May 2, 2006 and departure on May 6, 2006. Extended flights and/or hotel room nights requested by a competitor that
    result in additional costs will be the responsibility of the competitor and will be deducted from the competitor's
    total TCO prize money won.
</p>
