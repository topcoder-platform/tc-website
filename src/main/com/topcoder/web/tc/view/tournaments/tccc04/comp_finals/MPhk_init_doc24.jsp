    ...
    <tr valign="top">
        <td width="190">
            <jsp:include page="MPhk_files.jsp">
                ...
                <jsp:param name="doc" value="doc24"/>
            </jsp:include>
        </td>
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/MPhk/diagrams/Catalog_Use_Case_Diagram_managing_porduct_groups_and_products.gif" alt="" border="0"></div></td>
