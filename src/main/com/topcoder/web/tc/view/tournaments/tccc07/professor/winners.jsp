    ...
    <div id="containAll">
        <div id="content">
            ...
            <div id="pageBody">
                ...
                <p style="float:right; width:175px; height: 219px; padding:10px;"><img style="border: 3px solid #2f2f2f;" alt="Professor Vitaly Bondarenko" src="/i/tournament/tccc07/vvb.png" /></p>
                ...
                <p style="float:right; width:175px; height: 231px; padding:10px;"><img style="border: 3px solid #2f2f2f;" alt="Professor Yue Chen" src="/i/tournament/tccc07/chenyue.png" /></p>
