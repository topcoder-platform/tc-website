    ...
    <tr valign="top">
        ...
        <td width="99%">
            ...
            <jsp:include page="times.jsp">
                ...
                <tr>
                    <td width="99%"><img src="/i/tournament/tco03/comp_docs/pops/initial/AddaMethodAspecttoanexistingobject.gif" alt="" width="1056" height="434" border="0" class="compDocs"></td>
