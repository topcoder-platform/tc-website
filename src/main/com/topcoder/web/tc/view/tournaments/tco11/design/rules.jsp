...
<tco11:pageSetup title="TCO 11 : Design Competition Rules" area="design" menu="rules"/>
...
<div id="wrapper" class="homepage singlePage"><!-- the outest whole website wrapper -->
    ...
    <div id="content">
        <div class="contentInner">
			...
			The Design Competition is part of the Tournament, and by participating in the competition, you agree to these <tco11:designStaticPageLink page="rules">rules.</tco11:designStaticPageLink></p>
