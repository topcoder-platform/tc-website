    ...
    <tr valign="top">
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="2">
                        <jsp:include page="times.jsp">
                            <jsp:param name="member" value="rnielsen" />
                            <jsp:param name="time" value="1130" />
                        </jsp:include>
                    </td>
                </tr>
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tco03/comp_docs/rnielsen/SequenceDiagram3.gif" alt="" width="1392" height="634" border="0"></div></td>
