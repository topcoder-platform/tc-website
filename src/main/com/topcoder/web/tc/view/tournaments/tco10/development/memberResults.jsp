...
<tco10:pageSetup title="TCO 10 : Development Competition Results" area="development" menu="leaderboard"/>
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <h2 class="pageTitle">
                            ...
                            <tc-webtag:handle context="dev" coderId="${userDetailsRow.map['coder_id']}"
                                              darkBG="true"/>
                        </h2>
                                    ...
                                    <td class="first last alignText">
                                        ...
                                        <c:choose>
                                            <c:when test="${result.complete}">
                                                | <a href="/tc?module=ProjectDetail&amp;pj=${result.projectId}&amp;tab=results">contest
                                                details</a>
                                            </c:when>
                                            <c:otherwise>
                                                *
