...
<!-- Conditions of Participation -->
         ...
         <p>As a condition of participation in the tournament, all information provided in the TopCoder member profile must be comprehensive, accurate and up-to-date. TopCoder may require each competitor to complete an additional registration form to register for the tournament. In order to be eligible to participate in the tournament, each competitor must have completed any and all registration forms required by TopCoder.</p>
