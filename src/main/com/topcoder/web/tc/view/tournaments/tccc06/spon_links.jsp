      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr>
            ...
            <% if (tabLev2.equals("details")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_description"><img src="/i/tournament/tccc06/tabs/L2_detailsOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_description"><img src="/i/tournament/tccc06/tabs/L2_detailsOff.gif" alt="" border="0" /></A></td>
            <% } %>
<%--
            <% if (tabLev2.equals("registration")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_reg"><img src="/i/tournament/tccc06/tabs/L2_registrationOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_reg"><img src="/i/tournament/tccc06/tabs/L2_registrationOff.gif" alt="" border="0" /></A></td>
            <% } %>
            <% if (tabLev2.equals("registrants")) {%>
               <td class="nav"><A href="/tc?module=TCO05AlgRegistrants"><img src="/i/tournament/tccc06/tabs/L2_registrantsOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=TCO05AlgRegistrants"><img src="/i/tournament/tccc06/tabs/L2_registrantsOff.gif" alt="" border="0" /></A></td>
            <% } %>

            <% if (tabLev2.equals("advancers")) {%>
               <td class="nav"><A href="/tc?module=SimpleStats&c=tccc06_spon_adv_overview&trans=true&d1=tournaments&d2=tccc06&d3=spon_adv_overview"><img src="/i/tournament/tccc06/tabs/L2_advancersOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=SimpleStats&c=tccc06_spon_adv_overview&trans=true&d1=tournaments&d2=tccc06&d3=spon_adv_overview"><img src="/i/tournament/tccc06/tabs/L2_advancersOff.gif" alt="" border="0" /></A></td>
            <% } %>
<%--
...
--%>
            <% if (tabLev2.equals("competitionArena")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_arena"><img src="/i/tournament/tccc06/tabs/L2_competitionArenaOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_arena"><img src="/i/tournament/tccc06/tabs/L2_competitionArenaOff.gif" alt="" border="0" /></A></td>
            <% } %>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="subNav">
         <tr>
            <td class="subnavBG">&#160;&#160;&#160;</td>
               <% if (tabLev2.equals("details")) {%>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_description"><% if (tabLev3.equals("description")) {%><img src="/i/tournament/tccc06/tabs/L3_descriptionOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_descriptionOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_schedule"><% if (tabLev3.equals("schedule")) {%><img src="/i/tournament/tccc06/tabs/L3_scheduleOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_scheduleOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_rules"><% if (tabLev3.equals("rules")) {%><img src="/i/tournament/tccc06/tabs/L3_rulesOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_rulesOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=spon_instructions"><% if (tabLev3.equals("instructions")) {%><img src="/i/tournament/tccc06/tabs/L3_instructionsOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_instructionsOff.gif" border="0" /><% } %></a></td>
             <% } else if (tabLev2.equals("registration")) {%>
               ...
               <% } else if (tabLev2.equals("advancers")) {%>
                  <td class="subnav"><a href="/tc?module=SimpleStats&c=tccc06_spon_qual&trans=true&d1=tournaments&d2=tccc06&d3=spon_qualification"><% if (tabLev3.equals("qualification")) {%><img src="/i/tournament/tccc06/tabs/L3_qualificationOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_qualificationOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=SimpleStats&c=tccc06_spon_adv_overview&trans=true&d1=tournaments&d2=tccc06&d3=spon_adv_overview"><% if (tabLev3.equals("overview")) {%><img src="/i/tournament/tccc06/tabs/L3_overviewOn.gif" border="0" /><% } else { %><img src="/i/tournament/tccc06/tabs/L3_overviewOff.gif" border="0" /><% } %></a></td>
<%--
--%>
