    ...
    <tr valign="top">
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/MPhk/diagrams_final/Catalog_Use_Case_Diagram_catalog_and_managers.gif" alt="" border="0"></div></td>
