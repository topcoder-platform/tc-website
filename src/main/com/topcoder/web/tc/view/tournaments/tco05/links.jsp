...
--%>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tco05&d3=odds_rd1" target="_blank"><% if (tabLev3.equals("odds")) {%><img src="/i/tournament/tco05/tabs/L3_oddsOn.gif" border=0 /><% } else { %><img src="/i/tournament/tco05/tabs/L3_oddsOff.gif" border=0 /><% } %></a></td>
