...
--%>
            ...
            <% if (tabLev2.equals("advancers")) {%>
               <td class=nav><A href="/tc?module=SimpleStats&c=tco05_alg_qual&trans=true&d1=tournaments&d2=tco05&d3=alg_qualification"><img src="/i/tournament/tco05/tabs/L2_advancersOn.gif" alt="" border=0 /></A></td>
            <% } else { %>
               <td class=nav><A href="/tc?module=SimpleStats&c=tco05_alg_qual&trans=true&d1=tournaments&d2=tco05&d3=alg_qualification"><img src="/i/tournament/tco05/tabs/L2_advancersOff.gif" alt="" border=0 /></A></td>
            <% } %>
<%--
