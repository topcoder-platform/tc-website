...
<div id="wrapper">
    ...
    <jsp:param name="tabLev3" value="bt"/>
        ...
        <p>BT is excited to sponsor the world's top programming talent at the 2008 TopCoder&reg; Open.  Al-Noor Ramji, CIO, BT Group says: "At BT, we are harnessing the power of our software-driven innovation ecosystem.  Partnering with the world's leading programming minds is core to that strategy."</p>
