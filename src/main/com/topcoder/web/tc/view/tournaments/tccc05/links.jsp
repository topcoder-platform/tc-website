			...
			<tr>
				...
				<% if (tabLev1.equals("overview")) { %>
					<% if (tabLev2.equals("join_us")) {%>
						...
						<td class=subnav><a href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=specshow"><% if (tabLev3.equals("specshow")) {%><img src="/i/tournament/tccc05/tabs/L3_specshowOn.gif" border=0><% } else { %><img src="/i/tournament/tccc05/tabs/L3_specshowOff.gif" border=0><% } %></a></td>
				...
				<% } else if (tabLev1.equals("algorithm")) { %>
					...
					<% } else if (tabLev2.equals("advancers")) {%>
						<td class=subnav><a href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=alg_qual"><% if (tabLev3.equals("qualification")) {%><img src="/i/tournament/tccc05/tabs/L3_qualificationOn.gif" border=0><% } else { %><img src="/i/tournament/tccc05/tabs/L3_qualificationOff.gif" border=0><% } %></a></td>
				...
				<% } else if (tabLev1.equals("component")) { %>
					<% if (tabLev2.equals("details")) {%>
						<td class=subnav><a href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=comp_description"><% if (tabLev3.equals("details")) {%><img src="/i/tournament/tccc05/tabs/L3_detailsOn.gif" border=0><% } else { %><img src="/i/tournament/tccc05/tabs/L3_detailsOff.gif" border=0><% } %></a></td>
