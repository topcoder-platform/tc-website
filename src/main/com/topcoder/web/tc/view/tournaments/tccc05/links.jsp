...
--%>
				...
				<% if (tabLev2.equals("summary")) {%>
					<td class=nav><A href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=alg_room3_analysis"><img src="/i/tournament/tccc05/tabs/L2_summaryOn.gif" alt="" border=0 /></A></td>
				<% } else { %>
					<td class=nav><A href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=alg_room3_analysis"><img src="/i/tournament/tccc05/tabs/L2_summaryOff.gif" alt="" border=0 /></A></td>
				<% } %>
<%--
--%>
				<% } else if (tabLev1.equals("component")) { %>
