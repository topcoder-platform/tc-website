    ...
    <% } else if (list.equals("coding_advancers")) { %>
            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tcoSubNav">
                <tr>
                    ...
                    <td class="<%=tab.equals("radeye")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="Javascript:openWin('/tc?module=Static&d1=tournaments&d2=tco03&d3=tco03_radeye_rd1','radeye1',900,600);" class="topLink">radeye's Odds</a></td>
                    <td class="tcoSubNav" width="49%"><img src="/i/clear.gif" alt="" width="10" height="1" border="0" /></td>
                </tr>
            </table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodyText">
