...
<tco11:pageSetup title="TCO 11 : Design Competition Final Results" area="design" menu="finalResults"/>
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn" style="margin-bottom:30px">
                    <div class="text">
                        ...
                        <div style="float: left"><br/><img src="/i/tournament/tco11/result/design.jpg" alt="argolite"
