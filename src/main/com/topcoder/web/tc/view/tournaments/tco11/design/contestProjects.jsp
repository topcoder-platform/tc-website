...
<tco11:pageSetup title="TCO 11 : Design Competition Projects" area="design" menu="leaderboard"/>
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <h2 class="pageTitle">
                            <a href="${sessionInfo.servletPath}?module=ContestDetails&amp;eid=3433&amp;ct=479">
                                ...
                                <c:forEach items="${contestProjects}" var="project">
                                    <tr>
                                        ...
                                        <td class="first last alignText">
                                            ...
                                            |
                                            <a href="${sessionInfo.servletPath}?module=ProjectDetails&amp;eid=3433&amp;ct=479&amp;pj=${project.map['project_id']}">
                                                results
                                            </a>
                                            <c:if test="${project.map['is_complete'] != 0}">
                                                |
