...
<jsp:include page="../tco03Sublinks.jsp" >
   ...
   <jsp:param name="selectedTab" value="reception"/>
            ...
            <p class="terciary">
                <a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=summary&d4=reception">Play-by-Play</a>&nbsp;&nbsp;|&nbsp;&nbsp;Photos&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=summary&d4=reception_analysis">Problem Analysis</a>
            </p>
