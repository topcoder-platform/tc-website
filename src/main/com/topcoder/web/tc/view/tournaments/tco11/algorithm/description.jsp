...
<tco11:pageSetup title="TCO 11 : Algorithm Competition" area="algorithm" menu="description"/>
                ...
                <div class="bigColumn">
                    <div class="text">
                        <h2 class="pageTitle">Welcome to the Algorithm Competition!</h2><!-- page title -->
                             ...
                             <p>When is the competition? <tco11:algorithmStaticPageLink page="schedule">See the schedule.</tco11:algorithmStaticPageLink><br />
                                It is important for you to read the <tco11:overviewStaticPageLink page="rules">official rules and regulations</tco11:overviewStaticPageLink>
                                 for important details. Also, you must read through the specific rules for the 
                                <tco11:algorithmStaticPageLink page="rules">Alogrithm Competition.</tco11:algorithmStaticPageLink><br />
