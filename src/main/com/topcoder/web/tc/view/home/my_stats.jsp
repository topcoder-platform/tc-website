            ...
            <table border="0" cellspacing="0" cellpadding="10" bgcolor="#001935" width="100%">
                <tr>
                    <td colspan="2" valign="top" width="100%"><img src="/i/clear.gif" alt="" width="240" height="1" border="0" vspace="1"/><br />
                        <table border="0" cellspacing="0" cellpadding="0" bgcolor="#001935" width="100%">
                              <tr>
                                 <td class="statText" valign="top" colspan="5">You must compete to view this information.</td>
                              </tr>
                            <tr>
                            ...
                            <tr>
                                  <td class="statText" valign="middle" align="right" height="13">Rank&#160;&#160;</td>
                                  <td class="statText" valign="middle" align="right">Rating&#160;&#160;</td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" bgcolor="#001935" background="/i/steel_darkblue_bg.gif" width="100%">
                            ...
                            <tr><td background="/i/steel_gray_bg3.gif" colspan="16" class="smallFoot" height="16" valign="middle">&#160;Statistics from your Last X Matches (click the <img src="/i/coders_icon_onclear.gif" alt="" width="10" height="10" hspace="2" border="0"/> icon to view problem information).</td></tr>
                            ...
                            <tr><td background="/i/steel_darkblue_bg.gif" colspan="16"><img src="/i/clear.gif" alt="" width="1" height="2" border="0"/></td></tr>
                                ...
                                <tr>
                                    ...
                                    <td background="/i/steel_darkblue_bg.gif" valign="middle" width="10"><a><img src="/i/coders_icon.gif" alt="" width="10" height="10" hspace="2" border="0"/></a></td>
                                    <td class="statText" valign="middle" align="left">Handle</td>
                                    <td class="statText" valign="middle" align="right">crap</td>
