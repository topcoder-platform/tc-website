...
<IMG SRC="/i/home/tccc06_aol_alerts.png" border="0" alt="AOL Alerts" usemap="#tccc"/>
        </td>
...
<td class="homeLeftCol">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr><td class="homeBigPromo">
            ...
            <%-- SPONSORS 
            <map name="srm">
            <area shape="rect" alt="" coords="1,1,264,85" href="/tc?module=MatchDetails&rd=10002" />
            <area shape="rect" alt="" coords="1,96,264,135" href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=aol" />
            </map>
            <img src="/i/home/aol_srm322.png" alt="SRM 322 sponsored by AOL" border="0" style="display:block;" usemap="#srm"/>
            --%>
...
<td class="homeCentCol">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr><td class="homeBigPromo">
            <A href="http://<%=ApplicationServer.SOFTWARE_SERVER_NAME%>/customers/index.jsp"><img src="/i/home/tcs_client_verisign.png" alt="TopCoder Software & Verisign" border="0" style="display:block;" /></A>
        </td></tr>
    </table>
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
