    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="homeBigPromo">
                ...
                <%-- SRM SPONSOR --%>
                <map name="mm">
                <area shape="rect" alt="" coords="1,1,264,95" href="/tc?module=MatchDetails&rd=11128" />
                <area shape="rect" alt="" coords="1,106,264,135" href="/tc?module=Static&amp;d1=tournaments&amp;d2=tco08&amp;d3=sponsorpatrons&amp;d4=aol" />
                </map>
                <img src="/i/home/srm394_aol.png" alt="SRM 394 brought to you by AOL" border="0" style="display:block;" usemap="#mm"/>
                ...
                <%-- TCO08 
                <A href="<tc-webtag:linkTracking link='/tc?module=Static&d1=tournaments&d2=tco08&d3=sponsorpatrons&d4=aol' refer='homepage_promo' />"><img src="/i/home/tco08aolPromo.png" alt="TCO08" /></A>
                --%>
