...
<!-- Center Column Begins -->
        ...
        <jsp:include page="../page_title.jsp" >
            ...
            <tr class="bodyText"><td nowrap="nowrap">02.18.05 3:45 PM&#160;-&#160</td><td width="100%"><A href="/?t=support&c=ratings_cal">Small change to Unused Code Rule, new problem timeout limit, and more...</A></td></tr>
