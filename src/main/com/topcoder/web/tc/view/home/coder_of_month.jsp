...
<div class="leftColContent">
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22767958" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="22667317" context="<%=HandleTag.DESIGN%>" darkBG="true" /><br />
        	4 wins, 2 second places<br />
         <br />
      </td>
   </tr>
   <tr>
      <td style="border-top: 1px solid #CCCCCC; padding: 5px 0;" valign="top"><img src="/i/m/utlovey_big.jpg" alt="" width="55" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
