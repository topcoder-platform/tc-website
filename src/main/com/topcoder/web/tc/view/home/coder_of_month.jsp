...
<div class="leftColContent">
   ...
   <tr>
      <td height="76" valign="top" style="border-top: 1px solid #CCCCCC; padding: 5px 0;" ><img src="/i/m/nophoto.jpg" alt="" width="61" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22739514" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td style="border-top: 1px solid #CCCCCC; padding: 5px 0;" valign="top"><img src="/i/m/lukashov.jpeg" alt="" width="61" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="22695170" context="<%=HandleTag.DESIGN%>" darkBG="true" /><br />
        	3 wins, 1 second place<br />
         <br />
      </td>
   </tr>
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="23039546" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" /><br />
