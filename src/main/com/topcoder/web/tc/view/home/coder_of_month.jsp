...
<div class="leftColContent">
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22678332" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="22698133" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" /><br />
         with 4 wins<br />
      </td>
   </tr>
   </table>
...
<div><a class="cotmFeature" href="http://www.topcoder.com/news/2010/03/09/meet-the-february-coders-and-designers-of-the-month-2/ ">Read Their Interviews</a></div>
