...
<img id="competitions" src="/i/home/catcStaticV2.png" alt="All New Digital Run" border="0" usemap="#Competitions" />
    <map name="Competitions" id="Competitions">
        ...
        <area shape="poly" coords="271,191,407,186,429,91,281,100" href="/wiki/display/tc/Bug+Races" alt="Bug Races" onmouseover="MM_swapImage('competitions','','/i/home/catcBugracesV2.png',1)" onmouseout="MM_swapImgRestore()" />
        <area shape="poly" coords="49,112,31,45,158,58,169,127" href="/longcontest/?module=ViewActiveContests" alt="Marathon" onmouseover="MM_swapImage('competitions','','/i/home/catcMarathonV2.png',1)" onmouseout="MM_swapImgRestore()" />
        <area shape="poly" coords="177,59,333,59,320,145,189,146" href="javascript:arena();" alt="Algorithm" onmouseover="MM_swapImage('competitions','','/i/home/catcAlgorithmV2.png',1)" onmouseout="MM_swapImgRestore()" />
...
<%-- TCO10 --%>
<br />
<!--<a href="<tc-webtag:linkTracking link='http://www.topcoder.com/tco10' refer='/tc' />"><img src="/i/tournament/tco10/banners/tco10-new.png" alt="2010 TopCoder Open" /></a><br /><br />-->
...
<!--<a href="<tc-webtag:linkTracking link='http://www.topcoder.com/tc?module=Static&d1=tournaments&d2=tco10&d3=overview&d4=sponsor1' refer='/tc' />"><img src="/i/tournament/tco10/banners/tco10-yandex-510x100.png" alt="Yandex - Event Sponsor - 2010 TopCoder Open" /></a>-->
<!--<a href="<tc-webtag:linkTracking link='http://www.topcoder.com/tc?module=Static&d1=tournaments&d2=tco10&d3=overview&d4=sponsor2' refer='/tc' />"><img src="/i/tournament/tco10/banners/tco10-facebook-510x100.png" alt="Facebook - Event Sponsor - 2010 TopCoder Open" /></a><br /><br />-->
<a href="<tc-webtag:linkTracking link='http://topcoder.com/home/alcatel/web-mashup-challenge/' refer='/tc' />"><img src="/i/alcatel/alcatel-web-mashup-banner.png" alt="Alcatel-Lucent Web Mashup Challenge" /></a><br /><br />
<a href="<tc-webtag:linkTracking link='http://paypalx.topcoder.com' refer='/tc' />"><img src="/i/pressroom/paypalx-banner.png" alt="PayPal x powered by TopCoder" /></a>
