...
<h2 align="center">Search General Tax Forms</h2>
...
<%out.println("          <a href=\""+PactsConstants.INTERNAL_SERVLET_URL+"?"+PactsConstants.TASK_STRING+"="+PactsConstants.ADD_TASK+"&"+PactsConstants.CMD_STRING+"="+PactsConstants.TAX_FORM_CMD+"\">Add New General Tax Form</a>"); %>
        <table border="0" cellpadding="5" cellspacing="0">
          <tr>
            <td>Default Withholding Amount:</td>
<% out.println("            <td>Between <input type=\"text\" name=\""+PactsConstants.LOWEST_WITHHOLDING_AMOUNT+"\" size=\"10\"> and <input type=\"text\" name=\""+PactsConstants.HIGHEST_WITHHOLDING_AMOUNT+"\" size=\"10\"></td>"); %>
          ...
          <tr>
            <td>Default Withholding Percentage:</td>
...
<% out.println("        <input type=\"hidden\" name=\""+PactsConstants.CMD_STRING+"\" value=\""+PactsConstants.TAX_FORM_CMD+"\"><input type=\"hidden\" name=\""+PactsConstants.TASK_STRING+"\" value=\""+PactsConstants.LIST_TASK+"\">"); %>
      </form>
    </td>
  </tr>
</table>
