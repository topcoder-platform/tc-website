    ...
    <% if (list.equals("rules")) { %>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>                
                    ...
                    <td class="<%=tab.equals("registration")?"tourney_subnav_on":"tourney_subnav"%>" width="1" nowrap="nowrap"><a href="/tc/?&module=Static&d1=crpf&d2=crpf_rules_registration" class="topLink">Registration</a></td>
