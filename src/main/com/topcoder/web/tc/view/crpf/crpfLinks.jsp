...
<!-- Top Fundraisers tab -->
            <% if (selectedTab.equals("fundraisers")) {%>
                 <td class="statTextBig" width="128"><A href="/tc/?&module=Static&d1=crpf&d2=" class="statTextBig"><img src="/i/tournament/crpf03/tab_top_fundraisers_on.gif" alt="Fundraisers" width="128" height="22" border="0" /></A></td>
            <% } else { %>
                 <td class="statTextBig" width="128"><A href="/tc/?&module=Static&d1=crpf&d2=" class="statTextBig"><img src="/i/tournament/crpf03/tab_top_fundraisers_off.gif" alt="Fundraisers" width="128" height="22" border="0" /></A></td>
            <% } %>            
