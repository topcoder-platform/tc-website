...
<html>
  ...
  <body>
      ...
      <UL>
        ...
        <LI><A HREF="<%=Constants.SERVLET_ADDR+"?"+Constants.TASK_NAME_KEY+"="+Constants.NEW_REPORT_KEY+"&"+DataAccessConstants.COMMAND+"=brooks_usage_report&"+Constants.DB_KEY%>=SCREENING_OLTP">DoubleClick Registration</A></LI>
      </UL>
      <br/>
