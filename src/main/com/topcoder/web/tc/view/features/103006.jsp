...
<br><br>
The keys to understanding and enjoying the component finals lie in the changes that TopCoder introduced during the 2006 TCO, which I was lucky enough to experience firsthand as a design finalist. These changes include the wagering system, in which competitors have to decide how much each submission will contribute to their overall score, and the real time appeals phase, which is open to the any and all viewers.
<br><br>
...
In design, there are many new faces in the finalist group. Not at all new faces are inexperienced, though -- thanks to the magic of Digital Run, some of them have crystallized their skills and become much more formidable opponents than their limited component competition experience might suggest. 
<br><br>
