...
<div style="float: left; padding-right:20px;"><img src="/i/tournament/tccc04/onsite_photos/alg_finals.jpg" alt="Tomek" border="0" /></div>
<span class="bodySubtitle">Tomek: "Treat it as a fun game"</span><br>
<tc-webtag:handle coderId="144400" />'s TopCoder career is the stuff of legend. Currently the top-ranked Algorithm competitor, some of his past achievements include being a finalist at this year's TopCoder Open, a finalist at last year's Collegiate Challenge, and the Algorithm Champion at three on-site tournaments in a row: The 2003 TCO and both the TCO and TCCC in 2004.
<br><br>
...
<br><br>
"Last year I was second," he continues. "Well, it was hard to beat Mathijs that time. He was going for the win from the start of the competition, and he succeeded; I was quite happy about coming in second. Less concentration on the speed, and a little more on solution correctness, could have won it for me."
<br><br>
...
<br><br>
<br><br>
<div style="float: left; padding-right: 20px; clear: left;"><img src="/i/tournament/tccc05/onsite_photos/shot_development.jpg" alt="Gladius" border="0" /></div>
<span class="bodySubtitle">Gladius: The importance of sleeping and eating</span><br>
After a third-place finish in 2004, <tc-webtag:handle coderId="268851" /> came through to win the Development Championship at the 2005 Collegiate Challenge. His advice for this year's competitors is practical -- but not necessarily easy to follow -- especially for those traveling across multiple time zones on the way to San Diego. 
<br><br>
"Make sure to get a good amount of sleep, and eat right before the contest," he says. "That can make an absolutely huge difference in how well you perform! Other than that, just try to relax, and have fun coding or designing."
<br><br>
In terms of his approach to the finals, <tc-webtag:handle coderId="268851" /> says he would have to follow his instincts if he were in this year's tournament. "I took a gamble in how I approached the requirements by going for an Ôall or nothing' approach," he says. "The risk paid off, and I'd probably do it again, but it's a tough judgment call."
<br><br>
...
A TopCoder Open Component Design finalist in 2003 and 2004, <tc-webtag:handle coderId="277356" /> took home the Design Championship at the 2004 Collegiate Challenge.
<br><br>
