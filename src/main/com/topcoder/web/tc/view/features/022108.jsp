...
<p>A: Creating - it's as simple as that.  I absolutely love starting with a blank page, going through an iterative build process and seeing the end product run.  I still find it surprising when something runs the way I wanted it to and still get joy from what can be done on computers.</p>
