...
<td class="bodyText" align="center">
	...
	<tr>
		...
		<td class="store_td" colspan="2"><img class="store_img" src="/i/store/tcgear_logo.gif"></img></td>
		<td class="rightbg" rowspan="8"></td>
	</tr>
		<tr>
			<td class="store_td" colspan="2"><img class="store_img" src="/i/store/tc_store_teeshort_grey2.jpg"></img></td>
		</tr>
		<tr>
			<td class="store_td" colspan="2"><H3>TopCoder Logo Tee - Grey Short Sleeve<P> 	
100% ring-spun cotton, heavyweight 6.1oz T-shirt in Heather Grey. The TopCoder logo is silkscreened on the left chest and on the upper back.</p>
