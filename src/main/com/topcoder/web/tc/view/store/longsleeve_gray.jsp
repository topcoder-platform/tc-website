                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" class="bodyText">
                                          <select name="menu" size="1" class="dropdown">
                                             ...
                                             <option value="http://promo.askallied.com/topcoder/index.cfm?nav=proddet&CatID=69450&PID=309533&name=Go%20Shopping">X-Large</option>
                                             <option value="http://promo.askallied.com/topcoder/index.cfm?nav=proddet&CatID=69450&PID=309534&name=Go%20Shopping">XX-Large</option>
                                          </select>
                                          </td>
