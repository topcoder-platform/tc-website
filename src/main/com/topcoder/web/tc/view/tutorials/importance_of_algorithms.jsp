    ...
    <tr valign="top">
        ...
        <td width="100%" align="left" class="bodyColumn">
            ...
            <div class="linkBox">
                ...
                <tc-webtag:forumLink forumID="505914" message="Discuss this article" /><br />
                <a href="/tc?module=Static&d1=help&d2=writeForTC">Write for TopCoder</a>
            </div>

<span class="bodyTitle">The Importance of Algorithms</span>
