...
<div align=center><img src="/i/education/maxFlow01.gif" alt="Figure 1a - Maximum Flow in a network"/></div><br>
...
<div align=center><img src="/i/education/maxFlow02.gif" alt="Figure 2a"/></div><br>

<div align=center><img src="/i/education/maxFlow03.gif" alt="Figure 2b - The residual network of the network in 2a"/></div><br>
...
<div align=center><img src="/i/education/maxFlow04.gif" alt="Figure 3a"/></div><br>
...
<div align=center><img src="/i/education/maxFlow05.gif" alt="Figure 3b - The residual network of the network in 3a"/></div><br>
...
<div align=center><img src="/i/education/maxFlow06.gif" alt="Figure 1b - The residual network of the network in 1a"/></div><br>
...
<div align=center><img src="/i/education/maxFlow07.gif" alt="Figure 4 - A cut in the network"/></div><br>
...
<div align=center><img src="/i/education/maxFlow08.gif" alt="Figure 5 - A minimum cut in the network"/></div><br>
...
int bfs() 
	...
	keep an array from with the semnification: from[x] is the previous vertex visited in the shortest path from the source to x; initialize from with -1 (or any other sentinel value) 
...
<div align=center><img src="/i/education/maxFlow09.gif" alt="Figure 6 - Reduction of a multiple-source/multiple-sink max-flow problem"/></div><br>
...
<div align=center><img src="/i/education/maxFlow10.gif" alt="Figure 7 - Eliminating vertex-capacities"/></div><br>
...
<div align=center><img src="/i/education/maxFlow11.gif" alt="Figure 8"/></div><br>
...
<div align=center><img src="/i/education/maxFlow12.gif" alt="Figure 9 - the minimum-cut before/after"/></div><br>
...
class RookAttack
 {     // a list of the non-empty squares for each row
	 ...
	 bool find_match(int source) {
       ...
       {       // build lst from cutouts; column j should appear in row’s i list if square (i, j) is present on the board 
...
[http://www.topcoder.com/stat?c=problem_statement&pm=2852&rd=5075]
...
[http://www.topcoder.com/stat?c=problem_statement&pm=3530&rd=6535]
...
{
	// build a cost matrix cost[i][j] = cost of getting from car i to parking spot j, by doing a BFS
	// vertices 0, 1, ..., N - 1 will represent the cars, and vertices N, N + 1, ..., N + M - 1 will represent 
	...
	for (int source = 0; source < N; ++ source) {
		...
		while (!pq.empty()) {
			...
			if (where < N) {
				...
				// it this parking spot is unmatched we found the augmenting path with minimum cost
...
Here are some problems to practice:
		PlayingCubes - for this one ignore the low constraints and try to find a max-flow algorithm [http://www.topcoder.com/stat?c=problem_statement&pm=4731&rd=8016]
		DataFilter - be warned this is the hard from the TCCC 2004 Finals and is tough indeed! [http://www.topcoder.com/stat?c=problem_statement&pm=2010&rd=5080]
