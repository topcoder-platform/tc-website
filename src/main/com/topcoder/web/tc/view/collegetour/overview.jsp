        ...
        <td class="cardCell" width="100%" align="center">
            <div class="myTCBody">
                ...
                <p align="center">
                    ...
                    <a href="/tc?module=Static&amp;d1=collegetour&amp;d2=confirm&amp;<%=Constants.FORUM_ID%>=<%=request.getAttribute(Constants.FORUM_ID)%>&amp;<%=Constants.COLLEGE_TOUR_EVENT_ID%>=<%=request.getAttribute(Constants.COLLEGE_TOUR_EVENT_ID)%>">Registrants</A>&#160;&#160;|&#160;&#160;
                ...
                <p>
                    ...
                    <a href="/tc?module=Static&amp;d1=collegetour&amp;d2=confirm&amp;<%=Constants.FORUM_ID%>=<%=request.getAttribute(Constants.FORUM_ID)%>&amp;<%=Constants.COLLEGE_TOUR_EVENT_ID%>=<%=request.getAttribute(Constants.COLLEGE_TOUR_EVENT_ID)%>">here</a> and be onsite for the competition.
