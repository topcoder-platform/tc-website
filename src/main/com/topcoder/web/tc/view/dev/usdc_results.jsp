...
--%>
                        ...
                        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="2" class="sidebarBox">
                            ...
                            <tr>
                                ...
                                <td class="sidebarText" align=center nowrap=nowrap><rsc:item format="MM.dd.yyyy hh:mm:ssa" name="contest_start_timestamp" row="<%=resultRow%>"/></td>
                                <td class="sidebarText" align=center nowrap=nowrap><rsc:item format="MM.dd.yyyy hh:mm:ssa" name="contest_end_timestamp" row="<%=resultRow%>"/></td>
