...
<p>TopCoder Software uses Poseidon software from <A href="http://www.gentleware.com" target="_blank">www.gentleware.com</A> to capture diagrams during the design process. You need to download a Community Edition of the software. Gentleware regularly publishes updates to Poseidon. However, TopCoder Software does not switch to the latest version right away. Please consult <A href="/tc?module=Static&d1=dev&d2=support&d3=desDocumentation">Design Documentation</A> for the version of the software that you need to download.</p>
...
<p>Design distribution is an archive with the skeleton of the directory structure for your submission. Design distribution is available through the <a href="http://<%=ApplicationServer.FORUMS_SERVER_NAME%>/?module=Category&categoryID=<%=WebConstants.TCS_FORUMS_ROOT_CATEGORY_ID%>">Software Forums</A> -the first message on the design forum for your component contains the distribution archive. Most of the items in there are for developers - the only items in there related to the design are the build script and the requirements specification. Extract the archive to a directory of your choice. All your deliverables will go into the "docs" subdirectory of this directory.</p>
