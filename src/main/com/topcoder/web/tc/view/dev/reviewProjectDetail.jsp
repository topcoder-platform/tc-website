...
<!-- Center Column Begins -->
        <td width="100%" align="center">
            ...
            <table cellspacing="0" width="530" class="formFrame">
                <tr>
                    <td class="header">Component Name: <rsc:item set="<%=projectDetail%>" name="component_name"/></td>
                </tr>
                <tr>
                    <td class="projectHeaders">General</td>
                </tr>
                <tr>
                    <td class="projectCells">Catalog: <rsc:item set="<%=projectDetail%>" name="catalog"/></td>
                </tr>
                <tr>
                    <td class="projectCells">Phase: <rsc:item set="<%=projectDetail%>" name="phase_desc"/></td>
                </tr>
                <tr>
                    <td class="projectCells"><rsc:item set="<%=projectDetail%>" name="level"/></td>
                </tr>
            </table>
            ...
            <table cellspacing="0" width="530" class="formFrame">
                <tr>
                    <td class="projectHeaders" width="60%">Status</td>
                    <td class="projectHeaders" width="20%" align="center">Start</td>
                    <td class="projectHeaders" width="20%" align="center">End</td>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="submission_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="screening_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="review_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="aggregation_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="agg_review_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="final_fix_end" format="MM.dd.yyyy"/></td>
                </tr>
                <tr>
                    ...
                    <td class="projectCells" align="center"><rsc:item set="<%=projectDetail%>" name="final_review_end" format="MM.dd.yyyy"/></td>
                </tr>
            </table>
