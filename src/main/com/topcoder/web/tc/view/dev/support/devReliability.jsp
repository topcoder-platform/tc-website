...
<!-- Left Column Begins-->
        <td width="180">
         <jsp:include page="/includes/global_left.jsp">
            <jsp:param name="node" value="dev_reliability_ratings"/>
         </jsp:include>
        </td>
<!-- Left Column Ends -->
...
The new pay outs go into effect for projects launched after 9 am on 5/24/2007.  The following is an example of payouts based on the member's Reliability Rating:</p>
