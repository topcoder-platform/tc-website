...
<p><span class="bigTitle">SMC Testing Competition - Reporting</span></p>
...
<p>This testing competition will deal with generation, display and export of reports.</p>
...
[Member Handle]_ReportingTests.zip<br>
...
<tr><td>Requirements to test</td><td>2.21</td><td>Create Report</td></tr>
<tr><td>&#160;</td><td>2.23</td><td>Export Report</td></tr>
<tr><td>&#160;</td><td>2.24</td><td>Track Items</td></tr>
<tr><td>.NET namespace <br>to put tests into</td><td colspan="2">Athena.SMC.Tests.Reporting</td></tr>
<tr><td>Primary Test File Name</td><td colspan="2">ReportingTests.cs</td></tr>
<tr><td>Application Section</td><td colspan="2">Reporting</td></tr>
</table>
<br><br>
...
<%--
<p>To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: SMC Testing Competition - Reporting">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit: SMC Testing Competition - Reporting">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
