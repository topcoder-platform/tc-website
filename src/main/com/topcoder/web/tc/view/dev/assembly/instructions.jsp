...
To sign up as a Team Captain or a Free Agent, send an email to AssemblyCompetitions@topcoder.com.  In the email, include the following information:
<ul>
<li>Handle</li>
...
Once your team has working code you are ready to submit, you can do so by emailing your source code in RTF format to AssemblySubmissions@topcoder.com by the submission deadline.  Your team can submit code as many times as you wish before the submission deadline without any penalties.  The code that was last submitted before the deadline will be used as your final submission.
<br><br>
