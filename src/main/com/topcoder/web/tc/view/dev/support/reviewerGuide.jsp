...
<div class="guide">
		...
		<br/><br/>
		Some reviewers go as far as sending the PM a short email with a one-line comment per submission, telling me what's right or wrong with them.  We take those opinions very seriously, and they are appreciated.
		<br/><br/>
		...
		<li><span class=bodySubtitle>5 Development.</span>
			...
			<br/><br/>
				...
				<li><span class=bodySubtitle>5.4.2 Validity.</span>
