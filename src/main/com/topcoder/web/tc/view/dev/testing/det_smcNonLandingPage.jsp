...
<p><span class="bigTitle">SMC Testing Competition - Non-Landing Page</span></p>
...
<p>This testing competition will deal with creating, changing and deleting non-landing page events.</p>
...
[Member Handle]_NonLandingPageTests.zip<br>
...
<tr><td>Requirements to test</td><td>2.7</td><td>Create Calendar Entry<br>(Only Non-Landing Page)</td></tr>
<tr><td>.NET namespace <br>to put tests into</td><td colspan="2">Athena.SMC.Tests.NonLandingPage</td></tr>
<tr><td>Primary Test File Name</td><td colspan="2">NonLandingPageTests.cs</td></tr>
<tr><td>Application Section</td><td colspan="2">Non-Landing Page</td></tr>
</table>
<br><br>
...
<%--
<p>To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: SMC Testing Competition - Non-Landing Page">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit: SMC Testing Competition - Non-Landing Page">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
