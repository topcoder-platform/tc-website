        ...
        <td width="100%" align="center" class="bodyColumn">
            <div class="fixedWidthBody">
                ...
                <p><br />
                    ...
                    TopCoder will be holding weekly events, called Single Round Matches (SRMs), which will be available only to high school students. The SRMs will allow students to demonstrate their problem-solving skills by unraveling complex word problems through the use of a computer language - either Java, C++, C# or VB.Net. The worldwide TopCoder High School tournament will begin in December 2008 and will finalize online in January.<br />
                  <br />
                    <span class="subtitle">Prizes</span><br />
              Prizes will take the form of scholarships, hardware, software and educational materials awarded to the winners.<br />
                  <span class="subtitle"><br>
                  Who can Compete</span><br />
                  In order to be eligible to compete in TCHS competitions, students must be between the ages of 13 and 20 (inclusive) and must not yet be enrolled at a college or university. <br />
                  <br />
                  <a href="/tc?module=HSViewRegister">Register for Season 3</a>
                  <br />
                  <a href="/reg/">Register for TopCoder High School competitions <strong>and</strong> Season 3</a>
                  <br />
                  <br />
                  ...
                  Any questions that arise should be posted in the Algorithm and High School Competitions Discussions <a href="http://forums.topcoder.com/?module=ThreadList&amp;forumID=7167">forum</a>. <br />
                  <br />
                  <span class="subtitle">TCHS Referral Program</span><br />
                  Refer and Win!  Read more <a href="/tc?module=Static&amp;d1=hs&amp;d2=referralProgram">here</a>. <br />
                  <br />
              </p>
            </div>
        </td>
