...
<jsp:param name="title" value="Top Ranked Software Developers"/>
</jsp:include>
...
<br><br>
   ...
   <tr>
      <td class="title" colspan="3">Top Ranked Software Developers</td>
   </tr>
   <tr>
      <td class="headerC">
         Rank
   ...
   <tr class="<%=even?"dark":"light"%>">
      ...
      <TD CLASS="value"><tc-webtag:handle coderId='<%=resultRow.getLongItem("coder_id")%>' context="development" darkBG="true" /></TD>
