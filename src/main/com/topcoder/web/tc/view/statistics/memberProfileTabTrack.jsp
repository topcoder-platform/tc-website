                        ...
                        <ul class="masterLink">
                            <c:choose>
                                <c:when test="${param['track'] eq 'Assembly'}">
                                    <li><a href='/tc?module=AssemblyCompetitionHistory&amp;cr=<%=request.getParameter("cr")%>'>Competition History</a></li>
                                    <li><a href='/tc?module=AssemblyOutstandingProjects&amp;cr=<%=request.getParameter("cr")%>'>Current Contests</a></li>
                                    <li><a href='/tc?module=AssemblyReliabilityDetail&amp;uid=<%=request.getParameter("cr")%>'>Reliability Detail</a></li>
                                </c:when>
                                <c:otherwise>
