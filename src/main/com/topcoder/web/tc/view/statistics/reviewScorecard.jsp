...
<html>
<HEAD><TITLE>Review Scorecard</TITLE>
...
function openWin(url, name) {
    win = window.open(url, name, "menubar=no,status=no,scrollbars=yes,resizable=no,toolbar=no,width=300,height=400");
...
design, but there should be no influence on the functionality.
			    ...
			    <tr>
			        <td colspan="2">
                     ...
                     <tr><td class="forumTextOdd" colspan="3"><A href="javascript:openWin('/tc?module=Static&d1=statistics&d2=appeal','appealWindow')">Appeal</A></td></tr>
				        </tbody></table>
				    </td>
				</tr>
