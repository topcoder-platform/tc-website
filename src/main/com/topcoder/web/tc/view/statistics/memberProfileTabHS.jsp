<%--
  ...
  -
  - Description: This page displays the member profile high school page.
  -
            ...
            <td width="28%">
                <div class="dataMain">
                    <div id="left" class="left equal-height">
                        <div class="clr"></div>
                        <h2>High School Competitions</h2>
                        ...
                        <ul class="masterLink">
                            <li><a href='tc?module=HSRatingHistory&&ratid=2&cr=<%=request.getParameter("cr")%>'>Competition History</a></li>
                        </ul>
                        <!--End masterLink-->
                        <div class="masterContent">
                            <ul>
                                <% if (rscAlgData.getStringItem(0, "team_name") != null) { %>   
                                    <li><strong>Team</strong><span class="gray">
                                        <rsc:item name="team_name" set="<%=rscAlgData%>" ifNull="N/A" />
                                    </span></li>                                    
                                <% } %>  
                                ...
                                <li><strong>Competitions</strong><span class="red">
                                    <a href='tc?module=HSRatingHistory&&ratid=2&cr=<%=request.getParameter("cr")%>' class="redlink"><rsc:item name="num_ratings" set="<%=rscAlgData%>" /></a>
                                </span></li>
                                <li><strong>Most Recent Event</strong><span class="gray">
            ...
            <td style="text-align:right;">
                <div id="right" class="right equal-height">
                    ...
                    <table cellpadding="0" cellspacing="0" class="dataTable">
                        ...
                        <thead>
                            <tr class="title">
                                <th colspan="5" class="textLeft leftSpacing">Submission</th>
                            </tr>
                            <tr class="subTitle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><rsc:item name="problems_submitted" set="<%=rscTotal%>" /></td>
                                <td><rsc:item name="problems_failed_by_challenge" set="<%=rscTotal%>" /></td>
                                <td><rsc:item name="problems_failed_by_system_test" set="<%=rscTotal%>" /></td>
                                <td class="rightBorder"><rsc:item name="success_percentage" set="<%=rscTotal%>" format="0.00%" /></td>
                            </tr>
                        </tbody>
                    </table>      
