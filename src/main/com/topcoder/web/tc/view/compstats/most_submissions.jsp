...
<table class="stat" cellpadding="0" cellspacing="0" width="270" style="float: left; margin-right: 15px; margin-bottom: 15px;">
    <tr><td class="title" colspan="3">Most Component Challenge Submissions</td></tr>
...
<span class="bodyText">
<strong>Record:</strong> Most career submissions that passed screening.  Only challenges where the competitor was rated are included.
