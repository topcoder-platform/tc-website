...
<table class="stat" cellpadding="0" cellspacing="0" width="300" style="float: left; margin-right: 15px; margin-bottom: 15px;">
    <tr><td class="title" colspan="4">Largest Single Component Contest Prizes</td></tr>
    <tr><td class="headerC">Rank</td><td class="header" width="100%">Coder</td><td class="headerR">Prize</td><td class="header"><div style="width:130px;">Contest</div></td></tr>
    <% boolean even = false; %>
