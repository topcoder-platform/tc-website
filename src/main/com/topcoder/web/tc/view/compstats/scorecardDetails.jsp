      ...
      <td>
         <table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTable">
            ...
            <tr>
               ...
               <b><a href="javascript:toggleDisplay('shortQ_<%=questionNumber%>');toggleDisplay('longQ_<%=questionNumber%>');" class="statLink"><img src="/i/interface/open.gif" alt="open" border="0" /></a>
               <% } %>
                   <rsc:item name="question_desc" row="<%=resultRow%>" ifNull="" /></b>
               <rsc:item name="question_header" row="<%=resultRow%>" escapeHtml="true" ifNull="" />
               </div>

               <div class="hideText" id="longQ_<%=questionNumber%>">
               <% if (resultRow.getStringItem("question_header").equals(resultRow.getStringItem("question_text"))) { %>
               <b><a href="javascript:toggleDisplay('shortQ_<%=questionNumber%>');toggleDisplay('longQ_<%=questionNumber%>');" class="statLink"><img src="/i/interface/close.gif" alt="close" border="0" /></a>
               <% } %>
                   <rsc:item name="question_desc" row="<%=resultRow%>" ifNull="" /></b>
