...
<p><strong>Nikolay Archak</strong> (<tc-webtag:handle coderId="293874" context="development"/>) has won the competition in Applied Software Development for the second time like Peter Mitrichev. He studies in New York University. The Chinese student won the section Software Component Development and was awarded $15 thousand. The students from Indonesia and US headed the other TopCoder 2007 sections - Studio Design &amp; Marathon Match.</p>
