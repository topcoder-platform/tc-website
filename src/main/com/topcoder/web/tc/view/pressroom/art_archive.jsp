        ...
        <div id="pr_content" align="left">
            ...
            <div class="pr_box"><div class="pr_box2"><div class="pr_boxcontent">
                ...
                <div class="pr_newsarchive">
                    <dl>
                    <dt>&nbsp;</dt>
                    <dd><a target="_blank" href="<tc-webtag:linkTracking link='http://www.thejournal.com/articles/22736_2' refer='art_archive' />">Which Side Are You On? <br /><small style="margin-left:10px;">[June - THE Journal]</small></a></dd>
                    <dd><a target="_blank" href="<tc-webtag:linkTracking link='http://www.peoplemanagement.co.uk/pm/articles/2008/05/why-we-all-want-to-grow-towards-the-sun.htm?EmailSent=true' refer='art_archive' />">Why We All Want to Grow Towards the Sun <br /><small style="margin-left:10px;">[May 29 - People Management]</small></a></dd>
