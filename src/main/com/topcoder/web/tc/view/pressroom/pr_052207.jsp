...
<p>The Yodlee-sponsored series of matches will take place beginning 5/29/07 with SRM 351 and continue with matches on 6/24/07 (SRM 354) and 7/12/07 (SRM 357). For full details please visit: <a href="/tc?module=Static&d1=sponsors&d2=yodlee">http://www.topcoder.com/tc?module=Static&d1=sponsors&d2=yodlee</a>.</p>
