 ...
 * @version 1.0
 */
public class PayoneerServiceV4 {


    private static Logger log = Logger.getLogger(PayoneerServiceV4.class);
    ...
    public static PayeeStatus getPayeeStatus(long payeeId) throws PayoneerServiceException {
        ...
        final String requestUrl = config.getBaseApiUrl() + "/programs/" + config.getPartnerId() + "/payees/" + payeeId + "/status";
        ...
        try {
            ...
            if (httpResponse.response.has("result")) {
                ...
                if (!result.has("status"))
                    throw new PayoneerServiceException("Unexpected response encountered while parsing response from Payoneer.");
    ...
    public static double getBalanceAmount() throws PayoneerServiceException {
        ...
        final Map<String, String> headers = getAuthHeader();
        final String requestUrl = config.getBaseApiUrl() + "/programs/" + config.getPartnerId() + "/balance";
    ...
    public static long createPayment(long internalPaymentId, long payeeId, double amount) throws PayoneerServiceException {
        ...
        requestParams.put("program_id", config.getProgramId());
