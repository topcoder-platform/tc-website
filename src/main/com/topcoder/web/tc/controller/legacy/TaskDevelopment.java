                        ...
                        xsldocURLString = XSL_DIR + "inquiry_sent_pos.xsl";
                            ...
                            if (Long.parseLong(phase) == ComponentVersionInfo.SPECIFICATION) {
                                mail.setBody("Your inquiry has been received. Thank You!\r\n\r\n" +
                                        "Thank you, " + handle + ", for your interest in the " + project + " component. You now have access to the Developer Forum ( http://software.topcoder.com/forum/c_forum.jsp?f=" + activeForumId + " ) which can be used to obtain design documentation (see the Design Phase Documents thread), as well as to ask questions regarding the component design. Please post your questions at any time and a product manager will respond within 24 hours. Any questions asked within 6 hours of the submission due date/time may not be answered in time, so get your questions in early!\r\n\r\n" +
                                        "The deadline for submitting a solution is " + date + " at 11:59 PM EST. Please upload your design using the project page found here: http://software.topcoder.com/review.  If you encounter any problems, please contact us at service@topcodersoftware.com.  All late submissions will be ignored.  Also, a reminder that this is a competition, and only the top three designers will receive payment.\r\n\r\n" +
                                ...
                                mail.setBody("Your inquiry has been received. Thank You!\r\n\r\n" +
                                        "Thank you, " + handle + ", for your interest in the " + project + " component. You now have access to the Developer Forum ( http://software.topcoder.com/forum/c_forum.jsp?f=" + activeForumId + " ) which can be used to obtain the component design (See \"Development Phase Documents\" thread), as well as to ask questions regarding the development process or the component design. Please post your questions at any time and the component designer will respond within 24 hours. Any questions asked within 6 hours of the submission due date/time may not be answered, so get your questions in early!\r\n\r\n" +
                                        "The deadline for submitting a solution is " + date + " at 11:59 PM EST. Please upload your solution using the project page found here: http://software.topcoder.com/review. If you encounter any problems, please contact us at service@topcodersoftware.com.  Any late submissions will be ignored. Also, a reminder that this is a competition, and only the top three developers will receive payment.\r\n\r\n" +
                                        "If you have any questions please contact service@topcodersoftware.com\r\n\r\n" +
                                        "TopCoder Software Team");
                            }
                            EmailEngine.send(mail);
