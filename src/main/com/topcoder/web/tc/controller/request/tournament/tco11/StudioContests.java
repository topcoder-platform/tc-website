...
/**
 * <p>This class provides specific implementation for TCO11 Studio leaderboard details page.</p>
...
public class StudioContests extends StudioUserContestsBase {
     ...
     *
     * @return <code>String</code> containing the TCO11 contest prefix.
     */
    @Override
     ...
     * <p>Although this is not strictly required by TCO11 Studio rules, this method is required in order to extend
    ...
    protected String getPageName(Integer complete) {
        return TCO11Constants.TCO11_STUDIO_LEADERBOARD_DETAILS_PAGE;
    }
}
