...
/**
 * <p>
 * This action simply wraps around ActiveContestsManager and provides its
...
public class ActiveContestsManagerAction extends BaseJSONParameterAction {
     ...
     * </p>
     */
    private static final String CLASS_NAME = ActiveContestsManagerAction.class
            .getName();
     ...
     * Logger.getLogger(ActiveContestsManagerAction.class). It is used
     * throughout the class wherever logging is needed.
     * </p>
     */
    private static final Logger LOGGER = Logger
            .getLogger(ActiveContestsManagerAction.class);

    /**
     * <p>
     * The ActiveContestsManager for getting active contests. It is set through
     ...
     * created. It is used in execute(), setActiveContestsManager(). Its value
    ...
    /**
     * <p>
     * The retrieved active contests. It is accessed through getter and doesn't
     ...
     * created. It is used in execute(), getActiveContests().
     * </p>
     */
            ...
            throw Helper
                    .logException(
                            ...
                            new ContestServicesActionException(
                                    "ActiveContestsManagerException occurs while retrieving ActiveContests",
                                    e), signature);
        }
    }
    ...
    /**
     * <p>
     * Getter method for activeContests, simply return the value of the namesake
     * field.
     * </p>
     * 
    ...
    /**
     * <p>
     * Setter method for the activeContestsManager, simply set the value to the
     * namesake field.
     * </p>
     * 
     ...
     */
    public void setActiveContestsManager(
            ActiveContestsManager activeContestsManager) {
    ...
    public void checkConfiguration() {
        ...
        Helper.checkNotNullForConfiguration("activeContestsManager",
                activeContestsManager);
    }
