    ...
    <div id="wrapper">
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <h3>Will OpenAIM contests affect my TopCoder Rating?</h3>
                
                No. OpenAIM is independent of TopCoder ratings and statistics. Winning OpenAIM contests will not improve
                ...
                <ol>
                <li> <strong>You must be a registered OpenAIM member.</strong> You can register with
                OpenAIM by clicking any of the <a href="https://www.topcoder.com/reg/">Register Now</a>
                links on this site. If you already have a TopCoder handle, you may <a href="http://www.topcoder.com/reg/?nrg=false">login</a> update your profile by opting in for OpenAIM membership.</li>
                ...
                If you are confused about a required element in the Spec Doc, please post your question in the forums so that everyone may benefit from the answer. The OpenAIM Contest Administrator and your fellow OpenAIM members will help clarify things.
                <br /><br />
                ...
                At the conclusion of each contest, after the passing submissions have been scored and after a client has made selections, the Contest Administrator will notify winners via email with instructions on how to get paid. TopCoder begins the payment process for OpenAIM contests one business day after the final files for the contest have been delivered by the winner(s).  
                <br /><br />
                ...
                If you have more questions, please send them to <a href="mailto:openaimadmin@topcoder.com">openaimadmin@topcoder.com</a>.
