...
<br><br>
In a Marathon Match, all competitors are encouraged to improve their solutions and resubmit iteratively throughout the length of the submission phase. Once you submit, you will have to wait at least until the submission has been fully processed before you can submit again. The total number of submissions from a given competitor in a given event may not exceed 100. The most recent submission is always the one that counts, so if you make a submission that does not score as well as a prior submission, the most recent will still the one that counts in the standings. Participants may submit code written in one of the following languages: Java, C++, C# .NET, or VB .NET.
--%>
