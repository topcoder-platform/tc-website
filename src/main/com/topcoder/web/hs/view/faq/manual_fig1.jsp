            ...
            <table cellspacing="0" cellpadding="10" border="0" width="100%">
                ...
                <tr valign="top">
                    <td width="100%" class="bodyText">
                        ...
                        <b>*Note:</b>  In the event that this should happen during the course of competition, the latest saved version of the problem 
                        being solved at the time will automatically open in the coding window when the contestant returns to the coding room.</p>
