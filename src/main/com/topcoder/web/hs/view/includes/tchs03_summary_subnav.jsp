...
%>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="49%" class="tourney_subnav"><img src="/i/clear.gif" alt="" width="10" height="1" border="0" /></td>
...
<!-- Problems -->
<% if (isProblemsPage) { %>
        <td class="tourney_subnav_on" nowrap="nowrap"><a href="?module=Static&d1=tournaments&d2=tchs03_summary_problems" class="statText"><strong>Problem Analysis</strong></a></td>
<% } else { %>
        <td class="tourney_subnav" nowrap="nowrap"><a href="?module=Static&d1=tournaments&d2=tchs03_summary_problems" class="statText"><strong>Problem Analysis</strong></a></td>
<%  } %>
