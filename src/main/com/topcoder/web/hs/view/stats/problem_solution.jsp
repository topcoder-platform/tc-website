...
%>
               <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0"   WIDTH="100%">
                 ...
                 <TR>
                   ...
                   <TD BACKGROUND="/i/blue_heading_bg.gif" VALIGN="middle" WIDTH="5"><IMG SRC="/i/clear.gif" ALT="" WIDTH="5" HEIGHT="1" BORDER="0"></TD>
...
<% } else { %>
                 ...
                 <TR>
                   <TD BGCOLOR="#1B2E5D" COLSPAN="10"><IMG SRC="/i/clear.gif" ALT="" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
                 </TR>
<% }
   row++;
%>
...
<% } else { %>
                 ...
                 <TR>
                   <TD BGCOLOR="#1B2E5D" COLSPAN="7"><IMG SRC="/i/clear.gif" ALT="" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
                 </TR>
<% }
   row++;
 %>
