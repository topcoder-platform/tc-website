        ...
        <%-- Main Navigation --%>
            <div id="lCorner-nav"><%-- Left Corner Navigation --%></div>
                <ul>
                    ...
                    <li id="nav-standing"<% if (tabLev1.equals("standings")) {%> class="on"<% } %>><a title="Standings" onfocus="this.blur();" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=ViewStandings&amp;msi=${firstMiniSeasonId}"><span class="hide">Standings</span></a></li>
