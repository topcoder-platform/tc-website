...
<jsp:useBean id="ModifyQueryInputTask" scope="request" class="com.topcoder.web.query.request.ModifyQueryInputTask" />
                  ...
                  <query:queryInputIterator id="queryInput" list="<%=ModifyQueryInputTask.getCurrentInputList()%>">
                    ...
                    <TR>
                      <TD CLASS="statTextBig">
                        <A HREF="<jsp:getProperty name="SessionInfo" property="ServletPath"/>?<%=Constants.TASK_PARAM%>=<%=Constants.MODIFY_INPUT_TASK%>&<%=Constants.DB_PARAM%>=<jsp:getProperty name="ModifyQueryInputTask" property="Db"/>&<%=Constants.INPUT_ID_PARAM%>=<jsp:getProperty name="queryInput" property="InputId"/>" class="statText">
                          [edit]
                        </A>
                      </TD>
