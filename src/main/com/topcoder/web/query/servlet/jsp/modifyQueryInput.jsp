      ...
      <TD CLASS="statText" WIDTH="100%" BGCOLOR="#001935" VALIGN="top" ALIGN="left">
        <TABLE WIDTH="80%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
          <FORM ACTION="<jsp:getProperty name="ModifyQueryInputTask" property="ServletPath"/>" method="post" name="ModQueryInputForm" >
            ...
            <TR>
              <TD CLASS="statText" ALIGN="ceneter" COLSPAN="2">DB: <query:dbSelect name="<%=Constants.DB_PARAM%>" class="dropdown" list="<%=Constants.DB_LIST%>" selectedValue="<%=ModifyQueryInputTask.getDb()%>"/></TD>
            </TR>
            <TR>
              <TD COLSPAN="2">
