...
<TD WIDTH="69" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000"><A HREF="/?t=statistics&amp;c=index" onMouseOver="changeImages('image4', 'image4on')" onMouseOut="changeImages('image4', 'image4off')" TARGET="_parent"><IMG NAME="image4" SRC="/i/menu_stats_off.gif" ALT="Statistics" WIDTH="69" HEIGHT="21" BORDER="0"></A></TD>
...
<TD WIDTH="88" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000"><A HREF="/index?t=development&amp;c=index" onMouseOver="changeImages('image6', 'image6on')" onMouseOut="changeImages('image6', 'image6off')" TARGET="_parent"><IMG NAME="image6" SRC="/i/menu_dev_off.gif" ALT="Development" WIDTH="88" HEIGHT="21" BORDER="0"></A></TD>            
<TD WIDTH="40" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000"><A HREF="/index?t=tces&amp;c=index" onMouseOver="changeImages('image7', 'image7on')" onMouseOut="changeImages('image7', 'image7off')" TARGET="_parent"><IMG NAME="image7" SRC="/i/menu_jobs_off.gif" ALT="Jobs" WIDTH="40" HEIGHT="21" BORDER="0"></A></TD>
