...
<xsl:template match="/">
  <DIV class="statText">
    <br/><center><b>Statutory Declaration<br/><xsl:value-of select="/TC/Affidavit/round"/></b></center><br/><br/>
   ...
   <ol>
     ...
     <li>I reside at <xsl:value-of select="/TC/Affidavit/address1"/>, <xsl:value-of select="/TC/Affidavit/address2"/>, <xsl:value-of select="/TC/Affidavit/city"/>, <xsl:value-of select="/TC/Affidavit/state_name"/>, <xsl:value-of select="/TC/Affidavit/zip"/>, <xsl:value-of select="/TC/Affidavit/country_name"/>.</li>
     <li>I am submitting this statutory declaration with the understanding that it will be relied upon to determine my eligibility to receive the prize for whic h my entry has been submitted in the 2001 TopCoder Invitational Tournament (the &quot;Contest&quot;).</li>
     <li>I hereby represent that I am 18 years of age or older and have complied with, and will continue to comply with all the rules and regulations of this Co ntest and that I have perpetrated no fraud or deception in entering the Contest or in claiming any prize that may be awarded to me.  I hereby represent fur ther that my performance in the Contest is a result of my efforts alone and all ideas for code or challenges submitted by me during the course of the Conte st were mine alone.</li>
     <li>Further, I represent that the following information contained in TopCoder's member database represents my personal demographic information, and that su ch information is true and accurate:
    </td></tr>
    <tr><td class="statText" valign="top" colspan="3">
   ...
   <xsl:choose>
     ...
     <xsl:when test="/TC/Affidavit/country_name='United Kingdom'">  And I make this solemn declaration conscientiously believing the statements contained in this declaration to be true and by virtue of the Statutory Declara tions Act 1835. <br/><br/>   </xsl:when> </xsl:choose>
     </DIV>
     <tr><td class="statText" width="256" valign="top">
       <table width="552" cellspacing="0" cellpadding="1" border="0" align="center">
         <tr><td class="statText" width="256" valign="top">Declared before me at the __________________________________ this ____ day of ________________ 20__ before me:</td>
             <td class="statText" width="296" colspan="2" valign="top">       )<br/>)<br/>)     </td>   </tr>    <tr>     <td class="statText" width="256" height="40" valign="bottom">__________________________________</td>
