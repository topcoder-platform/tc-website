...
///////////////////////////////////
	...
	/////////////////////////////////////////////////////
		if (m_status_desc == null) return "";
		else return m_status_desc;
	}
...
///////////////////////////////////
	...
	/////////////////////////////////////////////////////
		...
		if (e instanceof NoException) {
			if (m_status_id < 0) rv = "Payment number " + id + " was reviewed";
			else {
				rv = "Payment number " + id + " updated to status of ";
				if (m_status_desc == null) rv += new String().valueOf(m_status_id);
				else rv += m_status_desc;
			}
		}
		else {
	...
	/////////////////////////////////////////////////////
		if (o instanceof UpdateResults &&
			...
			m_results.equals(((UpdateResults) o).getResults())) return true;
		else return false;
	}
