    ...
    <TD WIDTH="100%" BGCOLOR="#000000" ALIGN="right" VALIGN="top">
      <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
        ...
        <TR>
          ...
          <TD BGCOLOR="#000000" ALIGN="center" NOWRAP="0"><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="5" BORDER="0"/><!-- <A TARGET="_parent" HREF="/index?t=jobs&amp;c=index"><IMG SRC="/i/jobs_banner2.gif" ALT="" WIDTH="170" HEIGHT="46" VSPACE="5" BORDER="0"/></A><A TARGET="_parent" HREF="/index?t=about_tc&amp;c=membr_teams"><IMG SRC="/i/teams_banner.gif" ALT="" WIDTH="170" HEIGHT="46" VSPACE="5" BORDER="0"/></A> --></TD>
          <TD CLASS="time" VALIGN="middle" NOWRAP="" ALIGN="right"><BR CLEAR="all"/><% if ( nav.getLoggedIn() ) { %>Welcome Back <SPAN CLASS="smallBrackets">[ </SPAN> <A href="/index?t=statistics&amp;c=member_profile&amp;Coder_Id=<%=nav.getUser().getUserId()%>" class="statText" TARGET="_parent"><FONT color="<%=color%>"><B><%=nav.getUser().getHandle()%></B></FONT></A><SPAN CLASS="smallBrackets">]</SPAN> :<span class="time"><%@ include file="date_time.jsp" %></SPAN><% } else { %><BR/><SPAN CLASS="smallBrackets">[ </SPAN> <A HREF="/?t=registration" CLASS="registerToday" TARGET="_parent">Register Today</A> :<span class="time"><%@ include file="date_time.jsp" %></span><SPAN CLASS="smallBrackets">]</SPAN><% }%><BR CLEAR="ALL"/><a href="Javascript:tcTime()" class="statTextBig">Current time at TopCoder</a><BR CLEAR="ALL"/></TD><TD WIDTH="50" BGCOLOR="#000000"><IMG SRC="/i/clear.gif" WIDTH="50" HEIGHT="1" BORDER="0"/></TD>
