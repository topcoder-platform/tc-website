<%@ page import="com.topcoder.web.tc.Constants"%>            <table border="0" cellspacing="0" cellpadding="0" width="180">
            ...
            <table border="0" cellspacing="0" cellpadding="1" width="180" bgcolor="#990000">
                ...
                <tr><td class="statTextBig" colspan="3" nowrap><img src="/i/clear.gif" width="5" height="5" border="0"/><br />&#160;&#160;<A href="/tc?module=ViewAdvanced" class="statText">&gt; Advanced Search</A></td></tr>
            </table>
