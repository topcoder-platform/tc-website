...
<%-- My Home --%>
                ...
                <% if (level2.equals("support")) { %>
                	...
                	<tr><td id="<%=level3.equals("devTutorial")?"leftSubnavOn":"leftSubnav"%>"><A class="leftOn" href="/tc?module=Static&d1=dev&d2=support&d3=devTutorial">Development Tutorial</A></td></tr>
