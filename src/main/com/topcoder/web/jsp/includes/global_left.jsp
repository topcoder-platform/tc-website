...
<!-- Leave out until Dev info becomes available                <tr><td id="<%=level2.equals("development")?"leftSubnavOn":"leftSubnav"%>"><a class="leftOn" href="/tc/?d1=review_board&d2=development">Development</a></td></tr>  -->
