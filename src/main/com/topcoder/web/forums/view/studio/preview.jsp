   ...
   <tr>
        <td class="rtHeader" colspan="2">
         ...
         <%   if (parentMessage != null) { %>
               (response to <A href="?module=Message&<%=ForumConstants.MESSAGE_ID%>=<%=parentMessage.getID()%>" class="rtbcLink">post</A> by <tc-webtag:studioHandle coderId="<%=parentMessage.getUser().getID()%>"/>)
         <%   } %>
        </td>
    </tr>
   <tr>
