 ...
 *
 * A CPPViewer object is used to syntax highlight code. To make use of this class, first set
 ...
 * input that has been tagged with [cpp][/cpp] tags.
 */
public class CPPViewer {
    ...
    private static void loadCPPKeywords() {
        String[] keywordsC = {"auto", "break", "case", "char", "const", "continue", "default", 
        ...
        String[] keywordsCPP = {"asm", "bool", "catch", "const_cast", "class", "delete", 
        ...
        for (int i=0; i<keywordsC.length; i++) {
            reservedWords.put(keywordsC[i], keywordsC[i]);
        }
        for (int i=0; i<keywordsCPP.length; i++) {
            reservedWords.put(keywordsCPP[i], keywordsCPP[i]);
        }
    }
}