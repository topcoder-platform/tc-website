...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
    <tr valign="top">
        ...
        <td nowrap class="testTop"><screen:servletLink processor="PopulateSession" styleclass="testTopNav">Create a New Session</screen:servletLink></td>
        <td width="1" class="testTop">&#160;</td>
        <td nowrap class="testTop"><screen:servletLink processor="ProfileList" styleclass="testTopNav">Test Profiles</screen:servletLink></td>
        <td width="1" class="testTop">&#160;</td>
        <td nowrap class="testTop"><screen:servletLink processor="ProblemList" styleclass="testTopNav">Problem Sets</screen:servletLink></td>
        <td width="1" class="testTop">&#160;</td>
        <td nowrap class="testTop"><screen:servletLink processor="BuildCandidateList" styleclass="testTopNav">Candidates</screen:servletLink></td>
        <td class="testTop" width="49%">&#160;</td>
   </tr>
</table>
<!-- Menu bar ends here -->
