         ...
         <TABLE BORDER="0" CELLSPACING="1" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">                   
           ...
           <TR>
            ...
            <TR>
               ...
               <TD VALIGN="middle" ALIGN="center" CLASS="bodyText">&#160;<screen:resultSetItem row="<%=row%>" name="begin_time" format="yyyy-MM-dd HH:mm a"/></TD>
               <TD VALIGN="middle" ALIGN="center" CLASS="bodyText">&#160;<screen:resultSetItem row="<%=row%>" name="end_time" format="yyyy-MM-dd HH:mm a"/></TD>
