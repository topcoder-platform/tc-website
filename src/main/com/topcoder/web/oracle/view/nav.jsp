...
<div id="miniNav">
    ...
    <A href="?module=ViewSimpleResults&rm=2001"<% if (selectedTab.equals("tcdotcomPredRd1")) {%> class="on"<% } %>>Prediction Results</A>
    <A href="?module=ViewCandidateResults&rm=2001"<% if (selectedTab.equals("tcdotcomCandRd1")) {%> class="on"<% } %>>Candidate Results</A>
    <div class="section">Homepage Redesign Round 2</div>
    <A href="?module=ViewBallot&rm=1999">Make your prediction now!</A>
</div>
