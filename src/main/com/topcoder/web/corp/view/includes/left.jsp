...
<!-- Recruiting begins -->
                <tr><td id="myServicesNav"><img src="/i/nav_arrow_<%=level1.equals("recruiting")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=recruiting&d2=index" class="corpLeft">Recruiting</a></td> </tr>
<% if (level1.equals("recruiting")) { %>
                <tr><td id="<%=level2.equals("overview")?"myServicesSubnavOn":"myServicesSubnav"%>"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=recruiting&d2=index" target="_parent" class="corpLeft">Overview</a></td></tr>
                <tr><td id="<%=level2.equals("candidateID")?"myServicesSubnavOn":"myServicesSubnav"%>"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=candidate_id" target="_parent" class="corpLeft">Candidate Identification</a></td></tr>
                <tr><td id="<%=level2.equals("jobPostings")?"myServicesSubnavOn":"myServicesSubnav"%>"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=job_postings" target="_parent" class="corpLeft">Advertising and Job Postings</a></td></tr>
                <tr><td id="<%=level2.equals("emailCampaign")?"myServicesSubnavOn":"myServicesSubnav"%>"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=email_campaign" target="_parent" class="corpLeft">Targeted Email Campaign</a></td></tr>
                <tr><td id="<%=level2.equals("featuredEmployer")?"myServicesSubnavOn":"myServicesSubnav"%>"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=featured_employer" target="_parent" class="corpLeft">SRM Featured Employer</a></td></tr>
...
<!-- Private Label Events begins -->
                <tr><td id="myServicesNav"><img src="/i/nav_arrow_<%=level1.equals("privateLabel")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=private_label&d2=index" class="corpLeft">Private Label Events</a></td></tr>
