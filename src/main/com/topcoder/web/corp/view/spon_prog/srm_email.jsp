            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top">
                    <td class="bodyText" width="99%">
                        ...
                        <nobr><a href="<?module=Static&d1=corp&d2=spon_prog&d3=srm_email_annc">View sample</a></nobr></p>
                        
                        <h3>Match Results</h3>
                        Sponsors are given space within the email for company name and a desired URL. 
                        <nobr><a href="<?module=Static&d1=corp&d2=spon_prog&d3=srm_email_results">View sample</a></nobr></p>
