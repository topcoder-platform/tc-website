            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top">
                    <td class="bodyText" width="99%">
                        ...
                        <h2 class="corpHead">SRM - Web Site Coverage</h2>
                        ...
                        <p>The following pages are included in the sponsorship package:</p>
                        ...
                        <p><strong>Space and Specs</strong> - note red blocks are where sponsor would be presented</p>
