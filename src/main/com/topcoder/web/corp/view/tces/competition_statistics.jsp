                ...
                <tr valign="top">
                    <td class=bodyText>
                     <div style="float:right;">
                        <A href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?<%=TCESConstants.TASK_PARAM%>=ViewSearchTask&<%=TCESConstants.CAMPAIGN_ID_PARAM%>=<jsp:getProperty name="CompetitionStatisticsTask" property="campaignID" />">Search candidates</A>
                     </div>
