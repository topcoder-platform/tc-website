...
<!-- Center Column Begins -->
        <td class="bodytext" width="100%" align="center">
            ...
            <p>
                <A HREF="JavaScript:getGraph('/corp/graph?c=rating_history_graph&amp;cr=<jsp:getProperty name="CompetitionHistoryTask" property="MemberID"/>','800','600','history')" class="bodyText">Rating History Graph</a> &nbsp;&nbsp;|&nbsp;&nbsp;
