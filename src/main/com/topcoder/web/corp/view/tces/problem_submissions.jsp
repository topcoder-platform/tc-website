...
<!-- Center Column Begins -->
        <td class="bodytext" width="100%" align="center">
            ...
            <p>
                <A HREF="JavaScript:getGraph('/corp/graph/?c=rating_history_graph&amp;cr=<jsp:getProperty name="ProblemSubmissionsTask" property="MemberID"/>','800','600','history')" class="bodyText">Rating History Graph</a> &nbsp;&nbsp;|&nbsp;&nbsp;
                <A HREF="JavaScript:getGraph('/corp/graph/?c=rating_distribution_graph','600','400','distribution')" class="bodyText">Overall Rating Distribution Graph</a>
            </p>
