...
<!-- Center Column Begins -->
        <td class="bodytext" width="100%" align="center">
            ...
            <p>
                <A HREF="JavaScript:getGraph('/graph?c=rating_history_graph&amp;cr=<jsp:getProperty name="ProblemSubmissionsTask" property="MemberID"/>','800','600')" class="bodyText">Rating History Graph</a> &nbsp;&nbsp;|&nbsp;&nbsp;
