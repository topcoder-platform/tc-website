        ...
        <div id="container">
            ...
            <div id="content">
				...
				<div align="center" style="text-align:left; width:500px; font-size:12px; line-height: 18px;">
                    <br /><br />
                    Please be aware that you are <b>NOT REGISTERED for the TCO10 tournament</b> that this contest is part of. Registering for this contest will not register you for the TCO10 tournament. If you don't register for the tournament prior to registering for this contest, you will not receive points for this contest even if you sign up for TCO10 at a later date.
                    <br /><br />
				...
				<div align="center" style="font-size:14px;">
                        <br /><br />
                        <a href="http://<%=ApplicationServer.SERVER_NAME%>/tco10?module=ViewUnifiedRegistration" target="_blank">Take me to register for the TCO10</a><br />
                        <br />
                        <a href="#" onclick="document.terms.submit()">I don't want to register for TCO10. Just register for this contest.</a>
