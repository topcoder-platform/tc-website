        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <p>No.  You are only required to sign and return the assignment the first time you win a competition which starts after June 18, 2007.  Once you have signed and returned the Assignment, you will be able to collect your prize if you have won your contest.  You only have to sign and return the Assignment once.</p>
                </div>
                <div>
