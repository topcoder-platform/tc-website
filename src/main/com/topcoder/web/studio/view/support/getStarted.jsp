...
<strong>Client contacts TopCoder Studio with project</strong><br>
...
<strong>TopCoder Studio posts project as a new contest on studio.topcoder.com</strong><br>
Once the project documentation has been completed by the client and formatted appropriately by TopCoder Studio, it is posted on the Active Contest page.  All TopCoder Studio members will be alerted via email when new contests are posted.
<br><br>

<div style="float:left; margin: 0px 6px 4px 0px;">
   <img src="/i/studio/layout/step3.gif" alt="Step 3" />
</div>
<strong>Browse through the posted contests</strong><br>
Anyone interested in participating in TopCoder Studio can read through the Active Contest page - no prior registration is necessary.  If there is a contest that you think a friend, co-worker or fellow designer might be interested in, send them a link to the <A href="/?module=ViewActiveContests">Active Contests</A> page.
<br><br>

<div style="float:left; margin: 0px 6px 4px 0px;">
   <img src="/i/studio/layout/step4.gif" alt="Step 4" />
</div>
<strong>Registered TopCoder Studio members can download the full Project Specifications</strong><br>
...
<strong>Registered TopCoder Studio members can submit their design(s)</strong><br>
...
<strong>Submissions are screened</strong><br>
...
<strong>Submissions that pass screening are sent to client</strong><br>
...
<strong>Client chooses winning design</strong><br>
It is at the client's sole discretion which design is selected as the contest winner.  Once the client has selected a winner, the designer who submitted the winning design will be notified via email.
<br><br>

<div style="float:left; margin: 0px 6px 4px 0px;">
   <img src="/i/studio/layout/step9.gif" alt="Step 9" />
</div>
<strong>Winning designer is compensated for their work</strong><br>
