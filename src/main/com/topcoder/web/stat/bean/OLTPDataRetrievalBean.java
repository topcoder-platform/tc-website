 ...
 * @see     StatisticsBean
 */
public class OLTPDataRetrievalBean implements StatDataAccessInt {
    
    /**
     * This method passes a query command request and the transactional data source
     * to the statistics EJB and receives and passes on the results.
     *
