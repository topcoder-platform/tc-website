  		...
  		<% if (!bEmpty) { %>
			...
			<% } %> 
                 ...
                 <TR>
                   ...
                   <TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="statText" VALIGN="middle" HEIGHT="13"><stat:write format="MM.dd.yy" name="resultRow2" property='<%= "item[" + 3 /* event date */ + "].resultData" %>'/></TD>
