...
<div id="shortcutBar">
    ...
    <div class="icon"><a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=ViewArchitectureActiveContests"><img src="/i/interface/scArchitecture.png" alt="" onmouseover="postPopUpText('globalPopupText','Software Architecture Competitions'); popUp(this,'globalPopup');" onmouseout="popHide()" /></a></div>
...
<%--UNCOMMENT AT ASSEMBLY LAUNCH    <div class="icon"><a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=ViewAssemblyActiveContests"><img src="/i/interface/scAssembly.png" alt="" onmouseover="postPopUpText('globalPopupText','Software Assembly Competitions'); popUp(this,'globalPopup');" onmouseout="popHide()" /></a></div>--%>
