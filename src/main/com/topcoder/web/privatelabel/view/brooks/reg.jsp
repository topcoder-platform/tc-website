	...
	<tr>
		<td>
			<table cellspacing="0" cellpadding="0" border="0" width="100%"> 
				<tr> 
					<td class=brLeftCol valign="top"><a href="/pl/?&module=Static&d1=brooks&d2=brooks_overview"><img src="/i/events/brooks/overview.gif" alt="" width="146" height="19" border="0"></a></td> 
					<td width="100%" valign="top">
					    <p class="content"><span class="brBodyTitle">Registration</span><br/><br/>
					
						Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse commodo tincidunt eros. 
						Nunc mi ante, feugiat a, auctor at, iaculis non, diam. Sed lacinia massa non metus. Nullam venenatis sem et nunc. 
						Ut pulvinar dolor varius nisl. Curabitur sit amet lectus.
						</p>
