...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   <tr>
      <td valign="middle" align="left" style="padding: 20px 0px 20px 45px;"><a href="/pl/?module=Static&d1=verisign06&d2=description"><img src="/i/events/verisign06/verisign_logo.gif" alt="VeriSign" border="0"/></a></td>
      <td valign="top" align="right" style="padding: 0px 20px 0px 0px;"><a href="/"><img src="/i/events/verisign06/ver_tc_logo.gif" border="0"/></a></td>
   </tr>
<!-- LEVEL 2 TABS -->
   <tr>
      <td colspan="2">
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr>
            ...
            <% if (tabLev2.equals("details")) {%>
               <td class="nav"><A href="/pl/?module=Static&d1=verisign06&d2=description"><img src="/i/events/verisign06/tabs/ver_L2_detailsOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/pl/?module=Static&d1=verisign06&d2=description"><img src="/i/events/verisign06/tabs/ver_L2_detailsOff.gif" alt="" border="0" /></A></td>
            <% } %>
...
--%>
            <% if (tabLev2.equals("competitionArena")) {%>
               <td class="nav"><A href="/pl/?module=Static&d1=verisign06&d2=arena"><img src="/i/events/verisign06/tabs/ver_L2_arenaOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/pl/?module=Static&d1=verisign06&d2=arena"><img src="/i/events/verisign06/tabs/ver_L2_arenaOff.gif" alt="" border="0" /></A></td>
            <% } %>
         ...
         <tr>
            <td class="subnavBG">&#160;&#160;&#160;</td>
               <% if (tabLev2.equals("details")) {%>
                  ...
                  <td class="subnav"><a href="/pl/?module=Static&d1=verisign06&d2=rules"><% if (tabLev3.equals("rules")) {%><img src="/i/events/verisign06/tabs/ver_L3_rulesOn.gif" border="0" /><% } else { %><img src="/i/events/verisign06/tabs/ver_L3_rulesOff.gif" border="0" /><% } %></a></td>
            ...
            <!--   <% } else if (tabLev2.equals("advancers")) {%>
               ...
               <% } else if (tabLev2.equals("summary")) {%>
                  <td class="subnav"><a href="/pl/?module=Static&d1=verisign06&d2=alg_sum_onlinerounds"><% if (tabLev3.equals("online")) {%><img src="/i/events/verisign06/tabs/L3_onlineroundsOn.gif" border="0" /><% } else { %><img src="/i/events/verisign06/tabs/L3_onlineroundsOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/pl/?module=Static&d1=verisign06&d2=alg_room1_analysis"><% if (tabLev3.equals("room1")) {%><img src="/i/events/verisign06/tabs/L3_room1On.gif" border="0" /><% } else { %><img src="/i/events/verisign06/tabs/L3_room1Off.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/pl/?module=Static&d1=verisign06&d2=alg_room2_analysis"><% if (tabLev3.equals("room2")) {%><img src="/i/events/verisign06/tabs/L3_room2On.gif" border="0" /><% } else { %><img src="/i/events/verisign06/tabs/L3_room2Off.gif" border="0" /><% } %></a></td>
