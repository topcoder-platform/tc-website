	...
	<tr>
		...
		<td>
			...
			<br/><br/>
                        ...
                        required, the application will load automatically and present you with a red "Launch Competition Arena" button.
                        ...
                        <ul>
                           ...
                           The higher the point value assigned, the more difficult the problem will be.  You may open the problems in any order.  You may have all 
                        ...
                        a solution for a problem, the more point you will receive.

                        <br><br>                        
                        
                           The Coding Phase will allow you to submit a problem more than once.  If you've already submitted a problem and you choose to submit again, 
...
End Class </pre><br/><br/>
                    ...
                    The Challenge Phase will begin five minutes after the end of the Coding Phase (the period in between is an intermission), and will last for 15 minutes.
                       ...
                       During the Challenge Phase, you have the opportunity to view the source code submissions of the other competitors in your room.  If you believe that 
                    ...
                    will lose 50 points from your score.

                        <br><br>                        
                    
                       To challenge a competitor's submission, open the summary window in the competition room by using the "Summary" button.  Double click on any of the point 
                    ...
                    window.  The Challenge button will bring up the arguments window, allowing you to enter the test case with which to challenge the submission.
                    
                        <br><br>                        
                    
                   You may only submit a challenge if you have a positive (i.e., greater-than-zero) score at the time of the challenge.  A given submission may only be 
                successfully challenged once.  If any competitor has already successfully challenged a submission, it may not be further challenged.
                ...
                will result in a loss of all points. </i>
                
                        <br><br>                        

                   If your submission passes all of the test cases, you will keep the points that were assigned to you when you submitted the problem.  Your final score for 
                each round will cumulate the points remaining from the System Testing Phase and any points gained or lost during the Challenge Phase.
