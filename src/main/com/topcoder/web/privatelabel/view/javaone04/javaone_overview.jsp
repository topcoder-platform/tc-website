			...
			<table border=0 cellspacing=0 width="800" align="center">
				...
				<!-- start breadcrumb -->
  				...
  				<!-- end breadcrumb -->
  					...
  					<p></p>
  					<img src="/i/clear.gif" width="15" height="1"><a href="http://www.topcoder.com/pl/?&module=Static&d1=javaone04&d2=javaone_monday"><img src="/i/events/javaone04/winners.gif" width="335" height="61" border="0"></a><br/>
  					<img src="/i/clear.gif" width="20" height="10">
					<p class ="regmiddle"><strong><font size="4">Code - Compete - Win!</font></strong></p>
					
					<p class ="regmiddle">Sun Microsystems has again teamed up with TopCoder to bring the JavaOne<sup><font size="1">SM</font></sup> Coding Challenge to conference attendees.
					This unique event gathers together developers who use Java<sup><font size="1">TM</font></sup> technology for coding, competition, and fun. By participating 
