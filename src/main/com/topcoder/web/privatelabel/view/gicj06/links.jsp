...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=overview">Overview</a>&#160;|&#160;
<% } %>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=schedule">Schedule</a>&#160;|&#160;
<% } %>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=rules">Rules</a>&#160;|&#160;
<% } %>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=login">Registration</a>&#160;|&#160;
<a href="/pl/?module=Static&d1=gcji06&d2=reg_closed">Registration</a>&#160;|&#160;
<% } %>
--%>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=instructions">Instructions</a>&#160;|&#160;
<% } %>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=faq">FAQ</a>&#160;|&#160;
<% } %>
 -->
<%--
--%>
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=advancers">Advancers</a>&#160;|&#160;
<% } %>
 -->
<!-- Practice Arena  tab -->
...
<% } else { %>
<a href="/pl/?module=Static&d1=gcji06&d2=arena">Competition Arena</a>&#160;<!-- |&#160; -->
<% } %>
...
-->
<br><br>
<!--  <span class="bigRed">The Onsite Finals are complete. <A href="/pl/?module=Static&d1=gcji06&d2=EN_advFinal" class="bigRed">Click here</A> to see who won!</span>  -->