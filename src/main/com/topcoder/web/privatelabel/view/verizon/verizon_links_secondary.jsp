...
<!-- Register tab -->
                            <tr><td><img src="/i/clear.gif" width="1" height="7" alt="" ></td></tr>
                            <tr><td><a class="subnavLink" href="https://<%=ApplicationServer.SERVER_NAME%>/pl/?&<%=Constants.MODULE_KEY+"="+Constants.VERIZON_REG_MAIN+"&"+Constants.COMPANY_ID+"=1747&"+Constants.EVENT_ID+"=1"%>" style="margin-left:1px;display:inline;">Registration</a></td></tr>
