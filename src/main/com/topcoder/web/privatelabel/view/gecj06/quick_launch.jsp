...
<table width="100%" cellspacing="0" cellpadding="10" border="0">
    <tr>
        ...
        <PARAM value="GoogleEuropeContestApplet.jar" name="archive">
        ...
        <PARAM name="companyName" value="GoogleEurope">
        ...
        <EMBED type="application/x-java-applet;version=1.5"
            ...
            name="LaunchApplet"
            archive="GoogleEuropeContestApplet.jar"
