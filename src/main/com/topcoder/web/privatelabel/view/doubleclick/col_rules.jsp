...
<!-- eligibility -->
            ...
            <p>
            Those members who are eligible to compete in both the Algorithm Competition and in the CDDC will be permitted to participate in both.  In addition, members will be allowed to compete in both the design and development competitions of the CDDC.  However, if one member participates in Online Rounds #1 and #2 of both the design and development competitions AND qualifies as one of the finalists in each, then the member will be permitted to advance to the final round of only one of the competitions.  The following criteria will be used to determine which competition the member will advance to:
            </p>

            <ul>
            <li>The member will advance to the competition in which he/she achieved a higher cumulative score. (Details of how the cumulative score is calculated are provided below.)</li>
            <li>If the member's cumulative score is the same in both competitions, then the member will advance to the competition in which he/she achieved a higher individual component score in Online Round #2.</li>
            <li>If the member's Online Round #2 individual component score is the same for both competitions, then the member will choose the final round in which he/she will compete.</li>
            </ul>
 ...
 <!-- Competition Structure -->
            ...
            All eligible members may compete in Online Round #1 of either or both competition(s).  Those contestants who submit components that pass screening will be eligible to compete in Online Round #2.</li>

            <li><b>Online Round #2</b><br/>
            All contestants who submitted components that passed screening in Online Round #1 will compete and the four (4) contestants in each competition with the highest cumulative scores will advance to the Onsite Championship Round #3.  The Online Round #2 component score will be weighted more heavily than the Online Round #1 component score in calculating the cumulative score. Each contestant's cumulative score will be calculated as follows:<br/><br/>
               <ul>
            ...
            <p><span class="bodySubtitle">Onsite Championship Round #3</span><br/>
             ...
             <p>
             The four (4) advancers from Online Round #2 in each competition will travel to the Boston Park Plaza Hotel & Towers on Thursday, April 15 to compete in the final review stage of Round #3 being held on Friday, April 16.  All contestants must arrive at the Boston Park Plaza Hotel & Towers no later than 4:00 PM on Thursday, April 15.  If a contestant is unable to attend the onsite round, he/she will forfeit his/her eligibility to receive a prize, and his/her spot in the tournament will be given to the next highest cumulative scorer.  All 8 advancing competitors will be required to confirm their ability to travel to and attend the onsite rounds by <b>6:00PM EST on Wednesday, March 24</b>.</p>
             <p>
             ...
             <p>
             Championship Round #3 will be a single round of four (4) members in each competition.  Two winners will be crowned, one Design Champion and one Development Champion.  Each champion will be the member with the highest score of his/her component submission in each competition.</p>
...
<!-- About the Prizes -->
            ...
            <table width="500" align="center" border="1" cellpadding="5" cellspacing="2" class="sidebarBox">
                <tr>
                    ...
                    <td width="30%" class="sidebarTitle">Development</td>
                    <td width="20%" class="sidebarTitle" align="right">Prize</td>
                </tr>

                <tr>
                    <td class="sidebarText">1st place finisher* - Design Champion</td>
                    <td class="sidebarText" align="right">$25,000</td>
                    <td class="sidebarText">1st place finisher* - Development Champion</td>
...
<!-- Conditions of Participation -->
         ...
         <h3><font color="#CC0000">Contestants must not cheat. All ideas for any component design or development solution submitted must be the contestant's alone.</font></h3>
         ...
         <p>As a condition of participation in the tournament, all information provided in each competitor's TopCoder member profile must be comprehensive, accurate and up-to-date. TopCoder may require each competitor to complete an additional registration form to register for the tournament. In order to be eligible to participate in the tournament, each competitor must have completed any and all registration forms required by TopCoder.</p>
         ...
         <p>TopCoder reserves the right, in its sole discretion, to revoke any and all privileges associated with competing in this tournament, and to take any other action it deems appropriate, for no reason or any reason whatsoever, including if TopCoder suspects competitors of cheating, tampering with the entry process, the operation of the Web site, or the tournament process, or otherwise being in violation of the rules. TopCoder reserves the right to cancel, terminate or modify the tournament if it is not capable of completion as planned for any reason, including infection by computer virus, bugs, tampering, unauthorized intervention or technical failures of any sort.</p>
            ...
            <p>The results of a round of competition will be considered, by TopCoder, to be final at 11:00 AM EST on the day following the round of competition.  Any appeals regarding the validity of these results must be received by TopCoder at the <A href="mailto:service@topcoder.com">service@topcoder.com</A> email address no later than 11:00 AM EST on the second day following the date on which the round of competition was held.</p>

            <p>This tournament is brought to you by TopCoder, Inc. (http://www.topcoder.com/) 703 Hebron Avenue, Glastonbury, CT 06033.</p></div>
