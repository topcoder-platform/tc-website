...
<div align="center">
   ...
   <div id="regBcContainer">
      <div class="regBc">
         ...
         Step <strong>2</strong> of <strong>6</strong></div>
...
<c:if test="${cf:contains(fields, photo)}">
   <tr>
      ...
      <td class="value">
         <A HREF="mailto:memberphotos@topcoder.com?subject=${regUser.activationCode}%20|%20[%20${sessionInfo.handle}%20]%20|%20${sessionInfo.userId}%20<c:if test="${regUser.coder.memberPhoto!=null}">RE</c:if>SUBMIT%20IMAGE:%20PLEASE%20DO%20NOT%20CHANGE%20SUBJECT"> Click here to <c:if test="${regUser.coder.memberPhoto!=null}">re</c:if>submit your photo</A>
         <br>
