...
/**
 * Payment for test suites competition winner.
 *
 ...
 * @author pulky
 */
public class TestSuitesCompetitionPayment extends ComponentProjectReferencePayment {
    ...
    /**
     * Create a payment for the winner (or another place!) of a Test Suites competition.
     *
     ...
     * @param placed the place of the coder in the contest.
     */
    public TestSuitesCompetitionPayment(long coderId, double grossAmount, long projectId, int placed) {
     ...
     * @param projectId project that is being paid.
     */
    public TestSuitesCompetitionPayment(long coderId, double grossAmount, String client, long projectId) {
     ...
     * @param projectId project that is being paid.
     */
    public TestSuitesCompetitionPayment(long coderId, double grossAmount, long projectId) {
     ...
     * It just provides a method for generating a description for the Test Suites competition.
     *
     * @author pulky
     */
