...
/**
 * Payment for a Digital Run V2 prize.
 *
 ...
 *
 */
public class DigitalRunV2PrizePayment extends DigitalRunTrackReferencePayment {
     ...
     */
    public DigitalRunV2PrizePayment(long coderId, double grossAmount, long trackId) {
     ...
     */
    public DigitalRunV2PrizePayment(long coderId, double grossAmount, long trackId, int placed) {
        super(DIGITAL_RUN_V2_PRIZE_PAYMENT, coderId, grossAmount, trackId, placed);
    }
