...
/**
 * Payment class for Studio bug fixes.
 *
...
public class StudioBugFixesPayment extends StudioContestReferencePayment {
    ...
    /**
     * Creates a Studio bug fixes payment using the specified parameters.
     *
     ...
     */
    public StudioBugFixesPayment(long coderId, double grossAmount, String client, long contestId, int placed) {
        super(STUDIO_BUG_FIXES_PAYMENT, coderId, grossAmount, client, contestId, placed);
    }
     ...
     * @param contestId project that is being paid.
     */
    public StudioBugFixesPayment(long coderId, double grossAmount, String client, long contestId) {
    ...
    /**
     * Processor for Studio bug fixes payments.
     *
     * This class will implement <code>lookupDescription</code> to allow custom description
     * generation for the Studio bug fixes payment and <code>lookupEventDate</code> to retrieve
     * event's date.
     */
    protected static class Processor extends StudioContestReferencePayment.Processor {
         ...
         */
        private static final String PAYMENT_DESCRIPTION_SUFFIX = " - Bug fixes";
