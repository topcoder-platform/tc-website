...
public class drv2 extends DBUtility {
	...
	protected void runUtility() throws Exception {
        ...
        query.append("                           where s3.upload_id = u3.upload_id and s3.submission_type_id = 1 and u3.upload_status_id = 1 and s3.submission_status_id != 5 ");
        query.append("                           and u3.project_id = p.project_id and s3.mark_for_purchase = 'f') as count_of_passing_subs, ");
        ...
        query.append("            and up.upload_id = s.upload_id and up.upload_status_id = 1 ");
        ...
        query.append("             and s.submission_type_id = 1 and s.submission_status_id != 5");
