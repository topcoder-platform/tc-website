 ...
 */
public interface LocalDDEContactTypeHome extends EJBLocalHome {

    /**
     * The EJB reference name.
     */
    public static final String EJB_REF_NAME = "java:comp/env/ejb/DDEContactTypeEJB";
     ...
     */
    LocalDDEContactType findByPrimaryKey(Long key) throws FinderException;
     ...
     */
    LocalDDEContactType create(String description, long statusId) throws CreateException;
