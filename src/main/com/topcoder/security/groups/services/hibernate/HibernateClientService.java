...
public class HibernateClientService extends BaseGroupService implements ClientService {
     ...
     * </p>
     */
    private static final String HQL_SEARCH_CLIENTS = "from Client c where c.deleted != true";
     ...
     * </p>
     */
    private static final String HQL_GET_CLIENT = "from Client c where c.id = :id and c.deleted != true";
