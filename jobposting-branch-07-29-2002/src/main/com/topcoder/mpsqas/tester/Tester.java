...
public class Tester extends Thread
{
  ...
  private Class[] getParamClasses(ArrayList paramTypes)
  {
    ...
    for(int i=0;i<paramTypes.size();i++)
    {
      ...
      if(type.equals("int")) classes[i]=int.class;
      else if(type.equals("Integer")) classes[i]=Integer.class;
      else if(type.equals("double")) classes[i]=double.class;
      else if(type.equals("Double")) classes[i]=Double.class;
      else if(type.equals("long")) classes[i]=long.class;
      else if(type.equals("Long")) classes[i]=Long.class;
      else if(type.equals("Character")) classes[i]=Character.class;
      else if(type.equals("char")) classes[i]=char.class;
      else if(type.equals("String")) classes[i]=String.class;
      else if(type.equals("int[]")) classes[i]=int[].class;
      else if(type.equals("double[]")) classes[i]=double[].class;
      else if(type.equals("String[]")) classes[i]=String[].class;
    }
    return classes;
