...
You must use a vector graphics editor such as Adobe Illustrator or CorelDraw to create vector graphics.  PhotoShop .PSD or Photoshop EPS files are not acceptable formats. Please note that using other programs such as PaintShop Pro or PhotoShop to export or save a file as an .EPS or .AI file does not make it a proper vector graphic. 
<br><br>
<h3>How do I create a .PDF file?</h3>
There are many free options available to you on the internet if you do not own a copy of Adobe Acrobat. <A href="http://www.primopdf.com/" target="_blank">PrimoPdf</A> and <A href="http://www.cutepdf.com/" target="_blank">CutePdf</A> are two options for creating free .PDF files online.
<br><br>
<h3>What is an .ICO file?</h3>
.ICO files are Windows based icon image files. These files can hold multiple sizes of icons at varying color depths.  Standard sizes for most Windows applications are 64x64, 32x32 and 16x16.  Icon files should be created at maximum color depth, optimized for Windows XP unless otherwise specified in the contest details.
<br><br>
<h3>How do I create a .ICO file?</h3>
Many designers will create their artwork in another program such as Adobe Illustrator or PhotoShop and then import these files into an icon editor such as <A href="http://www.axialis.com/" target="_blank">Axialis</A>.  There are also a number of <A href="http://www.download.com/3120-2001_4-0-1-0.html?qt=icon+editor&author=&titlename=&desc=&dlcount=&daysback=&swlink=&gfiletype=&os=&li=49&dlsize=&ca=" target="_blank">free icon editors</A> available.
<br><br>
<h3>Will Studio contests affect my TopCoder Rating?</h3>
No. Studio is independent of TopCoder ratings and statistics.  Winning Studio contests will not improve your TopCoder standings.
<br><br>
<h3>Why can't I see the Contest Specifications?</h3>
You must be a registered Studio member to see a contest's specifications document. You can register with Studio by clicking any of the <A href="https://<%=ApplicationServer.SERVER_NAME%>/reg/">Register Now</A> links on this site. If you already have a TopCoder handle, you may login to <A href="http://<%=ApplicationServer.SERVER_NAME%>">www.topcoder.com</A> and update your profile by simply opting in for Studio membership.
<br><br>
...
<li>A completed and signed IRS tax form - either W-9 or W-8BEN, depending on where you live and what your U.S. resident status is. Members will only be required to submit this document once.</li>
<ul>
