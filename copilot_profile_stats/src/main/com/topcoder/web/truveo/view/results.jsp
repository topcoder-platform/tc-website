                        ...
                        <c:when test="<%=resultRow.getBooleanItem("is_image")%>">
                            <div align="center">
                                ...
                                <div style="overflow: hidden; width: 300px;">
                                    <truveo_tags:submissionDisplay submissionId="${resultRow.map['submission_id']}" width="${resultRow.map['width']}" height="${resultRow.map['height']}"/>
                                </div>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div align="center">
                                ...
                                <a href="${sessionInfo.servletPath}?module=DownloadSubmission&amp;<%=Constants.SUBMISSION_ID%>=<rsc:item name="submission_id" row="<%=resultRow%>"/>">
                                    <img src="/i/events/truveo/interface/magnify.png" alt="" onmouseover="popUp(this,'popView')" onmouseout="popHide()"/>
                                </a>
                            </div>
                        </c:otherwise>
                    </c:choose>
