...
--%>
				...
				<% } else { %>
					<td class=nav><A href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=ss_description"><img src="/i/tournament/tccc05/tabs/L2_specshowOff.gif" alt="" border=0 /></A></td>
				<% } %>
				...
				<% if (tabLev2.equals("summary")) {%>
					<td class=nav><A href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=alg_finals_analysis"><img src="/i/tournament/tccc05/tabs/L2_summaryOn.gif" alt="" border=0 /></A></td>
				<% } else { %>
					<td class=nav><A href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=alg_finals_analysis"><img src="/i/tournament/tccc05/tabs/L2_summaryOff.gif" alt="" border=0 /></A></td>
				<% } %>
<%--
--%>
				<% } else if (tabLev1.equals("component")) { %>
...
--%>
					<% } else if (tabLev2.equals("sponsors")) {%>
						...
						<td class=subnav><a href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=nvidia"><% if (tabLev3.equals("nvidia")) {%><img src="/i/tournament/tccc05/tabs/L3_nvidiaOn.gif" border=0 /><% } else { %><img src="/i/tournament/tccc05/tabs/L3_nvidiaOff.gif" border=0 /><% } %></a></td>
					<% } else {%>
				...
				<% } else if (tabLev1.equals("algorithm")) { %>
					...
					<% } else if (tabLev2.equals("advancers")) {%>
						...
						<td class=subnav><a href="/tc?module=Static&d1=tournaments&d2=tccc05&d3=radeye_semi" target="_blank"><% if (tabLev3.equals("radeye")) {%><img src="/i/tournament/tccc05/tabs/L3_radeyeOn.gif" border=0 /><% } else { %><img src="/i/tournament/tccc05/tabs/L3_radeyeOff.gif" border=0 /><% } %></a></td>
