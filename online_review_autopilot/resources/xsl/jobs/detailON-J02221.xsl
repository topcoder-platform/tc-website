...
<!--end contextual links-->
          ...
          <P><B>Top Secret Programmer</B></P>
		  <UL><LI>Software company in D.C. area</LI>
		  <LI>Java or C++ coders are welcome</LI>
		  <LI>Experience with government contracts is helpful</LI></UL>
		  <P><A HREF="/?t=jobs&amp;c=inquire&amp;Job=ON-J02221&amp;JobDesc=Top%20Secret%20Programmer&amp;To=tcesr@topcoder.com" CLASS="bodyText">Feel qualified and are interested?</A></P>
          <P><BR/></P>
          </TD>
