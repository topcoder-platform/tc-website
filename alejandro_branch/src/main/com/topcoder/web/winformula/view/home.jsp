        ...
        <%-- Main Content --%>
            ...
            <div class="full-content">
                ...
                <ol class="howCompete">
                    ...
                    The problem statement explains the task, scoring mechanism, and specification to the competitor so that the code works with TopCoder's judging engine.  <a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=problemStatement">View the problem statement &gt;&gt;</a></li>
                    ...
                    <li><strong><a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=manageMyAlgorithms">Submit your algorithm</a></strong> (through November 11th)<br />
