...
Your (possibly adjusted) score is <xsl:value-of select="SCORE"/> / <xsl:value-of select="MAX_SCORE"/>
...
The online review page for this project is:
<![CDATA[http://software.topcoder.com/review/projectDetail.do?id=]]><xsl:value-of select="PROJECT_ID"/>
