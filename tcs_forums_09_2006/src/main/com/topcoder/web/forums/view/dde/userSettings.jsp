...
<table cellpadding="0" cellspacing="0" border="0" class="tabTable">
  <tr>
      ...
      <td id="tabGen3" width="1%" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOnOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabGen5" width="1%" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOffOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabGen7" width="1%" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/rightOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabWatch3" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOffOn.gif" alt="" border="0" /></td>
      ...
      <td id="tabWatch5" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOnOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabWatch7" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/rightOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabRate3" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOffOff.gif" alt="" border="0" /></td>
      ...
      <td id="tabRate5" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/midOffOn.gif" alt="" border="0" /></td>
      ...
      <td id="tabRate7" width="1%" style="display:none" valign="top"><img src="http://forums.dev.topcoder.com/i/stats/tabs/rightOn.gif" alt="" border="0" /></td>
...
<div align="right">
<input type="image" src="http://forums.dev.topcoder.com/i/roundTables/save.gif" alt="Save"/>
</div></form>
