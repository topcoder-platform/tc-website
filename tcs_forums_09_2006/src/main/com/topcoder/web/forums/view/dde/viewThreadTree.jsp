...
<html>
<head>
<title>TopCoder Software Forums - <%=forum.getName()%></title>
...
<table cellpadding="0" cellspacing="0" class="rtTable">
   <tr>
      ...
      <%  String msgBodyID = "msgBody" + activeMessage.getID(); 
        ...
        <%  } %>
        <% if (ForumsUtil.userCanPost((Map) session.getAttribute("roleMap"), forum)) { %>
   ...
   <tr>
 	  <td class="rtHeader" colspan="2" width="100%">
		...
		while(attachments.hasNext()) {
			AttachmentProxy attachment = (AttachmentProxy) attachments.next();
		%>
...
<table cellpadding="0" cellspacing="0" class="rtTable">
   ...
   <tr>
      ...
      if (depth > 0) { %><img src="http://forums.dev.topcoder.com/images/clear.gif" width="<%=width%>" height="1"/><% } %>
      <% if (active) { %>
