...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Tournament Package - Onsite Arena</xsl:with-param>
</xsl:call-template>
...
<!--end contextual links-->
					<P>TopCoder's onsite arena is designed to give the competitors a degree of privacy while offering spectators viewing of coders and what they're coding.</P>
					<P>TopCoder has the following elements present for all onsite matches:<UL>
					<LI>Co-branded onsite signage directing spectators to location</LI><BR/>
					<LI>Co-branded information and collateral (TopCoder and Sponsor's) area</LI><BR/>
					<LI>Co-branded kiosk in lobby with match, sponsor, and competitor information</LI><BR/>
					<LI>50" Video Display - co-branded panels surrounding the live digital score board</LI><BR/>
					<LI>Viewing Islands - 2 monitors per coder showing their efforts in real-time</LI><BR/>
					<LI>Competitor stage - co-branded pillars</LI><BR/>
					<LI>TopCoder Arena &#40;see image below&#41;</LI></UL><BR/></P>
					<DIV ALIGN="center">
					<IMG SRC="/i/about/arena.gif" ALT="" WIDTH="450" HEIGHT="370" BORDER="0"/></DIV><BR/>
