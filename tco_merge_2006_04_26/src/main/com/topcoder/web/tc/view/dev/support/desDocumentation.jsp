...
<td class="bodyText" WIDTH="100%"><img src="/i/clear.gif" width="400" height="1" vspace="5" border="0"><br />
         ...
         <h2>Design Documentation</h2>
            ...
            <tr>
               ...
               <td class="projectCells" valign="top" align="right" nowrap="nowrap"><A href="/tc?module=Static&d1=dev&d2=support&d3=desMemberGuide">TopCoder Software Member Guide</A></td>
            </tr>
                <tr>
               <td class="projectCells" valign="top">
