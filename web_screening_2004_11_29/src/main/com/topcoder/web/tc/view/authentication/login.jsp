        ...
        <td width="100%"><img src="/i/clear.gif" width="400" height="11" alt="" border="0"><br>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tr valign="top">
                ...
                <tr valign="middle">
                  <form method="post" name="frmLogin" action="<jsp:getProperty name="sessionInfo" property="SecureAbosoluteServletPath"/>">
                    ...
                    <td class="bodyText" align="center">
                        <table border="0" cellpadding="3" cellspacing="0">
                           <tr><td colspan="3"><img src="/i/clear.gif" width="10" height="3" alt="" border="0"></td></tr>
                            ...
                            <tr valign="middle">
                                <td nowrap class="bodyText" colspan="3"><input type="checkbox" name="<%=Login.REMEMBER_USER%>"> Remember Me</td>
                            </tr>
