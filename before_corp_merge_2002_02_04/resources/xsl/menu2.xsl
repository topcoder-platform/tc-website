    ...
    <TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#CC0000">
      <TR>
        ...
        <!-- <TD CLASS="globalNav" WIDTH="100" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000" NOWRAP="0">   
          ...
          <A HREF="http://www.topcodersoftware.com" onMouseOver="changeImages('image4', 'image4on')" onMouseOut="changeImages('image4', 'image4off')" TARGET="_blank"><IMG NAME="image4" SRC="/i/menu_tcs_off.gif" ALT="TCS" WIDTH="128" HEIGHT="21" BORDER="0"/></A>         
          <!-- <IMG SRC="/i/divider.gif" ALT="" WIDTH="1" HEIGHT="21" BORDER="0"/> -->
