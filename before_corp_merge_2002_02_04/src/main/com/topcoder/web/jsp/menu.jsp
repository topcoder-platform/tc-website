...
<TD WIDTH="187" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000"><A HREF="/?&t=tces&c=index" onMouseOver="changeImages('image2', 'image2on')" onMouseOut="changeImages('image2', 'image2off')" TARGET="_parent"><IMG NAME="image2" SRC="/i/menu_tces_off.gif" ALT="TCES" WIDTH="187" HEIGHT="21" BORDER="0"></A></TD>
