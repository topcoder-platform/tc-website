  ...
  <BR/>
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="1">
	  ...
	  <TR>
		...
		<A HREF="/index?t=schedule&amp;c=tourny_regions_ne" CLASS="statTextBig">Regions</A></TD>
		<TD WIDTH="25%" ALIGN="center" VALIGN="middle" HEIGHT="16" CLASS="statTextBig" BACKGROUND="/i/steel_bluebv_bg.gif">
		...
		<A HREF="/index?t=schedule&amp;c=tourny_sched" CLASS="statTextBig">Schedule</A></TD>
		<TD WIDTH="25%" ALIGN="center" VALIGN="middle" HEIGHT="16" CLASS="statTextBig">
			...
			<xsl:otherwise>steel_bluebv_bg</xsl:otherwise></xsl:choose>.gif</xsl:attribute>	
		<A HREF="/index?t=schedule&amp;c=tourny_rules_overview" CLASS="statTextBig">Rules</A></TD>
	  </TR>
    </TABLE>
</xsl:template>
</xsl:stylesheet>
