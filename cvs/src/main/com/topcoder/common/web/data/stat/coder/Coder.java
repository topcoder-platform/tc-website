...
public final class Coder implements Serializable, Base, Comparable {
  ...
  public float getEasySuccessPercent() {
    ...
    else return (1-(float)(numEasyFailChallenge + numEasyFailSys) / numEasySubmitted)*100;
  }

  public float getMedSuccessPercent() {
    if ((numMedFailChallenge + numMedFailSys) == 0) 
      return numMedSubmitted == 0 ? 0 : 100;
    else return (1-(float)(numMedFailChallenge + numMedFailSys) / numMedSubmitted)*100;
  }

  public float getHardSuccessPercent() {
    if ((numHardFailChallenge + numHardFailSys) == 0)
      return numHardSubmitted == 0 ? 0 : 100;
    else return (1-(float)(numHardFailChallenge + numHardFailSys) / numHardSubmitted)*100;
  }
  ...
  public float getEasyChallengePercent() {
    ...
    else return (1-(float)numEasyChallengeFail/numEasyChallenges)*100; 
  }

  public float getMedChallengePercent() {
    if (numMedChallengeFail == 0)
      return numMedChallenges == 0 ? 0 : 100;
    else return (1-(float)numMedChallengeFail/numMedChallenges)*100; 
  }

  public float getHardChallengePercent() {
    if (numHardChallengeFail == 0)
      return numHardChallenges == 0 ? 0 : 100;
    else return (1-(float)numHardChallengeFail/numHardChallenges)*100; 
  }
  ...
  public float getTotalChallengePercent() {
    ...
    else return (1-(float)getTotalChallengeFail()/getTotalNumChallenges())*100;
  } 
