...
public class ResultSetContainer implements Serializable, List, Cloneable {
     ...
     * adds all rows of the ResultSet into the container.
     *
    ...
    private TCResultItem getItem(ResultSet rs, int i) throws Exception {
        ...
        case Types.LONGVARBINARY:
            String s = "";
            try {
                s = StringUtilities.makePretty(DBMS.getBlobObject(rs, i+1));
            } catch (Exception e) {
                Log.msg("Exception while retrieving blob object into result set");
