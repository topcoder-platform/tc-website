...
--%>
		...
		Component Competitions on Friday, March 12. Each grand prize includes a Yahoo!&#174; gift pack, a Motorola&#174; <A href="http://www.motorola.com/mdirect/hellomoto/experience/v3/flash/v3_homepage.shtml" target="_blank">Moto Razr V3 phone</A>, an NVIDIA&#174; gift pack and a TopCoder&#174; gift pack.  <a href="Javascript:openWin('/tc?module=Static&d1=tournaments&d2=tccc05&d3=ss_rules','comp',545,655);">Click here</a> for the complete rules.</p>
