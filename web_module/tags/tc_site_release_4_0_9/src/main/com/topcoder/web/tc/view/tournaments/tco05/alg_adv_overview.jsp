...
<% ResultSetContainer rsc = (ResultSetContainer) ((Map)request.getAttribute("resultMap")).get("tco05_alg_adv_overview"); %>
...
<!-- Body-->
	<tr valign=top>
        ...
        <p class=bigTitle>Advancers - Overview</p>
            ...
            <p>Click a column title to sort the list of advancers by that column. Click <a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&d1=tournaments&d2=tco05&d3=alg_adv_overview">here</a> to reset the list to its originally sorted format.</p>

            <table width="500" align="center" border="0" cellpadding="2" cellspacing="0" class="formFrame">
                <tr class="advHeader">
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=seed&d1=tournaments&d2=tco05&d3=alg_adv_overview">Seed</a></td>
                    <td width = "15%" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=handle_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Handle</a></td>
                    <td width = "5%" align = "right" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=desc&sc=rating&d1=tournaments&d2=tco05&d3=alg_adv_overview">Rating</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=round1_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Round 1</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=round2_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Round 2</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=round3_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Round 3</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=round4_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Round 4</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=semi_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Semi</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=wildcard_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Wildcard</a></td>
                    <td width = "10%" align = "center" nowrap="nowrap"><a href="?module=SimpleStats&c=tco05_alg_adv_overview&trans=true&sd=asc&sc=finals_sort&d1=tournaments&d2=tco05&d3=alg_adv_overview">Final</a></td>
                </tr>
