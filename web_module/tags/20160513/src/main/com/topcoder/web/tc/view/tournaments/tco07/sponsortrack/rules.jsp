...
<p>The dates and times of the online rounds of competition are as follows:</p>
                        ...
                        <tbody>
                                ...
                                <tr class="light">
                                <td class="value" colspan="4"><b>*NOTE</b>: All times are Eastern Daylight Time. In the event that a round must be cancelled for any reason, the round will be held the following day at the same time.</td>
                                </tr>
                        </tbody>
                        </table>
                    </div>
...
<p><b>NOTE:</b> In the event of a tie for any advancing position during the online rounds, the tie will be resolved in the following manner:</p>
<ul>
