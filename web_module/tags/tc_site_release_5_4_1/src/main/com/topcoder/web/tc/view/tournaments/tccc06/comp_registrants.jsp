                    ...
                    <tbody><tr>
                        ...
                        <tr>
                            <td class="<%=(even ? "advanceDk" : "advanceLt")%>">
                                <tc-webtag:handle coderId='<%=resultRow.getIntItem("user_id")%>' context="component" darkBG="true"/></td>
                            <td class="<%=(even ? "advanceDk" : "advanceLt")%>" align="right">
                                <rsc:item format="###0" ifNull="Unrated" name="design_rating" row='<%=resultRow%>'/></td>
                            <td class="<%=(even ? "advanceDk" : "advanceLt")%>" align="right">
                                <rsc:item format="###0" ifNull="Unrated" name="dev_rating" row='<%=resultRow%>'/></td>
                        </tr>
                            <%even = !even;%>
                        </rsc:iterator>
