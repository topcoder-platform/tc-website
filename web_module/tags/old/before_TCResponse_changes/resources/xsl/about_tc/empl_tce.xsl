...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;TopCoder Employment</xsl:with-param>
</xsl:call-template>
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
				<TR>
					<TD VALIGN="top" WIDTH="11"><IMG SRC="/i/clear.gif" ALT="" WIDTH="11" HEIGHT="1" BORDER="0"/></TD>
					<TD CLASS="bodyText" COLSPAN="2" VALIGN="top" BGCOLOR="#FFFFFF" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/><BR/><BR/>
					TopCoder Employment (TCE) is designed to help bring employers and members together for potential employment relationships.<BR/><BR/>
					The TCE team brings over 50 years of recruiting experience for companies in the technology consulting and development industry. TCE understands how to locate, review, and align the candidate(s) best suited to a company's technology needs.<BR/><BR/>
					Through TCE, employers are given access to review member statistics, history, submissions and more. Personal information such as first and last name, means of contact, and address are not available without the interaction of TCE and consent of the member.<BR/><BR/>
