...
<table width="500" align="center" border="0" cellpadding="6" cellspacing="2" class="sidebarBox">
   <tr>
      ...
      <td class="sidebarTitle" width="20%"># of Participants</td>
      <td class="sidebarTitle" width="20%"># of Advancers</td>
   </tr>
   <tr valign="top">
      <td class="sidebarText" nowrap="nowrap">Qualification Round #1</td>
      <td class="sidebarText" nowrap="nowrap">
      Thursday, September 7th<br>
      Register: 4:00 - 6:55 AM<br>
      START: 7:00 AM</td>
      <td class="sidebarText" nowrap="wrap">All members who have not previously qualified - limited to the first 1,350 participants to register</td>
      <td class="sidebarText">450</td>
   </tr>
   <tr valign="top">
      <td class="sidebarText" nowrap="nowrap">Qualification Round #2</td>
      <td class="sidebarText" nowrap="nowrap">
   ...
   <tr valign="top">
      <td class="sidebarText" nowrap="nowrap">Qualification Round #3</td>
      <td class="sidebarText" nowrap="nowrap">
...
<br><br>
The format for each Qualification Round will be the same as all other tournament rounds, which is outlined in the <LINK>Competition Round Structure</LINK> section.
<br><br>
...
<table width="510" align="center" border="0" cellpadding="6" cellspacing="2" class="sidebarBox">
   <tr>
      <td class="sidebarTitle" width="20%">Round of Competition</td>
      <td class="sidebarTitle" width="40%">Date and Time*</td>
      <td class="sidebarTitle" width="20%"># of Participants</td>
      <td class="sidebarTitle" width="20%"># of Advancers</td>
   </tr>
   ...
   <tr valign="top">
      <td class="sidebarText">Online Round #1 - <br>Section B</td>
      <td class="sidebarText">
   ...
   <tr valign="top">
      <td class="sidebarText">Online Round #1 - <br>Section C</td>
      <td class="sidebarText">
      Wednesday, September 27th<br>
      Register: 6:00 - 8:55 PM<br>
      START: 9:00 PM</td>
      <td class="sidebarText">Up to 600**</td>
      <td class="sidebarText">150</td>
   ...
   <tr valign="top">
      <td class="sidebarText">Online Round #2 - <br>Section B</td>
      <td class="sidebarText">
   ...
   <tr valign="top">
      <td class="sidebarText">Online Round #2 - <br>Section C</td>
      <td class="sidebarText">
   ...
   <tr valign="top">
      ...
      * NOTE:  All times are Eastern Daylight Time (GMT -4).  In the event that a round must be cancelled for any reason, the round will be the following day at the same time.<br>
      ** If less than 1,500 competitors qualify to compete in Online Round #1, the maximum number of competitors that will be assigned into any section will be 40% of the actual number of qualifiers, rounded up.</td>
   </tr>
</table>
<br/><br/>
...
<table width="500" align="center" border="0" cellpadding="5" cellspacing="2" class="sidebarBox">
   <tr>
      ...
      <td width="50%" class="sidebarTitle">Date and Time (Pacific Standard Time)</td>
   </tr>
   <tr>
      <td width="50%" class="sidebarText">Semifinal Room #1</td>
      <td width="50%" class="sidebarText">Wednesday, November 15, 9:00 AM</td>
   </tr>
   <tr>
      <td width="50%" class="sidebarText">Semifinal Room #2</td>
      <td width="50%" class="sidebarText">Wednesday, November 15, 4:00 PM</td>
   </tr>
   <tr>
      <td width="50%" class="sidebarText">Semifinal Room #3</td>
      <td width="50%" class="sidebarText">Thursday, November 16, 9:00 AM</td>
   </tr>
   <tr>
      <td width="50%" class="sidebarText">Wildcard Round</td>
      <td width="50%" class="sidebarText">Thursday, November 16, 4:00 PM</td>
   </tr>
   <tr>
      <td width="50%" class="sidebarText">Championship Round</td>
      <td width="50%" class="sidebarText">Friday, November 17, 2:30 PM</td>
   </tr>
</table>
<br><br>   
...
<br><br>
<strong>The Championship Round</strong> will be a single round of eight (8) coders. Placement in the Championship Round is determined by comparing the total points of each coder. The winner of the Championship Round will be the coder with the highest point total for the round. In the event of a tie in the Semifinal, Wildcard and/or Championship Rounds, the tie will be resolved in the following manner (in order):

<ul>
<li>Total points acquired (higher is better) during Online Rounds #1, #2 and #3 of the 2006 TopCoder Collegiate Challenge</li>
<li>If a tie still remains, then by rating (higher is better) following Online Round #3</li>
   <ul>
...
<table width="550" align="center" border="0" cellpadding="5" cellspacing="2" class="sidebarBox">
   ...
   <tr>
      ...
      <td class="sidebarText" align="right" style="padding-right: 100px;"><b>$25,000</b></td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td class="sidebarText" align="right" style="padding-right: 100px;">$1,000 each</td>
   </tr>
   <tr>
      <td class="sidebarText">9th - 48th place finishers* in the Semifinal Rounds</td>
      <td class="sidebarText" align="right" style="padding-right: 100px;">$400 each</td>
   </tr>
   <tr>
      <td class="sidebarText">Up to 150 advancers from Online Round #2 to Online Round #3</td>
      <td class="sidebarText" align="right" style="padding-right: 100px;">$100 each</td>
   </tr>
   <tr>
      <td class="sidebarText">Up to 450 advancers from Online Round #1 to Online Round #2</td>
      <td class="sidebarText" align="right" style="padding-right: 100px;">$50 each</td>
   </tr>
   <tr>
      <td class="sidebarText">Up to 1,500 competitors who compete in Online Round #1</td>
      <td class="sidebarText" align="right" style="padding-right: 100px;">Limited edition 2006 TopCoder Collegiate Challenge t-shirt</td>
   </tr>
   <tr>
