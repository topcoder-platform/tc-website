...
<div id="wrapper">
    ...
    <jsp:param name="tabLev3" value="devforums"/>
        ...
        <div class="sub_content">
            ...
            <p>The cockpit framework is also intended to be provided to every TopCoder member as an upgrade from the "MyTopCoder" page, bringing new social networking functionality such as blogs, customizable profile/portfolio pages, grouping and enhanced inter-member communication.</p>
            <p>The presentation will include an overview of the cockpit as well as a demonstration of how it works.  Particular attention will be paid to opportunities for members to act as TopCoder "co-pilots" or even Project Managers assisting clients directly in their ability to execute projects and competitions.</p>
