            ...
            <table cellspacing="0" cellpadding="10" border="0" width="100%">
                ...
                <tr>
                    <td width="100%" class="bodyText">
                        ...
                        <div align="center">
                        <table cellspacing="0" cellpadding="5" border="1" bordercolor="#cccccc" width="90%">
                            <tr>
                                <th class="bodyText" align="left">LEVEL</td>
                            ...
                            <tr valign="top">
                                ...
                                <td class="bodyText">
                                    <ul>
                                        ...
                                        <li>Predominate signage onsite during the championship rounds</li>
                                        <li>More...</li>
                                    </ul>
                                </td>
                            ...
                            <tr valign="top">
                                ...
                                <td class="bodyText" align="right">$5,000</td>
                            </tr>
                        </table>
                        </div>
