...
<% if (tabLev1.equals("overview")) {%>
   <tr>
      <td width="50%"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=about"><img src="/i/tournament/tccc06/tccc06_logo_aol.gif" width="220" height="180" border="0"/></A></td>
...
--%>
         ...
         <% } else if (tabLev1.equals("algorithm")) { %>
            ...
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tccc06&d3=alg_registrants"><img src="/i/tournament/tccc06/tabs/L2_registrantsOff.gif" alt="" border="0" /></A></td>
            <% } %>
