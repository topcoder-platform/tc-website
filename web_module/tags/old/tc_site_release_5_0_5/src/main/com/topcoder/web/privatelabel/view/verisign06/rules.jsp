...
<ol>
    ...
    <li><b>The Automated Testing Phase</b> is applied to all submitted code that has not already been
        ...
        submissions for a given problem. </li>
</ol>
<br/>
...
reflect their performance, based on TopCoder's rating formula. Contestant ratings play no role in a
...
<br/><br/>
Winners in each round of competition will be those competitors that win the most points in their
...
TopCoder, its affiliates, subsidiaries, sponsors, advertising and promotion agencies, and prize
...
process, the operation of the Web site, the tournament process, or is otherwise in violation of the
...
<span class="bodySubtitle">Participants</span>
<br/><br/>
The match is open to all members who are at least 18 years of age.
<br/><br/>
All competitors must have registered as a VeriSign employee, and must have agreed to the rules on this
page prior to competiting.
<br/><br/>
Employees of TopCoder and those involved in the development, production (including prize suppliers and
sponsors), implementation and distribution of this tournament and their advertising or promotion
...
<br/><br/>
This tournament is brought to you by <a href="http://www.topcoder.com/">TopCoder, Inc.</a> 703 Hebron
