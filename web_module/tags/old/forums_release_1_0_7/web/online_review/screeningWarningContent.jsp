...
<logic:present name="projectInfo">
				...
				<tr>
					<td width="5%" class="whiteBkgnd"><img src="/images/clear.gif" alt="" width="1" height="1" border="0"></td>
					<td class="forumTextOdd">We have successfully received your Solution for
					        <strong><bean:write name="projectInfo" property="projectName" />
					        <bean:message key="prompt.version" />
    				        <bean:write name="projectInfo" property="projectVersion" /></strong>.
					        We will contact you by email if any changes need to be made to your design in order for you to win this design competition.</td>
				</tr>
				<tr>
