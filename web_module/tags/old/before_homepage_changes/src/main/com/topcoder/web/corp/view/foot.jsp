...
<!-- Member sites -->
    <tr><td width="100%" class="footer"><a href="http://<%=ApplicationServer.SERVER_NAME%>" class="footerLinks">Competition</a>&#160;&#160;|&#160;&#160;
    <a href="http://<%=ApplicationServer.SERVER_NAME%>/?t=development&c=index" class="footerLinks">Development</a>&#160;&#160;|&#160;&#160;
