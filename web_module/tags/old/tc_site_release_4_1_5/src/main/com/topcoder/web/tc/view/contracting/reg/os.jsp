...
<!-- Breadcrumb-->
    <script language="javascript">
        function goToPage(s)
        {
            document.frmOS.module.value = s;
            document.frmOS.submit();
        }
    </script>

		<FORM ACTION="/tc" METHOD=POST onSubmit="" name="frmOS">
		<input type="hidden" name="module" value="ContractingOS"/>
        ...
        <table border=0 cellpadding=3 cellspacing=0 width="100%" class=bodyText>
			<tr>
				...
				<tc-webtag:textArea name="<%=Constants.NOTE_PREFIX + Constants.OS_NOTE_TYPE_ID%>" rows="3" cols="40"/>
				</td>
			</tr>
			<tr><td class=bodyText colspan=2 align=center><br/><br/><a href="javascript:goToPage('ContractingDatabases');"><img src="/i/submit.jpg" border=0/></a>
