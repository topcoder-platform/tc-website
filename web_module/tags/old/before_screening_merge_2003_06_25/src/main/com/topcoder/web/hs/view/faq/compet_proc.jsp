...
<!-- Center Column begins -->
        <td valign="top" background="/i/bluegradiant_bg.gif" bgcolor="#FFFFFF" width="99%">
            ...
            <!--Body starts here-->
                   <table cellspacing="0" cellpadding="0" border="0"><tr><td class="bodyText"><b>Starting a Competition</b><a href="?module=Static&d1=faq&d2=manual_fig3"> (Fig. 3)</a><br>
	...
	<ol><li><b>Alert message - start of round:</b>  Each contestant will receive a pop-up message when
	it is time for the round to begin.  This message will pop-up regardless of a contenstant's location within the applet.<br></li><br><li><b>Room assignment:</b>  The alert message will prompt the contestant to move into an assigned room and commence competition.
	Contestants will find the contest name, round room and time on this panel.<br></li><br><li><b>Move request:</b>  Each contestant will move to his/her assigned room by clicking "yes" on the alert message.<br></li></ol><br><b>Competition Phases</b><br><ul><li><b>Phase I: Coding</b><a href="?module=Static&d1=faq&d2=manual_fig4"> (Fig. 4)</a><br>
	...
	<ul><li>a problem with a low difficulty rating</li><li>a problem with a medium difficulty rating</li><li>a problem with a high difficulty rating</li></ul><br>
	When a problem has been selected, a window containing the following will be presented to the contestant:
	<ul><li>Problem information, problem statement, and coding area</li><li>A choice of either the <a href="?module=Static&d1=faq&d2=compet_proc">standard or VI editors</a></li><li>Buttons for saving, compiling, testing, clearing and submitting the coded problem</li></ul></li><br><li><b>Intermission</b><br>
	...
	and chat with other users.<br></li><br><li><b>Phase II: Challenge</b><a href="?module=Static&d1=faq&d2=manual_fig5"> (Fig. 5)</a><br>
	...
	be adjusted in favor of the challenger. For more information on point distribution, review our <a href="?module=Static&d1=faq&d2=ratings_ovrev">rating system</a>.<br></li><br><li><b>Phase III: System Testing</b><br>
	...
	available on the website.<br></li></ul><a href="?module=Static&d1=faq&d2=process_details">More details</a></td></tr></table><p><br></p>					<p><br></p>
              <!--Body Ends Here-->
                    </td>
                </tr>
            </table>
