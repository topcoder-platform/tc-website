...
<xsl:template name="BodyLeft">
  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" VALIGN="top">
    <TR>
      <TD WIDTH="25" BGCOLOR="#999999" VALIGN="top" ALIGN="right">
        <IMG SRC="/i/sub_navbox_top_left.gif" WIDTH="25" HEIGHT="1" BORDER="0"/>
        <BR/><IMG SRC="/i/sub_navbox_btm_left.gif" WIDTH="25" HEIGHT="21" BORDER="0"/>
      </TD>
  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" VALIGN="top" BACKGROUND="/i/steel_gray_bg2.gif" BGCOLOR="#43515E"> 
    <TR>
      <TD COLSPAN="2" BACKGROUND="">
        <IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0" VSPACE="2"/>
      </TD>
