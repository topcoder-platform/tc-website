...
public class JobMonitor {
  ...
  public static void main ( String[] args ) {
    ...
    try {
          ...
          EmailServer svr = (( EmailServerHome ) ctx.lookup ( "com.topcoder.server.ejb.EmailServices.EmailServer" )).create();
    ...
    static void printJobs(PrintWriter page, Context ctx, int status, int range) {
        try {
            ...
            for ( ; jobItr.hasNext(); ) {
				...
				case 0: page.print("TODO");break;
				case 1: page.print("SENT");break;
				case 2: page.print("FAILED: ");
