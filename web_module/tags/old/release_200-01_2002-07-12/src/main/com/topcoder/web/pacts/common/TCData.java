...
public class TCData {
	...
	try {
	    ...
	    if(printException) { e.printStackTrace(); }
	    if (defaultVal != null && defaultVal.equals("00/00/00")) return "00/00/0000";
    ...
    public static String dateForm(String userDate, String defaultVal, boolean printError) {
        ...
        while (token.hasMoreElements() && !error) {
            ...
            if (count < 2) {
                switch (piece.length()) {
                    case 1: returnString += "0" + piece + "/"; break;
                    case 2: returnString += piece + "/"; break;
                    default: error = true;
                }
            } else if (count == 2) {
                switch (piece.length()) {
                    ...
                    case 2: returnString += PactsConstants.YEAR_PREFIX + piece; break;
                    case 4: returnString += piece; break;
                    default: error = true;
                }
            }
            else error = true;
