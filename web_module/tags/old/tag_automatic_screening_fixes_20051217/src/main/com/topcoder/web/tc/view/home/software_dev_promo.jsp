...
if ( MM_FlashCanPlay ) {
	...
	document.write(' <PARAM NAME=movie VALUE="/i/promos/software_dev_promo.swf?currentTotal=<rsc:item set="<%=total%>" name="total" format="0,0" ifNull="0"/>"> <PARAM NAME=menu VALUE=false> <PARAM NAME=quality VALUE=high> <PARAM NAME=salign VALUE=T> <PARAM NAME=bgcolor VALUE=#FFFFFF>  ');
	document.write(' <EMBED src="/i/promos/software_dev_promo.swf?currentTotal=<rsc:item set="<%=total%>" name="total" format="0,0" ifNull="0"/>" menu=false quality=high salign=T bgcolor=#FFFFFF  ');
