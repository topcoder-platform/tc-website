...
<tr><td id="<%=level2.equals("queue_status")?"leftSubnavOn":"leftSubnav"%>"><A class="leftOn" href="http://<%=ApplicationServer.SERVER_NAME%>/longcontest?module=ViewQueue">Queue Status</A></td></tr>
