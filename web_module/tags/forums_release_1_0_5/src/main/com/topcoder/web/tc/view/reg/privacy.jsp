...
TopCoder sponsors may contact you proactively based upon your skills, experience and TopCoder success.  TopCoder may decide to utilize a process through which TopCoder members may choose to review online inquiries from interested TopCoder sponsors or subscribing companies before being contacted by those companies.
...
TopCoder will provide you with an opportunity to review at any time the information that it has compiled about you, as well as the opportunity to correct any erroneous information.  To view or correct your information, log in to the TopCoder web site, go to &quot;Update Profile&quot; under the &quot;Member Home&quot; page, or contact us at service@topcoder.com.

Privacy Commitment Changes
If we decide to change our privacy commitment for TopCoder, we will post those changes here so that you will always know what information we gather, how we might use that information, and whether we will disclose it to anyone.  In the event that we make any significant changes to our Privacy Statement, we will also provide you with the opportunity to consent to different uses of your personal information.  If, at any time, you have questions or concerns about TopCoder's privacy commitment, please feel free to e-mail us at service@topcoder.com.
