 ...
 * @version 1.0
 */
public class AggregationActionTest extends MockStrutsTestCase {
    /**
     ...
     */
    public AggregationActionTest(String testName) {
        super(testName);
    ...
    public void testViewSuccess() {
        ...
        verifyForward("edit");
        assertNotNull(getSession().getAttribute("aggregationWorksheetForm"));
