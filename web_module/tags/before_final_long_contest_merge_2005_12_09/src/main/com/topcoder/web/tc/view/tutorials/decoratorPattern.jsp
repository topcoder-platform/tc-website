...
The Decorator pattern doesn't seem to be commonly used, whether it be in applications or TopCoder components.  The only time I've ever seen the pattern employed (beyond applications where I've used it) was to add logging.  Because of that, I'd like to explore the logging example in depth to show you some important benefits of the decorator pattern.
<br><br>
...
<ol>
<li>Using your favorite logging component and manually insert logging code into your classes;</li>
