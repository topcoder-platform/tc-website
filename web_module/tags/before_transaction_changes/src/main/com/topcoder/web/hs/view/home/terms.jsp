...
<jsp:include page="../includes/left_calendar.jsp" />
    ...
    <TR>
        <TD>
            <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="" WIDTH="100%">
             <TR><TD ALIGN="left" HEIGHT="44" WIDTH="348"><IMG SRC="/i/headinginside_blank.gif" WIDTH="348" HEIGHT="44" BORDER="0"></TD>
    ...
    <TR>
        ...
        <TR>
           ...
           <P> By using this Web site you are indicating your agreement to these Terms of Use ("Terms").  If you do not agree to these Terms, please do not use the site and exit now.</P>

<P>We may revise these Terms at any time without prior notice by updating this page and such revisions will be effective upon posting to this page.  Please check this page periodically for any changes.  Your continued use of this Web site following the posting of any revisions to these Terms will mean you accept those changes.  We reserve the right to alter, suspend or discontinue any aspect of <A HREF="http://highschool.topcoder.com">http://highschool.topcoder.com</A>, including your access to it.  Unless explicitly stated, any new features will be subject to these terms and conditions.</P>
...
<P><B>LINKS TO OTHER WEB SITES AND SERVICES</B></P>
...
<P>You agree that no impediment exists to you joining the TopCoder High School website, and your participation in TopCoder High School's website and the competitions it offers will not interfere with your performance of any other agreement or obligation which has been or will be made with any third party.
</P>

<P><B>CHOICE OF LAW AND FORUM</B></P>

<P>This agreement is governed by the laws of the Commonwealth of Massachusetts.  You hereby agree to submit to the exclusive jurisdiction of the courts of the Commonwealth of Massachusetts. To the extent that applicable laws have mandatory application to this agreement or give you the right to bring action in any other courts, the above limitations may not apply to you.  Use of this Web site is unauthorized in any jurisdiction that does not give full effect to all provisions of these Terms.</P>
...
<P><B>TERMINATION/EXCLUSION</B></P>

<P>We reserve the right, in our sole discretion, to revoke any and all privileges associated with accessing and/or competing on our web site, and to take any other action we deem appropriate including but not limited to terminating or suspending your use of <A HREF="http://highschool.topcoder.com">http://highschool.topcoder.com</A>, for no reason or any reason whatsoever, including improper use of this site or failure to comply with these Terms.</P>

<P><B>GENERAL</B></P>

<P>We may assign, novate or subcontract any or all of our rights and obligations under these terms and conditions at any time.</P>
