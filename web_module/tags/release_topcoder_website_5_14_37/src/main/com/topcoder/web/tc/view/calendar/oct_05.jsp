...
<jsp:param name="title" value="October 2005"/>
</jsp:include>

<jsp:include page="dropdown.jsp" >
<jsp:param name="currMonth" value="oct_05"/>
</jsp:include>
...
<table width="100%" cellspacing="1" cellpadding="3" id="calendarFrame">
    ...
    <tr> 
        ...
        <td id="calendarSRM">
            ...
            <A href="/tc?module=MatchDetails&rd=7999">Details</A><br/><br/></td>
    </tr>
    ...
    <tr> 
        ...
        <td id="calendarSRM">
            ...
            <IMG src="/i/clear.gif" width="50" height="5" border="0" /><br />
            <A href="/tc?module=MatchDetails&rd=8000">Details</A><br/><br/></td>
        <td id="calendar">6</td>
        <td id="calendar">7</td>
        <td id="calendar">8</td>
    </tr>
    ...
    <tr> 
        ...
        <td id="calendarSRM">
            ...
            <strong>Match 268</strong><br />
            Register: 8:00&#160;AM<br />
            Compete: 11:00&#160;AM<br />
            <IMG src="/i/clear.gif" width="50" height="5" border="0" /><br />
            <A href="/tc?module=MatchDetails&rd=8001">Details</A><br/><br/></td>
    ...
    <tr> 
        ...
        <td id="calendarSRM">
            ...
            <IMG src="/i/clear.gif" width="50" height="5" border="0" /><br />
            <A href="/tc?module=MatchDetails&rd=8002">Details</A><br/><br/></td>
