 ...
 * @version 1.0
 */
public class TestTestCaseReview extends MockStrutsTestCase {
    /**
     ...
     */
    public TestTestCaseReview(String testName) {
        super(testName);
    ...
    public void testForwardEdit() {
        ...
        verifyForward("edit");
        TestCaseReviewForm form = (TestCaseReviewForm) getSession().getAttribute("testCaseReviewForm");
        assertNotNull(form);
