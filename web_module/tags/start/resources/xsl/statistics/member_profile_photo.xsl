...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
	...
	<TR>
		<TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="statText" ROWSPAN="11"><A HREF="mailto:rlovelace@topcoder.com?subject=Member photo for [ handle goes here ]"><IMG SRC="/i/m/nophoto_big.gif" ALT="Coder of the Week" WIDTH="126" HEIGHT="140" ALIGN="left" HSPACE="10" BORDER="0"/></A></TD>
