        ...
        <%-- Main Navigation --%>
            <div id="lCorner-nav"><%-- Left Corner Navigation --%></div>
                <ul>
                    ...
                    <li id="nav-profile"<% if (tabLev1.equals("profile")) {%> class="on"<% } %>><a title="My Profile" onfocus="this.blur();" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=myProfile"><span class="hide">My Profile</span></a></li>
