...
<!-- Body-->
	<tr valign=top>
        ...
        <p class="bigTitle">Development Finalists Bracket</p>
...
if ( MM_FlashCanPlay ) {
	...
	document.write(' <PARAM NAME=movie VALUE="/i/tournament/tccc05/brackets/bracket_dev.swf"> <PARAM NAME=menu VALUE=false> <PARAM NAME=quality VALUE=high> <PARAM NAME=salign VALUE=T> <PARAM NAME=bgcolor VALUE=#FFFFFF>  '); 
	document.write(' <EMBED src="/i/tournament/tccc05/brackets/bracket_dev.swf" menu=false quality=high salign=T bgcolor=#FFFFFF  ');
