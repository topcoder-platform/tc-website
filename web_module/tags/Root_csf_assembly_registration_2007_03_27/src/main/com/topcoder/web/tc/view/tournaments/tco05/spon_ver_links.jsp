...
<table width="100%" border="0" cellpadding=0 cellspacing=0>
   <tr>
      <td width="50%"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_description"><img src="/i/tournament/tco05/tco05_logo_solo.gif" border="0"/></A></td>
      <td valign=middle align=center rowspan="2"><a href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_description"><img src="/i/tournament/tco05/sponsortrack_ver_logo.gif" alt="Sponsor Track" border="0"/></a></td>
      ...
      <table border="0" cellspacing=0 cellpadding=0 width="100%">
          <tr>
            ...
            <% if (tabLev2.equals("details")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_description"><img src="/i/tournament/tco05/tabs/L2_detailsOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_description"><img src="/i/tournament/tco05/tabs/L2_detailsOff.gif" alt="" border="0" /></A></td>
            <% } %>
<%--
            <% if (tabLev2.equals("registration")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_reg"><img src="/i/tournament/tco05/tabs/L2_registrationOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_reg"><img src="/i/tournament/tco05/tabs/L2_registrationOff.gif" alt="" border="0" /></A></td>
            <% } %>
...
--%>
            <% if (tabLev2.equals("advancers")) {%>
               <td class="nav"><A href="/tc?module=SimpleStats&c=tco05_spon_adv_overview&trans=true&d1=tournaments&d2=tco05&d3=spon_ver_adv_overview"><img src="/i/tournament/tco05/tabs/L2_advancersOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=SimpleStats&c=tco05_spon_adv_overview&trans=true&d1=tournaments&d2=tco05&d3=spon_ver_adv_overview"><img src="/i/tournament/tco05/tabs/L2_advancersOff.gif" alt="" border="0" /></A></td>
            <% } %>
<%--
...
--%>
            <% if (tabLev2.equals("competitionArena")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_arena"><img src="/i/tournament/tco05/tabs/L2_competitionArenaOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_arena"><img src="/i/tournament/tco05/tabs/L2_competitionArenaOff.gif" alt="" border="0" /></A></td>
            <% } %>
      ...
      <table width="100%" border="0" cellspacing=0 cellpadding=0 class="subNav">
         <tr>
            <td class="subnavBG">&#160;&#160;&#160;</td>
               <% if (tabLev2.equals("details")) {%>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_description"><% if (tabLev3.equals("description")) {%><img src="/i/tournament/tco05/tabs/L3_descriptionOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco05/tabs/L3_descriptionOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_schedule"><% if (tabLev3.equals("schedule")) {%><img src="/i/tournament/tco05/tabs/L3_scheduleOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco05/tabs/L3_scheduleOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tco05&d3=spon_ver_rules"><% if (tabLev3.equals("rules")) {%><img src="/i/tournament/tco05/tabs/L3_rulesOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco05/tabs/L3_rulesOff.gif" border="0" /><% } %></a></td>
               ...
               <% } else if (tabLev2.equals("advancers")) {%>
                  <td class="subnav"><a href="/tc?module=SimpleStats&c=tco05_spon_qual&trans=true&d1=tournaments&d2=tco05&d3=spon_ver_qualification"><% if (tabLev3.equals("qualification")) {%><img src="/i/tournament/tco05/tabs/L3_qualificationOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco05/tabs/L3_qualificationOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=SimpleStats&c=tco05_spon_adv_overview&trans=true&d1=tournaments&d2=tco05&d3=spon_ver_adv_overview"><% if (tabLev3.equals("overview")) {%><img src="/i/tournament/tco05/tabs/L3_overviewOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco05/tabs/L3_overviewOff.gif" border="0" /><% } %></a></td>
