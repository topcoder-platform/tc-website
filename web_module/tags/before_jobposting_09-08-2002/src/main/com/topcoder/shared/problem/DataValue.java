    ...
    implements Element
{
    ...
    public String toXML()
    {
        return ProblemComponent.encodeHTML(encode());
    }
    ...
    static private HashMap buildTypes()
    {
        ...
        //types.put("double", "com.topcoder.shared.problem.FloatingValue");
  ...
  /**
   * Converts a single DataValue to and Object, throws a DataValueParseException
