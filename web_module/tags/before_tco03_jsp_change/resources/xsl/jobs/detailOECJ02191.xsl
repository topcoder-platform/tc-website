...
<!--end contextual links-->
          ...
          <P><B>Java and/or C++ with Oracle</B></P>
		  <UL><LI>Major software vendor</LI>
		  <LI>Multiple positions in the San Francisco bay area</LI>
		  <LI>Very strong Oracle background is a must</LI>
		  <LI>Experienced programmers only, no college students</LI></UL>
		  <P><A HREF="/?t=jobs&amp;c=inquire&amp;Job=OECJ02191&amp;JobDesc=Java%20and/or%20C%2B%2B%20with%20Oracle&amp;To=tcesr@topcoder.com" CLASS="bodyText">Feel qualified and are interested?</A></P>
          <P><BR/></P>
          </TD>
