...
<!--end contextual links-->
          ...
          <P><B>C++ Interactive Entertainment Senior Programmer </B></P>
<P>
This client is an independent developer of massively multiplayer online games for the PC and next generation consoles.
</P>

<P>
You will be working with a tight team of programmers going into the final stages of production on an ambitious project. This client needs someone who can problem solve well and who works well with others' code - someone who doesn't need to re-architect whole systems in order to become productive.
</P>
