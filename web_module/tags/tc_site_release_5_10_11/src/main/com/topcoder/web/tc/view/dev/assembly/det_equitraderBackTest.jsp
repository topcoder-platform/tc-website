...
<span class="bigTitle">Equitrader Phase-2 Back-Test Environment</span>
<br><br>
...
<br><br>
The changes in Phase-2 are broken down into several modules. The goal of this assembly competition is to implement the back-testing environment that will allow users to test their algorithms against historical stock data present in the Equitrader database. This will provide users with instant results on the performance of their algorithm, instead of requiring days of real-time testing to get any useful results.
<br><br>
All of the code is contained in components that have recently been created. The main tasks will involve configuring these components and making sure they function together as designed. The back-test environment is a stand-alone application and as such should be easier to test than applications that run in an application server, for example. All documentation related to Phase-2 will be made available to the competitors once registered.
<br><br>
...
<br><br>
<%--
To sign up as a Team Captain or a Free Agent, send an email to <A href="mailto:AssemblyCompetitions@topcoder.com?subject=Register: Equitrader Phase-2 Back-Test Environment">AssemblyCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
