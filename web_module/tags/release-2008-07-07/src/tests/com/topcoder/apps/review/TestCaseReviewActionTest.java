...
/**
 * <p>Test the TestCaseReviewAction classes.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class TestCaseReviewActionTest extends MockStrutsTestCase {
    /**
     ...
     */
    public TestCaseReviewActionTest(String testName) {
        super(testName);
    ...
    public void testViewSuccess() {
        ...
        setRequestPathInfo("/testCaseReview");
        actionPerform();

        verifyForward("edit");
        assertNotNull(getSession().getAttribute("testCaseReviewForm"));
