            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding: 10px 5px 10px 20px;" align="right">
                        <img src="/i/events/truveo/interface/btnRegisterNA.png" alt="Register" />
                    </td>
                    <td style="padding: 10px 0px 10px 5px;" align="right">
                        <a href="${sessionInfo.servletPath}?module=ViewSubmission&amp;<%=Constants.CONTEST_ID%>=${contest.id}"><img src="/i/events/truveo/interface/btnSubmit.png" alt="Submit" /></a>
                    </td>
                </tr>
                <tr>
                    ...
                    <c:otherwise>
                    <td style="padding: 10px 5px 10px 20px;" align="right">
                        <a href="${sessionInfo.servletPath}?module=ViewRegistration&amp;<%=Constants.CONTEST_ID%>=${contest.id}"><img src="/i/events/truveo/interface/btnRegister.png" alt="Register" /></a>
                    </td>
                    <td style="padding: 10px 0px 10px 5px;" align="right">
                        <img src="/i/events/truveo/interface/btnSubmitNA.png" alt="Submit" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="padding-top: 10px;" align="center">
