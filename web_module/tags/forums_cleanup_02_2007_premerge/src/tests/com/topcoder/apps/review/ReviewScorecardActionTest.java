 ...
 * @version 1.0
 */
public class ReviewScorecardActionTest extends MockStrutsTestCase {
    /**
     ...
     */
    public ReviewScorecardActionTest(String testName) {
        super(testName);
    ...
    public void testViewSuccess() {
        ...
        verifyForward("edit");
        assertNotNull(getSession().getAttribute("reviewScorecardForm"));
