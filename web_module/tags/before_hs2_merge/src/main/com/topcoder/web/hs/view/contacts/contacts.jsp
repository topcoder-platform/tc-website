    ...
    <TR>
        <TD>
            <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="" WIDTH="100%">
             <TR><TD ALIGN="left" HEIGHT="44" WIDTH="348"><IMG SRC="/i/hs/headinginside_contacts.gif" WIDTH="348" HEIGHT="44" BORDER="0"></TD>
    ...
    <TR>
        ...
        <TR>
            ...
            <TD HEIGHT="100%" CLASS="bodyText">
                    ...
                    <TD CLASS="bodyText" ALIGN="left" WIDTH="40%"><BR><A CLASS="bodyText" HREF="mailto:mlydon@topcoder.com">Competition Applet/Website</A><BR>
					Mike Lydon, CTO<BR>
					TopCoder, Inc.<BR>
					703 Hebron Avenue<BR>
					Glastonbury, CT 06033<BR>
					ph: 860.633.5540<BR>
					fx: 860.657.4276<BR></TD></TR></TABLE></DIV></P>
            </TD>
             <TD>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
                 <TR>
