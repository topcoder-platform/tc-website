...
<html class="compDocs">
<head>
    <title>2003 TopCoder Open sponsored by Intel&#174; - Component Finals - Pops</title><jsp:include page="/script.jsp" />
    ...
    <tr valign="top">
        ...
        <td width="99%">
            ...
            <jsp:include page="times.jsp">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tco03/comp_docs/pops/1130/AspectOrientedUseCases.gif" alt="" width="802" height="496" border="0"></div></td>
