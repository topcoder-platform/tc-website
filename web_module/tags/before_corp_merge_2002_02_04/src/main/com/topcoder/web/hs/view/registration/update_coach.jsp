...
<P><B>Update Coach Profile</B></P>
<P><BR></P>
<FORM ACTION="" METHOD="post" NAME="regForm">
 <INPUT TYPE="hidden" NAME="module" VALUE="UpdateCoach">
 ...
 <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="1" ALIGN="center">
  ...
  <TR>
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="text" NAME="first_name" VALUE="<jsp:getProperty name="coach" property="FirstName"/>" SIZE="30" MAXLENGTH="30"></TD>
  </TR>
  <TR>
   <TD></TD>
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="text" NAME="last_name" VALUE="<jsp:getProperty name="coach" property="LastName"/>" SIZE="30" MAXLENGTH="30"></TD>
  </TR>
  <TR>
   <TD></TD>
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
...
<reg:listSelect name="state_code" class="dropdown" onChange="Javascript:changeState()" list="<%=coach.getStateList()%>" selected="<%=coach.getStateCode()%>"/>
   </TD>
  </TR>
  <TR>
   <TD></TD>
...
<reg:listSelect name="school_id" class="dropdown" list="<%=coach.getSchoolList()%>" selected="<%=coach.getSchoolId().toString()%>"/>
   </TD>
  </TR>
  <TR VALIGN="middle">
   <TD COLSPAN="4" CLASS="bodyText" VALIGN="middle">&nbsp;</TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="center"><INPUT TYPE="checkbox" NAME="change_password" VALUE="true" ONCLICK="Javascript:togglePassword();" <%=coach.getChangePassword()?"CHECKED":""%>>&nbsp;Change password</TD>
  </TR>
  <TR ALIGN="right" VALIGN="middle">
   <TD CLASS="bodyText" ALIGN="right" VALIGN="middle">Password&nbsp;</TD>
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="password" NAME="password" VALUE="<jsp:getProperty name="coach" property="Password"/>" SIZE="30" MAXLENGTH="15" <%=coach.getChangePassword()?"":"DISABLED"%>></TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="password" NAME="confirm_password" VALUE="<jsp:getProperty name="coach" property="ConfirmPassword"/>" SIZE="30" MAXLENGTH="15" <%=coach.getChangePassword()?"":"DISABLED"%>></TD>
  </TR>
  <TR>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="text" NAME="email" VALUE="<jsp:getProperty name="coach" property="Email"/>" SIZE="30" MAXLENGTH="100"></TD>
  </TR>
  <TR>
   <TD></TD>
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="text" NAME="confirm_email" VALUE="<jsp:getProperty name="coach" property="ConfirmEmail"/>" SIZE="30" MAXLENGTH="100"></TD>
  </TR>
  <TR>
   <TD CLASS="bodyText" ALIGN="right" VALIGN="middle">&nbsp;</TD>
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
  ...
  <TR>
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" align="left" valign="middle">
<reg:listSelect name="editor_id" class="dropdown" list="<%=coach.getEditorList()%>" selected="<%=coach.getEditorId().toString()%>"/>
   </TD>
  </TR>
  <TR>
   <TD CLASS="bodyText" ALIGN="right" VALIGN="middle">&nbsp;</TD>
  ...
  <TR>
   ...
   <TD><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle">
<reg:listSelect name="language_id" class="dropdown" list="<%=coach.getLanguageList()%>" selected="<%=coach.getLanguageId().toString()%>"/>
   </TD>
  </TR>
  <TR>
   <TD CLASS="bodyText" ALIGN="right" VALIGN="middle">&nbsp;</TD>
