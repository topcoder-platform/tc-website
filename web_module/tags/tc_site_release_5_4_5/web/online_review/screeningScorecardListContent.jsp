				...
				<tr>
					<td>
						<table border="0" cellpadding="0" cellspacing="1" class="forumBkgd" width="75%">
							<tr>
								<td class="blackBkgnd" colspan="4"><strong><bean:message key="prompt.screeningScorecards" /></strong></td>
							</tr>
							<tr>
...
<logic:iterate id="scorecard" indexId="cIdx" name="scorecards" type="com.topcoder.apps.review.document.ScreeningScorecard">
	<% String rowClass=(cIdx.intValue()%2==0)?"forumTextOdd":"forumTextEven"; %>
							<tr>
								<td class="<%=rowClass%>">
								    <review:linkScorecard page="/screeningScorecard.do?action=edit" name="scorecard">
								        <bean:message key="prompt.screeningScorecard" /> <review:showSubmissionId name="scorecard" property="submission" />
