...
public class PrincipalManagerMockup extends EJBBase implements PrincipalMgrRemote {
    ...
    public Collection getUsers(TCSubject p1) { return null; }
    public TCSubject getUserSubject(long p1) { return null; }
    public void assignRole(GroupPrincipal p1, RolePrincipal p2, TCSubject p3) { }
    public RolePrincipal createRole(String p1, TCSubject p2) { return null; }
    public void removeRole(RolePrincipal p1, TCSubject p2) { }
    public void removeUser(UserPrincipal p1, TCSubject p2) { }
    public String getPassword(long p1) { return null; }
    public void unAssignRole(UserPrincipal p1, RolePrincipal p2, TCSubject p3) { }
    public UserPrincipal editPassword(UserPrincipal p1, String p2, TCSubject p3) { return null; }
    public void unAssignRole(GroupPrincipal p1, RolePrincipal p2, TCSubject p3) { }
    public Collection getGroups(TCSubject p1) { return null; }
    public UserPrincipal createUser(String p1, String p2, TCSubject p3) { return null; }
    public GroupPrincipal getGroup(long p1) { return null; }
    public GroupPrincipal createGroup(String p1, TCSubject p2) { return null; }
    public UserPrincipal getUser(String p1) { return null; }
    ...
    public RolePrincipal getRole(long p1) { return null; }
    public void addUserToGroup(GroupPrincipal p1, UserPrincipal p2, TCSubject p3) { }
    public UserPrincipal getUser(long p1) { return null; }
