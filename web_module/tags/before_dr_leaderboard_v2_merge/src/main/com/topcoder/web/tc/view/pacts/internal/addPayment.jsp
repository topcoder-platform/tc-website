...
<%
    ...
    int status = -1;
    try {
        status = Integer.parseInt(request.getParameter("status_id"));
    } catch (Exception e) {
    }
    ...
    int type = -1;
    try {
        type = Integer.parseInt(request.getParameter("payment_type_id"));
    } catch (Exception e) {
    }
    int method = -1;
    try {
        method = Integer.parseInt(request.getParameter("payment_method_id"));
    } catch (Exception e) {
    }
            ...
            <% int rowCount;
                ...
                if (stati != null) {
                    ...
                    for (int n = 0; n < rowCount; n++) {
                        ...
                        if (status < 0 && !payment_is_for_contract && s.equals(PactsConstants.DEFAULT_PAYMENT_STATUS)) {
                            out.print(" selected");
