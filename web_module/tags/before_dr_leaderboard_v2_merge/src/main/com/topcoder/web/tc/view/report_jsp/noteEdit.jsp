  ...
  <body>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0">
        <form action="/tc" method=post name="noteForm">
            ...
            <tr><td align=center><a href="/tc?module=LegacyReport&t=profile&ha=<%=request.getAttribute(com.topcoder.web.tc.Constants.HANDLE)%>">View Report Profile</a></td></tr>
            <tr><td align=center><A HREF="mailto:<%=request.getAttribute(com.topcoder.web.tc.Constants.EMAIL).toString()%>">Send Email</A></td></tr>
            <tr>
                <td align=center>
