...
<!-- Title -->
							...
							<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=XML%20Search:%20Design&amp;comp=3502170" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>
...
<!-- Overview -->
                            ...
                            An example where the XML Search component can be used is to provide a simple Help system. Help topics and details can be stored in an XML file. When a topic is requested that file can be search and the detail retrieved for display.
							</p>
...
<!-- Documentation -->
						...
						All <a class="statText" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3502170">documentation</a> for this project is available on the TopCoder Software web site.</p>
