...
<div class="subMenu">
    <ul class="secondaryNav overviewNav"><!-- orange secondary navigation -->
        <li class="${descriptionClass}"><!-- first item -->
            <tco10:designStaticPageLink page="description">
        ...
        <li class="${scheduleClass}"><!--  item -->
            <tco10:designStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="schedule">
                <span class="left"></span>
        ...
        <li class="${rulesClass}"><!-- second item -->
            <tco10:designStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="rules">
                <span class="left"></span>
        ...
        <li class="${leaderboardClass}"><!-- third item-->
            <tco10:designStaticPageLink page="leaderboard">
                <span class="left"></span>
        ...
        <li class="${finalResultsClass}"><!-- four item -->
            <tco10:designStaticPageLink styleClass="tertiaryNavBT SponsorsBT" page="finalResults">
                <span class="left"></span>
