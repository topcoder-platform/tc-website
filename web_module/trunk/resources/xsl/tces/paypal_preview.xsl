...
<h2>PayPal - TopCoder Employment Program</h2>
<p>Please view the following links for review of the PayPal Employment program.</p>
...
<table cellspacing="10" cellpadding="0" border="0">
    <tr valign="top">
        <td>
            ...
            <a href="/?t=tces&amp;c=paypal" class="bodyText" target="_blank">PayPal Main Page</a></p>
