...
<p><b><font face="Arial, sans-serif">What is it like to work at Google?</font></b> </p>
...
<p><li>Designing and improving software that can crawl and index
 ...
 <p><li>Developing efficient implementations for large-scale mathematical 
          ...
          problems, such as running Google's <a href="http://citeseer.nj.nec.com/page98pagerank.html">Pagerank&#153; algorithm</a> on a graph of 3 billion nodes and 20 billion edges.</li></p>
 ...
 <p><li>Efficiently and rapidly searching our full index of more than 2 billion web pages 
          ...
          of <a href="http://groups.google.com">20 years of Usenet data (700M+ 

          messages)</a> and <a href="http://images.google.com">320M+ images</a>.</li></p>
 ...
 <p><li>Using <i>millions of computers</i> to solve important problems requiring 
          ...
          example, we have recently begun small-scale tests with the <a href="http://folding.stanford.edu">Folding 

          at Home</a> project at Stanford University with a few thousand selected 

          <a href="http://toolbar.google.com/">Google Toolbar</a> users, in preparation 
...
<p><li> Building large-scale distributed file systems and other infrastructure 
 ...
 <p><li>Developing <a href="http://www.google.com/appliance/">Google's Search 
...
<li>We apply machine-learning techniques to learn relationships and associations 
          ...
          example (<a href="http://google.com/search?q=spehl+korector">spehl 

          korector</a>? <a href="http://google.com/search?q=phonitick+spewling">phonitick 

          spewling</a>? who needs a <a href="http://google.com/search?q=dictniary">dictniary</a>?). 

          People searching for <a href="britney.html">Britney Spears</a> have 
...
<li>See our <a href="http://catalogs.google.com">printed catalog search</a> for an example of this.</li>
...
<li> See our <a href="http://www.google.com/news/newsheadlines.html">automatically 
...
<p><b>Developing Google's <a href="http://www.google.com/ads/">advertising 
...
<p>Google's mission is intentionally broad and we actively explore interesting 
        ...
        are not just beneficial, but essential to millions of people every day.</p> <p><font face="Arial, sans-serif"><b>Google Myths &amp; Realities</b></font></p>

<p> We often hear myths and

		  misconceptions about Google that we would like to dispel:<br/>
