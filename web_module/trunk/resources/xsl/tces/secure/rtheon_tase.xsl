...
<P>
Tracker Algorithm and Software Engineer:<BR/>
Requisition Number: ES-723773<BR/>
Job Title: Tracker Algorithm and Software Engineer <BR/>
...
Design and implement tracking, simulation and real-time image/signal processing 
algorithms and software within a matrix organization for various missile applications. 
</P>
...
<P>
Positions at Raytheon may require U.S. citizenship for purposes of obtaining 
clearances. Additional clearances may also be required from the DoD. 
</P>
...
Good understanding of feature extraction, tracking, Electro-Optics methodology, infrared imaging techniques, digital video processing and real-time software. Competent in the development and implementation of C. 
</P>

<P>
<B>Desired Skills:</B> <BR/>
Target phenomenology, sensor design philosophy, signal processing, C++, Fortran, ADA, MATLAB and UNIX. 
</P>
