...
<!-- Client Job List begins -->
                        ...
                        <h3>Java Programmers and Analysts</h3>
                        ...
                        <p>Code and test software that meets the design specifications.</p>

                        <p>Maintain and repair applications to keep them performing in accordance with technical and 
                        functional specifications.</p>

                        <p>Assist in the creation of test scripts; execute and document the tests necessary to ensure that 
                        an application or technical environment meets performance requirements (technical, functional 
                        and user interface).</p>

                        <p>Document and assist in defining the technical requirements of the application.</p>

                        <p>Contribute to a high-performing, motivated work group by applying interpersonal communication 
                        and collaboration skills to achieve project goals and realize value.</p>

                        <p>Ideal candidates will possess experience in the complete product life cycle (design, code, test 
                        and document) in a business environment including object-oriented programming and design.</p>
                                                
                        <p><strong>Required Skills</strong></p>
                        
                        <ul>
                            <li>A strong background with EAI, EIM, Visual Basic, XML, WebSphere .4.x, WebSphere Commerce 
                            Server, WebSphere Portal Server</li>
                            <li>Knowledge of major server platforms Solaris, WinNT, Linux etc. </li>
                            <li>Experience applying basic Java concepts (e.g., J2EE, SDK, Java Runtime Environment (JRE), 
                            Servlets, Java Server Pages (JSP), Enterprise Java Beans (EJBs) </li>
                            <li>Understanding of databases and transaction servers. </li>
                            <li>Experience designing software solutions using the Unified Modeling Language and Rational software. </li>
                            <li>Planning and conducting formal reviews of the software architecture, design, and source code 
                            to ensure overall quality of the solution. </li>
                            <li>Strong skills in C++, UNIX Shell, Shell Scripting, JDBC, SOAP, PL/SQL, Oracle, MQSeries, 
                            and CORBA. </li>
