                      ...
                      <TR>
                        <TD COLSPAN="3" ALIGN="left" class="bodyText">
                            ...
                            <xsl:if test="/TC/SCHEDULE/Round/Details/forum_id!=''">
                                <center><BR/><A class="left"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/ForumsHost"/>/?module=ThreadList&amp;forumID=<xsl:value-of select="/TC/SCHEDULE/Round/Details/forum_id"/></xsl:attribute>Discuss this match</A><br/><br/></center>
                            </xsl:if>
