          ...
          <li>
            ...
            TopCoder members must register for the online tournament. 
              ...
              <xsl:choose>
                ...
                <xsl:when test="ContestId='4140'">30, </xsl:when>
                <xsl:when test="ContestId='4145'">1, </xsl:when>
              ...
              <xsl:choose>
                ...
                <xsl:when test="$contestId='4140'">10:00 PM</xsl:when>
                <xsl:when test="$contestId='4145'">9:00 PM</xsl:when>
...
However, prizes will only be paid to members who are at least 18 years of age, meeting the following eligibility requirements: 
        ...
        and must have agreed to the rules on this page by the 
          ...
          <xsl:choose>
            ...
            <xsl:when test="$contestId='4140'">9:55 PM</xsl:when>
            <xsl:when test="$contestId='4145'">8:55 PM</xsl:when>
