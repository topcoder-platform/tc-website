            ...
            <tr>
              ...
              <td>
                ...
                <a>
                  ...
                  <xsl:attribute name="href">/admin/contest?module=Challenge&amp;Command=get_problems&amp;RoundId=<xsl:value-of select="../RoundId"/>&amp;CoderId=<xsl:value-of select="CoderId"/>&amp;ProblemId=<xsl:value-of select="ProblemId"/></xsl:attribute>
