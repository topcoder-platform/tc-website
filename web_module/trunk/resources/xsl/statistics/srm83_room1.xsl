...
<P>Room 1 started with everyone opening the Level One problem, except <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">dmwright</A> 
who skipped to the Level Two and <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">reid</A> who did start with the Level One, but 
for some reason started five minutes late. Meanwhile, <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">ZorbaTHut</A> had finished 
and submitted the Level One problem in only seconds more than three and a half minutes, getting 196.90 points. 
<A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">SnapDragon</A> and <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">doeth</A> 
...
<P>In a surprise move, <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">benetin</A> apparently gave up on the Level Two problem, moving 
on to the Level Three problem after almost 18 minutes of work. Meanwhile, <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">Joe</A>, 
<A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">John Dethridge</A>, <B>reid</B>, and finally <B>ZorbaTHut</B> submitted their Level Two 
...
<P>Aside from <A HREF="/stat?c=last_match&amp;rd=4140&amp;dn=1" CLASS="bodyGeneric">derkuci's</A> late Level Two submission, only half a minute before the 
