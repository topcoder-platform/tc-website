...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;2002 TCCC Semifinal Room 1 Problem</xsl:with-param>
</xsl:call-template>
...
<BR CLEAR="all"/>         
          ...
          <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">         
            <TR>
              <TD VALIGN="middle" HEIGHT="18" BACKGROUND="/i/steel_gray_bg.gif" CLASS="statTextBig">&#160;&#160;Semifinal Room 1 Problem</TD>
            </TR>
            <TR>
