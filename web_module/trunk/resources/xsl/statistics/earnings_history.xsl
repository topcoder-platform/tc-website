...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Earnings History</xsl:with-param>
</xsl:call-template>
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
  <TR>
    ...
    <TD COLSPAN="2" VALIGN="top" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/><BR/>
      <xsl:choose>
      <xsl:when test="count(/TC/STATLISTS/EarningsHistory/Earning)='0'">
        <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
          <TR>
      ...
      <xsl:otherwise>
        <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
          ...
          <TR>
            <TD COLSPAN="4" BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="statText" VALIGN="middle" HEIGHT="16">
              ...
              |   
              <A>
                <xsl:attribute name="HREF">index?t=statistics&amp;c=ratings_history&amp;Coder_Id=<xsl:value-of select="/TC/STATLISTS/CoderId"/></xsl:attribute><xsl:attribute name="CLASS">statText</xsl:attribute>Ratings History
              </A>
            </TD>
          </TR>
          <TR>
        ...
        <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
          ...
          <TR>
            ...
            <TD BACKGROUND="/i/steel_bluebv_bg.gif" CLASS="statText" VALIGN="middle" ALIGN="left" WIDTH="42%">Contest</TD>
            <TD BACKGROUND="/i/steel_bluebv_bg.gif" CLASS="statText" VALIGN="middle" ALIGN="center" WIDTH="18%">Round</TD>
            <TD BACKGROUND="/i/steel_bluebv_bg.gif" CLASS="statText" VALIGN="middle" ALIGN="center" WIDTH="5%">Position</TD>
            <TD BACKGROUND="/i/steel_bluebv_bg.gif" CLASS="statText" VALIGN="middle" ALIGN="right" WIDTH="15%">Amount</TD>      
          ...
          <xsl:for-each select="/TC/STATLISTS/EarningsHistory/Earning">
            <xsl:if test="Amount!='0.0'">
              <TR>
                ...
                <TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="statText" VALIGN="middle" ALIGN="center"><xsl:value-of select="FinishPosition"/></TD>
