  ...
  <TR>
    ...
    <TD CLASS="statTextBig" COLSPAN="2" VALIGN="top" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/><BR/>
          <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
            ...
            <TR>
              <TD VALIGN="middle" HEIGHT="13" CLASS="statText"><A HREF="/?ContestId=4097&amp;t=schedule&amp;c=srm" CLASS="statText">Single Round Match 74<!-- 2002 TCCC Regional Championships --></A></TD>            
...
-->
<P>
2002 Collegiate Challenge finalist <A HREF="/stat?c=member_profile&amp;cr=252076" CLASS="coderTextRed">Wasteland</A> won Room 3  by the smallest margin in the division.  <A HREF="/stat?c=member_profile&amp;cr=252076" CLASS="coderTextRed">Wasteland</A> coded all three problems for 1152.16 final points. <A HREF="/stat?c=member_profile&amp;cr=252076" CLASS="coderTextRed">Wasteland</A> earned 253.33 points on the Level One problem, 340.46 on the Level Two problem, and 558.37 on the Level Three problem.  That total was only 8.34 points more than the 1143.82-point total of <A HREF="/stat?c=member_profile&amp;cr=251457" CLASS="coderTextYellow">etolson</A>.  <A HREF="/stat?c=member_profile&amp;cr=251457" CLASS="coderTextYellow">etolson</A> earned 1093.82 points by coding all three problems in the "Coding Phase", and added 50 additional points with a successful challenge of the Level One submission of axch in the "Challenge Phase".
</P>

<P>
The biggest upset in the division occurred in Room 15, as 
<A HREF="/stat?c=member_profile&amp;cr=159838" CLASS="coderTextBlue">gaul</A>, the ninth lowest ranked coder of the 10 competitors in the room, was the winner with 307.20 final points.  
<A HREF="/stat?c=member_profile&amp;cr=159838" CLASS="coderTextBlue">gaul</A> coded the Level One problem for 257.20 points during the "Coding Phase", and added 50 points to that total with a successful challenge of the Level Three submission of <A HREF="/stat?c=member_profile&amp;cr=251658" CLASS="coderTextBlue">maxjenius</A> in the "Challenge Phase".
</P>

<P>
<A HREF="/stat?c=member_profile&amp;cr=152347" CLASS="coderTextRed">ZorbaTHut</A> was the winner in Room 1, and had the highest point total, 1390.45, in the division.  <A HREF="/stat?c=member_profile&amp;cr=152347" CLASS="coderTextRed">ZorbaTHut</A> earned 293.82 points on the Level One problem, 420.95 on the Level Two problem, and 675.68 on the Level Three problem.  The room win was the 17th overall for <A HREF="/stat?c=member_profile&amp;cr=152347" CLASS="coderTextRed">ZorbaTHut</A>, and the 15th in Division-I.  <A HREF="/stat?c=member_profile&amp;cr=152347" CLASS="coderTextRed">ZorbaTHut</A> ranks eighth in Overall Room Wins (<A HREF="/stat?c=all_time_wins" CLASS="statText">View the list of Overall Wins</A>) and eighth in Division-I Room Wins (<A HREF="/stat?c=all_time_wins_by_div&amp;dn=1" CLASS="statText">View the list of Division-I Room Wins</A>).
</P>
...
<P>
In Room 49, <A HREF="/stat?c=member_profile&amp;cr=159146" CLASS="coderTextGray">badass_hacker</A> coded all three problems for 1132.35 points, 893.75 more than the second place finisher, <A HREF="/stat?c=member_profile&amp;cr=251022" CLASS="coderTextGray">PigeonBoy</A>, who earned 238.60 final points by coding the Level One problem.  <A HREF="/stat?c=member_profile&amp;cr=159146" CLASS="coderTextGray">badass_hacker</A> coded the Level One problem for 247.50 points, the Level Two problem for 484.23 points, and the Level Three problem for 400.62 points.
</P>

<P>
<A HREF="/stat?c=member_profile&amp;cr=112492" CLASS="coderTextGreen">ligremor</A> won Room 52 by an even greater margin, 999.64 points!!!  <A HREF="/stat?c=member_profile&amp;cr=112492" CLASS="coderTextGreen">ligremor</A> coded all of the problems in the "Coding Phase" for 1197.00 points, and added 50 more in the "Challenge Phase" with a successful challenge of the Level Two submission of <A HREF="/stat?c=member_profile&amp;cr=267264" CLASS="coderTextGray">Atom</A>.  <A HREF="/stat?c=member_profile&amp;cr=112492" CLASS="coderTextGreen">ligremor</A> finished with 1247.00 points.  <A HREF="/stat?c=member_profile&amp;cr=261030" CLASS="coderTextGray">meeish85</A> coded the Level One submission for 247.36 points and finished second in the room.  Besides the large margin of victory, <A HREF="/stat?c=member_profile&amp;cr=112492" CLASS="coderTextGreen">ligremor</A> also had a rating point increase of 402, which is the ninth highest in the division (<A HREF="/stat?c=biggest_rating_gains&amp;dn=2" CLASS="statText">View the list of Division-II Rating Point Gain</A>).
</P>
