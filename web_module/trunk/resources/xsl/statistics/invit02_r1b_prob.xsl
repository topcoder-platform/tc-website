...
To solve this problem correctly one should realize that a number inside a &quot;for&quot; structure is a 64 bit integer. For C++ coders I have seen 3 approaches on how to read this number:<BR/>
