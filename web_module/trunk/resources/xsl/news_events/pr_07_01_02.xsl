  ...
  <xsl:template match="/">
    <HTML>
      <HEAD>
        ...
        <TITLE>TopCoder Expands to Citizens of all Countries to Work as Independent Contractors</TITLE>
...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Member Updates - 2002</xsl:with-param>
</xsl:call-template>
