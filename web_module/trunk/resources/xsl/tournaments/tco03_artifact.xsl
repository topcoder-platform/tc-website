            ...
            <table border="0" cellspacing="10" cellpadding="0" width="100%">
             ...
             <tr valign="top">
                    <td align="left" width="100%" class="bodyText">
                        ...
                        <p class="promoText">The Artifact Network&#153; is an on-line developer network that provides developers with an open forum to exchange code and development expertise. </p>
                        
                        <p class="promoText">The Artifact Desktop&#153; is a free .Net application that helps the individual developer to easily find, manage and share code, and collaborate with other 
                         developers in real-time. </p>
                         
                         <p class="promoText">The Artifact Server&#153;  enables a development team to quickly establish their own private code-sharing network behind the corporate firewall. If so, the Artifact 
