            ...
            <table border="0" cellspacing="15" cellpadding="0" width="540">
                ...
                <tr align="left">
                    <td class="bodyText"> 
                        ...
                        forums, technical content and more.  <A href="openWin('?t=tournaments&c=tco03_intel_sample','comp',545,655);">Check out</A> what Intel Developer Services offers you. Then  <A href="https://welcome.intel.com/login.aspx?TARGET=https://ssl.intel.com/form-app/6135.aspx ">join today. </A></p>
                        ...
                        <table> 
                           ...
                           <td valign="top" width="1%"><img src="/i/sponsor/intel_ids/Centrino_Image_embossed.jpg" width="120" height="117" /> </td>
                             <td valign="top" width="34%">
                                    <p>Intel&#174; Centrino&#153; mobile technology-based notebook!  View Specs. </p>
