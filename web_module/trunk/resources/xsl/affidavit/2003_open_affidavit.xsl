  ...
  hereby state:
   <ul>
      ...
      <li>
          ...
          <br/>
          <br/>
          I am submitting this affidavit with the understanding that it will be relied upon to determine my eligibility to receive the prize for which my entry has been submitted in the 2003 TopCoder Open Coding Tournament, sponsored by Intel&#174; (the "Contest").
          <br/>
          <br/>
