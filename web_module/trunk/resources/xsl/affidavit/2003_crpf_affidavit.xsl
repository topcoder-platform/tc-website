...
<OL>
  ...
  <LI>I am submitting this statutory declaration with the understanding that it will be relied upon to determine my eligibility to receive the prize for which my entry has been submitted in the 2003 Charity Challenge, Sponsored by AT&amp;T, Benefiting the Christopher Reeve Paralysis Foundation (the "Contest").</LI>
  ...
  <LI>The undersigned hereby agrees that this Statutory Declaration shall be governed by the laws of the Commonwealth of Massachusetts and that the courts of the Commonwealth of Massachusetts shall have the exclusive jurisdiction over any and all claims, disputes and legal actions arising from or in connection with this Statutory Declaration.</LI>
</OL>
  <BR/>
