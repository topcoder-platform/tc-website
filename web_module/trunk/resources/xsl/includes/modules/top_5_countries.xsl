...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="top_5_countries">
            <table width="100%" border="0" cellspacing="0" cellpadding="2" valign="top" bgcolor="#001935">
                <tr valign="middle">
                    <td colspan="2" class="statTextBig" bgcolor="#093158" height="18">&#160;Countries&#160;<a href="javascript:infoWindow('/tc/?&amp;module=Static&amp;d1=statistics&amp;d2=info&amp;d3=topCountries')" class="statTextBig">info</a></td>
