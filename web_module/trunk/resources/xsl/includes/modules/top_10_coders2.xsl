...
<!-- Division I Begins -->
                <tr valign="middle">
                    <td colspan="2" class="statTextBig" bgcolor="#093158" height="18">&#160;Top <xsl:value-of select="count(/TC/HOME/TopDiv1RankedCoders/Coder)"/> Coders&#160;<a href="javascript:infoWindow('/tc/?&amp;module=Static&amp;d1=statistics&amp;d2=info&amp;d3=topRatedCoders')" class="statTextBig"><img src="/i/header_info.gif"/></a></td>
