...
<!-- For Members -->
            ...
            <xsl:when test="/TC/Command='membr_comm'">graybv_lite_bg</xsl:when>
            <xsl:otherwise>clear</xsl:otherwise></xsl:choose>.gif</xsl:attribute>
            &#160;&#160;&#160;<a class="statText"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=tces&amp;c=index</xsl:attribute>&#160;&#160;What is TCES?</a></td><td valign="top" class="statText" bgcolor="#333333">&#160;</td></tr>
            <xsl:call-template name="div_line_row"/>
            ...
            <tr>
                ...
                <td valign="middle" height="15" class="statText" bgcolor="#333333">
                    ...
                    <xsl:when test="/TC/Command='membr_comm'">graybv_lite_bg</xsl:when>
                    <xsl:otherwise>clear</xsl:otherwise></xsl:choose>.gif</xsl:attribute>
                    &#160;&#160;&#160;<a class="statText"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=about_tc&amp;c=jobs</xsl:attribute>&#160;&#160;Jobs at TopCoder</a></td>
                <td valign="top" class="statText" bgcolor="#333333">&#160;</td>
            </tr>
            <xsl:call-template name="div_line_row"/>
      ...
      <xsl:when test="/TC/Task='tces'">
          ...
          <table width="170" bgcolor="#000000" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
              ...
              <td valign="top" height="15" bgcolor="#666666" class="statText" width="100%">Employers <a href="http://corporate.topcoder.com/tces/?task=MainTask" class="statText"><b>login</b></a> to access the [TCES] reporting application.<br/></td>
