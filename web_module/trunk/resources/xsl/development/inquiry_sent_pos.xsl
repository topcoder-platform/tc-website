    						...
    						<a class="statText">
       						...
       						<xsl:choose>
    						    ...
    						    <xsl:when test="contains($Project, 'Design')">
    						        ...
    						        <p>The deadline for submitting a design is <xsl:value-of select="/TC/DEVELOPMENT/date"/> at 11:59 PM EST.  Please submit your design to <a href="mailto:submissions@topcodersoftware.com" class="statText">submissions@topcodersoftware.com</a>  All late submissions will be ignored. Also, a reminder that this is a competition, and only the winning designer will receive payment.</p>
    						    </xsl:when>
    						    <xsl:otherwise>
    						        ...
    						        <p>The deadline for submitting a solution is <xsl:value-of select="/TC/DEVELOPMENT/date"/> at 11:59 PM EST.  Please submit your solution to <a href="mailto:submissions@topcodersoftware.com" class="statText">submissions@topcodersoftware.com</a>.  Any late submissions will be ignored. Also, a reminder that this is a competition, and only the winning developer will receive payment.</p>
    						    </xsl:otherwise>
    						</xsl:choose>
