...
<!-- Title -->
						<h1 class="devSubhead"><strong>File Splitter: Development</strong></h1>
                                    
<!-- Overview -->
						<p><strong>Overview</strong><br />
						The File Splitter component divides a file into numerous file segments and then reassembles those segments back into the original file. The segments contain all the information required to reassemble the original file. This allows a file to be split and reconstructed in a different location or at a different time.

An example usage for this component is during a file transfer process to efficiently breakdown large files to facilitate file transfer and resumption in the event the transfer is interrupted. Instead of requiring the whole file to be retransmitted, the transfer process can resume from the last transferred sub-file.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Development Project: Provide a complete development solution for the File Splitter component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4211895">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=5504109">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=4211895&amp;c=tcs_inquire&amp;Project=File%20Splitter:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
