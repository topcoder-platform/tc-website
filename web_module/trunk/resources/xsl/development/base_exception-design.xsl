...
<!-- Title -->
						<h1 class="devSubhead"><strong>Base Exception: Design</strong></h1>
...
<!-- Project Type -->
						...
						Component Design Project: Provide a complete design for the Base Exception component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5710093">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5710093&amp;c=tcs_inquire&amp;Project=Base%20Exception:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
