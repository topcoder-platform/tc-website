...
<!-- Title -->
						<h1 class="devSubhead"><strong>LDAP Client: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The LDAP Client enables searching and browsing of individuals, organizations, and resources such as files and directories located on the network through the Lightweight Directory Access Protocol (LDAP).  An LDAP directory is organized as a simple tree hierarchy and is usually distributed across multiple servers.  This component provides one simplified interface to access any LDAP server regardless of the LDAP server implementation.

The latest human resource (HR) information for a company is replicated to an LDAP server for high availability.  Applications are required to query the LDAP server for HR data.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the LDAP Client component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5710129">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5802111">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5710129&amp;c=tcs_inquire&amp;Project=LDAP%20Client:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
