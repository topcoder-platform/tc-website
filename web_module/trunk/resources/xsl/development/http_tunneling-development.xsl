...
<!-- Overview -->
						...
						The HTTP Tunneling component serves as a conduit between proprietary web protocols and HTTP. It wraps and unwraps proprietary calls in HTTP and sends them to the proper destination. The purpose is to allow proprietary communication via HTTP through proxy servers and firewalls.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2809381">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=2809381&amp;c=tcs_inquire&amp;Project=HTTP%20Tunneling:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
