...
<!-- Title -->
						<h1 class="devSubhead"><strong>Thesaurus: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Thesaurus component provides developers the functionality to add thesaurus or synonym and antonym finding capability to their applications.   This component can be used to add thesaurus functionality to applications and websites by providing an API to which clients can connect. 

An example usage for this component is an Internet email account.  The component could be added to an email server to allow users to wordsmith their emails before sending.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Thesaurus component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3304370">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=3304370&amp;c=tcs_inquire&amp;Project=Thesaurus:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
