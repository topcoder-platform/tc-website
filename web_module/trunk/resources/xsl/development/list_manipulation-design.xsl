...
An example of where the List Manipulation component can be used is in the TopCoder Software Search component.  By implementing the List Manipulation component, the results of the search can easily be sorted by component name, status or description without requiring additional calls to the database server.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5501597">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5501597&amp;c=tcs_inquire&amp;Project=List%20Manipulation:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
