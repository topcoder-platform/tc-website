    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Seat Service Shell Design Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Design Application Project - Seat Service Shell Design</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        View the
                                                        <a target="_new" class="bodyText" href="/i/development/downloads/Seat_Service_Shell_Spec.pdf">Requirement Specification</a> for this application project.
                                                        View the
