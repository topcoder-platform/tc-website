...
An example of the Heartbeat component is in the TopCoder Software Rules Engine to maintain a continuos connection between the application and the server.  Without doing so, the client application would need to re-establish a connection and potentially re-aunthenticate the user after each timeout.  The Heartbeat is configured to occur at specified intervals that are less than the timeout period configured on the server.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4201389">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704742">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4201389&amp;c=tcs_inquire&amp;Project=Heartbeat:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
