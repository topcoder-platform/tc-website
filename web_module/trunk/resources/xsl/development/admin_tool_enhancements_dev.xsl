...
<!-- Center Column Begins -->
        <td class="bodyText" width="99%" valign="top">
            <img src="/i/clear.gif" width="240" height="10" alt="" border="0"/><br/>
...
<!-- Title -->
                        ...
                        <p class="smallText">&#160;&#160;&#160;&#160;<a href="#overview">Overview</a> | <a href="#projecttype">Project Type</a> | <a href="#payment">Payment</a> | <a href="#eligibility">Eligibility</a> | <a href="#timeline">Timeline</a> | <a href="#requirementspecification">Requirement Specification</a></p>

<!-- Overview -->
                        <p><strong><a name="overview">Overview</a></strong><br/>
                        ...
                        <p><strong>View the <a target="_new" class="bodyText" href="/i/development/downloads/AdminToolRequirementsSpecification-web.pdf">Business Requirement Specification</a> for this application project.</strong></p>

                        <p><strong>Group 1</strong> - Must implement the following functionality according to the design:<br/>
                        &#160;&#160;&#160;Add Time<br/>
                        &#160;&#160;&#160;Advance Contest Phase<br/>
                        &#160;&#160;&#160;Compiler and Tester Restart<br/>
                        &#160;&#160;&#160;Dynamic Loading of Terms</p>

                        <p><strong>Group 2</strong> - Must implement the following functionality according to the design:<br/>
                        &#160;&#160;&#160;Implement Round Sequence<br/>
                        &#160;&#160;&#160;Auto room assignments<br/>
                        &#160;&#160;&#160;Security Object Upgrade</p>

                        <p><strong>Group 3</strong> - Must implement the following functionality according to the design:<br/>
                        &#160;&#160;&#160;Admin Broadcast Problem<br/>
                        &#160;&#160;&#160;Backup and Restore Tables<br/>
                        &#160;&#160;&#160;Statistics Warehouse Load</p>
...
<!-- Project Type -->
                        <p><strong><a name="projecttype">Project Type</a></strong><br/>
                        ...
                        <a href="/?&amp;t=development&amp;c=app_meth">Application Development Methodology</a> before you submit a solution.</p>
...
<!-- Payment -->
                        <p><strong><a name="payment">Payment</a></strong><br/>
                        ...
                        When the winning solution is submitted and review board suggestions are integrated.</p>
                        
                        <p><strong>Final Payment:</strong><br/>
                        At the completion of the integration project*.</p>
                        ...
                        <p><strong>Winning Developer (1 per Group)</strong><br/>
                        Total Payment - $2,200.00<br/>
                        First Payment - $1,325.00<br/>
                        Final Payment - $875.00</p>
                      
                        <p><strong>Second Place Developer (1 per Group)</strong><br/>
                        Total Payment - 665.00</p>

<!-- Definition of Completion -->
                                        
                        <p><strong>Integration Lead Developer</strong><br/>
                        ...
                        $250.00 to manage the integration process.</p>

                        <p><sup>*</sup>Completion of the integration project is defined as follows:</p>
...
<!-- Eligibility Requirements -->
                        <p><strong><a name="eligibility">Eligibility</a></strong><br/>
                        You must be a rated TopCoder member, at least 18 years of age, meeting all of the membership 
                        requirements and fit into one of the following categories:</p>
...
<!-- Timeline -->
                        <p><strong><a name="timeline">Timeline</a></strong><br/>
                        ...
                        the development tasks for each phase at the start of the development phase.</p>
                        
                        <table border="0" cellspacing="2" cellpadding="3" class="sidebarBox">
                            <tr>
                                <td class="sidebarText" ><b/>Application Project Posting:</td>
                                <td class="sidebarText" align="right"><b/>9.22.2003</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="sidebarText">Phase 1 Due:<br/>
                                    &#160;&#160;&#160;Develop Test Cases<br/>
                                    &#160;&#160;&#160;Functionality Development<br/>
                                    &#160;&#160;&#160;Documentation
                                </td>
                            ...
                            <tr>
                                <td class="sidebarText">Phase 2 Due:<br/>
                                    &#160;&#160;&#160;Develop Test Cases<br/>
                                    &#160;&#160;&#160;Functionality Development<br/>
                                    &#160;&#160;&#160;Documentation
                                </td>
                            ...
                            <tr>
                                <td class="sidebarText">Phase 3 Due:<br/>
                                    &#160;&#160;&#160;Develop Test Cases<br/>
                                    &#160;&#160;&#160;Functionality Development<br/>
                                    &#160;&#160;&#160;Documentation
                                </td>
...
<!-- Register at TCS -->
                        <p><a name="requirementspecification"></a><strong>View the <a target="_new" class="bodyText" href="/i/development/downloads/AdminToolRequirementsSpecification-web.pdf">Requirement Specification</a> for this application project &gt;&gt;</strong></p>
                       
                        <p><strong><!--<a href="/index?&amp;t=development&amp;c=tcs_app_inquire&amp;Project=Admin%20Tool%20Enhancements%20Group1">Inquire for the Group 1 Development Tasks of the Application Project</a> to get selected as a developer and to obtain the information necessary to submit a solution. -->
                        Inquiry is closed.</strong></p>
<!--
                        <p><strong><a href="/index?&amp;t=development&amp;c=tcs_app_inquire&amp;Project=Admin%20Tool%20Enhancements%20Group2">Inquire for the Group 2 Development Tasks of the Application Project</a> to get selected as a developer and to obtain the information necessary to submit a solution.</strong></p>
                     
                        <p><strong><a href="/index?&amp;t=development&amp;c=tcs_app_inquire&amp;Project=Admin%20Tool%20Enhancements%20Group3">Inquire for the Group 3 Development Tasks of the Application Project</a> to get selected as a developer and to obtain the information necessary to submit a solution.</strong></p>  -->
