...
<!-- Overview -->
						...
						The Object Selector component enables objects to be selected based on their defined availability and "weight".  This component is used to determine what advertisments are displayed on the TopCoder website and in the TopCoder applet.  In this scenario, the "Objects" defined to the chooser represent a company logo and a url.  These objects are configured to display within a defined timeframe.  If timeframes overlap among objects, the object weighting will determine how often each is displayed.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2809469">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=2809469&amp;c=tcs_inquire&amp;Project=Object%20Selector:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
