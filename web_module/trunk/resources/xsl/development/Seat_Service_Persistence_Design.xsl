    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Seat Service Persistence Design Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Design Application Project - Seat Service Persistence Design</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p>
                                                        ...
                                                        module receives and parses all consumer XML requests and then makes the appropriate
                                                        call to either the Scheduling module or Admin module to execute business logic.  When
                                                        the call returns, the Shell module constructs an XML response and sends it to the consumer.
                                                        The Scheduling module handles all core business logic related to scheduling functionality.
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$1,600.00</td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$4,980.00</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="400">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">10.08.2004 &#160;&#160;5:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">10.18.2004 &#160;&#160;5:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        Register <a href="/index?t=development&amp;c=tcs_app_inquire&amp;Project=Seat%20Service%20Persistence%20Design&amp;phase=112">here</a> to get selected as a developer and to obtain the information necessary to submit a solution.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
