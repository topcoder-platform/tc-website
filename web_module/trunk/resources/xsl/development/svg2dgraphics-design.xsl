...
<!-- Title -->
						<h1 class="devSubhead"><strong>SVG2DGraphics: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The SVG2DGraphics Generator generates SVG (Scalable Vector Graphic) documents utilizing the functions defined by the standard Java 2 abstract Graphics2D class. The abstract Graphics2D is designed to rendor output into various formats including printers, screens and SVG documents.

An application currently using the Graphics2D library to print a map to a printer, now can also print the map to an SVG document.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the SVG2DGraphics component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5709951">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5804509">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5709951&amp;c=tcs_inquire&amp;Project=SVG2DGraphics:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
