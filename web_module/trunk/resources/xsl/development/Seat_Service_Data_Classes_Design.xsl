    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Seat Service Data Classes Design Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Design Application Project - Seat Service Data Classes Design</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p>
                                                        ...
                                                        worldwide.  The service provides mechanisms for scheduling seat datetimes for candidates to take
                                                        exams.  The service also facilitates seat inventory management including the adding, removing and
                                                        manipulation of seats and testing sites.
                                                    </p>
                                                    <p>
                                                        The seat service is to be broken up in to multiple modules for design.  For the most part,
                                                        these modules can be developed vertically, however each module will use the same classes to store
                                                        seat information in memory.  Therefore, these shared data classes must be designed before work on
                                                        the other modules may begin.
                                                    </p>
                                                    <p>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$3,080.00</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="400">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">08.16.2004</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Register By:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">08.18.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Member Acceptance:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">08.18.2004 &#160;&#160;5:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Design Start:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">08.19.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">09.01.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Appeals Due:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">09.02.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Appeal Responses Due:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">09.02.2004 &#160;&#160;5:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Winner Announced:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">09.03.2004 &#160;&#160;5:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Final Fixes Due:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">09.07.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        View the
                                                        <a target="_new" class="bodyText" href="/?t=development&amp;c=app_sample_docs">Documents and Templates</a> for the Application Development Methodology
