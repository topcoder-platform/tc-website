...
<!-- Overview -->
						...
						The Checksum component mathematically validates binary data.  Transporting data has the possibility of corruption; utilizing the Checksum component guarantees the integrity of transported data.  This component provides the ability to generate a checksum value from a variety of algorithms.

The Checksum component can be used during a file transfer process (FTP) to validate the delivery of the data.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Checksum component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4228071">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4228071&amp;c=tcs_inquire&amp;Project=Checksum:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
