...
<!-- Overview -->
						...
						The Generic Data Object is used to provide a generic interface for managing data.  The component supports multiple implementations that enable users to choose both in-memory storage and, if required, physical persistence implementations.  Abstracting this information enables the developer to focus on programming business logic while enabling the system architect to have more control over the low-level implementation details.

An example usage of the Generic Data Object is the HTTPSession object.  Instead of calling methods on the session object directly, the Generic Data Object can be used.  This will allow the application architect to define and modify the implementation of that data object at any time.  In this example, the options available to the architect include implementing an HTTPSession version of the data object for in-memory persistence of data, or implementing a relational database version to persist data directly to a database.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4202835">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4202835&amp;c=tcs_inquire&amp;Project=Generic%20Data%20Object:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
