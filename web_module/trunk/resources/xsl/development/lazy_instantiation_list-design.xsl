...
<!-- Title -->
						<h1 class="devSubhead"><strong>Lazy Instantiation List: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The lazy instantiation list provides a mechanism for caching a list of identifiers and retrieves the specific information for the identifier when it is accessed.  When accessing information about an object, it is usually beneficial to load related objects into memory.  However, having a large number of related objects in memory hurts performance when only a few objects are actually needed.  Lazy instantiation loads objects into memory when needed and caches the objects using SimpleCache.

A customer service application displays order numbers populated in the list.  Once the order is accessed, the order object is retrieved from the database with all of the order information populated and formatted for display to the user.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Lazy Instantiation List component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5703142">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704570">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5703142&amp;c=tcs_inquire&amp;Project=Lazy%20Instantiation%20List:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
