...
<!-- Title -->
						<h1 class="devSubhead"><strong>Java Stress Test: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Java Stress Test component is designed to facilitate the testing of java classes and components under heavy load and concurrent requests.  The number of test threads and/or concurrent users are configurable parameters.



A portion of the TopCoder Software Development Review Process focuses on stress testing the components.  The types of tests written are often very similar and attempt to attack the component in the same manner.  Facilitating the creation of these tests will give the tester more time for analysis of what is causing an error, rather than focusing all efforts on proving that an error even exists.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Java Stress Test component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4311900">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4311900&amp;c=tcs_inquire&amp;Project=Java%20Stress%20Test:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
