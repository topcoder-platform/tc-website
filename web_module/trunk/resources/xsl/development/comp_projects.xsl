...
<!-- Open Component Design Projects begins -->
            ...
            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="formFrame">
                <tr>
                    <td class="tco04UsdcCombo" colspan="9">TCO04 &amp; USDC Component Design Projects</td>
                </tr>
                <tr valign="middle">
...
<!-- Open Component Development Projects begins -->
            ...
            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="formFrame">
                <tr>
                    <td class="tco04UsdcCombo" colspan="9">TCO04 &amp; USDC Component Development Projects</td>
                </tr>
