            ...
            <table border="0" cellspacing="0" cellpadding="0" background="/i/steel_darkblue_bg.gif" bgcolor="#000033" width="100%">
                ...
                <tr>
                    ...
                    <td class="statText" colspan="3">
                        <p>Currently open projects total <span id="totalMoney">$5,624.00*</span> in payments to the winning designers and developers. Send us
...
<!--                <tr valign="top">
                ...
                <tr valign="top">
                    <td background="" width="10" class="statText"><img src="/i/clear.gif" alt="" width="10" height="1" border="0" /></td>
                    <td background="" class="statText"><a class="statText" href="/index?t=development&amp;c=config_manager-design">Data Access Object Generator</a></td>
                ...
                <tr valign="top">
                    <td background="" width="10" class="statText"><img src="/i/clear.gif" alt="" width="10" height="1" border="0" /></td>
                    <td background="" class="statText"><a class="statText" href="/index?t=development&amp;c=java_import_statement-design">Java Import Statement</a></td>
