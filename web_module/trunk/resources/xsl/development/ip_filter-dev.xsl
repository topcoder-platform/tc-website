				...
				<table border="0" cellspacing="0" cellpadding="0" bgcolor="#000033" background="/i/steel_darkblue_bg.gif" width="100%">
					<tr>
						...
						<td class="statText" colspan="2" valign="top" bgcolor="#000033" background="/i/steel_darkblue_bg.gif" width="100%"><img src="/i/clear.gif" alt="" width="240" height="1" border="0"/><br/>
							...
							<h1 class="devSubhead"><strong>IP Filter: Development</strong></h1>
                                    
							<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=IP Filter: Development" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>

							<p><strong>Overview</strong><br />
							The IP Filter component validates IP addresses against a list of authorized and unauthorized addresses. This validation is intended to control initial application access based on the user?s IP Address. This solution is more convenient than standard hardware or router based filtering in that it drives the administration of IP filtering away from system administrators toward application administrators.
							</p>
							...
							Winner Announced: 01.08.2003<br/>
							Final Submission Due Date: 01.13.2003<br/></p>
