            ...
            <table border="0" cellspacing="0" cellpadding="10" width="100%"><img src="/i/clear.gif" width="10" height="10" alt="" border="0" /><br />
                <tr valign="top">
                    <td class="bodyText" width="100%">
                        ...
                        /?t=development&amp;version=<xsl:value-of select="/TC/DEVELOPMENT/version"/>&amp;phase=<xsl:value-of select="/TC/DEVELOPMENT/phase"/>&mp;comp=<xsl:value-of select="/TC/DEVELOPMENT/comp"/>&amp;c=tcs_inquire&amp;Project=<xsl:value-of select="/TC/DEVELOPMENT/Project"/>&amp;projectId=<xsl:value-of select="/TC/DEVELOPMENT/projectId"/>
