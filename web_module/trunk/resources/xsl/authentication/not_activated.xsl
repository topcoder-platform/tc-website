...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <HTML>
      <HEAD>
        <TITLE>TopCoder Account Activated</TITLE>
        ...
        <TABLE WIDTH="100%" HEIGHT="69%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#CCCCCC">
          <TR>
            ...
            <TD class="bodyText" width="100%" bgcolor="#CCCCCC" valign="top">
              ...
              <DIV class="bodyText">
                <p>Your account has <b>NOT</b> been successfully activated.</p>
                ...
                If problems persist, please email us at <a href="mailto:service@topcoder.com">service@topcoder.com</a>.
              </DIV>
