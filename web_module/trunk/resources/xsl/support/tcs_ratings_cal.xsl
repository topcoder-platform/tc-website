...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
                ...
                <BR/>
                                    <BR/>
                After each competition, each coder who submitted a solution is re-rated according to the following algorithm.  Keep in mind that only coders who shared the same level of component are rated against one another.  The average rating of everyone who has competed for the component is calculated:
                <BR/>
                                    <BR/>
