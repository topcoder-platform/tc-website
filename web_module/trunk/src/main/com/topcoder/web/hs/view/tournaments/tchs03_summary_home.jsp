...
<!-- Center Column begins -->
        <td valign="top" width="99%">
            <table cellspacing="0" cellpadding="20" border="0" width="100%">
                <tr valign="top">
                    <td height="100%" class="statTextBig">
                        ...
                        <table border="0" cellspacing="10" cellpadding="0" align="right" width="200">
                        ...
                        totals stood as follows:</p>
                         ...
                         <table border="0" cellspacing="10" cellpadding="0">
                            <tr>
                                <td width="100" class="statText" nowrap="nowrap">dgarthur</td>
                                 <td width="30" class="statText" align="right" nowrap="nowrap">1447.71</td>
                             </tr>
                               			
                            <tr>
                                <td width="100" class="statText" nowrap="nowrap">Yarin</td>
                                 <td width="30" class="statText" align="right" nowrap="nowrap">1382.79</td>
                             </tr>
                               			
                            <tr>
                                <td width="100" class="statText" nowrap="nowrap">dmwright</td>
                                 <td width="30" class="statText" align="right" nowrap="nowrap">1245.14</td>
                             </tr>
                               			
                            <tr>
                                <td width="100" class="statText" nowrap="nowrap">sjelkjd</td>
                                 <td width="30" class="statText" align="right" nowrap="nowrap">446.08</td>
                             </tr>
                        </table>		
                        ...
                        to those at the end of the Coding Phase:</p>
                         ...
                         <table border="0" cellspacing="10" cellpadding="0">
                            ...
                            <tr>
                                <td width="100" class="statText" nowrap="nowrap">sjelkjd</td>
                                 <td width="30" class="statText" align="right" nowrap="nowrap">246.08</td>
                             </tr>
                        </table>		
            ...
            <table border="0" cellspacing="0" cellpadding="3" width="100%">            
                <tr><td valign="middle"><img src="/i/clear.gif" alt="" width="1" height="3" border="0"/><a name="photos"></a></td></tr>          
                ...
                <tr>
                    <td class="statText" align="center"><img src="/i/tournament/tccc03/champ_01.jpg" name="bigVersion" width="432" height="288" class="photoFrameBig" /></td>
                </tr>            
