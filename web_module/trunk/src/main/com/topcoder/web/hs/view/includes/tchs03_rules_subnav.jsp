...
<% if (isOnlinePage) { %>
        <td class="tourney_subnav_on" nowrap="nowrap"><a href="?module=Static&d1=tournaments&d2=tchs03_rules_online" class="statText"><strong>Online/Onsite Rounds</strong></a></td>
<% } else { %>
        <td class="tourney_subnav" nowrap="nowrap"><a href="?module=Static&d1=tournaments&d2=tchs03_rules_online" class="statText"><strong>Online/Onsite Rounds</strong></a></td>
<%  } %>
