...
<table width="180" border="0" cellspacing="0" cellpadding="3" bgcolor="#555555">
    <tr>
        <td class="statTextBig" bgcolor="#333333">&#160;Coder:
            <tc-webtag:handle coderId='<%=coderInfo.getLongItem(0, "coder_id")%>'/></td>
    </tr>
...
<table width="180" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr>
        <td class="formHandleEven" colspan="2" align="center">
            <A href="/stat?c=coder_room_stats&cr=<%=coderInfo.getLongItem(0, "coder_id")%>" class="statTextBig">My Last
                Match</A>
        </td>
    </tr>
    <% } %>
    ...
    <tr>
        <td class="formHandleEven">Rating</td>
        <td class="formHandleEven" align="right">
            <rsc:item set="<%=coderInfo%>" name="design_rating" ifNull="Not Rated" format="#"/></td>
    </tr>
    <tr>
        <td class="formHandleEven">Earnings</td>
        <td class="formHandleEven" align="right">
    ...
    <tr>
        <td class="formHandleEven">Rating</td>
        <td class="formHandleEven" align="right">
            <rsc:item set="<%=coderInfo%>" name="development_rating" ifNull="Not Rated" format="#"/></td>
    </tr>
    <tr>
        <td class="formHandleEven">Earnings</td>
        <td class="formHandleEven" align="right">
    ...
    <tr>
        <td class="statText">
            ...
            <p>To learn more about Design Competitions, check out
                <A href="/tc?module=Static&d1=dev&d2=support&d3=desGettingStarted" class="statText">this tutorial</A>.
            </p>

            <p>To learn more about Development Competitions, check out
                <A href="/tc?module=Static&d1=dev&d2=support&d3=devGettingStarted" class="statText">this tutorial</A>.
            </p>
        </td>
    </tr>
</table>
