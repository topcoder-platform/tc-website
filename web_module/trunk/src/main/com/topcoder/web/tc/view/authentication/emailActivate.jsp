                        ...
                        <table border="0" cellpadding="3" cellspacing="0">
                           <tr><td colspan="3"><img src="/i/clear.gif" width="10" height="3" alt="" border="0"></td></tr>
                            ...
                            <tr valign="middle">
                                ...
                                <td colspan="2" align="left"><input type="password" name="<%=Login.PASSWORD%>" value="" maxlength="15" size="12" onkeypress="submitEnter(event)"></td>
                            </tr>
                            <tr valign="middle">
                                <td nowrap class="bodyText" align="right">Email:</td>
                                <td nowrap class="bodyText"><input type="text" name="<%=Constants.EMAIL%>" value="<%= username %>" maxlength="100" size="12" onkeypress="submitEnter(event)"></td>
