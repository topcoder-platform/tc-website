...
if (!rsc.isEmpty()) {
  ...
  if (rsr.getItem(25).getResultData()!=null&&Integer.parseInt(rsr.getItem(25).toString()) > 0)
...
<% } %>
                 ...
                 <logic:notEqual name="resultRow" property='<%= "item[" + 2 /*"quote"*/ + "]" %>' type="ResultSetContainer.ResultSetRow" value="">
                            ...
                            <TR>
                                ...
                                <TD CLASS="statText" ALIGN="right"><% if (rsc.getIntItem(0, "rating")<1) { %>Not Rated<% } else { %><rsc:item set="<%=rsc%>" name="rating" ifNull="Not Rated"/><%}%></TD>
...
<%-- Reliability begins --%>
                            ...
                            <TR>
                                ...
                                <TD CLASS="statText" WIDTH="10"><IMG SRC="/i/clear.gif" ALT="" WIDTH="10" HEIGHT="1" BORDER="0"></TD>
                                <TD CLASS="statText" ALIGN="left"><A HREF="/stat?c=reliablity_history&cr=<bean:write name="resultRow" property='<%= "item[" + 1 /*"id"*/ + "]" %>'/>" CLASS="statText">[ history ]</A></TD>
                            </TR>

                            <TR>
                                <TD COLSPAN="4" HEIGHT="10"><IMG SRC="/i/clear.gif" ALT="" WIDTH="1" HEIGHT="10" BORDER="0"></TD>
                            </TR>
<%-- Reliability Statistics ends --%>
                            <TR>
                                <TD BACKGROUND="/i/steel_gray_bg3.gif" COLSPAN="4" CLASS="registerNav" HEIGHT="18">&#160;&#160;Earnings</TD>
                            </TR>
                            ...
                            <TR>
                                <TD CLASS="statText" >&#160;&#160;Software Royalties:</TD>
                                <TD CLASS="statText" ALIGN="right"><rsc:item set="<%=rsc%>" name="royalties" ifNull="$0.00" format="$0.00"/></TD>
                                <TD CLASS="statText" WIDTH="10"><IMG SRC="/i/clear.gif" ALT="" WIDTH="10" HEIGHT="1" BORDER="0"></TD>
                                <TD CLASS="statText" ALIGN="left">&#160;</TD>
                            </TR>
