...
--%>
            ...
            <% if (tabLev2.equals("summary")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=alg_room1_analysis"><img src="/i/tournament/tco05/tabs/L2_summaryOn.gif" alt="" border=0 /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco05&d3=alg_room1_analysis"><img src="/i/tournament/tco05/tabs/L2_summaryOff.gif" alt="" border=0 /></A></td>
            <% } %>
<%--
--%>
            <% } else if (tabLev1.equals("component")) { %>
