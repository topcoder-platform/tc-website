...
<tco11:pageSetup title="TCO 11 : Algorithm Competition Leaderboard" area="algorithm" menu="advancers"
                 subMenu="leaderboard"/>
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <div class="legend">
                            <p>
                                Advanced <img src="/i/tournament/tco11/advanced_ico.png" /> <br />
                                Eliminated <img src="/i/tournament/tco11/eliminated_ico.png" /> <br />
                                Did not compete<img src="/i/tournament/tco11/not_compete_ico.png" />
                            </p>
                        </div>
                        ...
                        <form name="mainForm" action='${sessionInfo.servletPath}' method="get" id="advancersForm">
                            ...
                            <div class="buttons_bar">
                                ...
                                <div class="right">
                                    <tco11:paginationLinks previousAvailable="${croppedDataBefore}"
                            ...
                            <table cellpadding="0" cellspacing="0" class="leaderboard"><!-- Start table list -->
                                <tr>
                                    <th class="first"><span class="left"></span>
                                        <tco11:sortColumnLink text="Seed" columnIndex="${seedColumnIndex}"/>
                                    </th>
                                    <th class="handle" style="width:95px;">
                                        <tco11:sortColumnLink text="Handle" columnIndex="${handleSortColumnIndex}"/>
                                    ...
                                    <th class="rating">
                                        <tco11:sortColumnLink text="Rating" columnIndex="${ratingColumnIndex}"/>
                                    </th>
                                    <th><tco11:sortColumnLink text="R1" columnIndex="${round1SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="R2" columnIndex="${round2SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="R3" columnIndex="${round3SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="R4" columnIndex="${round4SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="R5" columnIndex="${round5SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="S1" columnIndex="${semi1SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="S2" columnIndex="${semi2SortColumnIndex}"/></th>
                                    <th><tco11:sortColumnLink text="Wild" columnIndex="${wildcardSortColumnIndex}"/></th>
                                    <th class="last"><span class="right"></span>
                                        <tco11:sortColumnLink text="Final" columnIndex="${finalsSortColumnIndex}"/>
                                    </th>
                                </tr>
                                ...
                                <c:forEach items="${rsc}" var="resultRow" varStatus="index">
                                    <tr>
                                        ...
                                        <td>
                                            <tco11:roundResultStatus roundId="${finals_id}"
