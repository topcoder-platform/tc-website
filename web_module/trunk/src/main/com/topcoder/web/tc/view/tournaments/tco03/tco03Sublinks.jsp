    ...
    <% } else if (list.equals("summary")) { %>
            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tcoSubNav">
                <tr>
                    ...
                    <td class="<%=tab.equals("reception")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=reception" class="topLink">Reception</a></td>
                    <td class="<%=tab.equals("room1")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=room1" class="topLink">Room 1</a></td>
                    <td class="<%=tab.equals("room2")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=room2" class="topLink">Room 2</a></td>
                    <td class="<%=tab.equals("room3")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=room3" class="topLink">Room 3</a></td>
                    <td class="<%=tab.equals("room4")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=room4" class="topLink">Room 4</a></td>
                    <td class="<%=tab.equals("final")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=final" class="topLink">Final Round</a></td>
                    <td class="<%=tab.equals("awards")?"tcoSubNav_on":"tcoSubNav"%>" width="1" nowrap="nowrap"><a href="/tc?module=Static&d1=tournaments&d2=tco03&d3=onsite&d4=awards" class="topLink">Awards Dinner</a></td>
