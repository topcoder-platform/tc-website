...
<!-- Body-->
	<tr valign=top>
        ...
        <h2>Travel Information - must be submitted by 5:00 PM EDT (GMT -4) on Wednesday, September 21, 2005</h2>
        <p>
        ...
        <br />
          ...
          <a target="_blank" href="http://www.santaclaramarriott.com">www.santaclaramarriott.com</a><br />
            ...
            <p>
                A hotel room will be confirmed for your arrival on either October 11th or 12th and departure
                on October 15th. The check-in time is 3:00PM and check out time is 11:00AM. If you have any
                special requests, please indicate them on the travel form below. The cost of your sleeping room
                and applicable taxes will be charged to the TopCoder master account. You will be required,
                however, to provide a credit card upon check-in for any incidental expenses.
            </p>
        ...
        <p>
          TopCoder will secure airline reservations based upon your registration information and will email a
          travel itinerary to you by Friday, October 7th. Please be advised that once airlines tickets are
          confirmed, any changes are subject to penalty fees at your own expense.  TopCoder will provide flight
          arrangements for each competitor up to a cost of $1,000 per person.  If your airfare is greater
          than $1,000, the difference between the cost of the airfare and $1,000 will be deducted from your
          total TCO prize money won.  If your total TCO prize money is not sufficient to cover the additional
          costs, your will be responsible for remitting to TopCoder the remainder of the cost.
        </p>
        ...
        <tr>
          ...
          <td align="left"><input type="text" name="a34" size="15"/></td>
            ...
            <tr>
              ...
              <td align="left"><select name="a43"><option value="Tuesday, March 8">Tuesday, March 8</option><option value="Wednesday, March 9">Wednesday, March 9</option></select></td>
           </tr>
            <tr>
            ...
            <tr>
              <td align="right"><input type="hidden" name="q45" value="March 12, 2005 - preferred departure time"/>March 12, 2005 - preferred departure time:</td>
