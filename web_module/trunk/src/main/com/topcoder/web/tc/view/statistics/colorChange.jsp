        ...
        <div align="center">
            <strong>
                ...
                <A href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=ColorChange&amp;<%=Constants.COLOR%>=Blue" class="coderTextBlue">New
                    blues</A>
                |
        <span class="selected"><A href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=ColorChange&amp;<%=Constants.COLOR%>=Yellow" class="coderTextYellow">New
            yellows</A></span>
                |
            ...
            <tbody>
                ...
                <rsc:iterator list="<%=changeList%>" id="resultRow">
                    <tr class="<%=even?"dark":"light"%>">
                        ...
                        <td class="valueC"><span class="coderTextBlue"><rsc:item name="old_rating" row="<%=resultRow%>"/></span>
                        </td>
                        <td class="valueC"><span class="coderTextYellow"><rsc:item name="new_rating" row="<%=resultRow%>"/></span>
                        </td>
