...
<tco11:pageSetup title="TCO 11 : Marathon Competition Leaderboard" area="marathon" menu="advancers"
                 subMenu="leaderboard"/>
                        ...
                        <form name="mainForm" action='${sessionInfo.servletPath}' method="get" id="advancersForm">
                            ...
                            <table cellpadding="0" cellspacing="0" class="leaderboard"><!-- Start table list -->
                                <tr>
                                    ...
                                    <th class="center"><tco11:sortColumnLink text="R1" columnIndex="${round1SortColumnIndex}"/></th>
                                    <th class="center"><tco11:sortColumnLink text="R2" columnIndex="${round2SortColumnIndex}"/></th>
                                    <th class="center"><tco11:sortColumnLink text="R3" columnIndex="${round3SortColumnIndex}"/></th>
