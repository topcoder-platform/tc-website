...
<br><br>
            <table border="0" cellspacing="0" cellpadding="3" width="100%" align="center" class="formFrame">
               <tr><td class="advHeader" colspan="9" valign="middle">Component Requirements:<br><A class="topLink" href="/i/tournament/tco05/comp_submissions/common.zip"><img src="/i/download.gif" border="0"/></A></td></tr>
               <tr>
