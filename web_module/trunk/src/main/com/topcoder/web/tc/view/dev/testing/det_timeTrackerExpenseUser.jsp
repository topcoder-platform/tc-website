...
<span class="bigTitle">Time Tracker Expense and User Tests Competition</span>
<br><br>
...
The tests in this competition will verify entering expenses, deleting expenses, editing expenses, listing users, editing users and user GUI requirements.
<br><br>
...
To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Time Tracker Expense and User Tests">TestingSubmissions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
