...
TopCoder, Inc. will be conducting a contest for members prior to the 2006 TopCoder Open (TCO06).  As a result of this contest, one logo will be selected as the base for the tournament logo for the TCO06.
<br><br>
<span class="bodySubtitle">ELIGIBILITY</span><br>
To be eligible for the contest, you must be:
<ul>
<li>18 years of age or older; and 
<li>A registered member of TopCoder in good standing.
</ul>
...
<li><b>Content:</b>
   <ul>
   <li>The logo <span class="bigRed">MUST</span> include the title of the tournament: "2006 TopCoder Open"</li>
   ...
   <li>"Open" <span class="bigRed">MUST</span> be written as either "Open" or "OPEN"</li>
   </ul>
</li>
...
<br><br>
<span class="bodySubtitle">PRIZE</span><br>
