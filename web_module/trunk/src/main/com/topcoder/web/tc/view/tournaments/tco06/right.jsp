...
<% if (level1.equals("all")) { %>
            ...
            <a href="/tc?module=Static&d1=tournaments&d2=tco06&d3=amd"><img src="/i/tournament/tco06/amd_right.gif" alt="AMD" border="0" /></a><br />
...
<% } else if (level1.equals("amd")) { %>
            ...
            <img src="/i/clear.gif" alt="" width="170" height="15" border="0" /><br />
            <a href="/tc?module=Static&d1=tournaments&d2=tco06&d3=amd"><img src="/i/tournament/tco06/amd_right.gif" alt="NSA" border="0" /></a><br />
            <img src="/i/clear.gif" alt="" width="10" height="10" border="0" /><br />
            <jsp:include page="/calendar.jsp" />
