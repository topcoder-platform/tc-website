...
<tco11:pageSetup title="TCO 11 : Development Competition Final Results" area="development" menu="finalResults"/>
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn" style="margin-bottom:30px;">
                    <div class="text">
                        ...
                        <div style="float: left"><br/><img src="/i/tournament/tco11/result/development.jpg" alt="Yeung"
