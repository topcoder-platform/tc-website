...
<div style="float: right;"><tc-webtag:forumLink forumID="505838" message="Discuss this article" /></div>
<span class="bodyTitle">How To Dissect a TopCoder Problem Statement</span>
