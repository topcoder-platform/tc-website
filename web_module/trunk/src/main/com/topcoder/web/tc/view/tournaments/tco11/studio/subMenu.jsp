...
<div class="subMenu">
    <ul class="secondaryNav overviewNav"><!-- orange secondary navigation -->
        <li class="${descriptionClass}"><!-- first item -->
            <tco11:studioStaticPageLink page="description">
        ...
        <li class="${scheduleClass}"><!--  item -->
            <tco11:studioStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="schedule">
                <span class="left"></span>
        ...
        <li class="${rulesClass}"><!-- second item -->
            <tco11:studioStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="rules">
                <span class="left"></span>
        ...
        <li class="${advancersClass}"><!-- third item-->
            <tco11:studioStaticPageLink page="leaderboard">
                <span class="left"></span>
        ...
        <li class="${finalResultsClass}"><!-- four item -->
            <tco11:studioStaticPageLink styleClass="tertiaryNavBT SponsorsBT" page="finalResults">
                <span class="left"></span>
        ...
        <c:choose>
          ...
          <ul class="advancers">
                    <li class="${leaderboardClass}">
                        <tco11:studioStaticPageLink page="leaderboard">Leaderboard</tco11:studioStaticPageLink>
                    </li>
                    <li class="${bracketClass}">
                        <tco11:studioStaticPageLink page="bracket">Bracket</tco11:studioStaticPageLink>
                    </li>
                    <li class="${judgesClass}">
                        <tco11:studioStaticPageLink page="judges">Guest Judges</tco11:studioStaticPageLink>
                    </li>
                </ul>
            </c:when>
            <c:otherwise>
