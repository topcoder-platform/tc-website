...
<tco11:pageSetup title="TCO 11 : Design Competition Schedule" area="design" menu="schedule"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Schedule</h2><!-- page title -->
                            <p>Competitors can register for the Tournament and be eligible for the Design Competition between 9:00 UTC -4 on March 29, 2010 and 9:00 UTC -4 on July 30, 2010.  The Design Competition will take place between March 29, 2010 and July 30, 2010. Only Tournament-eligible design competitions in which registration has closed during the Design Competition Period shall be included in determining points for the Design Competition.</p>
                        </div>
