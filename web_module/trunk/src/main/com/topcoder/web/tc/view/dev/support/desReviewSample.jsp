...
requirements document AND the forums for the component.</strong></td>
			    	<td class="forumTitleCenter" width="10%">
			    	    <strong>Weight: 300</strong>
			    	</td>
			    	<td class="forumTitleCenter" width="10%">
			    ...
			    <tr>
			    	<td class="forumTextOdd" width="80%"><p class="scorecardQuestion">The design addresses all the requirements as specified in the requirements documents and/or the forum.
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">The reviewer should be able to take
each point in the requirements document and find the associated
implementation in the design. The reviewer should read the component
forum prior to doing this to ensure that any modifications or additions
to the requirements are taken into account.
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">Rating 1 &#8211; The design is missing any of the &#8216;core&#8217; requirements.
</p><p class="scorecardQuestion">Rating 2 &#8211; The design has all of the &#8216;core&#8217; requirements but does not address a majority of the &#8216;non-core&#8217; requirements
</p><p class="scorecardQuestion">Rating 3 &#8211; The design has all of the
&#8216;core&#8217; requirements and a majority of the &#8216;non-core&#8217; requirements and,
potentially, includes minor additional functionality.
...
</p><p class="scorecardQuestion">&#8216;Core&#8217; requirements are those
requirements that are essential to component&#8217;s intent (i.e. the
...
and/or methodologies were used and were identified correctly. The
reviewer should also assign this rating if the design, appropriately,
does not need any patterns/methodologies.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 10
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[4].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[4].responses[1].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
</p><p class="scorecardQuestion">Rating 1 &#8211; The design would need
substantial modifications to accommodate the enhancements both the
reviewer and designer came up with. </p><p class="scorecardQuestion">Rating 2 &#8211; The design could
accommodate (without substantial changes) the enhancements the designer
included but would need substantial changes to accommodate the reviewer
enhancements.
</p><p class="scorecardQuestion">Rating 3 &#8211; The design could accommodate (with moderate changes) both the reviewer and designer enhancements.
</p><p class="scorecardQuestion">Rating 4 &#8211; The design could easily accommodate the reviewer and designer enhancements.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 10
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[5].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
one of the recommended components but not all and did not give
sufficient justification as to why. Likewise, assign this rating if the
designer missed using likely components or used any other component
incorrectly.
</p><p class="scorecardQuestion">Rating 3 &#8211; The design used all the recommended components correctly but missed using other likely components.
</p><p class="scorecardQuestion">Rating 4 &#8211; The design used all
recommended and likely components correctly. Likewise, assign this
rating if components were appropriately not used.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 30
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[6].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[7].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
name is too generic or too high-level).
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">Rating 1 &#8211; Multiple classes definitely violate scope and should be refactored into smaller or larger classes.
</p><p class="scorecardQuestion">Rating 2 &#8211; A single class definitely violates scope and should be refactored into smaller or larger classes.
</p><p class="scorecardQuestion">Rating 3 &#8211; The classes seem fine but at least one class could potentially benefit from being refactored.
</p><p class="scorecardQuestion">Rating 4 &#8211; All classes seem to be scoped well.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 10
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[9].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
<!-- spacer  -->										
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody><tr>
					<td class="whiteBkgnd">Design Section</td>
				</tr>
			</tbody></table>
...
The answers to the questions should be limited to design fundamentals (how well the design was executed).</strong></td>
			    	<td class="forumTitleCenter" width="10%">
			    ...
			    <tr>
			    	<td class="forumTextOdd" width="80%"><p class="scorecardQuestion">Sub-packages have been defined to separate functionality into maintainable units.
</p><p class="scorecardQuestion">
...
doing associations are appropriate:
</p><p class="scorecardQuestion">1)	Define a variable for the association, draw the association and label it with the variable.
</p><p class="scorecardQuestion">2)	Define the association and label it with a variable name &#8211; no variable needs to be shown for the relationship in the class.
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">Rating 1 &#8211; Relationships are missing
between internal classes and/or external TopCoder components.
Relationships are consistently missing attribute information.
</p><p class="scorecardQuestion">Rating 2 &#8211; Relationships exist
between internal classes and/or external TopCoder components. However,
system classes are missing or some of the relationships have
missing/incorrect attributes.
</p><p class="scorecardQuestion">Rating 3 &#8211; Relationships between
internal classes and external entities (both TopCoder components and
system classes) have been defined. Some of the association attributes
are either missing or incorrect.
</p><p class="scorecardQuestion">Rating 4 &#8211; Relationships between
internal classes and external entities (both TopCoder components and
system classes) have been defined and all association attributes are
correct.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 25
			    	</td>
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		    <td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[14].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
</p><p class="scorecardQuestion">Rating 4 &#8211; Language features are used correctly.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 15
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[16].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
<!-- spacer  -->										
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody><tr>
					<td class="whiteBkgnd">Documentation Section</td>
				</tr>
			</tbody></table>
...
if any section is not applicable to the design.</strong></td>
			    	<td class="forumTitleCenter" width="10%">
			    	    <strong>Weight: 250</strong>
			    	</td>
			    	<td class="forumTitleCenter" width="10%">
			    	    <strong>Response</strong></td>
			    </tr>
			    ...
			    <tr>
			    	<td class="forumTextOdd" width="80%"><p class="scorecardQuestion">The class documentation in the 'Documentation' tab of Poseidon provides a
...
visually in the diagram.</p></td>
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[20].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
			    ...
			    <tr>
			    	<td class="forumTextOdd" width="80%"><p class="scorecardQuestion">The component specification contains a comprehensive demo section.
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">Is the demo section complete (does it
demonstrate each requirement)? Was it written in a way that 'promotes'
the component (i.e. clear, demonstrates flexibility, etc.)?
</p><p class="scorecardQuestion">
</p><p class="scorecardQuestion">Rating 1 &#8211; Demo section is missing or
the existing demo section contains non-compilable errors (don't
actually try to compile it &#8211; just view it to make sure it looks
correct).
</p><p class="scorecardQuestion">Rating 2 &#8211; The demo section
demonstrates some but not all of the requirements or the demo section
demonstrates class/methods/variables that don't exist in the design
(probably were never updated).
</p><p class="scorecardQuestion">Rating 3 &#8211; The demo section demonstrates each of the requirements correctly.
</p><p class="scorecardQuestion">Rating 4 &#8211; The demo section
demonstrates each of the requirements correctly in a clear fashion
using a likely customer scenario (i.e. sets up a scenario that is
similar to what a user of the component would see) or demonstrates
extra functionality or flexibility.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 20
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[21].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
...
actively confuses the reviewer in trying to understand the design.
</p><p class="scorecardQuestion">Rating 2 &#8211; The presentation lacks many of the above but doesn't add to any confusion in understanding the design.
...
</p><p class="scorecardQuestion">Rating 4 &#8211; The presentation looks professional, and polished, and contributes to understanding the design.</p></td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			    	    Weight: 15
			    	</td>
			    	<td class="forumTextOdd" valign="top" width="10%">
			            ...
			            <table class="whiteBkgnd" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				        	...
				        	<tbody><tr>
				        		...
				        		<td class="forumTextOdd" width="60%">
				        		    <textarea name="questions[24].responses[0].responseText" cols="65" rows="2"></textarea></td>
				        		<td class="forumTextOdd" valign="middle" width="15%">
				        		    <select name="questions[23].responses[0].responseType"><option value="Recommended">Recommended</option><option value="Required">Required</option><option value="Comment" selected="selected">Comment</option></select>
			                    </td>
				        		<td class="forumTextOdd" valign="middle" width="5%">
