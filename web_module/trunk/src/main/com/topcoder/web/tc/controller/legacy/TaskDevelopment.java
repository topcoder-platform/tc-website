                        ...
                        xsldocURLString = XSL_DIR + "inquiry_sent_pos.xsl";
                            ...
                            if (Long.parseLong(phase) == ComponentVersionInfo.SPECIFICATION) {
                                mail.setBody("Your inquiry has been received. Thank You!\r\n\r\n" +
                                        ...
                                        "The deadline for submitting a solution is " + date + " at 11:59 PM EST. Please upload your design using the project page found here: http://" + ApplicationServer.SOFTWARE_SERVER_NAME + "/review.  If you encounter any problems, please contact us at service@topcodersoftware.com.  All late submissions will be ignored.  Also, a reminder that this is a competition, and only the top three designers will receive payment.\r\n\r\n" +
                                ...
                                mail.setBody("Your inquiry has been received. Thank You!\r\n\r\n" +
                                        ...
                                        "The deadline for submitting a solution is " + date + " at 11:59 PM EST. Please upload your solution using the project page found here: http://" + ApplicationServer.SOFTWARE_SERVER_NAME + "/review. If you encounter any problems, please contact us at service@topcodersoftware.com.  Any late submissions will be ignored. Also, a reminder that this is a competition, and only the top three developers will receive payment.\r\n\r\n" +
                                        "If you have any questions please contact service@topcodersoftware.com\r\n\r\n" +
                                        "TopCoder Software Team");
                            }
                            EmailEngine.send(mail);
