   ...
   <tr>
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTable">
         ...
         <TR>
            ...
            <TD CLASS="tableHeader" WIDTH="55%"><a href="<%=sSortUrl%>&sc=4&sd=<%= "4".equals(srb.getProperty("sc")) && srb.getProperty("sd","desc").equals("desc") ?"asc":"desc"%>">Contest</a></TD>
...
<%--
            <TD class="<%=even?"statLt":"statDk"%>" align="right" nowrap="nowrap"><A href="/tc?module=Static&d1=statistics&d2=compContestDetails" class="statLink">contest details</A></TD>
--%>
         </TR>
         <%even=!even;%>
         </logic:iterate>
