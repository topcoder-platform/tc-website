...
<div id="header">
    ...
    <ul id="nav">
        ...
        <li id="nav_program"><a title="Download Tournament Program (PDF)" onfocus="this.blur();" href="#"<% if (tabLev1.equals("program")) {%> class="active"<% } %>>Tournament Program</a></li>
        ...
        <li id="nav_registrants"><a title="Registrants" onfocus="this.blur();" href="/tchs?module=ViewRegistrants&eid=992"<% if (tabLev1.equals("registrants")) {%> class="active"<% } %>>Registrants</a></li>
