...
<table class="formFrame" border="0" cellpadding="6" cellspacing="0" width="300">
    ...
    <tr class="advHeader">
       <td align="left" width="50%"><a href="/tc?module=TCO05AlgRegistrants<tc-webtag:sort column="2"/>">Handle</a></td>
       <td align="right" width="50%"><a href="/tc?module=TCO05AlgRegistrants<tc-webtag:sort column="3"/>">Rating</a></td>
    </tr>
<%boolean even = false;%>
