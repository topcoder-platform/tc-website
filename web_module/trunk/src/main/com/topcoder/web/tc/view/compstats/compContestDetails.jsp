...
<td class="divider">
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="stat" style="border: none;">
        ...
        <tr>
            ...
            <rsc:item set="<%=projectInfo%>" name="version_text"/><br><br>
            </TD>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="num_inquiries"
                                                     ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;"><strong>Submissions:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="num_submissions"
                                                     ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;" nowrap="nowrap"><strong>Submission %:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="submission_percent" format="0.00'%'"
                                                     ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;" nowrap="nowrap"><strong>Passed Screening:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="passed" ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;" nowrap="nowrap"><strong>Passed %:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="passed_percent" format="0.00'%'"
                                                     ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;" nowrap="nowrap"><strong>Avg Initial Score:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="avg_raw_score" format="0.00"
                                                     ifNull="unknown*"/></TD>
        </tr>
        <tr>
            <td class="value" style="border: none;" nowrap="nowrap"><strong>Avg Final Score:</strong></TD>
            <TD class="value" style="border: none;" align="right"><rsc:item set="<%=projectInfo%>" name="avg_final_score" format="0.00"
                                                     ifNull="unknown*"/></TD>
        </tr>
    </table>
</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="stat" style="border: none;">
<tr><td class="title" colspan="<%= canDownloadSubm? 12 : 11 %>">
    Competitors
</td></tr>
<tr>
...
<rsc:iterator list="<%=submissions%>" id="resultRow">
    <tr class="<%=even?"light":"dark"%>">
        <TD class="value"><tc-webtag:handle coderId='<%= resultRow.getLongItem("user_id") %>'
                                                                  context='<%= projectInfo.getStringItem(0, "phase_desc") %>'/></TD>

        <TD class="valueC"><rsc:item name="inquire_timestamp" row="<%=resultRow%>"
                                                                         format="MM.dd.yyyy" ifNull="unknown*"/></TD>
        <TD class="valueC"><rsc:item name="submit_timestamp" row="<%=resultRow%>"
                                                                         format="MM.dd.yyyy" ifNull="unknown*"/></TD>
        <TD class="valueR">
        ...
        <% if (resultRow.getIntItem("passed_screening") == 1) { %>
        <TD class="valueC"><rsc:item row="<%=resultRow%>" name="initial_score"
                                                                         format="0.00"
                                                                         ifNull="unknown*"/></TD>
        <TD class="valueC"><b><rsc:item row="<%=resultRow%>" name="final_score"
                                                                            format="0.00"
                                                                            ifNull="unknown*"/></b></TD>
        <TD class="valueC"><b><rsc:item row="<%=resultRow%>" name="final_points"
                                                                            ifNull="N/A"/>
