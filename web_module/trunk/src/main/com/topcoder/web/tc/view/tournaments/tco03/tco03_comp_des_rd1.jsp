...
<div align="right" class="bodyText">Round
    1&#160;&#160;|&#160;&#160;<A href="/tc?module=Static&d1=tournaments&d2=tco03&d3=tco03_comp_des_rd2">Round 2</A>
</div>
<br/>
...
<table border="0" cellspacing="0" cellpadding="3" width="500" align="center" class="formFrame">
    ...
    <tr valign="middle">
        ...
        <td class="formHandleOdd" align="left">
            <a class="coderTextYellow" href="/tc?module=MemberProfile&cr=119676">Pops</a></td>
        <td class="formHandleOdd" align="right">bye</td>
        <td class="formHandleOdd" align="right">
            <a class="StatText" href="/tc?module=Static&amp;d1=dev&amp;d2=bonusContest1">Contest 1</a></td>
        <td class="formHandleOdd" align="right">$0.00</td>
    </tr>

    <tr valign="middle">
        <td class="formHandleEven" align="center">1(T)</td>
        <td class="formHandleEven" align="left"><a class="coderTextBlue" href="/tc?module=MemberProfile&cr=268546">TangentZ</a>
        </td>
        <td class="formHandleEven" align="right">bye</td>
        <td class="formHandleEven" align="right">
            <a class="StatText" href="/tc?module=Static&amp;d1=dev&amp;d2=bonusContest2">Contest 2</a></td>
        <td class="formHandleEven" align="right">$0.00</td>
    </tr>

    <tr valign="middle">
        <td class="formHandleOdd" align="center">3</td>
        <td class="formHandleOdd" align="left"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=302018">Tomson</a>
        </td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleEven" align="left">
            <a class="coderTextGreen" href="/tc?module=MemberProfile&cr=299180">isv</a></td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleOdd" align="left"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=277356">aksonov</a>
        </td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleEven" align="left"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=152342">kyky</a>
        </td>
    ...
    <tr valign="middle"><td background="/i/graybv_bg.gif" class="statTextLarge" width="20%" align="left" colspan="5">
        *the average of the two highest scores, including at least one level II score</td></tr>
...
<table border="0" cellspacing="0" cellpadding="3" width="500" align="center" class="formFrame">
    ...
    <tr valign="middle">
        ...
        <td class="formHandleOdd" align="left"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=296145">srowen</a>
        </td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleEven" align="left"><a class="coderTextBlue" href="/tc?module=MemberProfile&cr=304976">giginim</a>
        </td>
    ...
    <tr valign="middle">
        <td class="formHandleOdd" align="center">3</td>
        <td class="formHandleOdd" align="left"><a class="coderTextGreen" href="/tc?module=MemberProfile&cr=7405912">StrongHold</a>
        </td>
...
<table border="0" cellspacing="0" cellpadding="3" width="500" align="center" class="formFrame">
    ...
    <tr valign="middle">
        <td class="formHandleOdd">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7411659" class="statText" target="_blank">Business
                Date Utility</a></td>
        <td class="formHandleOdd" align="center">3</td>
        <td class="formHandleOdd" align="center">1</td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleEven" align="center">2</td>
        <td class="formHandleEven"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=296145">srowen</a></td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleOdd" align="center">3</td>
        <td class="formHandleOdd"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=152342">kyky</a></td>
        <td class="formHandleOdd" align="right">80.03</td>
    </tr>

    <tr valign="middle">
        <td class="formHandleEven">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7409563" class="statText" target="_blank">Dependency
                Map</a></td>
        <td class="formHandleEven" align="center">1</td>
        <td class="formHandleEven" align="center"></td>
        <td class="formHandleEven"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=152342">kyky</a></td>
        <td class="formHandleEven" align="right">80.13</td>
    </tr>
    <tr valign="middle">
        <td class="formHandleOdd">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7410827" class="statText" target="_blank">Image
                Overlay</a></td>
        <td class="formHandleOdd" align="center">3</td>
        <td class="formHandleOdd" align="center">1</td>
    ...
    <tr valign="middle">
        ...
        <td class="formHandleEven" align="center"></td>
        <td class="formHandleEven" align="center">2</td>
        <td class="formHandleEven"><a class="coderTextBlue" href="/tc?module=MemberProfile&cr=304976">giginim</a></td>
        <td class="formHandleEven" align="right">89.18</td>
    </tr>
    <tr valign="middle">
        <td class="formHandleOdd"></td>
    ...
    <tr valign="middle">
        <td class="formHandleEven">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7408776" class="statText" target="_blank">Load
                Estimator</a></td>
        <td class="formHandleEven" align="center">1</td>
        <td class="formHandleEven" align="center"></td>
    ...
    <tr valign="middle">
        <td class="formHandleOdd">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7410707" class="statText" target="_blank">Shopping
                Cart</a></td>
        <td class="formHandleOdd" align="center">1</td>
        <td class="formHandleOdd" align="center"></td>
        <td class="formHandleOdd"><a class="coderTextGreen" href="/tc?module=MemberProfile&cr=299180">isv</a></td>
        <td class="formHandleOdd" align="right">81.84</td>
    </tr>

    <tr valign="middle">
        <td class="formHandleEven">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7408797" class="statText" target="_blank">SVG
                Generator</a></td>
        <td class="formHandleEven" align="center">1</td>
        <td class="formHandleEven" align="center"></td>
        <td class="formHandleEven"><a class="coderTextYellow" href="/tc?module=MemberProfile&cr=302018">Tomson</a></td>
        <td class="formHandleEven" align="right">86.79</td>
    </tr>

    <tr valign="middle">
        <td class="formHandleOdd">
            <a href="http://software.topcoder.com/catalog/c_component.jsp?comp=7411234" class="statText" target="_blank">Tree
                View Tag</a></td>
        <td class="formHandleOdd" align="center">1</td>
        <td class="formHandleOdd" align="center"></td>
        <td class="formHandleOdd"><a class="coderTextGreen" href="/tc?module=MemberProfile&cr=7405912">Stronghold</a>
        </td>
        <td class="formHandleOdd" align="right">80.58</td>
    </tr>
