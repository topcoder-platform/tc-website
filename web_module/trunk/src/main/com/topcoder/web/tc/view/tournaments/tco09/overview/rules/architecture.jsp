 ...
 *
 * This JSP shows specific rules for architecture track.
 *
 * Author TCSDEVELOPER
 * Version 1.0
                                                    ...
                                                    <div id="mainContentInner">
                                                        <div>
                                                            <div class="pageContent">
                                                                <h2 class="title">Architecture Competition Official Rules and Regulations</h2>
                                                                    <p>The 2009 TopCoder Open Architecture Competition will take place between February 11 and June 4, 2009 ("Architecture Competition"). The Architecture Competition will consist of eight (8) weeks of online qualifying competitions, with up to six (6) of the highest scoring competitors winning a trip to the Tournament.</p>
                                                                    <p>The Architecture Competition is part of the Tournament, and by participating in this Architecture Competition, you agree to these Rules.</p>
                                                                        <div class="subtitle">
                                                                            <h3 class="subtitle">Schedule</h3>
                                                                                <p>Competitors can register for the Tournament and be eligible to participate in the Architecture Competition between 9:00 a.m. EST on February 11, 2009 and 9:00 a.m. EST on March 19, 2009.  Competitors do not need to register separately for the Architecture Competition. The Architecture Competition will take place between February 11 and April 17, 2009 ("Architecture Competition Period").  </p>
                                                                        ...
                                                                        <div class="subtitle">
                                                                            <h3 class="subtitle">Penalty points</h3>
                                                                                <p>All final fixes will be completed according to the Online Review schedule. If there is a delay in submitting final fixes to a submission in a Tournament-eligible architecture competition, the Competitor will be docked one (1) placement point per day (or part thereof) in which the final fixes are late. </p>
                                                                        </div>
                                                                        <div class="subtitle">
                                                                            <h3 class="subtitle">Advancement</h3>
                                                                                <p>Upon the completion of all Tournament-eligible architecture competitions, up to the five (5) highest individual placement scores that a Competitor receives during the Architecture Competition Period will be added for a cumulative placement score.  Up to six (6) Competitors with the highest cumulative placement score will be invited to attend the onsite awards ceremony at the Tournament.</p>
                                                                                <p>In the event of a tie, the tie will be resolved in the following manner:</p>
                                                                                    <ol>
                                                                                        ...
                                                                                        <li>Architecture competitions where the Competitor earned 0 points will not be counted towards calculating tiebreaker scores. </li>
                                                                                    </ol>
                                                                        ...
                                                                        <div class="subtitle">
                                                                            <h3 class="subtitle">About the Prizes</h3>
                                                                                <p>The Architecture Competition will award up to $13,300 in cash prizes. Any and all applicable taxes on prizes are the sole responsibility of the prizewinner. </p>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="first">&nbsp;</td>
                                                                                        <td class="first last alignText">1st place finisher* in the Architecture Competition</td>
                                                                                        <td class="first last alignText">$10,000</td>
                                                                                        <td class="last">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="first">&nbsp;</td>
                                                                                        <td class="first last alignText">2nd place finisher* in the Architecture Competition</td>
                                                                                        <td class="first last alignText">$2,500</td>
                                                                                        <td class="last">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="first">&nbsp;</td>
                                                                                        <td class="first last alignText">3rd place finisher* in the Architecture Competition</td>
                                                                                        <td class="first last alignText">$500</td>
                                                                                        <td class="last">&nbsp;</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="first">&nbsp;</td>
                                                                                        <td class="first last alignText">4th-6th place finishers* in the Architecture Competition</td>
                                                                                ...
                                                                                <p><em>* Prior to Competitors receiving their cash prize, they must complete all work for all underlying architecture competitions and Tournament and Architecture Competition-related work, such as final fixes.</em></p>
                                                                        </div>
                                                            </div>
                                                        </div>
