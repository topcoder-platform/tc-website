...
<p><span class="bigTitle">Document Indexer Testing Competition: Indexing Module</span></p>
...
[Member_Handle]_IndexingTests.zip</p>
...
<tr><td>2.8</td><td valign="top">Index Single Document</td></tr>
<tr><td>2.9</td><td valign="top">Index All Modified Documents</td></tr>
<tr><td>2.10</td><td valign="top">Index All Documents</td></tr>
<tr><td>2.16</td><td valign="top">Delete Index Record</td></tr>
</table>
</div>
<br>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit: Document Indexer Testing Competition: Indexing Module">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
