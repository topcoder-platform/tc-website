...
<%--<tr class="bodyText"><td nowrap="nowrap">06.29.06 9:00 AM - </td><td width="100%"><A href="/tc?module=Static&d1=my_home&d2=empReferrals">TopCoder Employee Referral Program Prize Increase</A></td></tr>--%>
