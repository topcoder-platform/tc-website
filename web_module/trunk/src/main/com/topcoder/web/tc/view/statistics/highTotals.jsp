...
<% if (sDivision.equals("2")){ %>
                    This chart represents the Top-10 highest point totals earned in a Division II Competition.
                  </P>
                  <P CLASS="statText">
                    See Highest Totals for <A CLASS="statText" HREF="/stat?c=highest_totals&dn=1">Division I</A>
<% } else { %>
                    This chart represents the Top-10 highest point totals earned in a Division I Competition.
                  </P>
                  <P CLASS="statText">
...
<logic:iterate name="QUERY_RESPONSE" id="queryEntries" type="java.util.Map.Entry" scope="request">
  ...
  <logic:present name="queryEntries" property="value">
    ...
    <tr valign="middle">
          ...
          <td><A HREF="/tc?module=MemberProfile&cr=<bean:write name="resultRow" property='<%= "item[" + 1 /*"coder_id"*/ + "]" %>'/>" CLASS="<bean:write name="nameColor" property='<%= "style[" + coderrank.toString() + "]" %>'/>"> <bean:write name="resultRow" property='<%= "item[" + 0 /* handle */ + "]" %>'/></A></td>
