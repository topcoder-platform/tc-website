...
<div class="subMenu">
    <ul class="secondaryNav overviewNav"><!-- orange secondary navigation -->
        <li class="${descriptionClass}"><!-- first item -->
            <tco11:overviewStaticPageLink page="overview">
                <span class="left"></span>
                <span class="text">Latest Happenings</span>
                <span class="right"></span>
            </tco11:overviewStaticPageLink>
        </li>
        <li class="${scheduleClass}"><!--  item -->
            <tco11:overviewStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="schedule">
                <span class="left"></span>
        ...
        <li class="${rulesClass}"><!-- second item -->
            <tco11:overviewStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="rules">
                <span class="left"></span>
        ...
        <li class="${leaderboardClass}"><!-- third item-->
            <tco11:overviewStaticPageLink page="patron">
                <span class="left"></span>
        ...
        <li class="${finalResultsClass}"><!-- four item -->
            <tco11:overviewStaticPageLink styleClass="tertiaryNavBT SponsorsBT" page="sponsor1">
                <span class="left"></span>
        ...
        <li class="${registrantsClass}"><!--five item -->
            <tco11:overviewStaticPageLink page="registrants">
                <span class="left"></span>
            ...
            <c:when test="${isSchedule}">
                ...
                <ul class="competitionRules">
                    <li class="${scheduleClass}">
                        <tco11:overviewStaticPageLink page="schedule">Event Schedule</tco11:overviewStaticPageLink>
                    </li>
                    <li class="${leaderboardClass}">
                        <tco11:overviewStaticPageLink page="travelInfo">Travel Info</tco11:overviewStaticPageLink>
                    </li>
                    <li>
            ...
            <c:when test="${isSponsors}">
                ...
                <ul class="competitionRules">
                    <li class="${sponsor1Class}">
                        <tco11:overviewStaticPageLink page="sponsor1">Yandex</tco11:overviewStaticPageLink>
                    </li>
                    <li class="${sponsor2Class}">
                        <tco11:overviewStaticPageLink page="sponsor2">Facebook</tco11:overviewStaticPageLink>
                    </li>
                    <li class="${sponsor3Class}">
                        <tco11:overviewStaticPageLink page="sponsor3">PayPal X Developer Network</tco11:overviewStaticPageLink>
                    </li>
                </ul>
            </c:when>
            <c:otherwise>
