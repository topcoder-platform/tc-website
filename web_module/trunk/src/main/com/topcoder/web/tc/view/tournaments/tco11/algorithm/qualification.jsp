...
<tco11:pageSetup title="TCO 11 : Algoritm Competition Qualification" area="algorithm" menu="advancers"
                        ...
                        <form name="mainForm" action='${sessionInfo.servletPath}' method="get" id="advancersForm">
                            ...
                            <table cellpadding="0" cellspacing="0" class="leaderboard"
                                ...
                                <tr>
                                    ...
                                    <th class="rating">
                                        <tco11:sortColumnLink text="Round" columnIndex="${roundNameColumnIndex}"/>
                                    </th>
                                    <th class="rating">
                                        <tco11:sortColumnLink text="Rating" columnIndex="${ratingColumnIndex}"/>
                                    </th>
                                    <th class="last"><span class="right"></span>
                                        <tco11:sortColumnLink text="Points" columnIndex="${pointsColumnIndex}"/>
                                    </th>
                                </tr>
