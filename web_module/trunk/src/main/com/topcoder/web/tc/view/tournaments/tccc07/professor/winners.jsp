    ...
    <div id="containAll">
        <div id="content">
            ...
            <div id="pageBody">
                ...
                <p style="float:right; padding:10px; width:175px; height: 219px;"><img alt="Professor Vitaly Bondarenko" src="/i/tournament/tccc07/vvb.png" /></p>
                ...
                <p style="float:right; padding:10px; width:175px; height: 231px;"><img alt="Professor Yue Chen" src="/i/tournament/tccc07/chenyue.png" /></p>
