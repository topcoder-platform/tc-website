            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="statText" valign="top" width="100%"><img src="/i/clear.gif" alt="" width="240" height="1" border="0"><br>
                        ...
                        <p>Please read the <A href="/tc?module=Static&d1=about_tc&d2=terms" class="statTextBig">Terms of Use</A> and <A href="/?&t=about_tc&c=privacy"class="statTextBig">Privacy Policy</A>, and let me be the first to say good luck in the arena.</p>
...
<!-- Upload Member Photo -->
                ...
                <tr valign="middle">
                    ...
                    <td class="statText" width="99%">Let other TopCoder Members know what you look like. Send us a head shot that is at least 200 pixels (3 inches) across.
                        <a href="JavaScript:void window.open('/tc?module=Static&d1=member_photos&d2=index','Photo_Info','top=2,left=2,width=600,height=700,status=0');" class="statTextBig">Click here</a>
