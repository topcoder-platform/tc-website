...
<span class="bigTitle">TCO Preview: By the Numbers</span>
<br /><br />
...
<p>The Development finalists are "younger," with average TopCoder membership a little under 3 years, with Marathon and Algorithm averages hovering around or just over the 3 year mark. The Studio squad is the youngest, with the only two members of less than six months (mahestro and Tricia_Tjia) and a membership time of less than 18 months. </p>

<p>What do they do in all that time? They compete - a lot, and not just in their own category. Fifty-one of the 78 on-site attendees have competed in at least two of the four TopCoder-specific competition tracks (Algorith, Design, Development, and Marathon Match), 20 have tried three of the four, and a handful -- AleaActaEst, marian, Gluk, and enefem21 -- have tried their hand at all four of them. AleaActaEst also heads up the top 10 list for the most overall TopCoder competitions, with a whopping 549:</p>

<table cellspacing="0" cellpadding="0" class="stat" style="width: 100%">
<thead>
    <tr class="sidebarTitle" nowrap="nowrap">
<td class="header">Handle</td><td class="header">Country</td><td class="header">Member Since</td><td class="header">Total Competitions</td>
    </tr>
</thead>
<tbody>
...
<p>But it's not just time, and it's not just practice - it's about talent, too. As evidenced by the average rating, this year's crop of on-site contestants looks like a strong one. The Algorithm contingent's average rating of 2637 (based on the TCO07 program, anyway) compares favorably to the TCO06 average of 2607 and the TCCC06 average of 2562.</p>

<p>The average Marathon Match rating, for finalists in the track, is 2092, which seems pretty impressive for the very first on-site match. (The marathoners are no slouches in the Algorithm arena, either, with the average Algo rating for Marathon Match finalists around 1959.) As for the component numbers, the average rating for Design finalists is 1703, with the Developer average at 1414. </p>

<p>We could slice and dice the numbers into stranger and stranger categories (for example, which competition category wears the largest average shirt size*), but we're probably reaching a point of diminishing returns, and these numbers have less and less to do with the ultimate question here -- who will walk away the big check in Vegas next week.</p>

<p>For more on that story, watch the continuing TCO coverage next week from petr and jmzero. Good luck to all!</p>

<p>*Design wears the largest - with assigned values of 1 to 5 for the size range from Small to XX-Large, the Design finalists average out to a shirt size of 2.875. Mathematically speaking, that'd round up to a Large with a little extra room in the sleeves.</p>
<br>
