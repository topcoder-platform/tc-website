                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td class="devProjectText" colspan="2">
                                    <A href="/index/?t=development&c=tcs_inquire-design&comp=<rsc:item row="<%=resultRow%>" name="component_id"/>&phase=<rsc:item row="<%=resultRow%>" name="phase_id"/>&docId=<rsc:item row="<%=resultRow%>" name="document_id"/>&version=<rsc:item row="<%=resultRow%>" name="version"/>&payment=<rsc:item row="<%=resultRow%>" name="price"/>&compvers=<rsc:item row="<%=resultRow%>" name="comp_vers_id"/>&date=<rsc:item row="<%=resultRow%>" name="initial_submission" format="MM%2edd%2eyyyy"/>&final_submission=<rsc:item row="<%=resultRow%>" name="final_submission" format="MM%2edd%2eyyyy"/>&winner_announced=<rsc:item row="<%=resultRow%>" name="winner_announced" format="MM%2edd%2eyyyy"/>&posting_date=<rsc:item row="<%=resultRow%>" name="posting_date" format="MM%2edd%2eyyyy"/>&estimated_dev=<rsc:item row="<%=resultRow%>" name="estimated_dev" format="MM%2edd%2eyyyy"/>"/>
