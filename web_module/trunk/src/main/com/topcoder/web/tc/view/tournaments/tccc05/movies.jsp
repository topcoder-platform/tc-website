	...
	<tr valign=top>
		...
		<table cellspacing=0 cellpadding=5 class=bodyText width="100%">
         ...
         <tr>
				...
				<td class=bodyText align=center valign=top><A href="/i/tournament/tccc05/onsite_movies/algFinals.mov"><img src="/i/tournament/tccc05/onsite_movies/algFinals.jpg" border=0/></A>
				<br/><A href="/i/tournament/tccc05/onsite_movies/algFinals.mov">Algorithm Finals and<br>winners (3.7 MB)</A><br/></td>
            </tr>
         <tr>
