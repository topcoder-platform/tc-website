...
Completing all three tasks in about 48 minutes, <tc-webtag:handle coderId="21468741" context="hs_algorithm"/> secured the win by a
margin of more than 100 points.  At the end of the challenge phase, six coders had solved the hard problem but, by the end
of system testing, <tc-webtag:handle coderId="22378820" context="hs_algorithm"/> was the only other to pass
system tests on all three problems, earning himself a second place finish.<br /><br /> 

In all, with 100 slots for advancement, and only 35 competitors, earning a positive score was all that was required
to stay in the tournament.  Thirty-three of the 35 were able to do so.<br /><br />
