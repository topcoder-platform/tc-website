...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <tr valign="top">
  ...
  <td class="statTableSpacer" width="100%" valign="top"><div class="bodyText">
    <jsp:include page="../../page_title.jsp" >
    <jsp:param name="image" value="high_school"/>
    <jsp:param name="title" value="Match Editorials"/>
    </jsp:include>
    <div class="linkBox"> <A href="tc?module=Static&d1=hs&d2=match_editorials&d3=archive">Archive</A><br>
     ...
     </span> <A href="/tc?module=HSRoundOverview&rd=10718&snid=1&er=5">Match Overview</A><br>
     <tc-webtag:forumLink forumID="514493" message="Discuss this match" />
    </div>
    <span class="bodySubtitle">TCHS07 Round 2 Gamma</span><br>
    Thursday, March 8, 2007 <br>
    <br>
    <h2>Match summary</h2>
    Completing all three tasks in about 48 minutes,
    <tc-webtag:handle coderId="21468741" context="hs_algorithm"/>
    secured the win by a
    margin of more than 100 points.  At the end of the challenge phase, six coders had solved the hard problem but, by the end
    of system testing,
    <tc-webtag:handle coderId="22378820" context="hs_algorithm"/>
    was the only other to pass
    system tests on all three problems, earning himself a second place finish.<br />
    <br />
    In all, with 100 slots for advancement, and only 35 competitors, earning a positive score was all that was required
    to stay in the tournament.  Thirty-three of the 35 were able to do so.<br />
    <br />
    <H1> The Problems </H1>
    <font size="+2"> <b><a href="/stat?c=problem_statement&amp;pm=7570&amp;rd=10718" name="7570">ItemizedList</a></b> </font> <A href="Javascript:openProblemRating(7570)"><img src="/i/rate_it.gif" hspace="10" border="0" alt="rate it" /></A> <A HREF="http://forums.topcoder.com/?module=ThreadList&forumID=514494" CLASS="statText"><img src="/i/interface/btn_discuss_it.gif" alt="discuss it" border="0" /></A> <br>
    ...
    <blockquote>
     <table cellspacing="2">
      ...
      <tr>
       ...
       <td class="bodyText" style="background: #eee;"> 34 / 35 (97.14%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Success Rate</b> </td>
       <td class="bodyText" style="background: #eee;"> 32 / 34 (94.12%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>High Score</b> </td>
       <td class="bodyText" style="background: #eee;"><b>Curiouser</b> for 248.19 points (2 mins 25 secs) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Average Score</b> </td>
       <td class="bodyText" style="background: #eee;"> 217.63 (for 32 correct submissions) </td>
      </tr>
     </table>
    </blockquote>
    Most coders using C++ used the STL map&lt;string, int&gt; here, iterated through the array, and then
    iterated through the completed map to generate the required output.  This was easy enough.<br />
    <br />
...
public String[] generateList (String[] items) {
    ...
    <font size="+2"> <b><a href="/stat?c=problem_statement&amp;pm=7565&amp;rd=10718" name="7565">FractionPoints</a></b> </font> <A href="Javascript:openProblemRating(7565)"><img src="/i/rate_it.gif" hspace="10" border="0" alt="rate it" /></A> <A HREF="http://forums.topcoder.com/?module=ThreadList&forumID=514494" CLASS="statText"><img src="/i/interface/btn_discuss_it.gif" alt="discuss it" border="0" /></A> <br>
    ...
    <blockquote>
     <table cellspacing="2">
      ...
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Submission Rate</b> </td>
       <td class="bodyText" style="background: #eee;"> 25 / 35 (71.43%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Success Rate</b> </td>
       <td class="bodyText" style="background: #eee;"> 13 / 25 (52.00%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>High Score</b> </td>
       <td class="bodyText" style="background: #eee;"><b>Burunduk3</b> for 458.12 points (8 mins 45 secs) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Average Score</b> </td>
       <td class="bodyText" style="background: #eee;"> 298.77 (for 13 correct submissions) </td>
      </tr>
     </table>
    </blockquote>
    ...
    the lower and upper halves of a data set (again, paying attention to parity).<br />
    <br />
    ...
    the lower half.  If 2a > b, then we need the (a-b/2)/(b/2) point from the upper half of the data.<br />
    <br />
...
public double findPoint(int[] data, int numerator, int denominator) {
    ...
    <font size="+2"> <b><a href="/stat?c=problem_statement&amp;pm=7563&amp;rd=10718" name="7563">YahtzeeAdversary</a></b> </font> <A href="Javascript:openProblemRating(7563)"><img src="/i/rate_it.gif" hspace="10" border="0" alt="rate it" /></A> <A HREF="http://forums.topcoder.com/?module=ThreadList&forumID=514494" CLASS="statText"><img src="/i/interface/btn_discuss_it.gif" alt="discuss it" border="0" /></A> <br>
    ...
    <blockquote>
     <table cellspacing="2">
      ...
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Submission Rate</b> </td>
       <td class="bodyText" style="background: #eee;"> 6 / 35 (17.14%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Success Rate</b> </td>
       <td class="bodyText" style="background: #eee;"> 2 / 6 (33.33%) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>High Score</b> </td>
       <td class="bodyText" style="background: #eee;"><b>Burunduk3</b> for 535.21 points (33 mins 20 secs) </td>
      </tr>
      <tr>
       <td class="bodyText" style="background: #eee;"><b>Average Score</b> </td>
       <td class="bodyText" style="background: #eee;"> 523.51 (for 2 correct submissions) </td>
      </tr>
     </table>
    </blockquote>
    ...
    existing dice showed no scoring formation, from having a trivial solution of not re-rolling anything.</em>)<br />
    <br />
    ...
    it's obvious that 7776 * 26 = 202,176... and more importantly, that brute forcing this easily runs in time.<br />
    <br />
...
public int[] reRollDice(int[] scores, int[] dice) {
    ...
    <div class="authorPhoto"> <img src="/i/m/timmac_big.jpg" alt="Author" /> </div>
