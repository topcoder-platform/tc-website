...
<br /><br />
Each contest posted in <a href="/tc?module=ViewActiveContests&amp;ph=113">Software Development</a>, <a href="/tc?module=ViewAssemblyActiveContests">Software Assembly</a> and <a href="/tc?module=ActiveContests&amp;pt=13">Application Testing</a> will carry a point value. <a href="/tc?module=Static&amp;d1=digital_run&amp;d2=2008v2&amp;d3=devOverview">Placement Points</a> will be awarded based on the number of submissions that pass review. By registering for any <a href="/tc?module=ViewActiveContests&amp;ph=113">Software Development</a>, <a href="/tc?module=ViewAssemblyActiveContests">Software Assembly</a> or <a href="/tc?module=ActiveContests&amp;pt=13">Application Testing</a> competition, a competitor agrees to the items outlined on each project's Project Overview page, including the Eligibility requirements and the Terms of Work, and the completion of all paperwork required by TopCoder. 
<br /><br />
