            ...
            <tr>
                ...
                <td id="bodySpacer" width="100%">
                    <div id="pageBody">
                        ...
                        <p>4:08 - the easy problem is finding the inverse of a power series, which is achieved by appl<tc-webtag:handle coderId="10157606" context="algorithm"/> simple formulas, and the only difficulty is that the answer is expected to be presented precisely with fractions. <tc-webtag:handle coderId="7446789" context="algorithm"/> has already submitted it.</p>
                        ...
                        <p>5:44 - 	 in the finals, in that order.</p>
