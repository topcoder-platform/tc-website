...
<span class="bigTitle">PMC Offline</span>
<br><br>
<div class="sectionHeader">Overview</div>
<span class="bodySubtitle">Application Overview</span><br>
The PMC Offline is part of the Product Management Console, a Server Client Application that allows users to import, change and export products to an eCommerce Application from various existing corporate Divisions and Brands.
<br><br>
The PMC Offline application allows the user to download product data from the database and work with this data without being connected to it.
<br><br>
...
<ul>
<li>Offline Data<br>
Allows user to download data to work offline without connection to the DB and upload the changed data as soon the connection to the DB  is established</li>
<li>Samples<br>
Order Sample, View Samples, Create Barcode, Scan Samples, Process and Print and Track Samples</li>
<li>Copy Text<br>
Create, edit, proof and Review Product Descriptions</li>
</ul>
...
<br><br>
<%--
To sign up, please send an email to <A href="mailto:AssemblyCompetitions@topcoder.com?subject=Register: PMC Offline">AssemblyCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
