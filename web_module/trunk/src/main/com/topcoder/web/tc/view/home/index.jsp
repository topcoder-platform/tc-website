		...
		<table width="100%" border=0 cellpadding=0 cellspacing=0>
			<tr>
                <td class=homeTopBar align=left>
                    ...
                    <tc:format object="<%=sessionInfo.getDate()%>" format="MMMM d, yyyy"/><a href="Javascript:w=window.open('/contest/time.html','Time','top=2,left=2,width=250,height=50,status=1')" class="statText">&#160;<strong>[Get Time]</strong></a>
                </td>
