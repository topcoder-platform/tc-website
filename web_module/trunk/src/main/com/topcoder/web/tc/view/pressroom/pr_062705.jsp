...
<br><br>
"Sun is excited that this year's TopCoder Open Component Competition will introduce a Java-centric theme," said Dan Roberts, Group Manager Development Tools Marketing at Sun Microsystems. "Developers in the Design and Development challenges will compete to build reusable JSF components that simplify user interface builds for Java Web applications. The highest-rated submissions from six separate component competitions will ultimately find their way into the JSF catalogs and libraries of Java users everywhere." 
<br><br>
Component Design and Development registration began June 13th and closes June 29th, with online rounds running weekly through August 18th and a final online round starting on August 24th. The top 8 competitors from each of these categories will advance to the Onsite Finals in Santa Clara, CA on October 12th. Online registration for the Algorithm competition will run August 1 - 16, with qualification rounds beginning August 16th and continuing on a weekly basis through September 7th. The top 48 competitors will advance to the Onsite Finals.  Contestants can compete in the Algorithm or Component competitions, or both. Cash prizes for the 2005 TopCoder Open will comprise $75,000 for the Algorithm challenge and $75,000 for the Component tournament ($46,500 Design, $28,500 Development) for an overall prize purse worth $150,000. 
<br><br>
