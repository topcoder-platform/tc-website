...
document.write( 'value="/flash/ratingHistory.swf?competitionType=dev&coderID=<%=request.getParameter("cr")%>" ');
document.write( '<param name="menu" value="true" /> ');
document.write( '<param name="quality" value="high" /> ');
document.write( '<param name="bgcolor" value="#EEEEEE" /> ');
document.write( '<embed ');
document.write( 'src="/flash/ratingHistory.swf?competitionType=dev&coderID=<%=request.getParameter("cr")%>" ');
