...
To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Time Tracker Performance and GUI Tests">TestingSubmissions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
