...
<div class="leftColContent">
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22425394" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="22498968" context="<%=HandleTag.DESIGN%>" darkBG="true" /><br />
         with 9 submissions and 9 wins<br />
         <br />
      </td>
   </tr>
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="15992135" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" /><br />
         with 7 submissions and 7 wins<br />
      </td>
   </tr>
   </table>
<!--

<div><a class="cotmFeature" href="http://www.topcoder.com/news/2010/01/12/meet-the-december-coders-and-designers-of-the-month/">Read Their Interviews</a></div>-->
