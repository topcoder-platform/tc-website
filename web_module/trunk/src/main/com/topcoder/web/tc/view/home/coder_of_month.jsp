...
<div class="leftColContent">
   ...
   <tr>
      <td height="76" valign="top" style="border-top: 1px solid #CCCCCC; padding: 5px 0;" ><img src="/i/m/Gammy.jpeg" alt="" width="61" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22836702" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td style="border-top: 1px solid #CCCCCC; padding: 5px 0;" valign="top"><img src="/i/m/gevak_big2.jpg" alt="" width="61" height="61"/></td>
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="23137080" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" /><br />
         4 wins<br />
		 <br />
      </td>
   </tr>
