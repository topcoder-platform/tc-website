...
<div class="leftColContent">
   ...
   <tr>
      <td height="76" valign="top" style="border-top: 1px solid #CCCCCC; padding: 5px 0;" ><img src="/i/m/fushar_big2.jpg" alt="" width="55" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="22767798" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td style="border-top: 1px solid #CCCCCC; padding: 5px 0;" valign="top"><img src="/i/m/gevak_big2.jpg" alt="" width="55" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="7340263" context="<%=HandleTag.DESIGN%>" darkBG="true" /><br />
        	8 wins, 4 second places<br />
         <br />
      </td>
   </tr>
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="22839410" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" /><br />
         8 wins, 1 second place<br />
      </td>
   </tr>
   </table>


<!--<div><a class="cotmFeature" href="http://www.topcoder.com/news/2010/09/15/congratulations-to-the-august-coders-and-designers-of-the-month/">Read Their Interviews</a></div>-->
