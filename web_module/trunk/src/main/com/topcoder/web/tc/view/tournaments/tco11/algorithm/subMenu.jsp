...
<div class="subMenu">
    <ul class="secondaryNav overviewNav"><!-- orange secondary navigation -->
        <li class="${descriptionClass}"><!-- first item -->
            <tco11:algorithmStaticPageLink page="description">
        ...
        <li class="${scheduleClass}"><!--  item -->
            <tco11:algorithmStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="schedule">
                <span class="left"></span>
        ...
        <li class="${rulesClass}"><!-- second item -->
            <tco11:algorithmStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="rules">
                <span class="left"></span>
        ...
        <li class="${advancersClass}"><!-- third item-->
            <tco11:algorithmStaticPageLink page="qualification">
                <span class="left"></span>
        ...
        <li class="${finalResultsClass}"><!-- four item -->
            <tco11:algorithmStaticPageLink styleClass="tertiaryNavBT SponsorsBT" page="finalResults">
                <span class="left"></span>
            ...
            <c:when test="${isAdvancers}">
                ...
                <ul class="advancers">
                    <li class="${qualificationClass}">
                        <tco11:algorithmStaticPageLink page="qualification">Qualification</tco11:algorithmStaticPageLink>
                    </li>
                    <li class="${leaderboardClass}">
                        <tco11:algorithmStaticPageLink page="leaderboard">Leaderboard</tco11:algorithmStaticPageLink>
                    </li>
                    <li class="${bracketClass}">
                        <tco11:algorithmStaticPageLink page="bracket">Bracket</tco11:algorithmStaticPageLink>
                    </li>
                </ul>
            </c:when>
            <c:otherwise>
