...
<tco11:pageSetup title="TCO 11 : Marathon Competition" area="marathon" menu="description"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Welcome to the Marathon Competition!</h2><!-- page title -->
                            ...
                            <p>When is the competition? See the <tco11:marathonStaticPageLink page="schedule">schedule.</tco11:marathonStaticPageLink><br />
                                It is important for you to read the <tco11:overviewStaticPageLink page="rules">official rules and regulations</tco11:overviewStaticPageLink> for important details. Also, you must read through the specific rules for the <tco11:marathonStaticPageLink page="rules">Marathon Competition.</tco11:marathonStaticPageLink><br />
