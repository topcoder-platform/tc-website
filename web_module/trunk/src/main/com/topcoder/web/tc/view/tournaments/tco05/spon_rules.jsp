...
<br><br>
The Qualification Round will consist of only two phases: the Coding Phase and System Testing Phase.  Note: The Qualification Round will not include a Challenge Phase.
<ul>
...
<br><br>
<b>NOTE:  In the event of a tie for any advancing position during the Qualification Round, the tie will be resolved in the following manner:</b>
<ul>
