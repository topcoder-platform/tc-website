...
<br /><br />
Each contest posted in <a href="/tc?module=ViewActiveContests&amp;ph=112">Component Design</a>, <a href="/tc?module=ActiveContests&amp;pt=7">Architecture</a>, <a href="/tc?module=ActiveContests&amp;pt=23">Conceptualization</a>, <a href="/tc?module=ActiveContests&amp;pt=6">Specification</a>, and <a href="/tc?module=ActiveContests&amp;pt=26">Test Scenarios</a> will carry a point value. Placement points will be awarded based on the number of submissions that pass review, as follows:
<br /><br />
