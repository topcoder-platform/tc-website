...
<tco11:pageSetup title="TCO 11 : Design Competition Leaderboard" area="design" menu="leaderboard"/>
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <h2 class="pageTitle">
                            ...
                            <a href="${sessionInfo.servletPath}?module=ContestProjects&amp;eid=3433&amp;ct=479">View Components</a>
                        </h2>
                                ...
                                <c:forEach items="${results}" var="result">
                                    <tr>
                                        ...
                                        <td class="first last alignText">
                                            <tc-webtag:handle context='design' coderId='${result.userID}' darkBG='true' />
                                        ...
                                        <td class="first last alignText">
                                            <a href="${sessionInfo.servletPath}?module=MemberResults&amp;eid=3433&amp;ct=479&amp;cr=${result.userID}">results</a>
                                        </td>
                                        <td class="last">&nbsp;</td>
                                    </tr>
                                </c:forEach>
