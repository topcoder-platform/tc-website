...
<table class="stat" cellpadding="0" cellspacing="0" width="270" style="float: left; margin-right: 15px; margin-bottom: 15px;">
    <tr><td class="title" colspan="3">Best Average Component Challenge Score</td></tr>
...
<span class="bodyText">
<strong>Record:</strong> Best average score per challenge. Only challenges where the competitor was rated are included.
