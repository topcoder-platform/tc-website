...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
            <table border="0" cellspacing="0" cellpadding="5" width="100%" bgcolor="#555555">
                <tr valign="top">
                    <td class="smallFoot">Here is a view of the Top-10 Division II scorers from &#160;</td>
                 </tr>
            </table>
            <table border="0" cellspacing="0" cellpadding="3" width="100%" bgcolor="#333333">
                ...
                <tr valign="top">
                    <td colspan="4" align="right" class="statText" height="18">
                        <A href="stat?&amp;c=round_stats" class="statText"><img src="/i/mystats_icon.gif" alt="" width="10" height="10" border="0" hspace="3" />All last match results</A>&#160;
                    </td>
                </tr>
            </table>