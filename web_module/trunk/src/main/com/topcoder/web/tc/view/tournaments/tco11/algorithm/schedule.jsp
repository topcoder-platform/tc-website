...
<tco11:pageSetup title="TCO 11 : Algorithm Competition Schedule" area="algorithm" menu="schedule"/>
                     ...
                     <h2 class="pageTitle">Algorithm Competition Schedule</h2><!-- page title -->
                        ...
                        <table cellpadding="0" cellspacing="0"><!-- start table list -->
                            ...
                            <tr class="last">
                              ...
                              <br />
                              <strong><em>Please note that in order to register for this qualification round you will need to have <a href="http://www.topcoder.com/tco11?module=ViewUnifiedRegistration" target="_blank">registered for the TCO</a> at least 24 hours prior to the start of this round.</em></strong></td>
                                <td colspan="2">600</td>
							</tr>
                        </table>
                        <table cellpadding="0" cellspacing="0"><!-- start table list -->
