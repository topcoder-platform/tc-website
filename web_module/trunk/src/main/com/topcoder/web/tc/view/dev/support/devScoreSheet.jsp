...
<br/><p class=guideSubTitle>1. Component Development (20%)</p>

<br/><p class=guideQuestion>
1.1. The implementation addresses the functionality as detailed in the component design documents. 
</p>
<p class=guideDesc>
The reviewer should check whether and how well all the functionality outlined in the design is implemented. Each method should be implemented based on the provided documentation. The functionality of the component as a whole should be implemented as it was described in the documentation. Where applicable, list the missing elements below. (50%) 
</p>
...
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> The implementation is a quality one, follows the design documentation, and may even have some improvements.</td></tr>
</table>
...
<br/><p class=guideQuestion>
1.3. The submission properly implements required algorithms as defined in section 1.3 of the Component Specification. 
</p>
<p class=guideDesc>
...
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> Some algorithms are not implemented as the design specifies, and this slightly affects the performance of the component or the elegance of the implementation.</td></tr>
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> The algorithms are implemented properly.</td></tr>
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> All algorithms are implemented properly and efficiently and the developer brings improvements beyond the design. Direct translations of the pseudocode from the spec (or even copy/paste) should not be awarded with this score.</td></tr>
</table>
...
<table class=guideTable cellspacing=0>
The reviewer should verify the conformity of the implementation to the design. No changes and no missing entities are permitted (unless previously approved by the designer in the forums). (40%) 
...
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> The added entities seem fine. If they have naming problems or use incorrect English, then this score should be given. However, if the problems are more than just a few typos, then lower scores can be considered.</td></tr>
...
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> Some relationships are not implemented but they do not affect the component (for example a dependency to a class is not used, and an alternae route is used for getting some information) or some relationships are added without being necessary that do not break any design pattern and do not tighten the coupling between the classes unnecessarily.</td></tr>
...
<p class=guideDesc>
The reviewer should look for pieces of code that are not needed. Such code includes emulating standard Java functionality (such as array copying), code that can be easily simplified, unused variables, assignments to variables that are not used afterwards. (10%) 
</p>
<table class=guideTable cellspacing=0>
...
<p class=guideDesc>
The reviewer should score here how well the developer managed to avoid code redundancy. There should be no duplicated pieces of code. The developer should factor out code into helper classes or private methods and implement overloads if possible. This factorisation should not go to the opposite extreme either. The end result should not be a class with many small helper methods that do very little. Every method used to factor code should have well defined functionality and should fit naturally in the design. (20%) 
</p>
<table class=guideTable cellspacing=0>
<tr><td class=guideHead><b>Score 1</b> -</td><td class=guideCell> The code is consistently duplicated. Large pieces of common code are copied in different places and there seems to be no effort to avoid such situations.</td></tr>
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> Some duplication exists but there are signs that the developer paid some attention to redundancy.</td></tr>
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> No code redundancy exists.</td></tr>
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> No code redundancy exists and the developer uses elegant techniques to avoid it.</td></tr>
</table>
...
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> The code clarity and efficiency could benefit from some improvements but it is obvious that the developer was concerned with these aspects. The same score should be given if the balance between clarity and efficiency is not right.</td></tr>
...
<p class=guideDesc>
The reviewer should check whether the exceptions provide useful error messages.The spelling of the messages should be checked, too. (10%) 
</p>
<table class=guideTable cellspacing=0>
<tr><td class=guideHead><b>Score 1</b> -</td><td class=guideCell> No messages at all or the messages are so poorly written that they aren't very useful.</td></tr>
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> Consistent errors in messages are present but the messages are still comprehendable.</td></tr>
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> Some minor typos or some isolated situations in which the messages are missing.</td></tr>
...
<br/><p class=guideSubTitle>4. Documentation (15%)</p>

<br/><p class=guideQuestion>
4.1. The implementation code contains detailed documentation for classes, written in Javadoc / XML style as required by the Java / C# coding standards. (25%) 
</p>
<p class=guideDesc>
...
<br/><p class=guideQuestion>
4.2. The implementation code contains detailed documentation for methods, written in Javadoc / XML style as required by the Java / C# coding standards. (25%) 
</p>
<p class=guideDesc>
...
<table class=guideTable cellspacing=0>
<tr><td class=guideHead><b>Score 1</b> -</td><td class=guideCell> Documentation is consistently missing or consistently unhelpful. A majority of the methods either lack documentation or do not provide required details.</td></tr>
...
<br/><p class=guideQuestion>
4.3. The implementation code contains detailed documentation for variables, written in Javadoc / XML style as required by the Java / C# coding standards. (10%) 
</p>
<p class=guideDesc>
...
<br/><p class=guideQuestion>
4.4. The implementation code contains detailed documentation. (20%) 
</p>
<p class=guideDesc>
...
<table class=guideTable cellspacing=0>
<tr><td class=guideHead><b>Score 1</b> -</td><td class=guideCell> Documentation is consistently missing or consistently not helpful.</td></tr>
...
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> Documentation is complete and adequate to understand the implementation, but there may be several places where it can further be enhanced with useful details, or simplified by removing useless comments.</td></tr>
...
<br/><p class=guideQuestion>
4.5. There are no errors and no warnings while generating the Javadoc / XML documentation. (10%)
</p>
<p class=guideDesc>
...
<br/><p class=guideQuestion>
4.6. The component documentation contains no grammatical or spelling errors. (10%) 
</p>
<table class=guideTable cellspacing=0>
...
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> The developer was concise and made no grammatical or spelling errors.</td></tr>
</table>

<a name="unitTestCases"></a>
<br/><p class=guideSubTitle>5. Unit Test Cases (15%)</p>

<br/><p class=guideQuestion>
5.1. Unit Test Cases test all methods and constructors.  (25%) 
</p>
<p class=guideDesc>
...
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> The submission does not contain test methods for trivial functionality of the component, such as set / get methods or exception constructors. However, this does not appear to be a pattern throughout the unit testing.</td></tr>
...
<br/><p class=guideQuestion>
5.2. Unit Test cases contain an implementation or a demonstration of how the component will be used. (10%) 
</p>
<p class=guideDesc>
...
<br/><br/>
The reviewer should look at this section from the point of view of a client and identify if the provided demonstration suits the needs of such a client, by helping the client understand how the component is used.  (40%) 
</p>
<table class=guideTable cellspacing=0>
<tr><td class=guideHead><b>Score 1</b> -</td><td class=guideCell> No demonstration of the component usage is provided, or the one provided is not helpful or does not refer to important basic functionality of the component. Basic functionality is that functionality that is essential to the component.</td></tr>
...
<br/><p class=guideQuestion>
5.3. Unit Test Cases thoroughly and correctly test all methods and constructors.  (25%) 
</p>
<p class=guideDesc>
...
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> The submission is properly tested using different types of tests that address different aspects of each tested method or constructor. For example, if an algorithm has time constraints it should be tested not only for accuracy but also to see if it respects the constraints.  When testing for accuracy, an algorithm should be presented with different sets of data. </td></tr>
</table>

<br/><p class=guideQuestion>
5.4. Where applicable, Unit Test Cases properly configure the test environment. (10%) 
</p>
<p class=guideDesc>
...
<br/><p class=guideQuestion>
5.5. Where applicable, files used in Unit Test Cases exist in the /test_files directory. (5%)
</p>
<p class=guideDesc>
...
<tr><td class=guideHead><b>Score 2</b> -</td><td class=guideCell> Not applicable </td></tr>
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> Not applicable </td></tr>
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> Yes - Temporary files are removed from the file system after testing is complete and temporary files are created only when needed. </td></tr>
</table>

<br/><p class=guideQuestion>
5.7. The unit test code contains detailed documentation for classes, methods and variables as defined in the Deliverables Document. (20%) 
</p>
<p class=guideDesc>
...
<br/><br/><p class=guideSubTitle>6. Review Board Test Cases (10%)</p>
<p class=guideDesc>
...
<a name="overall"></a>
<br/><p class=guideSubTitle>7. Overall Comments (15%)</p>
<p class=guideDesc>
...
<tr><td class=guideHead><b>Score 3</b> -</td><td class=guideCell> The submission meets all requirements but it doesn't excel in any way.  The fixes that need to be done should not be significant. The submission should be of average quality.</td></tr>
<tr><td class=guideHead><b>Score 4</b> -</td><td class=guideCell> The submission excels in many areas. All requirements are met and some are exceeded. In order to complete the component, only minor items need to be fixed. This submission is clearly above average.</td></tr>
</table>
