...
<tco11:pageSetup title="TCO 11 : Studio Competition" area="studio" menu="description"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Welcome to the Studio Design Competition!</h2><!-- page title -->
                            ...
                            <p>When is the competition? <tco11:studioStaticPageLink page="schedule">See the schedule.</tco11:studioStaticPageLink><br />
                                It is important for you to read the <tco11:overviewStaticPageLink page="rules">official rules and regulations</tco11:overviewStaticPageLink> for important details. Also, you must read through the specific rules for the <tco11:studioStaticPageLink page="rules">Studio Competition.</tco11:studioStaticPageLink><br />
