...
<p id="secondaryNav">
    ...
    |
    <a href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=onsiteSchedule"<% if (tabLev2.equals("joinus")) {%> class="on"<% } %>>Join
        us onsite</a>
    <%--
...
<p id="tertiaryNav">
    <a href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=onsiteSchedule"<% if (tabLev3.equals("onsiteschedule")) {%> class="on"<% } %>>Onsite
        schedule</a>
    <%--
    | <a href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=devForums"<% if (tabLev3.equals("devforums")) {%> class="on"<% } %>>Developer forums</a>
    --%>
    |
    <a href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=getVisa"<% if (tabLev3.equals("getvisa")) {%> class="on"<% } %>>Getting
        a visa</a>
    |
    ...
    |
    <a href="/tc?module=Static&d1=tournaments&d2=tccc07&d3=whatToDo"<% if (tabLev3.equals("whattodo")) {%> class="on"<% } %>>What
        to do</a>
</p>
