...
<%--------------------------------------------------------%>
   <tr>
      ...
      <td valign="top"><span class="newsTitle">
        <A href="https://<%=ApplicationServer.STUDIO_SERVER_NAME%>/?module=ViewContestDetails&ct=2080">Now open at Studio: TCO07 Program Design Contest</A>
        </span><br><br>
        For this project, we're asking you to design the 2007 TopCoder Open program, including the front and back covers and templates for the bracket pages and competitor profiles.
        </td>
      </tr></table>
      </td>
   </tr>
   <tr><td class="newsLinksCell">
        <A href="https://<%=ApplicationServer.STUDIO_SERVER_NAME%>/?module=ViewContestDetails&ct=2080">details</A>
...
<%--------------------------------------------------------%>
   <tr>
      ...
      <table cellspacing="0" cellpadding="0" class="newsPhotoTable"><tr>
      <td valign="top"><span class="newsTitle">
        <A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=algorithm&d4=schedule">TCO07 Algorithm Round 1B set for April 10</A>
        </span><br><br>
        Online Round 1B of the TCO07 Algorithm Competition, brought to you by NSA, is set for 9:00 PM EDT on April 10.
        </td>
      </tr></table>
      </td>
   </tr>
...
<%--------------------------------------------------------%>
   <tr>
      ...
      <table cellspacing="0" cellpadding="0" class="newsPhotoTable"><tr>
      <td valign="top"><span class="newsTitle">
        <A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=algorithm&d4=schedule">TCO07 Algorithm Round 1A set for April 7</A>
        </span><br><br>
        Online Round 1A of the TCO07 Algorithm Competition, brought to you by UBS, is set for 1:00 PM EDT on April 7.
        </td>
      </tr></table>
      </td>
   </tr>
