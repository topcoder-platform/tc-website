...
<%--------------------------------------------------------%>
   <tr>
      ...
      <table cellspacing="0" cellpadding="0" class="newsPhotoTable"><tr>
      <td valign="top"><span class="newsTitle">
        <A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=algorithm&d4=algoFinals">Congratulations to Jan_Kuipers, the TCO07 Algorithm Champion</A>
        </span><br><br>
        <tc-webtag:handle coderId="309453" context="algorithm"/> is the Algorithm Champion of the 2007 TopCoder Open.
        </td>
      </tr></table>
      </td>
   </tr>
...
<%--------------------------------------------------------%>
   <tr>
      ...
      <table cellspacing="0" cellpadding="0" class="newsPhotoTable"><tr>
      <td valign="top"><span class="newsTitle">
        <A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=studio&d4=summary">Congratulations to yiming, the TCO07 Studio Design Champion</A>
        </span><br><br>
        <tc-webtag:handle coderId="10481546"/> is the winner of the inaugural TopCoder Open Studio Design Competition.
        </td>
      </tr></table>
      </td>
   </tr>
