...
<%-- Center Column Begins --%>
    ...
    <%if(rsr.getIntItem("round_id") == 13772 || round_id == 14525 || round_id == 14584 || round_id == 15024 || round_id == 15023 || round_id == 15034) {%>
		<div class="sectionHeader">Prizes</div>
	...
	<p>
     ...
     <p align="justify">
		...
		<% if (Arrays.binarySearch(assignRounds, round_id)>=0 || round_id==14481 || round_id==14525 || round_id == 14584 || round_id == 15024 || round_id == 15023 || round_id == 15034) { %>
	...
	<% if (Arrays.binarySearch(assignRounds, round_id)>=0 || round_id==14525 || round_id == 14584 || round_id == 15024 || round_id == 15023 || round_id == 15034) { %>
