...
<%-- Center Column Begins --%>
        ...
        <p><span class="bodySubtitle">When to start the Competition Round</span><br />
        	TopCoder members must register for the competition round. Registration may occur at any time from. 08.13.2009 01:00 PM EDT to 08.27.2009 01:00 PM EDT All competitors who have registered for the competition round will immediately be given access to the competition problem statement for that round. The competition round will begin at 08.13.2009 01:00 PM EDT which is the earliest time that any member will be given access to the problem statement.        
