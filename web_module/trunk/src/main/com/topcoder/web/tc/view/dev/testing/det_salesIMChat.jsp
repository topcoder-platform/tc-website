...
<p><span class="bigTitle">Sales IM Chat</span></p>
...
<p>The application is broken into a number of logical sections. This testing competition will only verify the flows after opening the chat.</p>
...
[Member Handle]_salesim_chat_[root directory name].zip</p>
...
<tr><td valign="top">General Actions</td>
      <td valign="top">2.4, 2.7, 2.12, 2.15, 2.16</td>
      <td valign="top">46-52, 66-78, 88-91, 106-109, 110-120</td>
      <td valign="top">Common chatting functionality. This includes the interactions in the chat room screen, managing buddies / blocked users.</td>
</tr>
</table>
</div>
...
<p><strong>Testing Interactions</strong><br>
Interactions between multiple users are involved when two or more users participate in a chat. The test cases will verify the AJAX response. Group chat session can be used for testing.</p>
 
<p>On the user side, four scenarios should be tested:</p>
<ol>
	<li>1st user enters some text.</li>
	<li>2nd user enters some text.</li>
	<li>2nd user leaves the chat room (i.e. close session).</li>
	<li>3rd user joins the chat room.</li>
</ol>
...
<p>To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Sales IM Chat">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit: Sales IM Chat">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
