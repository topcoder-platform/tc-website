...
<!-- ends -->
      ...
      The event is from SRM START TIME -30 MINS until SRM START TIME +120 MINS in the NAME OF BUILDING/LAB. This event is being run in conjunction with <A href="/?RoundId=8078&t=schedule&c=srm">SRM #281</A>. In addition to registering with TopCoder, all competitors must register <A href="/tc?module=Static&d1=collegetour&d2=register">here</a> and be onsite for the competition. After the event ends, pizza will be served and a TopCoder representative will be present to discuss TopCoder competitions and employment services. 
