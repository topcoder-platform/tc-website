...
<div>
<table cellpadding="0" cellspacing="0" class="rightNav" style="width: 100%;" onmouseover="goTall('t10Des');">
    <tr>
...
<tbody>
    ...
    <%=(i==2 ? "</tbody><tbody class='hide' id='t10Des'>" : "")%>
    <%i++;%>
    </rsc:iterator>
    <%=(i<3 ? "</tbody><tbody class='hide' id='t10Des'>" : "")%>
    <tr>
