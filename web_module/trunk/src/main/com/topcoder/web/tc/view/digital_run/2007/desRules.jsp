...
<jsp:param name="title" value="2007 Design Cup Series"/>
</jsp:include>
...
<br><br>
Each component posted for a design competition will carry a point value of 500 placement points. <A href="/tc?module=Static&d1=digital_run&d2=2007&d3=desOverview">Placement Points</A> will be awarded based on the number of submissions that pass review. By registering for any design competition, a competitor agrees to the items outlined on each component's Project Overview page, including the Eligibility requirements and the Terms of Work, and completion of all paperwork required by TopCoder.
<br><br>
