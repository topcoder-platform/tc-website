...
<tco11:pageSetup title="TCO 11 : Mod Dash Competition" area="moddash" menu="description"/>
    ...
    <div id="content">
        <div class="contentInner">
			...
			<h2 class="pageTitle">Welcome to the Mod Dash&trade; Competition!</h2><!-- page title -->
				...
				<p>The submissions will be reviewed and tested by the TopCoder project team that posted the Mod Dash and/or member reviewers.&nbsp;Submissions will be reviewed in the order they are received.&nbsp;The first submission that successfully solves the issue and includes all updates to documentation and test cases will be declared the winner and awarded the stated prize amount as well as points toward the TCO. The top ten (10) point earners during the competition timeframe will earn a spot in the finals to compete in Las Vegas, Nevada October  11-14, 2010.</p>
                            ...
                            <p>When is the competition? <tco11:moddashStaticPageLink page="schedule">See the schedule.</tco11:moddashStaticPageLink><br />
                                It is important for you to read the <tco11:overviewStaticPageLink page="rules">official rules and regulations</tco11:overviewStaticPageLink> for important details. Also, you must read through the specific rules for the <tco11:moddashStaticPageLink page="rules">Mod Dash Competition.</tco11:moddashStaticPageLink><br />
