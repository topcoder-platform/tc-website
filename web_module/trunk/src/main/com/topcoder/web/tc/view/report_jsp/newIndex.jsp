...
<html>
  ...
  <body>
      ...
      <UL>
        ...
        <LI><A HREF="<%=Constants.SERVLET_ADDR+"?"+Constants.TASK_NAME_KEY+"="+Constants.NEW_REPORT_KEY+"&"+DataAccessConstants.COMMAND+"=tc04_reg&"+Constants.DB_KEY+"=OLTP"%>">TCO 04 Reg Info</A></LI>
