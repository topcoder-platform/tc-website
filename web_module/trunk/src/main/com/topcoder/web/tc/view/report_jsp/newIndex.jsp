...
--%>
        ...
        <LI>Submission rate per inquiry: Members who signed up in last - <A HREF="<%=baseURL+"submission_rate&days=90"%>">3 months?</a> <a href="<%=baseURL+"submission_rate&days=180"%>">6 months?</a> <a href="<%=baseURL+"submission_rate&days=3600"%>">all?</a> </LI>
        <LI>Average cost of component by phase - projects completed in last - <A HREF="<%=baseURL+"cost_by_phase&days=90"%>">3 months?</a> <a href="<%=baseURL+"cost_by_phase&days=180"%>">6 months?</a> <a href="<%=baseURL+"cost_by_phase&days=3600"%>">all?</A></LI>
        <LI>Average cost of component by phase and catalog - projects completed in last - <A HREF="<%=baseURL+"cost_by_catalog&days=90"%>">3 months?</a> <a href="<%=baseURL+"cost_by_catalog&days=180"%>">6 months?</a> <a href="<%=baseURL+"cost_by_catalog&days=3600"%>">all?</A></LI>
...
--%>
      ...
      <UL>
        ...
        <LI><A HREF="<%=Constants.SERVLET_ADDR+"&"+Constants.TASK_NAME_KEY+"="+Constants.NEW_REPORT_KEY+"&"+DataAccessConstants.COMMAND+"=google_reg&"+Constants.DB_KEY+"=java:GOOGLE_INDIA_OLTP"%>">Google India Registration</A></LI>
          ...
          <LI><A HREF="<%=Constants.SERVLET_ADDR+"&"+Constants.TASK_NAME_KEY+"="+Constants.NEW_REPORT_KEY+"&"+DataAccessConstants.COMMAND+"=google_reg&"+Constants.DB_KEY+"=java:GOOGLE_EUROPE_OLTP"%>">Google Europe Registration</A></LI>
      </UL>
      <br/>
