...
<tco11:pageSetup title="TCO 11 : Tournament Overview" area="overview" menu="happenings"/>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <jsp:include page="../includes/htmlhead.jsp"/>
    <script type="text/javascript" src="/js/tournament/tco11/overview.js"></script>
    <style type="text/css">
        ...
        <div class="contentInner">
            ...
            <div id="welcome">
                ...
                <div class="crossButton"><!-- right side button -->
                    <div class="comics"><a href="http://topcoder.com/home/tco11/comics/"></a></div>
                    <div class="blog"><a href="http://topcoder.com/home/tco11/"></a></div>
                    <div class="programe"><a href="http://topcoder.com/i/tournament/tco11/TCO11-Program.pdf"></a></div>
                    <div class="tweet"><a href="http://topcoder.com/home/tco11/twitter/"></a></div>
                    <div class="movie"><a href="http://topcoder.com/home/tco11/movies/"></a></div>
                    <div class="photo"><a href="http://topcoder.com/home/tco11/photos/"></a></div>
                </div>
                <!--End .crossButton-->
                ...
                <div class="welcomeText"><!-- left side text -->
                    ...
                    <div style="float: left;margin-right:10px;"><img src="/i/tournament/tco11/result/overview.jpg"
                                                                     alt=""/></div>
