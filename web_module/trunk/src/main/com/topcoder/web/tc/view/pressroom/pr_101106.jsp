...
<br><br>
"One of TopCoder's core goals is to bring value to the programming community, and with the help of AOL we'll now be able to present much of the excitement and thrill of the onsite challenge live, via the internet," said Rob Hughes, President and COO of TopCoder, Inc. "We'll have some special surprises in store, including celebrity commentators and powerful production technologies using multiple cameras, screens and data feeds that will allow a menu of end-user choices and create a custom feel for viewers." 
<br><br>
