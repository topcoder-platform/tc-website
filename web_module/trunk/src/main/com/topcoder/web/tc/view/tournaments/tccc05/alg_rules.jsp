    ...
    <!-- overview -->
			...
			<table width="500" align="center" border="0" cellpadding="5" cellspacing="2" class="sidebarBox">
				...
				<tr>
                    ...
                    <td width="50%" class="sidebarText">Wednesday, January 19th<br/>Register:  6:30 - 9:25 PM<br/>START: 9:30 PM</td>
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">Online Round #3</td>
                    <td width="50%" class="sidebarText">Wednesday, January 26th<br/>Register:  6:30 - 9:25 PM<br/>START: 9:30 PM</td>
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">Online Round #4</td>
                    <td width="50%" class="sidebarText">Wednesday, February 2nd<br/>Register:  6:30 - 9:25 PM<br/>START: 9:30 PM</td>
				</tr>
				<tr>
			...
			<ul>
			<li>Total points acquired (higher is better) during Online Rounds #1, #2, #3 and #4 of the 2005 TopCoder Collegiate Challenge</li>
			<li>If a tie still remains, then by rating (higher is better) following the Qualification Round.</li>
			...
			<table width="500" align="center" border="0" cellpadding="5" cellspacing="2" class="sidebarBox">
				...
				<tr>
                    <td width="50%" class="sidebarText"><b>1st place finisher* - Algorithm Competition Champion</b>
                    <td width="50%" class="sidebarText"><b>$20,000</b>
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">2nd place finisher* in the Championship Round
                    <td width="50%" class="sidebarText">$10,000
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">3rd place finisher* in the Championship Round
                    <td width="50%" class="sidebarText">$5,000
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">4th place finisher* in the Championship Round
                    <td width="50%" class="sidebarText">$2,500
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">5th - 24th place finishers* in the Semifinal Rounds
                    <td width="50%" class="sidebarText">$400 each
				</tr>
				<tr>
                    <td width="50%" class="sidebarText">Up to 50 Competitors who compete in Online Round #4
				...
				<tr>
                    <td width="50%" class="sidebarText">Up to 500 competitors who compete in Online Round #1
                    <td width="50%" class="sidebarText">Limited edition 2005 TopCoder Collegiate Challenge t-shirt
				</tr>
				<tr>
					<td width="50%" class="sidebarText" colspan=2>* Prize will be awarded at the conclusion of the Championship Round.  Winner must be present at the onsite rounds to receive prize.
				</tr>
			</table>
			...
			<li>Affidavit of Eligibility and Liability and Publicity Release (must be notarized unless a notarized affidavit is already on file with TopCoder)
