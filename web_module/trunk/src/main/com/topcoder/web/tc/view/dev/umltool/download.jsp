...
<%-- Center Column Begins --%>
        <td width="100%" align="center" class="bodyColumn">
            <div class="fixedWidthBody">
                ...
                <li><a href="/download/development/umltool/UML_Tool_Frontend_Installer-1.0.2.jar">Download</a> and execute installer jar. The OS may support doing this in the GUI, or you can use the command line: java -jar UML_Tool_Frontend_Installer-1.0.2.jar</li>
                ...
                <div align="center">
                    <a href="/download/development/umltool/UML_Tool_Frontend_Installer-1.0.2.jar" class="bigButton" style="width: 140px; margin: 40px;">Download Now</a>
                </div>
