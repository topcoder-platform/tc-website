...
<%-- Center Column Begins --%>
        <td width="100%" align="center" class="bodyColumn">
          ...
          <ul>
            ...
            <li>Must be no older than 20 years of age on March 15, 2009; AND</li>
