...
Fig 2.6 Homepage of MailReader Demo Application</div>
...
Fig 3.1 Create a Test Element</div>
...
Fig 3.2 Select New HTTP Test</div>
...
Fig 3.7 Custom code stub class</div>
...
tes.getTestLogManager().reportMessage("Can't get hostname");
    ...
    tes.getTestLogManager().reportMessage("JVM maximum heap size for host " + hostName + " is " + maxMB + " MB");
return null;
}
</pre>
</li>
...
Fig 3.9 Logged message for JVM heap</div>
</li>
</ul>
...
Then we need to add a reference to the argument indicating username (args[0] in the code), the argument will come from the editing page:<br>
	...
	Fig 3.13 Add argument reference</div>
	</li>
	...
	Fig 3.14 Select argument reference</div>
	</li>
	</ul>
</li>	
