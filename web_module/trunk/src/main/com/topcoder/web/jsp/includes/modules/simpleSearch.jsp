...
<table width="180" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td id="leftNavTitle">
                        ...
                        <form name="simpleSearchForm" method="get" action="http://<%=ApplicationServer.SERVER_NAME%>/tc">
                        <table border="0" cellspacing="3" cellpadding="0">
                            ...
                            <tr>
                                <td class="statTextBig" colspan="2" nowrap>&#160;<A href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=ViewAdvanced"><strong>Advanced Search</strong></A></td>
                            </tr>
                        </table>
                        </form>
                    </td>
