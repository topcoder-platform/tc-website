...
/*
      nav.search("m_my_tc").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/PactsMemberServlet?module=AssignmentDocumentHistory", "Assignment Documents", "ip_transfers"));
*/
