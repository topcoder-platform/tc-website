...
<TD WIDTH="128" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000"><A HREF="http://www.topcodersoftware.com" onMouseOver="changeImages('image4', 'image4on')" onMouseOut="changeImages('image4', 'image4off')" TARGET="_parent"><IMG NAME="image4" SRC="/i/menu_tcs_off.gif" ALT="TCS" WIDTH="128" HEIGHT="21" BORDER="0"/></A></TD>
