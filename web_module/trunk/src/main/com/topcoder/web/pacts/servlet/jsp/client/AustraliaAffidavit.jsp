...
<xsl:template match="/">
   ...
   <ol>
     ...
     <li>Further, I represent that the following information contained in TopCoder's member database represents my personal demographic information, and that su ch information is true and accurate:</li>
   </ol>
    </td></tr>
    <tr><td class="statText" valign="top" colspan="3">
