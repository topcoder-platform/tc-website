                ...
                <tr valign="top">
                    <td width="50%" class="bodyText">
                       ...
                       <h1 class="bodyTitle"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=tces&d2=index">Recruiting</a></h1>
                        TopCoder Recruiting provides you with innovative programs designed to <a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=tces&d2=index"><strong>attract, identify, and evaluate</strong></a> 
                    ...
                    <td width="50%" class="bodyText">
                       ...
                       As a TopCoder sponsor <a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=spon_prog&d2=index"><strong>you can market</strong></a> 
