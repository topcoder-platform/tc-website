            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr valign="top">
                    <td class="bodyText" width="100%" colspan="3">
                        <h1 class="testHead">Reporting</h1>
                    </td>
                <tr>
                
                <tr valign="top">
                    <td class="bodyText" width="99%">
                        <p>Clients are provided access to a reporting application that gives detailed statistical information on the candidates' performance 
                        in the testing environment.  The detail includes language chosen, attempted problem status, system test results, time to submit, 
                        problem statements, and submitted code.  The following are sample comparative statistics clients are given on candidates.</p>
                    </td>
