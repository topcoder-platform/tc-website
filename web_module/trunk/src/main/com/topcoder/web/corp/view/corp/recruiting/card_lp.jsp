...
document.write(' <param name="movie" value="/i/card/tc_card.swf?memberID=<%=request.getAttribute("cr")%>"');
document.write(' <param name="menu" value="false" />');
document.write(' <param name="quality" value="high" />');
document.write(' <param name="bgcolor" value="#ffffff" />');
document.write(' <embed ');
document.write(' src="/i/card/tc_card.swf?memberID=<%=request.getAttribute("cr")%>" ');
