            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top">
                    <td class="bodyText" width="99%">
                        ...
                        <h2 class="corpHead">SRM - Applet Coverage</h2>
                        ...
                        <ul>
                            ...
                            <nobr><a href="?module=Static&d1=corp&d2=spon_prog&d3=srm_applet_l">View large sample</a></nobr></li>
                            <li><strong>Coding</strong> - where competitors view problems, submit solutions, and challenge code 
                            <nobr><a href="?module=Static&d1=corp&d2=spon_prog&d3=srm_applet_c">View large sample</a></nobr></li>
                            <li><strong>Status</strong> - informs both spectators and coders of who's doing what 
                            <nobr><a href="?module=Static&d1=corp&d2=spon_prog&d3=srm_applet_s">View large sample</a></nobr></li>
                            <li><strong>Leader Board</strong> - Dynamic listing of room leaders and current points 
                            <nobr><a href="?module=Static&d1=corp&d2=spon_prog&d3=srm_applet_lb">View large sample</a></nobr></li>
                        </ul>
