...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
		...
		<div id="content">
			<p>By using this Web site you are indicating your agreement to these Terms and Conditions of Use (&quot;Terms of Use&quot;). If you do not agree to these Terms of Use, please do not use the Web site and exit now. </p>
			...
			<p>According to Section 2 of the Decision, &quot;to protect national security and social stability, the person or organization perpetrating any of the following ads in violation of the criminal law shall be penalized according to the criminal code:</p>
			<ol>
			...
			<p>Section 3 of the Decision also stipulates that &quot;to safeguard the order of the socialist market economy and social stability, the person or organization perpetrating any of the following acts in violation of the criminal law shall be penalized according to the criminal code:</p>
			<ol>
			...
			<p>We reserve the right to remove any postings or other uploaded materials in response to complaints of infringement, obscenity or defamation or to otherwise review or edit such materials as appropriate, in our sole discretion and without notice. </p>
			<h4>Other Restrictions on Conduct</h4>
			<p>You are allowed to register with our Web site only once and you must provide true and accurate registration information. You are prohibited from misrepresenting your registration information or tampering with the registration process. </p>
			<p>You agree not to disrupt, modify or interfere with the functioning of our Web site or any services provided on or through our Web site or with any associated software, hardware or servers in any way and you agree not to impede or interfere with others' use of our Web site. This includes your agreement that you will not cheat; that the idea for the code and/or challenge(s) submitted by you is yours alone. You also agree not to alter or tamper with any information or materials on, or associated with our Web site or services provided on or through our Web site. </p>
			...
			<p>You agree that no impediment exists to you joining the TopCoder Web site, and your participation in TopCoder's Web site and the Competitions it offers will not interfere with your performance of any other agreement or obligation which has been or will be made with any third party. </p>
			<h4>Choice of Law and Forum</h4>
			<p>These Terms of Use are governed by the laws of the Commonwealth of Massachusetts. You hereby agree to submit to the exclusive jurisdiction of the courts of the Commonwealth of Massachusetts. To the extent that applicable laws have mandatory application to this agreement or give you the right to bring action in any other courts, the above limitations may not apply to you. Use of this Web site is unauthorized in any jurisdiction that does not give full effect to all provisions of these Terms of Use. </p>
			<h4>Severability and Enforceability</h4>
			...
			<div class="center">
				<a class="redBtn" id="close-button" onclick="self.close();">
					<span class="buttonMask"><span class="text">Close Window</span></span>
				</a>
			</div>
		</div>
		<div class="clear"></div>
