    ...
    <TR>
      <TD WIDTH="170" VALIGN="top">
        <jsp:include page="left.jsp">
          <jsp:param name="<%=Constants.DB_PARAM%>" value="<jsp:getProperty name="ModifyCommandQueryTask" property="Db"/>"/>
          <jsp:param name="<%=Constants.SERVLET_PATH_PARAM%>" value="<jsp:getProperty name="ModifyCommandQueryTask" property="ServletPath"/>"/>
        </jsp:include>
      </TD>
