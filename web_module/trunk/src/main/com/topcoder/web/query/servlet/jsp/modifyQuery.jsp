      ...
      <TD WIDTH="170" bgcolor="#000000" VALIGN="top">
        <TABLE WIDTH="170" BORDER="0" CELLPADDING="0" CELLSPACING="0">
          <jsp:include page="left.jsp">
            <jsp:param name="<%=Constants.DB_PARAM%>" value="<jsp:getProperty name="ModifyQueryTask" property="Db"/>"/>
            <jsp:param name="<%=Constants.SERVLET_PATH_PARAM%>" value="<jsp:getProperty name="ModifyQueryTask" property="ServletPath"/>"/>
          </jsp:include>
        </TABLE>
      </TD>
