                    ...
                    <rsc:iterator list="<%=contests%>" id="resultRow">
                        ...
                        <tr class="<%=even?"light":"dark"%>">
                            ...
                            <td class="value">
                                ...
                                <a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=Static&amp;d1=tournaments&amp;d2=tco08&amp;d3=studio&amp;d4=description">-icon-<img src="/i/tournament/tco08/emblem.png" alt="" onmouseover="popUp(this,'popTCO08')" onmouseout="popHide()" style="display: block; margin: 4px;"></a>
                                <% } else { %>
                                &nbsp;
                                <% } %>
                            </td>
