                        ...
                        <div id="mycarousel" class="jcarousel-skin-tango">
                            ...
                            <div id="homePageBanner">
                                <a href="http://community.topcoder.com/tco12/">
                                    <img src="/i/tournament/tco12/2012-tco-banner-studio-clear-FINAL.jpg" alt="TCO 2012"/></a>
                                <br/>
                                <br/>
                            </div>
                        </div>
                            ...
                            <div id="bottom_part_r">
                                <div class="box_content_container">
                                    ...
                                    <div class="member_image" style="float:left;">
                                        <img width="126" height="140" alt="Member of the Month" src="http://www.topcoder.com/i/m/thinkcreeper.jpeg">
                                    </div>
                                    <div id="member_content">
                                        ...
                                        <div id="member_greeting">
                                            <span class="member_content special handle">Congratulations <span class="handle-color">thinkcreeper</span></span><br/><br/>
                                        </div>
                                        <div id="member_stats">
                                            <span class="member_content special">won $3000 in 7 contests</span><br/><br/>
