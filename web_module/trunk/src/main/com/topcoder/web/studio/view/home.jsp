      ...
      <td valign="top" style="padding-left: 10px;">
         ...
         <tbody>
            ...
            <tr class="<%=even?"light":"dark"%>">
               ...
               <td class="valueR">
                <div class="container">
                    <a href="/pdfs/downloads/TopCoder_Generic_Application_Icons.pdf"><img src="/i/layout/disk.gif" alt="Download submission" border="0" onmouseover="popUp('pop<%=i%>')" onmouseout="popHide()" /></a>
