...
<div id="menubar">
    <div id="nav">
        <ul>
            ...
            <li<% if (node.equals("support")) {%> class="active"<% } %>><a href="/?module=Static&amp;d1=support&amp;d2=getStarted" title="Support" onfocus="this.blur();">How It Works</a></li>
            <li<% if (node.equals("digitalrun")) {%> class="active"<% } %>><a href="/?module=Static&amp;d1=digitalrun&amp;d2=2008v2&amp;d3=home" title="Studio Cup" onfocus="this.blur();">Studio Cup</a></li>
            <li<% if (node.equals("myStudio")) {%> class="active"<% } %>><a href="/?module=MyStudioHome" title="My Studio" onfocus="this.blur();">My Studio</a></li>
            <li<% if (node.equals("blog")) {%> class="active"<% } %>><a href="http://tcstudioblogs.com/" title="Blog" onfocus="this.blur();">Blog</a></li>
            <li<% if (node.equals("portfolio")) {%> class="active"<% } %>><a href="/?module=Static&amp;d1=portfolio&amp;d2=portfolio" title="Portfolio" onfocus="this.blur();">Portfolio</a></li>
