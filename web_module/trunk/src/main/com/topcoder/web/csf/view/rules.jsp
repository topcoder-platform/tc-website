...
<li>Entry and all supporting materials must be acceptable for all audiences and must not be or include any material or content that, in the Contest judges sole opinion is, vulgar, offensive, or inappropriate for public viewing or presents TopCoder, Microsoft and/or the Sponsor in a negative light.</li>
</ul>

<p>
Entries that, in TopCoder, Microsoft, applicable Sponsor  and/or the Contest judges sole opinion, are found to be duplicates, the result of collaborative work, infringe upon the rights of any third party, violate applicable laws or are otherwise not in compliance with these Terms & Conditions, applicable Contest Details, and the spirit of this Contest Series, will be disqualified.  By registering for this Contest Series and/or submitting an entry, Participants agree that the decisions of TopCoder, Microsoft, applicable Sponsors and the Contest judges are final and binding in all matters related to this Contest Series and each individual Contest.
</p>
...
<p>
By participating in this Contest Series, you acknowledge and agree that it is possible that others, including Microsoft and the Sponsor, may independently develop applications that are similar in function, appearance, action, name, character, or in other ways appear to resemble the application submitted, and that such duplication or similarity between your application and any other's shall in no way entitle you to any compensation from TopCoder, Microsoft, the Sponsor, or any third party. Further, you agree that in no event shall you have the right to enjoin or prevent the production, distribution, exhibition, use, advertising or promotion of TopCoder's, Microsoft's or the Sponsors' technology or related applications or products.
</p>
...
<p>
If you are one of the winners (or, if you have not yet reached the age of legal majority in your country or state of residence, your parent or legal guardian):
</p>

<ul>
<li>you will notified by phone or by U.S. mail, overnight mail, or e-mail; and</li>
<li>you may be required to sign and return an Affidavit of Eligibility/Liability/Publicity release, unless prohibited by law, within ten (10) days of date of prize notification.  </li>
<li>If you are a minor in the country or state in which you reside we will award the prize to your parent or legal guardian, who must sign all documents required under the Official Rules. </li>
</ul>
