            ...
            <table border="0" cellpadding="0" cellspacing="10" width="75%">
                <tr>
                    <td class="bodyText">
                        ...
                        <p>The coding window is the most important part of the Testing Application.  It is in the coding window that the <a href="#problem">problem statement</a> is shown, 
                        ...
                        <p>Currently the Testing Application supports three programming languages - Java, C++, and C#.  Employers decide which options you 
