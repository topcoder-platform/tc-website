...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="testTop">
    <tr valign="middle">
        <td width="15" nowrap="nowrap" background="/i/ev/graybv_lite_bg.gif"><img src="/i/ev/clear.gif" width="15" height="20" border="0"/></td>
        ...
        <td width="100%" nowrap="nowrap" background="/i/ev/graybv_lite_bg.gif"><img src="/i/ev/clear.gif" width="15" height="20" border="0"/></td>  
   </tr>
</table>
<!-- Menu bar ends here -->
