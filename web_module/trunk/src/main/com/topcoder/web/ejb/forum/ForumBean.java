...
public class ForumBean extends BaseEJB {

    private static Logger log = Logger.getLogger(ForumBean.class);
    ...
    public void createMatchForum(int roundID) {
        ...
        try {
            ...
            com.jivesoftware.forum.Forum forum = forumFactory.createForum(roundName, "", forumFactory.getForumCategory(14));
