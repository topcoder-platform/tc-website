...
public class ResponseBean extends BaseEJB {
    ...
    public void createResponse(long userId, long questionId, long answerId) {
        ...
        try {
            ...
            DBMS.printSqlException(true, sqe);
            throw new EJBException("SQLException creating user_id="+userId+" questionId="+questionId+" answerId="+answerId);
        } catch (NamingException e) {
            throw new EJBException("NamingException creating user_id="+userId+" questionId="+questionId+" answerId="+answerId);
        } catch (Exception e) {
