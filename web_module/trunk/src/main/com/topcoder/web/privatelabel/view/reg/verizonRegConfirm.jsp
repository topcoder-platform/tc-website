...
<table border="0" cellspacing="0" cellpadding="0" class="black"  width="100%">
 ...
 <!-- Verizon logo-->
        <td width="147" valign="top"><a href="http://www22.verizon.com/"><A href="http://www.verizon.com"><img src="/i/events/verizon2003/logo_black_147x41.gif" width="147" height="37" alt="Verizon" border="0"></A></a></td>
...
<!-- Center Column -->
        ...
        <form action="<jsp:getProperty name="sessionInfo" property="ServletPath"/>" method="POST" name="regForm">
            ...
            <tr>
               ...
               <td align="right">
                  <p><br /></p>
                  <p><a href="javascript: document.regForm.submit();"><img src="/i/events/verizon2003/button_finish.gif" alt="finish" width="56" height="23" align="right" border="0"></a></p>
                  <p><br /></p>
                                </td>
                            </form></tr>
                        </table>
