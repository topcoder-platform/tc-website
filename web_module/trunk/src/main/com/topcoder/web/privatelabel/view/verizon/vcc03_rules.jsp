...
<!-- Center Column -->
        <td valign="top" width="579"><img src="/i/clear.gif" width="574" height="10" border="0"/><br />
            ...
            <h2 class="pgTitle">Competition Structure</h2>
...
<!-- Championship Round -->
            ...
            <h2 class="pgTitle">About the Prizes</h2>
            ...
            <h2 class="pgTitle">Eligibility</h2>
            ...
            <h2 class="pgTitle">Conditions of Participation</h2>
