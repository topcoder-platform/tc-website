...
<br><br>
You need at least <A href="http://java.sun.com/getjava/index.jsp " target="_blank">Java Runtime version 1.4</A> to run
the Arena. Click <A href="http://java.sun.com/getjava/index.jsp " target="_blank">here</A> if you do not have Java
Runtime 1.4 installed.
<br><br>
...
<tr>
    <td align="center" valign="bottom" colspan="2">
        Student: <input type="radio" name="<%=Constants.CODER_TYPE%>"
