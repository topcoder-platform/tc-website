...
<br><br>
Be sure to read the <A href="/pl/?&module=Static&d1=verisign06&d2=instructions">Instructions</A> page for a complete explanation.
<br><br>
<b>How will I know if I have advanced the next round of the VeriSign Coder Challenge?</b><br>
As soon as the Testing Phase has been completed, the advancers to the next round will be posted <A href="/pl/?&module=Static&d1=verisign06&d2=overview">here</A>.  In addition, an email will be sent to all participants indicating whether or not each has advanced.
<br><br>
Questions not addressed here should be directed to <A href="verisign06@topcoder.com?subject=Question regarding VeriSign Coder Challenge 2006">verisign06@topcoder.com</A>
<br><br>
Good luck!
         <br/><br/>
