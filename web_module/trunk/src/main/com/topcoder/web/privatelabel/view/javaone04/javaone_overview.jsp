		...
		<div align="center">
			<table border=0 cellspacing=0 width="800">
				...
				<!-- start breadcrumb -->
  				...
  				<!-- end breadcrumb -->
  					<p></p>
					<span class ="title">Code - Compete - Win!</span><br>
					...
					<p class ="title">Let the Coding Begin!<br/>
					<span class ="middle">A 30-minute challenge pits you against all other participants at the JavaOne conference.</span></p>
					
					<p class ="middle">In the on-site Competition Arena, participants will be presented with real-world programming problems and will be 
					...
					<p class ="middle">Each day, TopCoder will objectively score the competitors' submissions for accuracy and for how long they took to 
					...
					<p class ="title">Be Recognized</p>
					
					<p class ="middle">Have you ever wanted to show your colleagues how much better you are in your Java programming skills? This is the 
