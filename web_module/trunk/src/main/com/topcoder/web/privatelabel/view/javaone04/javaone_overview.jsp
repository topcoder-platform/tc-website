			...
			<table border=0 cellspacing=0 width="800">
				...
				<!-- start breadcrumb -->
  				...
  				<!-- end breadcrumb -->
					...
					<p class ="regmiddle">Sun Microsystems has again teamed up with TopCoder, Inc. to bring Attendees the JavaOne<sup><font size="1">SM</font></sup> Coding Challenge, 
					an event that gathers together developers who use Java<sup><font size="1">TM</font></sup> technology for coding, competition, and fun. By participating 
					in the JavaOne Coding Challenge, Attendees have a chance to apply what they learn during the Conference sessions 
					to real-world programming problems that have a Mobility, Enterprise Applications, or Web Services theme. If you are a 
					Java technology developer, you do not want to miss this event. The first 1,000 participants receive a JavaOne Coding 
					Challenge t-shirt and messenger bag.</p>
					
					<p class ="regmiddle"><strong><font size="4">Let the Coding Begin!</font></strong><br/></p>
					<p class ="regmiddle">A 30-minute challenge pits you against all other participants at the JavaOne Conference.</p>
