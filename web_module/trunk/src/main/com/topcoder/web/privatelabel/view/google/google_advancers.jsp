                  ...
                  <table border=0 cellspacing=0 width="100%"> 
                     <tr>
                      ...
                      <table class=googleFrame bgcolor="#ffffff" cellpadding=5 cellspacing=2 border=0 width="350">
                        <tr>
                           <td class="advancersTitle" align="left" colspan="4">Round ID</td>
                        </tr>
                        <tr>
                           <td class="google_round_id" align="left" width="20%">Seed</td>
                           <td class="google_round_id" align="left" width="40%">Handle</td>
                           <td class="google_round_id" align="left" width="20%">Rating</td>
