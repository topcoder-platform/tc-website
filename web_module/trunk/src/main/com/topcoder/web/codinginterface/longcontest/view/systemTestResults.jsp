...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr valign="top">
        ...
        <TD CLASS="statTableSpacer" WIDTH="100%" VALIGN="top">
            ...
            <span class="bigHandle">Contest: <A href="?module=ViewOverview&rd=<rsc:item name="round_id" row="<%=infoRow%>"/>" class="bcLink"><rsc:item name="contest_name" row="<%=testRow%>"/> - <rsc:item name="contest_name" row="<%=testRow%>"/></A></span><br>
