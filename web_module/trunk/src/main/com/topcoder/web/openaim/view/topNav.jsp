...
<div class="navBox">
    ...
    <a class="navTab" href="http://<%=ApplicationServer.OPENAIM_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=1002"><img src="/i/events/openaim/tabs/submit.png" alt="submit" onmouseover="this.src='/i/events/openaim/tabs/submitOn.png';"  onmouseout="this.src='/i/events/openaim/tabs/submit.png';" /></a>
    <a class="navTab" href="http://<%=ApplicationServer.OPENAIM_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=1002"><img src="/i/events/openaim/tabs/register.png" alt="Register" onmouseover="this.src='/i/events/openaim/tabs/registerOn.png';"  onmouseout="this.src='/i/events/openaim/tabs/register.png';" /></a>
