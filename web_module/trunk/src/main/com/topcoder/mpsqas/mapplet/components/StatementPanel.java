...
public class StatementPanel extends JPanel {
    ...
    public void setDifficultyLevel(int in) {
        ...
        if (index >= MessageTypes.DIFFICULTY_IDS.length) {  //in is not a recognized difficulty id
            index = -1;
        }
    ...
    public void setDivision(int in) {
        ...
        if (index >= MessageTypes.DIVISION_IDS.length) {  //in is not a recognized divisionid
            index = -1;
        }
