 ...
 * provided by the StatementWrapper.<p>
...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    /**
     * The CallableStatement being wrapped.
     */
    private CallableStatement callableStatement;

    /**
     * Constructs a new CallableStatementWrapper
     *
     * @param callableStatement the CallableStatement to wrap
     * @param connectionWrapper the ConnectionWrapper to which
     *        this CallableStatementWrapper belongs
     */
    CallableStatementWrapper(CallableStatement callableStatement, ConnectionWrapper connectionWrapper) {
        super(callableStatement, connectionWrapper);
        this.callableStatement = callableStatement;
    }

    //All methods below delegate to the wrapped CallableStatement
