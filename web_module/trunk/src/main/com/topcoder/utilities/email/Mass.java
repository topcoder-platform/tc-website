...
///////////////////
  ...
  //////////////////////////////////
    ...
    msg.append ( " -p from_personal_name\n" );
    msg.append ( "    Personal name for the from email address.  Default is 'TopCoder Competitions'.\n" );
    msg.append ( "\n" );
    ...
    try {
      ...
      while ( rs.next() ) {
        ...
        try {
          ...
          mail.setMailFromPersonal ( fromName );
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  public static String setText ( String fileName ) throws Exception {
  //////////////////////////////////////////////////////////////////////////////// 
