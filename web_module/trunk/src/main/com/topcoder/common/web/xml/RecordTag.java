...
public class RecordTag extends Tag
{
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  {
    ...
    try {
      ...
      Log.msg(VERBOSE,"ERROR RecordTag getXML");
    }
    return result;
  }
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  {
    ...
    try {
      ...
      Log.msg(VERBOSE,"ERROR RecordTag createXML(int offSet)");
      e.printStackTrace();
    }
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  {
    ...
    try {
      ...
      Log.msg(VERBOSE,"ERROR RecordTag createXML()");
      e.printStackTrace();
    }
    return retVal.toString();
  }
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  {
    ...
    try {
      ...
      Log.msg(VERBOSE,"ERROR RecordTag createOffset(int offSet)");
    }
    ...
    try {
      ...
      if (attrList!=null) {
        for (int i=0; i< attrList.size(); i++) {
          Base attrObj = (Base) attrList.get(i);
          try {
