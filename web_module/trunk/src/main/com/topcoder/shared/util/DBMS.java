...
public class DBMS {
    ...
    public final static String CORP_DATASOURCE_NAME = getProperty("CORP_DATASOURCE_NAME", "CORP_OLTP");
    public final static String CORP_JTS_DATASOURCE_NAME = getProperty("CORP_JTS_DATASOURCE_NAME", "JTS_CORP_OLTP");
