...
<!-- ABB begins -->
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr valign="top">
                    ...
                    <A href="<tc-webtag:linkTracking link="http://<%=ApplicationServer.SOFTWARE_SERVER_NAME%>/pdfs/tcs/casestudies/abb_casestudy.pdf" refer="customer_index"/>" target="_blank">case study</A>
                     </td>
                </tr>
            </table>
<!-- ABB ends -->
...
<!-- UBS begins -->
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr valign="top">
                    <td width="170"><img src="/images/clients/ubs_logo.png" alt="Verisign" border="0" /></td>
                    <td width="15"><img src="/images/clear.gif" alt="" width="15" height="10" border="0" /></td>
                    ...
                    <A href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=LinkTracking&link=http://www.ubs.com&refer=TCS%20Customer" target="_blank">homepage</A>
                     </td>
                </tr>
            </table>
<!-- UBS ends -->
