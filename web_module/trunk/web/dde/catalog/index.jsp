...
<!-- Middle Column begins -->
		...
		<table cellspacing=0 cellpadding=0 border=0 width=510 align=center>
			...
			<tr valign=top>
				<td class=catalogIndexCell><img src="/images/catalog/indexBtn.jpg" border=0/></td>
				<td class=catalogIndexCell><A href=""><b>Browse Components Index</b></A><br/>An alphabetical listing of our components, both Java and .Net.  Browse here if you know that exact component that you are looking for.</td>
			</tr>
		</table>
        </td>
<!-- Middle Column ends -->
