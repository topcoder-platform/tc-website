...
<%-- PLATFORM TOOLS --%>
	<div id="platform">
		...
		<div class="platform_row_dark">
			<div>
				<a href="http://<%=ApplicationServer.SERVER_NAME%>/catalog/index.jsp"><img src="/i/component_catalog.png" alt="Component Catalog" class="platform_img" /></a>
				<h3><a href="http://<%=ApplicationServer.SERVER_NAME%>/catalog/index.jsp"><img src="/i/component_catalog_text.png" alt="Component Catalog" width="204" height="29" /></a><span class="sub_header"> - <a href="http://<%=ApplicationServer.SERVER_NAME%>/catalog/index.jsp">VIEW AND DOWNLOAD COMPONENTS NOW!</a></span></h3>				
