...
<jsp:include page="../body_top.jsp">
    ...
    <jsp:param name="title" value="TopCoder Software Web Site Change Log"/>
</jsp:include>
...
<p>
    ...
    1.0.1 - 2006.07.26
    <ul>
        <li>Component version admin page was fixed to admit changes for public-non public forums.</li>
    </ul>    
</p>
