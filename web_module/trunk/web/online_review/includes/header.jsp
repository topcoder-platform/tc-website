    ...
    <tr valign="middle">
        ...
        <td class="login" nowrap="nowrap">
            ...
            <logic:notPresent name="user">
                ...
                <% } else { %>
                &#160;&#160;|&#160;&#160;<a href="http://<%=ApplicationServer.SERVER_NAME%>/reg/"
                class="loginLinks">Register</a>
                <% } %>
            </logic:notPresent>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000">
    <tr valign="middle">
        ...
        <td width="99%" align="right" valign="bottom">
            <img src="/images/clear.gif" alt="" width="541" height="22" border="0"></td>
        <td width="10"><img src="/images/clear.gif" width="10" height="75" alt="" border="0"></td>
    </tr>
    <tr><td height="4" class="headStripe" colspan="5"><img src="/images/clear.gif" alt="" height="4" alt="" border="0">
    </td></tr>
</table>
<!-- Header ends -->
