...
<h3>Registration for Coaches</h3>
...
<reg:listSelect name="school_id" class="dropdown" list="<%=coach.getSchoolList()%>" selected="<%=coach.getSchoolId().toString()%>"/>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG src="/i/hs/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="text" NAME="handle" VALUE="<jsp:getProperty name="coach" property="Handle"/>" SIZE="30" MAXLENGTH="15"></TD>
  </TR>
  <TR>
   <TD></TD>
   <TD><IMG src="/i/hs/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG src="/i/hs/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="password" NAME="password" VALUE="<jsp:getProperty name="coach" property="Password"/>" SIZE="30" MAXLENGTH="15"></TD>
  ...
  <TR ALIGN="right" VALIGN="middle">
   ...
   <TD><IMG src="/i/hs/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD>
   <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><INPUT TYPE="password" NAME="confirm_password" VALUE="<jsp:getProperty name="coach" property="ConfirmPassword"/>" SIZE="30" MAXLENGTH="15"></TD>
  </TR>
  <TR>
  ...
  <TR>
   <TD COLSPAN="4" CLASS="bodyText" ALIGN="center" VALIGN="middle">
    <TEXTAREA CLASS="bodyText" ROWS="10" COLS="80" READONLY>
     <jsp:getProperty name="coach" property="TermsOfUse"/>
    </TEXTAREA>
   </TD>
  </TR>
  <TR>
