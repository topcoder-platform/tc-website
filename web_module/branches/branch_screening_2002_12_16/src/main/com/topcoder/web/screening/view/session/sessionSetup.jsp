...
<screen:form name="sessionSetupForm" action="/SessionSetup" method="POST">
         <TABLE BORDER="0" CELLSPACING="1" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="50%">
           <TR>
              ...
              <select value ="testprofile">
              	<option value="1">Test Profile 1</option>
              	<option value="2">Test Profile 2</option>              	
              </select>
              </TD>
              <TD CLASS="bodyText" VALIGN="middle">
              &#160;<screen: HREF="/eval/sess_o_setup.jsp" CLASS="bodyText">Create a New Test Profile</A></TD>
           </TR>                              
           <TR>
