...
<screen:form name="sessionConfirmForm" action="<%=Constants.CONTROLLER_URL%>" method="POST">
         ...
         <TABLE BORDER="0" CELLSPACING="1" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="95%">
           ...
           <TR>
              ...
              <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><jsp:getProperty name="sessionInfo" property="beginDate" /></TD>
           </TR>
           <TR>
              ...
              <TD COLSPAN="2" CLASS="bodyText" ALIGN="left" VALIGN="middle"><jsp:getProperty name="sessionInfo" property="endDate" /></TD>
           </TR>           
           <TR>
              <TD></TD><TD><IMG SRC="/i/ev/clear.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD><TD colspan="2" class="errorText" align="left" valign="middle"></TD>
           </TR>
