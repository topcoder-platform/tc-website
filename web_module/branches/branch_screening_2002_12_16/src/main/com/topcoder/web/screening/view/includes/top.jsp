...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#000000">            
   <TR>
      <TD COLSPAN="3" WIDTH="100%" BGCOLOR="#333333" ALIGN="right" VALIGN="middle" HEIGHT="15"><% if(requestInfo.isLoggedIn()) { %><screen:servletLink processor="Logout" target="_top" styleClass="globalNavSmall">Logout</screen:servletLink><%} else {%><screen:servletLink processor="Login" target="_top" styleClass="globalNavSmall">Login</screen:servletLink><%}%> &nbsp;&nbsp;&nbsp;<screen:servletLink target="_top" styleClass="globalNavSmall">Main Page</screen:servletLink><img src="/i/ev/clear.gif" width="20" height="1" hspace="5" border="0"/></TD>        
   </TR>   
   <TR>
