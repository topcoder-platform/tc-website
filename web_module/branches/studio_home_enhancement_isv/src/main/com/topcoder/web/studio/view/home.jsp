                            ...
                            <div id="bottom_part_r">
                                <div class="box_content_container">
                                    <div id="member_of_the_month">
                                        Member of the Month<br/><br/>
                                    </div>
                                    <div class="member_image" style="float:left;">
                                        <img width="126" height="140" alt=""
                                             src="http://www.topcoder.com//i/m/oninkxronda_big2.jpg">
                                    </div>
                                    <div class="member_content">
                                        ...
                                        <div id="member_greeting">
                                            <span class="member_content special handle">Congratulations oninkxronda!</span><br/><br/>
                                        </div>
                                        <div id="member_stats">
                                            <span class="member_content special">Earned $1,100 in 4 competitions during
                                                the month of February</span><br/><br/>
                                        </div>
                                    </div>
                                    <!-- member_content -->
                                    <div class="clear"></div>
