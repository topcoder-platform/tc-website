...
<div class="leftColContent">
   ...
   <tr>
      ...
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;" width="100%">
         ...
         <tc-webtag:handle coderId="12005484" context="<%=HandleTag.ALGORITHM%>" darkBG="true" />:<br>
         <span class="small">
         SRM 326: 1601<br>
         SRM 327: 1691<br>
         SRM 328: 1872
   ...
   <tr>
      <td style="border-top: 1px solid #CCCCCC;" valign="top"><img src="/i/m/KKD_big.jpg" alt="" width="55" height="61"/></td>
      <td style="padding-left:5px; border-top: 1px solid #CCCCCC;">
         ...
         <tc-webtag:handle coderId="21101272" context="<%=HandleTag.DEVELOPMENT%>" darkBG="true" />:<br>
         <span class="small">4 first places.
         </span><br><br>
      </td>
   </tr>
   </table>
