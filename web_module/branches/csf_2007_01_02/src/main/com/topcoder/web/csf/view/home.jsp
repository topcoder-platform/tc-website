...
<p><strong><a href="">Assembly Competitions:</a></strong> The Assembly Competition is the second stage and requires that the winning Mashup Design from the first stage of the competition be built into a prototype that delivers a demonstrable service. The Connected Services Sandbox Competition Series are not intended to produce commercial, carrier-grade software, but a working prototype or proof-of-concept service which could then be scaled for commercial use.</p>
