...
<div id="content">
    ...
    <div id="primaryNav">
    <ul>
    <li style="border-top: 1px solid #CCCCCC;" class="on"><A href="">Primary Nav On</A></li>
    <li><A href="">Primary Nav</A></li>
    <li><A href="">Primary Nav</A></li>
    <li><A href="">Primary Nav</A></li>
    <li style="background-image: none; border-bottom: 1px solid #CCCCCC;"><A href="">Primary Nav</A></li>
    </ul>
