...
<ul>
<li>Fuel the creative development process  and encourage collaboration among the wide range of Connected Services Sandbox participants and freelance application developers.</li>
<li>Develop an experienced pool of resources able to meet the growing demand for new service development using the Connected Services Framework.</li>
<li>Excite customers by providing  resources that can reduce time from concept to market.</li>
<li>Deliver a broad range of new services that will help consumers to tie together office, home and mobile data to meet the growing demand for information regardless of location, device or platform.</li>
</ul>
...
<p><strong><%--<a href="/">--%>Assembly Competitions:<%--</a>--%></strong> The Assembly Competition is the second stage and requires that the winning Mashup Design from the first stage of the competition be built into a prototype that delivers a demonstrable service. The Connected Services Framework Mashup Service Design and Assembly Competitions are not intended to produce commercial, carrier-grade software, but a working prototype or proof-of-concept service which could then be scaled for commercial use.</p>
