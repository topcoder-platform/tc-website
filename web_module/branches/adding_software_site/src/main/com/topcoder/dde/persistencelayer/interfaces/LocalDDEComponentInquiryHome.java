...
public interface LocalDDEComponentInquiryHome extends EJBLocalHome {
     ...
     */ 
    LocalDDEComponentInquiry create(long componentId, long userId, long rating, String comments , boolean agreedToTerms, long phase, long tcUserId, long version) throws CreateException;
