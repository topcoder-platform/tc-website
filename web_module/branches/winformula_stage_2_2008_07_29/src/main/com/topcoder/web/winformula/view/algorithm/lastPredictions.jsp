...
<body>
    ...
    <%-- Wrapper --%>
        ...
        <div id="main-content">
        <%-- Main Content --%>
            <div class="sub-navigation"><a href="?module=ManageMyAlgorithms">Manage My Algorithms</a> | <a href="?module=Submit">Submit</a> | Current Algorithm's Predictions | <a href="?module=ViewQueue">Queue Status</a></div>
