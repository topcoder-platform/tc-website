...
<script language="javascript">
    ...
    function openWin(url, name) {
        ...
        <%-- Main Content --%>
        <div class="sub-navigation"><a href="?module=ManageMyAlgorithms">Manage My Algorithms</a> | Submit | <a href="?module=ViewLastPredictions">Current Algorithm's Predictions</a> | <a href="?module=ViewQueue">Queue Status</a></div>
        <h1>Submit</h1>
