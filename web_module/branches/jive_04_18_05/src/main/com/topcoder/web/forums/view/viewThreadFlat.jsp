...
<table cellpadding="0" cellspacing="0" class="rtTable">
   <tr>
      ...
      <a name=<jsp:getProperty name="message" property="ID"/>><tc-webtag:beanWrite name="message" property="modificationDate" format="MMM dd, yyyy 'at' h:mm a z"/> | <jsp:getProperty name="message" property="unfilteredSubject"/>
