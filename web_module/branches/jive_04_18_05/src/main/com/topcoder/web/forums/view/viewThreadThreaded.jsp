...
<table cellpadding="0" cellspacing="0" width=100%><tr>
	...
	<td width=99%><table cellpadding="0" cellspacing="0" class="rtTable">
		...
		<%  } %>
		<span class="bodyText"><tc-webtag:handle coderId="<%=message.getUser().getID()%>"/></span><br><A href="?module=History&<%=ForumConstants.USER_ID%>=<jsp:getProperty name="user" property="ID"/>"><%=forumFactory.getUserMessageCount(message.getUser())%> posts</A></div></td>
