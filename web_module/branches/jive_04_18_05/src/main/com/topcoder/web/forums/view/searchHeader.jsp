...
<%  HashMap errors = (HashMap)request.getAttribute(BaseProcessor.ERRORS_KEY);
    String queryTerms = com.topcoder.web.common.StringUtils.checkNull((String)request.getAttribute("queryTerms")); %>
...
<input name="<%=ForumConstants.SEARCH_QUERY%>" size="20" maxlength="100" value="<%=queryTerms%>" id="<%=ForumConstants.SEARCH_QUERY%>" type="text">
