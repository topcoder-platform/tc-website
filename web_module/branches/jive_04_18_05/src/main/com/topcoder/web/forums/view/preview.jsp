...
<table cellpadding="0" cellspacing="0" class="rtTable">
   ...
   <tr>
      ...
      <td class="rtTextCell">I did know it... and to be honest, this was my first idea on how to solve the problem. <br><br>Luckily, it was immediately followed by the second one: "Hey, this is the 500, not the 1000! Stop it riiiight there and look for a brute force solution that involves less thinking."<br><br>Still, I do think that this is a possible way of solving the problem -- and most probably the time will be only (poly)logarithmic in the row number if implemented well.<br><br>Ah well, maybe I'll just submit it as a 1000 sometimes :-P</td>
   </tr>
</table>
