                                    ...
                                    <a>
                                       ...
                                       <xsl:choose>
                                        ...
                                        <xsl:when test="contains($Project, 'Design')">
                                            ...
                                            <p>The deadline for submitting a design is <xsl:value-of select="/TC/DEVELOPMENT/date"/> at 9:00 AM EST.  Please submit your design through the project's <a href="http://software.topcoder.com/review">TopCoder posting page</a>.  All late submissions will be ignored. Also, a reminder that this is a competition, and only the top 2 submissions will receive payment.</p>
                                        </xsl:when>
                                        <xsl:otherwise>
