    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Palm Receiving Application Design Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Design Application Project - Palm Receiving Application</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p>
                                                        ...
                                                        these is a merchandise receiving application.   In order to minimize
                                                        the number of transferred cartons that are lost or stolen, the client
                                                        would like to begin storing receipts in a corporate database on a 
                                                        real-time basis as they are being scanned on the Palm at the store.
                                                        <br/>
                                                        <br/>
                                                        The existing Palm-based Receiving Application will be modified to not
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        View the <a target="_new" class="bodyText" href="/i/development/downloads/Palm_Receiving_App_Req_Spec.pdf">Business Requirements Specification</a> for this project.
                                                    </p>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="400">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">06.15.2004</td>
                                                        </tr>
                                                        <tr>
