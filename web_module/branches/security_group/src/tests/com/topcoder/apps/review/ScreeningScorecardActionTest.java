...
/**
 * <p>Test the ReviewScorecardAction classes.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ScreeningScorecardActionTest extends MockStrutsTestCase {
    /**
     ...
     */
    public ScreeningScorecardActionTest(String testName) {
        super(testName);
    ...
    public void testViewSuccess() {
        ...
        verifyForward("edit");
        assertNotNull(getSession().getAttribute("screeningScorecardForm"));
