...
public class RookieBoardRowComparator implements Comparator {

    /**
     * The logger to log to.
     */
    private static final Logger log = Logger.getLogger(RookieBoardRowComparator.class);

    /**
     * Default constructor
     */
    public RookieBoardRowComparator() {
        super();
    }

    public int compare(Object arg0, Object arg1) {
        RookieBoardRow lbr0 = (RookieBoardRow) arg0;
        RookieBoardRow lbr1 = (RookieBoardRow) arg1;
        ...
        // compares placements
        ResultSetContainer rsc0 = retrieveInfo("dr_rookie_tie_break_placement", lbr0.getSeason(), lbr0.getPhase(), lbr0.getUserId());
        ResultSetContainer rsc1 = retrieveInfo("dr_rookie_tie_break_placement", lbr1.getSeason(), lbr1.getPhase(), lbr1.getUserId());
        ...
        // compares scores
        rsc0 = retrieveInfo("dr_rookie_tie_break_score", lbr0.getSeason(), lbr0.getPhase(), lbr0.getUserId());
        rsc1 = retrieveInfo("dr_rookie_tie_break_score", lbr1.getSeason(), lbr1.getPhase(), lbr1.getUserId());
