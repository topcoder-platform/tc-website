                ...
                <tr valign="top">
                    ...
                    <xsl:choose>
                        <xsl:when test="/TC/DEVELOPMENT/max_reg = 0">
                            <p>Unrated members are not allowed to register for this component.</p>
                        </xsl:when>
                        <xsl:otherwise>
                            <p>The maximum number of unrated members for this component has been reached (<xsl:value-of select="/TC/DEVELOPMENT/max_reg"/>).</p>
                        </xsl:otherwise>
                    </xsl:choose>
