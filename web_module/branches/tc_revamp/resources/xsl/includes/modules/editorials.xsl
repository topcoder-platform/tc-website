...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="editorials">
      		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" VALIGN="top" WIDTH="170">       		
        		<TR> 
          			<TD BGCOLOR="#FFFFFF" VALIGN="top" WIDTH="170"> 
            			<TABLE CELLSPACING="0" CELLPADDING="5" BORDER="0" WIDTH="170">
              				<TR> 
    <TD VALIGN="top" ALIGN="left" CLASS="smallText"><DIV><A HREF="/index?t=#" CLASS="moduleSubHead">Headline Here</A></DIV>
    <IMG SRC="/i/m/dmwright_mug.gif" ALT="" WIDTH="55" HEIGHT="61" BORDER="0" HSPACE="8" VSPACE="1" ALIGN="left"/>
<A HREF="/?t=statistics&amp;c=member_profile&amp;Coder_Id=114853" CLASS="smallText">dmwright</A><BR/>
The big cheese.  The head honcho.  The top gun.  The dictionary defines a favorite as "a competitor judged most likely to win".  Let's take a deeper look at the four coders who have earned the distinction as favorites...<A HREF="/?t=#" CLASS="smallText">full&#160;story</A>
</TD>
              				</TR>
							<TR><TD BGCOLOR="#FFFFFF" CLASS="grayLine" ALIGN="center">-----------------</TD></TR>              				
              				<TR> 
                				    <TD VALIGN="top" ALIGN="left" CLASS="smallText"><DIV><A HREF="/index?t=#" CLASS="moduleSubHead">Headline Here</A></DIV>
    <IMG SRC="/i/m/ante_mug.gif" ALT="" WIDTH="55" HEIGHT="61" BORDER="0" HSPACE="8" VSPACE="1" ALIGN="left"/>
<A HREF="/?t=statistics&amp;c=member_profile&amp;Coder_Id=114853" CLASS="smallText">ante</A><BR/>
The big cheese.  The head honcho.  The top gun.  The dictionary defines a favorite as "a competitor judged most likely to win". Let's take a deeper look at the four coders who have earned the distinction as favorites...<A HREF="/?t=#" CLASS="smallText">full&#160;story</A>
</TD>
              				</TR>
							<TR><TD BGCOLOR="#FFFFFF" CLASS="grayLine" ALIGN="center">-----------------</TD></TR> 
...
<A HREF="/?t=statistics&amp;c=member_profile&amp;Coder_Id=154089" CLASS="smallText">milhouse</A><BR/>    
These are the coders that the top-seeds fear the most.  They are either TopCoder veterans, TopCoder tournament tested, those who had outstanding performances with top scores in the Regional Quarterfinals and/or Regional Semifinals, or all of the above...<A HREF="/?t=#" CLASS="smallText">full&#160;story</A></TD>							
              				</TR>							              				
...
The big cheese.  The head honcho.  The top gun.  The dictionary defines a favorite as "a competitor judged most likely to win".  And win is exactly what the favorites have done so far in their TopCoder careers, as all of the favorites are among the top-25 in all-time room wins.  Let's take a deeper look at the four coders who have earned the distinction as favorites...<A HREF="/?t=statistics&amp;c=2002tccc_favs" CLASS="statText">click here</A>
</TD>
