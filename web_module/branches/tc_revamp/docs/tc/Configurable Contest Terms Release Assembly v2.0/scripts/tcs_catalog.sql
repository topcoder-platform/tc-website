...
-- create permissions for new admin processors
insert into security_perms values (24, "com.topcoder.web.admin.controller.request.ViewEditTermsUsers", 132456, 1);
insert into security_perms values (24, "com.topcoder.web.admin.controller.request.CreateTermsOfUseAgreement", 132456, 1);
