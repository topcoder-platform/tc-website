...
/**
 * <p>
 * This interface defines the contract for getting information of review opportunities by various filtering conditions.
 * It has an overloaded method that supports pagination.
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public interface ReviewOpportunitiesManager {
     ...
     * @return a list of ReviewOpportunityDTO that matches given filter. It will be null if no such contest can be
     *         found.
