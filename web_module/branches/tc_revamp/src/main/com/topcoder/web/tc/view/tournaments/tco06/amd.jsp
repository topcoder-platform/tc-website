...
<br><br>
Software development is at a key juncture with 64-bit processing and multi-core breaking their way into the mainstream.  With ever changing technology opportunities it is a challenge to stay ahead of the game.  AMD Developer Central is here to offer the resources and tools you need to succeed.
<br><br>
Capture the benefits of AMD performance and technology in your products and in your software development effort. AMD Developer Central is dedicated to supporting software developers and x86 free-thinkers with the resources they need to be successful in developing software.  Resources include information, how-tos, development tools, forums, and community. Featured tools are CodeAnalyst&#153;, and the AMD Core Math Library.  To learn more and become a member of AMD Developer Central visit <a href="/?t=sponsor&c=link&link=http://www.amd.com/devcentral/">www.amd.com/devcentral</a>.
<br><br>
