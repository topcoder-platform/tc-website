      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr>
            ...
            <% if (tabLev2.equals("advancers")) {%>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco06&d3=spon_ver_results"><img src="/i/tournament/tco06/tabs/L2_advancersOn.gif" alt="" border="0" /></A></td>
            <% } else { %>
               <td class="nav"><A href="/tc?module=Static&d1=tournaments&d2=tco06&d3=spon_ver_results"><img src="/i/tournament/tco06/tabs/L2_advancersOff.gif" alt="" border="0" /></A></td>
            <% } %>
<%--
--%>
<%--
         ...
         <tr>
            <td class="subnavBG">&#160;&#160;&#160;</td>
               ...
               <% } else if (tabLev2.equals("advancers")) {%>
                  <td class="subnav"><a href="/tc?module=SimpleStats&d1=tournaments&d2=tco06&d3=spon_ver_qualification&c=tco06_spon_qual&trans=true"><% if (tabLev3.equals("qualification")) {%><img src="/i/tournament/tco06/tabs/L3_qualificationOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco06/tabs/L3_qualificationOff.gif" border="0" /><% } %></a></td>
                  <td class="subnav"><a href="/tc?module=Static&d1=tournaments&d2=tco06&d3=spon_ver_results"><% if (tabLev3.equals("overview")) {%><img src="/i/tournament/tco06/tabs/L3_overviewOn.gif" border="0" /><% } else { %><img src="/i/tournament/tco06/tabs/L3_overviewOff.gif" border="0" /><% } %></a></td>
<%--
--%>
