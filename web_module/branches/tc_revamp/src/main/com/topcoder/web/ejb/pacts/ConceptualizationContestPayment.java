 ...
 * @author FireIce
 */
public class ConceptualizationContestPayment extends ComponentProjectReferencePayment {
    ...
    /**
     * Create a payment for the winner (or another place!) of a conceptualization.
     *
     ...
     */
    public ConceptualizationContestPayment(long coderId, double grossAmount, String client, long projectId, int placed) {
        super(CONCEPTUALIZATION_CONTEST_PAYMENT, coderId, grossAmount, client, projectId, placed);
    }
     ...
     * @param placed the place of the coder in the contest.
     */
    public ConceptualizationContestPayment(long coderId, double grossAmount, long projectId, int placed) {
     ...
     * @param projectId project that is being paid.
     */
    public ConceptualizationContestPayment(long coderId, double grossAmount, String client, long projectId) {
     ...
     * @param projectId project that is being paid.
     */
    public ConceptualizationContestPayment(long coderId, double grossAmount, long projectId) {
     ...
     * It just provides a method for generating a description for the conceptualization.
     *
     * @author pulky
     */
