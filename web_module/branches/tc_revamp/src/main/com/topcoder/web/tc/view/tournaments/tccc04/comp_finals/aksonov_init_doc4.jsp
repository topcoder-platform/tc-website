    ...
    <tr valign="top">
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/aksonov/diagrams/Catalog_Sequence_Diagram_Addproductgrouptoparentgroup.gif" alt="" border="0"></div></td>
