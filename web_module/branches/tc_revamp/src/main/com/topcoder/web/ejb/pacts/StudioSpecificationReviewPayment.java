...
/**
 * Payment class for Studio specification reviews.
 *
 ...
 */
public class StudioSpecificationReviewPayment extends StudioContestReferencePayment {
    ...
    /**
     * Creates a Studio specification reviews payment using the specified parameters.
     *
     ...
     */
    public StudioSpecificationReviewPayment(long coderId, double grossAmount, String client, long contestId, int placed) {
        super(STUDIO_SPECIFICATION_REVIEW_PAYMENT, coderId, grossAmount, client, contestId, placed);
    }
     ...
     * @param contestId project that is being paid.
     */
    public StudioSpecificationReviewPayment(long coderId, double grossAmount, String client, long contestId) {
     ...
     * @param contestId project that is being paid.
     */
    public StudioSpecificationReviewPayment(long coderId, double grossAmount, long contestId) {
    ...
    /**
     * Processor for Studio specification reviews payments.
     *
     * This class will implement <code>lookupDescription</code> to allow custom description
     * generation for the Studio specification reviews payment and <code>lookupEventDate</code> to retrieve
     * event's date.
     */
    protected static class Processor extends StudioContestReferencePayment.Processor {
         ...
         */
        private static final String PAYMENT_DESCRIPTION_SUFFIX = " - Specification Reviews";
