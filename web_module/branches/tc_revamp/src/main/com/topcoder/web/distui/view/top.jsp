    ...
    <div style="float: right; margin: 5px 0px 0px 0px;">
        <% if ( !sessionInfo.isAnonymous() ) { %>
            ...
            <% if (level1.equals("long")) { %>
                | <a class="gMetal" href="http://community.topcoder.com/longcontest/?module=Logout">Logout</a>
        ...
        <% } else {
            if (level1.equals("long")) {%>
                <a class="gMetal" href="http://community.topcoder.com/longcontest/?module=Login">Login</a>
            <% } else if (level1.equals("forums")) { %>
