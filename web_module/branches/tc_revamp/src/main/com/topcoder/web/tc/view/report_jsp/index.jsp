...
<%@ page
        ...
        import="com.topcoder.common.web.data.report.Constants,
                com.topcoder.common.web.data.report.Report"

        %>
<%@ page import="com.topcoder.common.web.data.report.ReportNode" %>
...
<br/>
<br/>
<a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=report_jsp&d2=newIndex">Additional
    Reports<a><br/><br/>

    <b>Profile Information<b><br/>
        <ul>
            <li>
                <a href=<%=Constants.SERVLET_ADDR + "&" + Constants.TASK_NAME_KEY + "=" + Constants.REPORT_PROFILE_LIST_MENU_KEY%>>Profile
                    List</a></li>
        </ul>
        <ul>
            <li>
                <a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=ProfileSearch&t=profile_search">Super
                    Mega Profile Search</a></li>
        </ul>
        <ul>
            <li>
                <a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=report_jsp&d2=profile">Profile
                    Look Up</a></li>
        </ul>
        <%--
        ...
        <b>TCS<b><br/>
            <ul>
                <li><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=TCSSurveyResults">Registration
