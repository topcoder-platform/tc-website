<%--
  ...
  -
  - Description: This page is the articles archive page in press room.
  -
...
<head>
    ...
    $(document).ready(function() {
        getRssArticles('<%=Constants.ARTICLES_ARCHIVE_RSS%>', renderArticlesArchive, '<%=Constants.ARTICLES_ARCHIVE_CATEGORY%>');
    });
    </script>
</head>
<body>
