...
/**
 * <p>Test the FinalReviewAction classes.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class FinalReviewActionTest extends MockStrutsTestCase {
    /**
     ...
     */
    public FinalReviewActionTest(String testName) {
        super(testName);
    ...
    public void testViewSuccess() {
        ...
        verifyForward("edit");
        assertNotNull(getSession().getAttribute("finalReviewForm"));
