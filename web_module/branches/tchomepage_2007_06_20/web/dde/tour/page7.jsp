...
<div align="center">
    ...
    <div style="width: 700px; background: transparent;">
        ...
        <div id="slide">
            <a href="/tour/page8.jsp" onfocus="this.blur();"><img src="/i/tour/page7.jpg" alt="" /></a>
        </div>
        ...
        <div align="center">
            <div style="width: 60px; height: 28px; margin: 10px;">
                <div style="float: left;">
                    <a href="/tour/page6.jsp" onfocus="this.blur();"><img src="/i/tour/prev.png" alt="Previous page" /></a>
                </div>
                <div style="float: right;">
                    <a href="/tour/page8.jsp" onfocus="this.blur();"><img src="/i/tour/next.png" alt="Next page" /></a>
                </div>
            </div>
        </div>
