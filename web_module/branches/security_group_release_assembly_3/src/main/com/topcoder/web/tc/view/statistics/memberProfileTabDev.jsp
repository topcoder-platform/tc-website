<%--
  ...
  -
  - Description: This page displays the member profile dev contest page.
  -
            ...
            <td width="28%">
                <div class="dataMain">
                    <div id="left" class="left equal-height">
                        <h2>Development Competitions</h2>
                        <h3>Rating</h3>
                        <h1>
                        ...
                        <ul class="masterLink">
                            <li><a href='/tc?module=CompetitionHistory&<%=Constants.PHASE_ID%>=113&cr=<%=request.getParameter("cr")%>'>Competition History</a></li>
                            <li><a href='/tc?module=OutstandingProjects&<%=Constants.PHASE_ID%>=113&cr=<%=request.getParameter("cr")%>'>Current Contests</a></li>
                            <li><a href='/tc?module=ReliabilityDetail&ph=113&uid=<%=request.getParameter("cr")%>'>Reliability Detail</a></li>
                        </ul>
                        <!--End masterLink-->
                        <div class="masterContent">
                            <ul>
                                ...
                                <li><strong>Competitions</strong><span class="red">
                                    <a href='/tc?module=CompetitionHistory&<%=Constants.PHASE_ID%>=113&cr=<%=request.getParameter("cr")%>' class="redlink">
                                        <rsc:item name="num_ratings" set="<%=rscDevData%>" format="####"/>
                                    </a>
                                </span></li>
                                
                                <li><strong>Reliability</strong><span class="red">
                                    <a href='/tc?module=ReliabilityDetail&ph=113&uid=<%=request.getParameter("cr")%>' class="redlink">
