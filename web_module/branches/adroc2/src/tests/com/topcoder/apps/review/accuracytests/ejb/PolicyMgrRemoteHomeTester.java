...
public class PolicyMgrRemoteHomeTester implements PolicyMgrRemoteHome {
     ...
     * @return the instance
     */
    public static PolicyMgrRemoteHomeTester getInstance() {
        if (instance.get() == null) instance.set(new PolicyMgrRemoteHomeTester());
        return (PolicyMgrRemoteHomeTester) instance.get();
    }
