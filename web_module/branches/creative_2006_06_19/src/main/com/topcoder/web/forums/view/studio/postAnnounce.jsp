...
<tbody>
   ...
   <tr>
      ...
      <span class="bodyText"><a href="http://www.topcoder.com/tc?module=MemberProfile&amp;cr=7346876" class="coderTextOrange">ntrefz</a></span><br><a href="?module=History&amp;userID=7346876">304 posts</a></div>
      </td>
      <td class="rtTextCell100">
      <b>Subject:</b><br><input name="subject" size="60" onkeypress="return noenter(event)" value="" type="text"><br><br>
   ...
   <tr>
      <td class="rtFooter" colspan="2">
      <input src="/i/roundTables/post.gif" class="rtButton" alt="Post" onclick="form1.module.value='PostMessage'" type="image"><input src="/i/roundTables/preview.gif" class="rtButton" alt="Preview" onclick="form1.module.value='PreviewMessage'" type="image">
      </td>
   </tr>
</tbody>
</table>
