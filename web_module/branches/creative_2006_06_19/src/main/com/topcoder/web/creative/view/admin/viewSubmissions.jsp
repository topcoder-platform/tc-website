...
<tr>
    ...
    <td class="header">
        <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("submitter_handle")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Submitter</a>
    </td>
    <td class="headerC">
        <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("original_file_name")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Submission</a>
    </td>
    <td class="headerC">
        <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("submit_date")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Submit
            Date</a>
    </td>
    <td class="headerC">
        <c:choose>
            ...
            <c:otherwise>
                <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("review_date")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Review
                    Date</a>
            </c:otherwise>
        </c:choose>
    ...
    <td class="headerC">
        <c:choose>
            ...
            <c:otherwise>
                <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("reviewer_handle")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Reviewer</a>
            </c:otherwise>
        </c:choose>
    ...
    <td class="headerC">
        <c:choose>
            ...
            <c:otherwise>
                <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=AdminViewSubmissions<tc-webtag:sort column="<%=submissions.getColumnIndex("review_status_desc")+1%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>,<%=DataAccessConstants.START_RANK%>,<%=DataAccessConstants.END_RANK%>"/>">Status</a>
            </c:otherwise>
        </c:choose>
