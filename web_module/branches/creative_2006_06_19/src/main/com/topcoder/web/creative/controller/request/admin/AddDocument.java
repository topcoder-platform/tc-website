...
public class AddDocument extends Base {
    ...
    protected void dbProcessing() throws Exception {
        ...
        if ("".equals(StringUtils.checkNull(contestId))) {
            ...
            DocumentType docType = CreativeDAOUtil.getFactory().getDocumentTypeDAO().find(new Integer(dt));
            if (docType == null) {
            ...
            if (hasErrors()) {
                ...
                d.setType(CreativeDAOUtil.getFactory().getDocumentTypeDAO().find(SubmissionType.INITIAL_CONTEST_SUBMISSION_TYPE));
