...
public interface UserPreference extends EJBObject {
    ...
    String getValue(long userId, int preferenceId, String dataSource) throws RowNotFoundException, RemoteException;

    void setPreferenceValueID(long userId, int preferenceId, int valueId, String dataSource) throws EJBException, RemoteException;

    int getPreferenceValueID(long userId, int preferenceId, String dataSource) throws RowNotFoundException, RemoteException;
