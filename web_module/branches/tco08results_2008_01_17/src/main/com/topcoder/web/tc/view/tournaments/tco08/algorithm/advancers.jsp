    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value="overview"/>
            ...
            <div id="pageBody">
                ...
                <div align="center">
                <a href="/tc?module=AlgorithmAdvancers">Reset sorting</a>

                <c:choose>
                    <c:when test="${full}">
                        | <a href="/tc?module=AlgorithmAdvancers&full=false">Pages</a>
                        | Full view
                    </c:when>
                    <c:otherwise>
                        | Page view
                        | <a href="/tc?module=AlgorithmAdvancers&full=true">Full view</a>
                    </c:otherwise>
                </c:choose>
