...
<p>Instead of working with the given line
    ...
    of the transmitted character being correct. Since in a state <strong>S</strong><sub
        style="font-weight: bold;">i</sub>
    ...
    the quality for that state is <img alt="Qi = Si + (1-Si)/C"
                                       src="/i/longcontest/match_editorials/intelmtcs8/120adeea.gif" name="Object13"
                                       align="middle">.
...
<div>
    <img alt="PF(T) = Sum PC(T,M) * PI(T-M,M)" src="/i/longcontest/match_editorials/intelmtcs8/4eee81a6.gif"
         name="Object2" align="middle">
</div>
<p>where <strong>PC(T,
...
<p>The error penalty factor is <img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m28b2df19.gif"
                                    name="Object18" align="middle">, or
    approximately<img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m17d8daa0.gif" name="Object19"
                      align="middle">.<br>
</p>
...
<p>where O is the observation,
    ...
    is an event that for a quality Q<sub>i</sub> has a probability<img alt=""
                                                                       src="/i/longcontest/match_editorials/intelmtcs8/m2ed38f9a.gif"
                                                                       name="Object5" align="middle">of
...
<p>If we call <strong>C</strong> the hypothesized correct
    ...
    then the probability of getting T<sub>i</sub> is:<img alt=""
                                                          src="/i/longcontest/match_editorials/intelmtcs8/m5d50c24d.gif"
                                                          name="Object20" align="middle">.<br>
    Let us define<img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m4d1bb570.gif" name="Object21"
                      align="middle">the
    probability of any incorrect character, and<img alt=""
                                                    src="/i/longcontest/match_editorials/intelmtcs8/m118f59dd.gif"
                                                    name="Object22" align="middle">
    the odds ratio for a correct character.</p>

<p>The probability of all our
    observations, or likelihood of C, is:<img alt="" src="/i/longcontest/match_editorials/intelmtcs8/1f96983e.gif"
                                              name="Object7" align="middle"></p>

<p>Dividing by <img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m922ceb9.gif" name="Object8" align="middle">(which
    doesn't depend on the C):<img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m111e4dcf.gif" name="Object9"
                                  align="middle"></p>

<p>Normalizing:<img alt="" src="/i/longcontest/match_editorials/intelmtcs8/m541f1495.gif" name="Object10"
                    align="middle"></p>
...
<ol>
    ...
    <li>
        ...
        interval found so far. Otherwise, we continue in step 2.
    </li>
    <li>if the best interval's total value is higher than the cost of the
        ...
        worth querying, the overall interval isn't, so we discard it.
    </li>
    <li>
        return to step 1 and continue looking for intervals from the next
        position, until the entire message length has been processed.
    </li>
</ol>
...
or merging less worthwhile intervals.
</p>
