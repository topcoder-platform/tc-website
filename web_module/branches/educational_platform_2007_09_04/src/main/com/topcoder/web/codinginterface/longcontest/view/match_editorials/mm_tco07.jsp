...
by
<tc-webtag:handle coderId="10600282"/>
<br>
...
<p>
    ...
    <tc-webtag:handle coderId="22657262" context="marathon"/>
    's. He missed the third power in the gravitation
...
<p>
    ...
    our programs in the visualizer. During this time when
    <tc-webtag:handle coderId="287131"/>
    and
    <tc-webtag:handle coderId="7267401"/>
    were working hard fixing a bug and were
...
<p>
    During lunch I had plenty of time to thing about the problem, what I had been doing wrong and what should I do next.
    The break was very helpful as I needed only fifteen more minutes to make my first reasonable submission.
    The prime decision I took was to stop my ship at each waypoint. The idea was supposed to eliminate situations when
    the ship misses the next waypoint by millimeters (or inches).
...
<p>
    ...
    <tc-webtag:handle coderId="261024" context="marathon"/>
    's submission and his post
...
<p>
    ...
    <tc-webtag:handle coderId="7459326" context="marathon"/>
    was also testing this idea.
</p>
<br/>
...
<p>
    You can find explanations of the approaches taken by
    <tc-webtag:handle coderId="261024" context="marathon"/>
    and
    <tc-webtag:handle coderId="7459326" context="marathon"/>
    in <a href="http://forums.topcoder.com/?module=Thread&threadID=580237&start=0&mc=13">the
    forum</a>.
    <tc-webtag:handle coderId="9987185" context="marathon"/>
    's approach is also worth explaining as the
    ...
    directions that crash on a planet.
    <tc-webtag:handle coderId="9987185" context="marathon"/>
    tried to do a sort of binary search to a the exact
    best direction, but he didn't manage to make it work in time. After the
    competition
    <tc-webtag:handle coderId="287131" context="marathon"/>
    showed us his solution (obviously
...
<p>
    ...
    <tc-webtag:handle coderId="261024" context="marathon"/>
    proved that in this track bugs can also be very
    expensive. Note that,
    <tc-webtag:handle coderId="261024" context="marathon"/>
    and
    <tc-webtag:handle coderId="7459326" context="marathon"/>
    ...
    students and
    <tc-webtag:handle coderId="9987185" context="marathon"/>
    is losing his student status in a
