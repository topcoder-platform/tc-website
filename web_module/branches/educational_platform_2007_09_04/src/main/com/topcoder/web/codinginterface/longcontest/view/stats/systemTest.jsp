    ...
    <tr valign="top">
        ...
        <TD CLASS="statTableSpacer" WIDTH="100%" VALIGN="top">
            ...
            <div style="float:right; padding: 0px 0px 0px 5px;">
                ...
                <A href="/longcontest/stats/?<%=Constants.MODULE%>=ViewSystemTestResults&<%=Constants.ROUND_ID%>=<rsc:item name="round_id" row="<%=testRow%>"/>&<%=Constants.PROBLEM_ID%>=<rsc:item name="problem_id" row="<%=testRow%>"/>">back
                    to results</A>
            </div>
