    ...
    <tr valign="top">
        ...
        <td class="statTableSpacer" width="100%" valign="top">
            ...
            <div class="fixedWidthBody">
                ...
                <br/>
                <b>Note:</b> provisionally, a school must have just 5 members to be ranked, but after more people
                compete, the criteria will be raised to 10 members in order to agree with other ranks. <br/>

                <table class="stat" cellpadding="0" cellspacing="0" width="510" border="0">
                    <tr>
                        <td class="title" colspan="5">Top Ranked Marathon Match Schools</td>
                    </tr>
                    <tr>
                    ...
                    <c:forEach items="${list}" var="row" varStatus="status">
                        <tr class='${status.index % 2 == 1? "dark" : "light" }'>
                            ...
                            <td class="valueC">
                                <fmt:formatNumber value="${row.map['avg_rating']}" pattern="#####0.00"/>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
