...
<html>
    ...
    <body>
        ...
        <br/>        
        Are you sure you want to accept ${student_classroom.id.student.user.lastName}, ${student_classroom.id.student.user.firstName} registration?
        <form name="f" action="${sessionInfo.servletPath}" method="post">
            ...
            <tc-webtag:hiddenInput name="<%=Constants.STUDENT_ID%>" value="${selected_students}"/>
            <p>
