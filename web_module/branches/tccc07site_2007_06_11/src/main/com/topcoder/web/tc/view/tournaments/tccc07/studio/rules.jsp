...
<div align="center" style="background: transparent;">
    <div id="content">
        ...
        <jsp:param name="tabLev1" value="<%=EventType.STUDIO_TOURNAMENT_ID.toString()%>"/>
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                <p>TopCoder Studio members meeting the following criteria are eligible to compete in the SDC:</p>
                    <ul>
                        <li>Must be at least 18 years of age as of July 30, 2007; AND</li>
                ...
                <p>TopCoder Studio members who are 18 years of age or older as of July 30, 2007 are eligible to win cash prizes, unless otherwise prohibited. The SDC is void in the Quebec province of Canada, and elsewhere where prohibited by applicable law. Residents of Cuba, Iran, North Korea, Sudan, or Syria are ineligible to receive cash prizes and are ineligible to attend the onsite final round of competition as competitors.</p>
                ...
                <table cellpadding="0" cellspacing="0" class="stat"> 
                    <tbody> 
                        ...
                        <tr class="dark"> 
                            <td class="value" colspan="2">Prize will be awarded after the conclusion of the Championship Round. Winner must be present to receive prize.<br />In addition to the prizes mentioned above, all onsite finalists will receive a one-day Disney Park Hopper pass to use at the event on Saturday, November 3, 2007.</td> 
                        </tr> 
                    </tbody> 
                </table>
                <br />
