    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value="getvisa"/>
            ...
            <div id="pageBody">
                ...
                <p><span style="font-weight:bold;">Marathon Match Competitors: </span>All competitors who advance to Online Round 4 will receive a request form to fill out if they require a letter. As soon as a competitor fills out the form in its entirety, the letter will be shipped out by FedEx International Priority mail.</p>
                <p><span style="font-weight:bold;">Studio Design Competitors: </span>All competitors who earned TCCC SDC placement points by September 7, 2007will receive a request form to fill out if they require a letter. As soon as a competitor fills out the form in its entirety, the letter will be shipped out by FedEx International Priority mail.</p>
