    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                <p>After each online round, the highest scoring competitors will advance to the next online round. Whether a competitor advances to the next round is determined by comparing the total points from all system testing for each competitor. To advance, a competitor must submit a full submission, as defined herein. The structure of each of the online rounds is as follows:</p>
                ...
                <p>The eight (8) competitors who advance from online round #3 will travel to Orlando Florida to compete in the Championship round of the Competition being held on Wednesday, October 31, 2007. All onsite competitors must arrive at the Contemporary Resort no later than 2:00 PM EDT on Tuesday, October 30, 2007.</p>
                ...
                <p>The Championship Round will consist of a maximum of 8 competitors and will be a single round.  The winner of the Championship Round will be the competitor with the highest point total for the Championship round. In the event that two or more competitors are tied at the end of the Championship Round, the tie will be resolved as follows:</p>
                    <ol>
                        <li>By reference to the total points acquired during online round #4 of the Competition.</li>
                        <li>If a tie remains, by reference to the total points acquired during online round #3 of the Competition.</li>
                        ...
                        <li>If a tie remains, by reference to the highest rating following online round #4.</li>
                ...
                <h2>Other</h2>
                <p>The Tournament and the Competition is void in whole or in part where prohibited by law.<br />A list of winners in the Competition by handle will be available on the web site at <a href="http://www.topcoder.com/tc">http://www.topcoder.com/tc</a>, and will be displayed for at least 3 months after the completion of the Competition.</p>
                <p>The Tournament and Competition are brought to you by TopCoder, Inc. (<a href="http://www.topcoder.com/">http://www.topcoder.com/</a>) 703 Hebron Avenue, Glastonbury, CT 06033.</p>
