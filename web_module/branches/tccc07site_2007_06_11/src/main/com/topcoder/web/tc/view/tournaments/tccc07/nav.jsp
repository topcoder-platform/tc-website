...
<%--------------SECONDARY NAV---------------%>
            ...
            <% } else if (tabLev1.equals("algorithm")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&et=6"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&et=6"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
            ...
            <% } else if (tabLev1.equals("component")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=5"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=5"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
            ...
            <% } else if (tabLev1.equals("marathon")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=9"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=9"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
                    | <a href=""<% if (tabLev2.equals("advancers")) {%> class="on"<% } %>>Advancers</a>
                    | <a href=""<% if (tabLev2.equals("summary")) {%> class="on"<% } %>>Summary</a>
                --%>
            ...
            <% } else if (tabLev1.equals("studio")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=7"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=7"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
                    | <a href=""<% if (tabLev2.equals("advancers")) {%> class="on"<% } %>>Advancers</a>
                    | <a href=""<% if (tabLev2.equals("summary")) {%> class="on"<% } %>>Summary</a>
                --%>
