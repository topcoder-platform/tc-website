...
<%--------------SECONDARY NAV---------------%>
            ...
            <% } else if (tabLev1.equals("algorithm")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=algorithm"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=algorithm"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
            ...
            <% } else if (tabLev1.equals("component")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=component"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=component"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
            ...
            <% } else if (tabLev1.equals("marathon")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=marathon"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=marathon"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
                    | <a href=""<% if (tabLev2.equals("advancers")) {%> class="on"<% } %>>Advancers</a>
                    | <a href=""<% if (tabLev2.equals("summary")) {%> class="on"<% } %>>Summary</a>
                --%>
            ...
            <% } else if (tabLev1.equals("studio")) { %>
                <p id="secondaryNav">
                    ...
                    | <a href="/tc?module=TCCC07ViewRegistration&ct=studio"<% if (tabLev2.equals("register")) {%> class="on"<% } %>>Register</a>
                    | <a href="/tc?module=TCCC07ViewRegistrants&ct=studio"<% if (tabLev2.equals("registrants")) {%> class="on"<% } %>>Registrants</a>
                <%--
                    | <a href=""<% if (tabLev2.equals("advancers")) {%> class="on"<% } %>>Advancers</a>
                    | <a href=""<% if (tabLev2.equals("summary")) {%> class="on"<% } %>>Summary</a>
                --%>
