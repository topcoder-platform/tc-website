...
<div align="center" style="background: transparent;">
    <div id="content">
        ...
        <jsp:param name="tabLev1" value="<%=EventType.ALGORITHM_TOURNAMENT_ID.toString()%>"/>
...
.</p>
                <table cellpadding="0" cellspacing="0" class="stat"> 
                    <tbody> 
                        ...
                        <tr class="dark"> 
                            <td class="value" colspan="2">* Prize will be awarded at the conclusion of the Championship Round. Winner must be present at the onsite rounds to receive prize.<br />
                              <br />
