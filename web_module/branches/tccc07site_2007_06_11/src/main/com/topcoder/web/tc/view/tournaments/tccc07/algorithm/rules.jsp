    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                <p>The TopCoder Open is void in the Quebec province of Canada and where prohibited by applicable law. Residents of Cuba, Iran, North Korea, Sudan, or Syria are ineligible to receive cash prizes and are ineligible to attend the onsite semi-final round of competition as competitors.</p>
                ...
                <h2>Registration</h2>
                <p>Registration for the 2007 TopCoder Collegiate Challenge Algorithm Competition will open at 9:00AM EDT on Monday, July 23, 2007, and will close at 5:00 PM EDT on Thursday, August 16, 2007. Competitors must register separately for the Algorithm Competition in order to compete. There is no limit to the number of registrants for the Algorithm Competition; however each competitor may only register once.</p>
                
                <a name="qualification"></a>
                <h2>Qualification Rounds</h2>
                <p><span style="font-weight:bold;">Automatic Berths</span> - The top 150 rated competitors as of Thursday, August 16 who have met all of the following criteria will receive an automatic berth into Online Round #1:</p>
                    <ol>
                        ...
                        <li>Meets all other Algorithm Competition and Tournament eligibility criteria.</li>
                    </ol>
                ...
                <p>All competitors who have qualified for an online round will indicate the section of the round in which they wish to compete. During tournament registration competitors will indicate their preferences regarding Online Round #1. TopCoder will attempt to fill the sections for Online Round #1 based on indicated preference.  In the event that all indicated preferences cannot be accommodated, the preferences of competitors who registered for the tournament earlier will be given preference.</p>
                ...
                <table cellpadding="0" cellspacing="0" class="stat"> 
                    <tbody> 
                        ...
                        <tr class="dark"> 
                            ...
                            <td class="value">Saturday, September 22<br />Register: 10:00 AM - 12:55 PM<br />START: 7:00 AM</td> 
                            <td class="value">150</td> 
                ...
                <p><span style="font-weight:bold;">The Coding Phase</span> is a timed event in which all competitors are presented with the same three questions representing three levels of complexity and, accordingly, three levels of potential points. Points for a problem are awarded upon submission of any solution that successfully compiles.  Points are calculated on the total time elapsed from the time the problem was opened until the time it was submitted. During the online rounds, the Coding Phase will last 75 minutes. During the onsite rounds, the Coding Phase will last 85 minutes.</p>
                ...
                <p>TopCoder will determine the room assignments for the Semifinal rooms prior to the start of each Semifinal round, in the following manner:<br />All competitors will be arranged by their tournament seed. Starting with the highest seeded competitor and going down the list in order, a competitor will be assigned to room 1, then room 2, then room 3, then room 3 again, then room 2, then room 1. This pattern will continue (1,2,3,3,2,1) until all competitors are assigned to a room.</p>
                <table cellpadding="0" cellspacing="0" class="stat"> 
                    <tbody> 
                        <tr> 
                        ...
                        <tr class="light"> 
                            ...
                            <td class="value">Wednesday, June 27, 8:30 AM</td> 
                        </tr> 
                        <tr class="dark"> 
                            <td class="value">Semifinal Room #2</td> 
                            <td class="value">Wednesday, June 27, 2:00 PM</td>
                        </tr> 
                        <tr class="light"> 
                            <td class="value">Semifinal Room #3</td> 
                            <td class="value">Thursday, June 28,8:30 AM</td>
                        </tr> 
                        <tr class="dark"> 
                            <td class="value">Wildcard Round</td> 
                            <td class="value">Thursday, June 28, 2:00 PM</td>
                        </tr> 
                        <tr class="light"> 
                ...
                <The Algorithm Competition will award prizes to up to 1,800 competitors and $100,000 in cash prizes. Any and all applicable taxes on prizes are the sole responsibility of the prizewinner. Prizes will be distributed as follows:</p>
                <table cellpadding="0" cellspacing="0" class="stat"> 
                    <tbody> 
                        <tr> 
                        ...
                        <tr class="dark"> 
                            <td class="value" colspan="2">Prize will be awarded at the conclusion of the Championship Round. Winner must be present at the onsite rounds to receive prize.<br /><br />
