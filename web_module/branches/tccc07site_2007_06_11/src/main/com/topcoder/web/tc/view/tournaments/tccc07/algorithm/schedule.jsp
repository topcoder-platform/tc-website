        ...
        <div id="pageBody">
            ...
            <table cellpadding="0" cellspacing="0" class="stat"> 
                <tbody> 
                    ...
                    <tr class="light"> 
                        <td class="value">Online Round #1 - <br />Section A</td> 
                    ...
                    <tr class="light"> 
                        <td class="value">Online Round #1 - <br />Section C</td> 
            ...
            <p><a href="http://www.timeanddate.com/worldclock/fixedtime.html?month=9&day=12&year=2006&hour=7&min=0&sec=0&p1=179">7:00 AM</a> | 
