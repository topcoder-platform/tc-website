    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                Competitors are encouraged to improve solutions and resubmit throughout the submission phase.  The most recent submission is the one that will always count towards the standings.</p>
