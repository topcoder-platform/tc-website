    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                <p>Competitors are eligible to win cash prizes, unless otherwise prohibited. The Tournament and the CDDC are void in the Quebec province of Canada, and elsewhere where prohibited by applicable law. Cash prizes will not be paid to residents of Cuba, Iran, North Korea, Sudan, or Syria.</p>
                ...
                <h2>Other</h2>
                <p>The CDDC and the Tournament are void in whole or in part where prohibited by law. A list of CDDC and Tournament winners by handles will be available on the web site at <a href="http://www.topcoder.com/tc">http://www.topcoder.com/tc</a>, and will be displayed for at least 3 months after the completion of the CDDC and the Tournament.</p>
                <p>The CDDC and the Tournament are brought to you by TopCoder, Inc. (<a href="http://www.topcoder.com/">http://www.topcoder.com/</a>) 703 Hebron Avenue, Glastonbury, CT 06033.</p>
