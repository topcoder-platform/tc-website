    ...
    <div id="content">
        ...
        <jsp:param name="tabLev3" value=""/>
            ...
            <div id="pageBody">
                ...
                <p>When is the competition?  See the schedule <a href="" alt="TCCC07 Schedule">here</a>.</p> <!-- <link to schedule> -->
                <p>It is important for you to read the official <a href="" alt="TCCC07 Rules and Regulations">rules and regulations</a> (link to rules) for more details.</p>
