...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:import href="agreement_body.xsl"/>
...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Arena Source</xsl:with-param>
</xsl:call-template>
<TABLE HEIGHT="69%" BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
  <TR>
...
<P CLASS="statText">
  ...
  <xsl:call-template name="AgreementBody"/>
</P>

<form action="/index" method="post" name="frmAgree" >
  <input type="hidden" name="t" value="arena"/>
  <input type="hidden" name="c" value="source_agree"/>
  ...
  <A CLASS="statText">
    ...
    <b>I Agree to the Terms and Conditions Stated Above &gt;&gt;</b>
  </A>
  <br/>
  <br/>
  <br/>
  <A CLASS="statText" HREF="/index">
    <b>I Do Not Agree &gt;&gt;</b>
  </A>
  </center>
</form>
