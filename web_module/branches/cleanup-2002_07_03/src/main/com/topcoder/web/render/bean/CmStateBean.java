...
public String getPageFile () {
    if (currentPage == null) return "";
    else return currentPage.getPath() + "/" + currentPage.getFileName();
}
...
*/
    ...
    */
    ...
    int ainx;
    if (after == null) ainx = pageItems.size();
    else {
...
public void processForm (Map params) throws AuthenticationException {
    ...
    if ("login".equals(form)) processLoginForm(params);
    else if ("logout".equals(form)) processLogout();
    else if ("Apply Edit".equals(form)) processEditPageForm(params);
    else if ("Save Page".equals(form) ) saveCurrentPage(params);
    else if ("Save Modifications".equals(form)) processEditResourceForm(params);
    else if ("Move to Production".equals(form)) processEditResourceFormProd(params,"t3://"+PROD_IP+":"+PROD_PORT);
    else if ("Move to QA".equals(form)) processEditResourceFormProd(params,"t3://"+QA_IP+":"+QA_PORT);
    else if ("Move to Development".equals(form)) processEditResourceFormProd(params,"t3://"+DEV_IP+":"+DEV_PORT);
    else if ("Find Page".equals(form)) processLoadPageForm(params);
    else if ("Create Page".equals(form)) processNewPageForm(params);
    else if ("Create File Resource".equals(form)) processNewFileResourceForm(params);
    else if ("Create Stored Content Resource".equals(form)) processNewStoredResourceForm(params);
    else if ("Load Page".equals(form)) processPageHitsForm(params);
    else if ("Release Selected".equals(form)) processReleaseResourcesForm(params);
    else if ("Release All".equals(form)) releaseAllResources();
    else if ("Load Resources".equals(form)) processResourceHitsForm(params);
    else if ("Find Resources".equals(form)) processFindResourcesForm(params);
    else if ("Edit Resource".equals(form)) processSelectResourceForm(params);
...
AuthenticationException {
    ...
    if (handle == null || password == null) throw 
...
protected void releaseAllResources () {
    if (currentPage == null) resourceList.clear();
    else resourceList.retainAll(currentPage.getItems());
}
