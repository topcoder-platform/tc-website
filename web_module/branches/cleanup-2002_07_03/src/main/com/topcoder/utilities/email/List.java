...
public class List
{
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  {
    ...
    {
      System.out.println("");
      String msg="Usage: java com.topcoder.email.List subject text_filename list_filename [<mail_from>:default=tlongo@topcoder.com] [<live>:default=false]";
    ...
    String fromAddress = "tlongo@topcoder.com";
    String fromPersonal = "Tom Longo";
    if ( args.length>3 ) {
      fromAddress = args[3];
    }
    boolean live = false;
      ...
      while(true)
      {
        ...
        else
        {
          ...
          try{
            ...
            mail.setMailFromPersonal(fromPersonal);
  ...
  //////////////////////////////////////////////////////////////////////////////// 
  public static String setText(String fileName)
  //////////////////////////////////////////////////////////////////////////////// 
  {
