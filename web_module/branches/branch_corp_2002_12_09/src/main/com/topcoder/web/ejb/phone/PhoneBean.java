    ...
    public long getPhoneId(long userId) throws RemoteException, EJBException {
        ...
        try {
            ...
            DBMS.printSqlException(
                                   true,
                                   sqe);
            throw new EJBException("SQLException getting phone_id");
        } catch (NamingException e) {
            throw new EJBException("NamingException getting phone_id");
        } catch (Exception e) {
            throw new EJBException("Exception getting phone_id\n" +
                                   e.getMessage());
        } finally {
            if (rs != null) {
                try {
                    ...
                    log.error("FAILED to close ResultSet in getPhoneId");
                }
            }
            ...
            if (conn != null) {
                try {
                    ...
                    log.error("FAILED to close Connection in getPhoneId");
                }
            }
            ...
            if (ctx != null) {
                try {
                    ...
                    log.error("FAILED to close Context in getPhoneId");
                }
            }
        }
        return (ret);
