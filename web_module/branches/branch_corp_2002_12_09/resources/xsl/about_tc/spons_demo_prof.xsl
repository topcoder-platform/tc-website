...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Demographics - Professional</xsl:with-param>
</xsl:call-template>
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
				<TR>
					<TD VALIGN="top" WIDTH="11"><IMG SRC="/i/clear.gif" ALT="" WIDTH="11" HEIGHT="1" BORDER="0"/></TD>
					<TD ALIGN="left" COLSPAN="2" VALIGN="top" BGCOLOR="#FFFFFF" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/><BR/><BR/>
...
<!--end contextual links-->
					<P CLASS="bodyText">Professionals make up about 40% of the membership. The following charts demonstrate where these professionals are coming from, their position within the organization, 
					and where their professional interests lie.</P><BR/><BR/><BR/><BR/><DIV ALIGN="center">
					<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" ALIGN="center">
					<TR><TD ALIGN="center"><IMG SRC="/i/about/prof_all.gif" ALT="" WIDTH="500" HEIGHT="500" BORDER="0"/><BR/><BR/></TD></TR>
					</TABLE></DIV>
					</TD>
