                ...
                <xsl:choose>
                    ...
                    <xsl:when test="$roundId='8070' or $roundId='8073' or $roundId='8076'">
                      ...
                      <UL>
                        ...
                        <li>You must be a member of the SAP Developer Network to be eligible for the iPod raffle.  Go here to register:  <a href="http://www.topcoder.com/?t=sponsor&amp;c=link&amp;link=http://sdn.sap.com">http://sdn.sap.com</a> and use â€œTopCoderâ€? as a referral.</li>
                      </UL>
                      <BR/><BR/>
