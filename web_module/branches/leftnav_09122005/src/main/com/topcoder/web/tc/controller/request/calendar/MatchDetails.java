 ...
 * @author cstjohn
 */
public class MatchDetails extends Base {
    private static Logger log = Logger.getLogger(MatchDetails.class);
    ...
    protected void businessProcessing() throws TCWebException {
        ...
        try {
            ...
            ResultSetContainer.ResultSetRow rsr = (ResultSetContainer.ResultSetRow)((ResultSetContainer) resultMap.get("Schedule_SRMS")).get(0);
