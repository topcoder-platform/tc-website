...
<div style="float: right;"><tc-webtag:forumLink forumID="505844" message="Discuss this article" /></div>
<span class="bodyTitle">Dynamic Programming: From novice to advanced</span>
