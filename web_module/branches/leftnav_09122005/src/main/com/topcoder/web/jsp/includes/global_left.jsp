...
<%
   ...
   */
   ...
   nav.addRoot(new NavNode("<a href=\"Javascript:toggleMenu('m_competitors')\" class=\"exp\">Competitions</a>", "m_competitors"));
      ...
      nav.search("m_competitors").addChild(new NavNode("<a href=\"Javascript:toggleMenu('m_alg_comp')\" class=\"exp\">Algorithm Competitions</a>", "m_alg_comp"));
         ...
         nav.search("m_alg_comp").addChild(new NavNode("<a href=\"Javascript:toggleMenu('m_alg_support')\" class=\"exp\">Support/FAQs</a>", "m_alg_support"));
            nav.search("m_alg_support").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=Static&d1=help&d2=index", "How to compete", "alg_how_to_compete"));
      ...
      nav.search("m_competitors").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=Static&d1=calendar&d2=thisMonth", "Calendar", "competition_calendar"));
   nav.addRoot(new NavNode("<a href=\"Javascript:toggleMenu('m_corp_services')\" class=\"exp\">Corporate Services</a>", "m_corp_services"));
   nav.addRoot(new NavNode("<a href=\"Javascript:toggleMenu('m_emp_services')\" class=\"exp\">Employment Services</a>", "m_emp_services"));
      nav.search("m_emp_services").addChild(new NavNode("<a href=\"Javascript:toggleMenu('m_find_job')\" class=\"exp\">Find a job</a>", "m_find_job"));
         nav.search("m_find_job").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=Static&d1=contracting&d2=index", "Job Openings", "tces_openings"));
         nav.search("m_find_job").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=ContractingPreferences", "Registration", "tces_reg"));
      nav.search("m_emp_services").addChild(new NavNode("<a href=\"Javascript:toggleMenu('m_hire_competitor')\" class=\"exp\">Hire a competitor</a>", "m_hire_competitor"));
         nav.search("m_hire_competitor").addChild(new NavNode("", "Post a job opening", "placement"));
         nav.search("m_hire_competitor").addChild(new NavNode("", "Event Sponsorship", "event_sponsorship"));
   nav.addRoot(new NavNode("<a href=\"Javascript:toggleMenu('m_forums')\" class=\"exp\">Forums</a>", "m_forums"));
      nav.search("m_forums").addChild(new NavNode("http://"+ApplicationServer.FORUMS_SERVER_NAME+"/?module=Category&categoryID=13", "Round Tables", "forum_round_tables"));
      nav.search("m_forums").addChild(new NavNode("http://"+ApplicationServer.FORUMS_SERVER_NAME+"/?module=Category&categoryID=14", "Algorithm Matches", "forum_alg_matches"));
      nav.search("m_forums").addChild(new NavNode("http://"+ApplicationServer.FORUMS_SERVER_NAME+"/?module=Category&categoryID=17", "Marathon Matches", "forum_marathon_matches"));
      nav.search("m_forums").addChild(new NavNode("http://"+ApplicationServer.FORUMS_SERVER_NAME+"/?module=Category&categoryID=8", "News Discussions", "forum_news_disc"));
      nav.search("m_forums").addChild(new NavNode("http://"+ApplicationServer.FORUMS_SERVER_NAME+"/?module=Category&categoryID=6", "Sponsor Discussions", "forum_spons_disc"));
   ...
   nav.addRoot(new NavNode("<a href=\"Javascript:toggleMenu('m_about_tc')\" class=\"exp\">About TopCoder</a>", "m_about_tc"));
      nav.search("m_about_tc").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=Static&d1=about&d2=index", "Overview", "tc_about"));
      ...
      nav.search("m_about_tc").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=Static&d1=about&d2=management", "Management", "tc_management"));
      nav.search("m_about_tc").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/", "Contact us", "contact_us"));
