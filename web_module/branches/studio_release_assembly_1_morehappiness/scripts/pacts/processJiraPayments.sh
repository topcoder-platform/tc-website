...
nohup java  -cp $CP com.topcoder.shared.util.sql.DBUtilityLauncher com.topcoder.utilities.pacts.ProcessJiraPayments -xmlfile processJiraPayments.xml $@ > ./nohup.out 2>&1 &
tail -f nohup.out
