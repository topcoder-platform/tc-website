				...
				<div class="information rightSide">
					...
					<div class="content-body">
						<ul class="form">
							...
							<li class="row" id="${demogPrefix}${assignment.question.id}_row">
								<label>
							...
							<li class="row" id="<%=Constants.VISIBLE_SCHOOL%>_row">
							...
							<li class="row" id="<%=Constants.GPA%>_row">
							...
							<li class="row" id="<%=Constants.GPA_SCALE%>_row">
							...
							<li class="row" id="${referralCoder}_div">
							...
							<li class="row" id="${referralOther}_div">
							...
							<li class="form-bottom"><br />
								<a id="btnSave" class="redBtn" href="JavaScript:submitForm();">
