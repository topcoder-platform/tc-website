...
<br/><br/>
This is the second year of the Google Code Jam.  In 2003, Jimmy Mardell of Stockholm, Sweden, took home the grand prize.  Prior to the first Google Code Jam, Google held a smaller programming challenge and hired the winner, who is now part of Google's New York-based engineering team.  More information about Google Code Jam 2004 can be found at http://www.google.com/codejam.  
<br/><br/>
