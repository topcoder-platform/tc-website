...
<p>Members have competed in over 10,000 client competitions to date on the TopCoder platform, including more than 7,500 software development and Studio graphics competitions and 3,500 Races. Client work by members encompasses builds ranging from major b-to-b eCommerce systems and 3rd party developer community platforms for creating new applications for Fortune 500 companies, to online lead generation products for the automobile sector to crowdsourcing and social media platforms for start up businesses. </p>
