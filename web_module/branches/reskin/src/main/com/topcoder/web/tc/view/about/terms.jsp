...
<!-- Left Column Begins-->
        <td width="180">
            <jsp:include page="../includes/global_left.jsp">
                <jsp:param name="node" value="tc_terms"/>
            </jsp:include>
        </td>
<!-- Left Column Ends -->
...
<jsp:include page="/page_title.jsp">
    ...
    <jsp:param name="title" value="Terms & Conditions of Use at TopCoder"/>
</jsp:include>

<span class="bigTitle">Terms & Conditions of Use at TopCoder</span>
<br><br>
<span class="bodySubtitle">Acceptance of Terms and Conditions</span><br>
...
<br><br>
<span class="bodySubtitle">Privacy</span><br>
See our complete <A href="/tc?module=Static&d1=about&d2=privacy">privacy policy</A>.
<br><br>
<span class="bodySubtitle">Provisions Applicable to Chinese Citizens and Expatriates Residing in China</span><br>
...
<span class="bodySubtitle">Copyright, Trademark and Other Intellectual Property</span><br>
...
<br><br>
<span class="bodySubtitle">Indemnification and Release</span><br>
...
<br><br>
<span class="bodySubtitle">Disclaimer</span><br>
...
<br><br>
<span class="bodySubtitle">Limitation of Liability</span><br>
...
<br><br>
<span class="bodySubtitle">Links to Other Web Sites and Services</span><br>
...
<br><br>
<span class="bodySubtitle">Competitions</span><br>
In addition to these Terms of Use, TopCoder may provide specific Official Rules and Regulations and other documentation for certain activities on this Web site, including without limitation, challenges, matches, tournaments or other competitions (collectively "Competitions") conducted by us and those in conjunction with third parties.  These Terms of Use are incorporated by reference into the specific Official Rules and Regulations which appear in connection with information about a particular Competition.  To the extent that any conflict exists between these Terms of Use and any specific Official Rules and Regulations, the Official Rules and Regulations for that Competition in which you choose to participate shall govern.
<br><br>
<span class="bodySubtitle">Materials Posted by Visitors</span><br>
...
<br><br>
<span class="bodySubtitle">Other Restrictions on Conduct</span><br>
...
<br><br>
<span class="bodySubtitle">Choice of Law and Forum</span><br>
...
<br><br>
<span class="bodySubtitle">Severability and Enforceability</span><br>
...
<br><br>
<span class="bodySubtitle">Termination/Exclusion</span><br>
...
<br><br>
<span class="bodySubtitle">General</span><br>
