...
/**
 * <p>Test the ReviewScorecardListAction classes.</p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
public class ReviewScorecardListActionFailureTest extends MockStrutsTestCase {
    /**
     ...
     */
    public ReviewScorecardListActionFailureTest(String testName) {
        super(testName);
