...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:import href="../includes/modules/calendar_apr02.xsl"/>  
...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">2002 - Year at a Glance</xsl:with-param>
</xsl:call-template>			
	...
	<DIV ALIGN="center">  
      <TABLE WIDTH="90%" BORDER="0" CELLSPACING="0" CELLPADDING="5">
        <TR> 
          <TD VALIGN="top"><xsl:call-template name="calendar_apr02"/></TD>
          <TD VALIGN="top"><xsl:call-template name="calendar_apr02"/></TD>
          <TD VALIGN="top"><xsl:call-template name="calendar_apr02"/></TD>
        </TR>
        <TR> 
