...
<jsp:usebean id="sessionInfo" class="com.topcoder.web.common.SessionInfo" />
    ...
    <% if ((level1.equals("testing")) || (level1.equals("tournament")) || (level1.equals("tces")) || (level1.equals("privatelabel"))) { %>
                ...
                <tr><td id="<%=level1.equals("placement")?(level2.equals("placement")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/corp/nav_arrow_<%=level1.equals("testing")?"bottom":"right"%>.gif" width=10 height=10 border=0><a href="/" target="_parent" class="<%=level1.equals("placement")?"leftOn":"left"%>">Placement</a></td></tr>
