...
<jsp:usebean id="sessionInfo" class="com.topcoder.web.common.SessionInfo" />
    ...
    <% if ((level1.equals("testing")) || (level1.equals("tournament")) || (level1.equals("tces")) || (level1.equals("privatelabel"))) { %>
                ...
                <tr><td id="<%=level1.equals("privatelabel")?"leftNavSelect":"leftNav"%>"><img src="/i/corp/nav_arrow_<%=level1.equals("privatelabel")?"bottom":"right"%>.gif" width=10 height=10 border=0><a href="/corp/?module=Static&d1=corp&d2=private_label&d3=index" class="<%=level1.equals("privatelabel")?"leftOn":"left"%>">Private Label Events</a></td></tr>
                <tr><td id="<%=level1.equals("testing")?(level2.equals("overview")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/corp/nav_arrow_<%=level1.equals("testing")?"bottom":"right"%>.gif" width=10 height=10 border=0><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=testing&d3=index" target="_parent" class="<%=level1.equals("testing")?"leftOn":"left"%>">Technical Assessment Tool</a></td></tr>
	            <% if (level1.equals("testing")) { %>
	                ...
	                <tr><td id="leftNavApplet"><img width=10 height=10 src="/i/corp/clear.gif" border=0/><A href="<jsp:getProperty name='sessionInfo' property='ServletPath'/>testing/" class="left">Launch Testing App Tool</A></td></tr>
	            <% } %>
