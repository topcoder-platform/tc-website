    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Health Care Order Processing Development Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Development Application Project - Health Care Order Processing: Front End</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p class="noSpListTitle">
                                                        <strong>Technical Development Requirements</strong>
                                                    </p>
                                                    <ul class="noSpList">
                                                        <li>MVC</li>
                                                        <li>J2EE</li>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$1250.00</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">First Payment -</td>
                                                            <td class="bodyText" align="right">$875.00</td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Total Payment -</td>
                                                            <td class="bodyText" align="right">$437.50</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$2,527.50</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="400">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.15.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Register By:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.16.2004 &#160;&#160;9:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Member Acceptance:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.17.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.26.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Winner Announced:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.28.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Updated Submission Due Date:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.29.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Integration Start:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">04.30.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Integration End:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">05.05.2004 &#160;&#160;6:00 PM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Certification Start:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">05.06.2004 &#160;&#160;9:00 AM ET</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Certification End:</td>
                                                            <td class="bodyText" nowrap="nowrap" align="left">05.07.2004 &#160;&#160;6:00 PM ET</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        Register <a href="/index?t=development&amp;c=tcs_app_inquire&amp;Project=Health%20Care%20Order%20Processing%20Front%20End">here</a> to get selected as a developer and to obtain the information necessary to submit a solution.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
