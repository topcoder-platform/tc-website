    ...
    <rsc:iterator list="<%=designContests%>" id="resultRow">
        <tr class="<%=even?"dark":"light"%>">
            ...
            <td class="value">
                ...
                <div align="center">
                    <a href='/tc?module=Static&d1=tournaments&d2=tco07&d3=component&d4=description'><img class="emblem" src="/i/tournament/tco07/emblem.png" alt="" border="0" onmouseover="popUp(this,'popUp<rsc:item name="project_id" row="<%=resultRow%>"/>')" onmouseout="popHide()"/></a>
                </div>
                <% } else { %>
                &nbsp;
                <% } %>
