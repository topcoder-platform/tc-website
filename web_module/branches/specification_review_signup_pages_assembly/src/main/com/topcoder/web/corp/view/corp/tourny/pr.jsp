...
<td width="100%">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr valign="top"><td id="corpTitle" width="100%" colspan="3">
    <img src="/i/corp/header_event_sponsorship.gif" alt="" width="546" height="41" border="0"></td></tr>
...
<table cellpadding="10" cellspacing="0" border="0" align="right">
    <tr><td>
        <table border="0" cellpadding="6" cellspacing="0" class="sidebarBox">
...
<p>See our complete list of <a href="/tc?module=Static&amp;d1=pressroom&amp;d2=pr_archive" class="bodyText">press
    releases</a>
    and <a href="/tc?module=Static&amp;d1=pressroom&amp;d2=art_archive" class="bodyText">articles</a> to date.</p>
