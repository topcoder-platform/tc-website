    ...
    <table cellspacing="0" cellpadding="0" width="100%" class="screeningFrame">
        ...
        <%
            while (StudentQuestionIterator.hasNext()) {
                ...
                List StudentResponsesList = (java.util.List) StudentQuestionMap.get(question);
        %>
        <TR>
            <TD class="screeningHeader" COLSPAN="3"><%=question%>
            </TD>
        </TR>
        <% boolean odd = true;
            ; %>
...
<TD width="50%">
    ...
    <table cellspacing="0" cellpadding="0" width="100%" class="screeningFrame">
        ...
        %>
        <TR>
            <TD class="screeningHeader" COLSPAN="3"><B><%=question%>
            </B></TD>
        </TR>
        <% boolean odd = true; %>
