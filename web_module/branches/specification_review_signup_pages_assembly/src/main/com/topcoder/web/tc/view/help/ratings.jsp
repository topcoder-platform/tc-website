...
<!-- Left Column Begins-->
        <td width="180">
         <jsp:include page="/includes/global_left.jsp">
            <jsp:param name="node" value="algo_rating_system"/>
         </jsp:include>
        </td>
<!-- Left Column Ends -->
...
<!-- Center Column Begins -->
        <td width="100%" align="left" class="bodyText">
         ...
         <jsp:param name="title" value="Algorithm Competition Rating System"/>
         </jsp:include>

<span class="bigTitle">Algorithm Competition Rating System</span>
<br><br>
