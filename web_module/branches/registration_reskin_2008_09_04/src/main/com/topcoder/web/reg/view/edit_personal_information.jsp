                            ...
                            <div class="content-body">
                                <ul>
                                    ...
                                    <li class="form-row">
                                        ...
                                        <p class="label-description">Street address, P.O. box, company name, c/o</p>
                                    </li>
                                    <li class="form-row">
                                        <label for="address_2">Address Line 2:</label>
                                        <input type="text" name="address_2" id="address_2" size="60" />
                                        <p class="label-description">Apartment, suite, unit, building, floor, etc.</p>
                                    </li>
                                    <li class="form-row">
                                    ...
                                    <li class="form-row"><label>OR &nbsp;&nbsp;&nbsp;</label></li>
                                    <li class="form-row">
                                        <label for="state_province">State/Province:</label>
                                        <input type="text" name="state_province" id="state_province" size="40" />
                                    </li>
                                    <li class="form-row">
                                    ...
                                    <li class="form-row">
                                        <label for="country_represent">* Country to represent:</label>
                                    ...
                                    <li class="form-row">
                                        ...
                                        <input type="text" name="phone_number" id="phone_number" size="30" value="" />
                                    </li>
                                    <li class="form-row">
                                    ...
                                    <li class="form-row">
                                     ...
                                     <li class="form-row">
                                        <label for="email_notify">Email Notifications:</label>
                                          <input type="checkbox" name="TC_studio" id="TC_studio" />TopCoder Studio Competitions</li>
                                    <li class="form-row">
                            ...
                            <div class="content-body">
                                <ul>
                                    <li class="form-row">
                                        ...
                                        <p class="static-field">SuperSmoothie</p>
                                    </li>
                                    <li class="form-row">
