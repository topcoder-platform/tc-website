			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="forumBkgd">
				<tr>
					<td class="blackBkgnd" colspan="2">
					    ...
					    <review:showSubmissionId name="reviewScorecardForm" property="submission" /></td>				
				</tr>
				<tr>
...
<logic:iterate id="question" indexId="qIdx" name="reviewScorecardForm" property="questions">
    ...
    <logic:equal name="question" property="valid" value="false">
                <tr>
					<td colspan="2" width="100%" class="errorText">
					    <html:errors property='<%="questions["+qIdx+"]"%>' /></td>
				</tr>
    </logic:equal>
			    <tr>
			    	<td width="80%" class="forumTextOdd"><review:showString name="question" property="questionText" styleClass="scorecardQuestion" /></td>
	...
	<logic:equal name="question" property="type" value="testcase">
						&nbsp;Pass: <html:text property='<%="questions["+qIdx+"].totalPass"%>' styleClass="registerForm" size="4" /><br>
			...
			<logic:equal name="rspns" property="valid" value="false">
			                <tr>
			        		    <td colspan="5" width="100%" class="errorText">
			        		        <html:errors property='<%="questions["+qIdx+"].responses["+rIdx+"]"%>' /></td>
			        	    </tr>
			</logic:equal>
				        	<tr>
				        		...
				        		<td width="60%" class="forumTextOdd">
				        		    <html:textarea property='<%="questions["+qIdx+"].responses["+rIdx+"].responseText"%>' rows="2" cols="65" /></td>
