 ...
 *   </ol>
 *
 *   Version 1.0.14 (Gameplan Contest Type Assembly 1.0) Change notes:
 *   <ol>
...
public class RBoardApplicationBean extends BaseEJB {
    ...
    /**
     * <p>An <code>int</code> representing the primary review id for gameplan projects.</p>
     *
     * @since 1.0.14
     */
    private static final int GAMEPLAN_PRIMARY_REVIEW_ID = 38;
    ...
    private void validateUserTrans(Connection conn, long projectId, int phaseId, long userId, Timestamp opensOn,
        ...
        if (phaseId == SoftwareComponent.DEV_PHASE) {
            ...
            validateReviewPositions(reviewTypeId, primary, reviewers, RIA_COMPONENT_PRIMARY_REVIEW_ID,
                INCONSISTENT_REVIEWERS_ERROR_MESSAGE_COMMON);
        } else if (phaseId == (WebConstants.GAMEPLAN_PROJECT_TYPE + 111)) {
            validateReviewPositions(reviewTypeId, primary, reviewers, GAMEPLAN_PRIMARY_REVIEW_ID,
                INCONSISTENT_REVIEWERS_ERROR_MESSAGE_COMMON);
        }
