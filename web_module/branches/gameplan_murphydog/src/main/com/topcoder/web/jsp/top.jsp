...
<div id="shortcutBar">
    ...
    <div class="icon"><a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=ActiveContests&pt=29"><img src="/i/interface/scAssembly.png" alt="" onmouseover="postPopUpText('globalPopupText','Gameplan Competitions'); popUp(this,'globalPopup');" onmouseout="popHide()" /></a></div>
