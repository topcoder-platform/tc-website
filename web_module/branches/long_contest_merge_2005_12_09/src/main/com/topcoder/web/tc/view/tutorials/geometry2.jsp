...
<div style="float: right;"><tc-webtag:forumLink forumID="505842" message="Discuss this article" /></div>
<span class="bodyTitle">Geometry Concepts: Line Intersection and its Applications</span>
