...
<!-- Register tab -->
                                    <img src="/i/clear.gif" width="1" height="6" alt="" ><br>
                                    <a class="leftnav" href="https://<%=ApplicationServer.SERVER_NAME%>/pl/?<%=Constants.MODULE_KEY+"=Static&d1=verizon&d2=vcc03_reg"%>" style="margin-left:1px;display:inline;">Registration</a><br/>
...
<!-- Competition Arena tab -->
                        <table border="0" cellpadding="0" cellspacing="0" >
                            <tr valign="middle">
                                <td align="right" width="99%" class="leftnav"><a href="/pl/?module=Static&d1=verizon&d2=vcc03_competition">Competition Arena</a></td>
                                <td align="right" width="18" class="leftnav"><a href="/pl/?module=Static&d1=verizon&d2=vcc03_competition"><img src="/i/events/verizon2003/icn_go.gif" alt="&gt;" width="18" height="18" border="0" hspace="5"></a></td>
                            </tr>
                        </table>
...
--%>
                        <img src="/i/spacer.gif" alt="" width="1" height="20"><br/>
