        ...
        <ul id="secNavRight">
           <c:choose>
              ...
              <c:when test="${mainTab == 'algorithm'}">
                    ...
                    <li><a href="${sessionInfo.servletPath}?module=AlgorithmQualification" class="${secondaryTab == 'advancers' ? 'on' : ''}"><span>Advancers</span></a></li>
              ...
              <c:when test="${mainTab == 'marathon'}">
                    ...
                    <li class="last"><a href="${sessionInfo.servletPath}?module=MarathonAdvancers" class="${secondaryTab == 'advancers' ? 'on' : ''}"><span>Advancers</span></a></li>
              </c:when>
              <c:when test="${mainTab == 'moddash'}">
                    ...
                    <li class="last"><a href="${sessionInfo.servletPath}?module=ModDashLeaders" class="${secondaryTab == 'advancers' ? 'on' : ''}"><span>Advancers</span></a></li>
              </c:when>
