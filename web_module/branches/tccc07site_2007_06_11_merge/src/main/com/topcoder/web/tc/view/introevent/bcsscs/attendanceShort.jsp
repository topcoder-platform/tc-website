            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td>
                            <p>The students at your university have lately picked up the annoying habit of missing classes. To fix this problem your board has decided to only allow students with 75% or higher attendance to sit for the exams. Given a String[] <b>names</b> containing the students' names and a String[] <b>attendance</b> containing their attendance records, return the list of students who have less than 75% attendance.</p>
                            <p>The i<sup>th</sup> student's name is given as the i<sup>th</sup> element of <b>names</b> and his attendance record as the i<sup>th</sup> element of <b>attendance</b>. The attendance record corresponding to each student is specified as a string of 'A's, 'P's and 'M's. An 'A' indicates the students was absent for a class, whereas a 'P' means he was present and a 'M' means he was absent but he submitted a doctor's note for that class. If a student was absent for a class but submitted a doctor's note then that class is not counted when calculating his attendance percentage. Return a String[] containing the names of all the students who do not meet the attendance requirements. The names in the returned String[] should be in the same relative order as <b>names</b>.</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><b>names</b> will contain between 0 and 50 elements, inclusive.</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td><b>attendance</b> will contain the same number of elements as <b>names</b>.</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td>Each element of <b>names</b> will contain between 1 and 50 characters, inclusive.</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td>Each element of <b>attendance</b> will contain between 1 and 50 characters, inclusive.</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td>Each element of <b>names</b> will contain only letters ('A' - 'Z' and 'a' - 'z').</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td>Each element of <b>attendance</b> will contain only 'A', 'P' and 'M' characters.</td>
                    </tr>
                    <tr>
                        <td align="center" valign="top">-</td>
                        <td>Each element of <b>attendance</b> will contain at least one 'A' or 'P' character.</td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
