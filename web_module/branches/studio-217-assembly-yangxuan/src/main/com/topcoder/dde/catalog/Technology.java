...
/**
 * An object that represents a component technology. Instances of this class can
 ...
 * former case, the instance will contain information about the technology's
...
public class Technology implements java.io.Serializable {
    ...
    /** The status constant used to indicate a technology has been deleted */
    public static final long DELETED = 0;

    /** The status constant used to indicate a technology is active */
    ...
    Technology(long id, String name, String description) {
        this(name, description);
        this.id = id;
    }

    /**
     * Constructs a new <code>Technology</code> object.
     *
     * @param name the name of the technology
     * @param description a description of the technology
    ...
    /**
     * Returns the name of this component technology.
     *
    ...
    /**
     * Sets the name of this component technology.
     *
    ...
    /**
     * Returns a description of this component technology.
     *
     * @return a description of this technology
     */
    ...
    /**
     * Sets the description of this component technology.
     *
    ...
    /**
     * Compares the specified object with this technology for equality. Two
     * technologies are considered equal if they have the same name and
     ...
     * technology; <code>false</code> otherwise
     */
     ...
     * codes of the <code>String</code> objects containing the name and
     * description.
     *
     * @return the hash code value for this technology
     */
    public int hashCode() {
