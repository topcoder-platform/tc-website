                    ...
                    <rsc:iterator list="<%=contests%>" id="resultRow">
                        ...
                        <tr class="<%=even?"light":"dark"%>">
                            ...
                            <td class="valueC" nowrap="nowrap">
                                ...
                                <a href="${sessionInfo.servletPath}?module=ViewSubmission&amp;<%=Constants.CONTEST_ID%>=<rsc:item name="contest_id" row="<%=resultRow%>"/>" onfocus="this.blur();"><img src="/i/v2/interface/btnSubmitOrganize.png" alt="Submit &amp; Organize" onmouseover="this.src = '/i/v2/interface/btnSubmitOrganizeOn.png';" onmouseout="this.src = '/i/v2/interface/btnSubmitOrganize.png';" style="margin: 6px 0px 6px 0px;"/></a>
                                <% } else { %>
                                <a href="${sessionInfo.servletPath}?module=ViewRegistration&amp;<%=Constants.CONTEST_ID%>=<rsc:item name="contest_id" row="<%=resultRow%>"/>" onfocus="this.blur();"><img src="/i/v2/interface/btnRegister.png" alt="Register" onmouseover="this.src = '/i/v2/interface/btnRegisterOn.png';" onmouseout="this.src = '/i/v2/interface/btnRegister.png';" style="margin: 6px 0px 6px 0px;"/></a>
                                <% } %>
