...
/**
 * The bean implementation class representing the CMP bean for the comp_download table.
 *
 * @version     1.0
 * @author      Timur Zambalayev
 */
public abstract class DDECompDownloadBean extends DDEBaseDescriptionBean {

    /**
     * Creates a new instance.
     */
    public DDECompDownloadBean() {
    }
