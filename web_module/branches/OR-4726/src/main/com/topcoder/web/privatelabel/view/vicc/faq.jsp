...
<table align="left" cellspacing="0" cellpadding="0" valign="top" width="760">
    ...
    <tr>
        <td align="left" valign="top" colspan="2" style="padding: 0px 0px 0px 20px;">
            ...
            your score.
            <br/><br/>
            Be sure to read the <A href="/pl/?&module=Static&d1=vicc&d2=instructions">Instructions</A> page for a
            ...
            <A href="/pl/?&module=Static&d1=vicc&d2=overview">here</A>. In addition, an email will be sent to all
            participants indicating whether or not each has advanced.
            <br/><br/>
            Questions not addressed here should be directed to
            <A href="vicc@topcoder.com?subject=Question%20regarding%20VeriSign%20Coder%20Challenge%202006">vicc@topcoder.com</A>
            <br/><br/>
            Good luck!
            <br/><br/>
