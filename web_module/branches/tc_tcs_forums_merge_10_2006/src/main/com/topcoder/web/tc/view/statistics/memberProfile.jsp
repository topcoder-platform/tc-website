...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTableHolder">
    ...
    <tr>
        ...
        <td valign="top">
            <table cellpadding="0" cellspacing="0" border="0" class="statTable">
                ...
                <tr><td class="cat" nowrap="nowrap">Total Earnings:</td><td class="stat" align="right">
                    <rsc:item name="overall_earnings" set="<%=rscCoderData%>" format="$#,##0.00"/></td></tr>
                <tr><td class="cat" nowrap="nowrap">Software Royalties:</td><td class="stat" align="right">
                    <rsc:item name="royalties" set="<%=rscCoderData%>" format="$#,##0.00" ifNull="$0.00"/></td></tr>
                <% } %>
                ...
                <tr><td class="cat" colspan="2">
                    ...
                    <A href="/tc?module=MemberContact&th=<%=rscCoderData.getStringItem(0, "handle")%>">[Send a
                        message]</A><br>
                    <% } %>
                    <A href="http://<%=ApplicationServer.FORUMS_SERVER_NAME%>/?module=History&userID=<%=rscCoderData.getStringItem(0, "coder_id")%>">[Forum
                        post history]</A><br>
        ...
        <td class="quoteCell">
            <% if (rscCoderData.getItem(0, "quote").getResultData() != null && !rscCoderData.getStringItem(0, "quote").equals("")) {%>
