                ...
                <div id="pressContainer2">
                    ...
                    <div>
                        ...
                        <div id="pressContainer5">
                            ...
                            <div class="floatR" style="padding-right:10px;" >
                                <div>
                            ...
                            <div id="pressContainer6">
                                <!-- Header Image -->
                                <div id="promoVideos">
                                    <img class="floatR" src="/i/pressroom/promo_vid_banner_right.png" alt="Promo Vid Banner Right" />
                                    <div id="promoVideos2">
                                        <img class="floatL" src="/i/pressroom/promo_vid_banner_left.png" alt="Promo Vid Banner Left" />
                                    </div>
                                </div>

                                <!-- Featured Videos begins-->
                                <div id="featuredVideos">
                                    <img class="floatR" src="/i/pressroom/featured_videos_right.png" alt="Featured Videos Header Right" />
                                    <div id="featuredVideos2">
                                        <img class="floatL" src="/i/pressroom/featured_videos_left.png" alt="Featured Videos Header Left" />
                                    </div>
                                </div>
                                ...
                                <div id="featuredVideosFtr">
                                    <img class="floatR" src="/i/pressroom/featured_vid_ftr_right.png" alt="Featured Videos Footer Right" />
                                    <div id="featuredVideosFtr2">
                                        <img class="floatL" src="/i/pressroom/featured_vid_ftr_left.png" alt="Featured Videos Footer Left" />
                                    </div>
                                </div>
                            </div>
                        </div>
