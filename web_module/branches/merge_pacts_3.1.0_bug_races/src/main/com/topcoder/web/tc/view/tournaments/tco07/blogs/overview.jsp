                    ...
                    <div id="pageBody">
                        ...
                        <div style="width:400px; padding-bottom:20px;">
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=Petr09">Algorithm Finals: Jan_Kuipers wins!</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=jmzero06">The wildcard round: Now with 50% more Batman references</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=Petr07">Design and Development: Round 2</A></span><br />
                                    [ Thursday, June 28 - 7:45 PM ]
                                </p>
                            </div>
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=jmzero05">A sneak peek at the Studio finals</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=Petr05">Algorithm Semifinal Room #3</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=Petr03">Algorithm Semifinal Room #2</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                ...
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=jmzero03">Studio sketchbook showcase showdown</A></span><br />
                            ...
                            <div style="width:400px; float:left;">
                                <p style="float:left; width:50px;">
                                    <img src="/i/m/nophoto.jpg" alt="" width="27" height="30"/><br />
                                    <span class="smallHandle"><tc-webtag:handle coderId="279551" context="algorithm"/></span>
                                </p>
                                
                                <p style="float:left;">
                                    <span style="font-weight:bold;"><A href="/tc?module=Static&d1=tournaments&d2=tco07&d3=blogs&d4=scamp01">Presentation: How the TopCoder process handles QA</A></span><br />
