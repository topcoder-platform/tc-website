...
public class Constants
{
    ...
    public static void initialize(ServletConfig config) {
        ...
        TEST_SET_B_REMOVE = config.getInitParameter("test_set_b_remove_parameter");
        ...
        ROUND_PROBLEM_ID = config.getInitParameter("round_problem_id_parameter");
        ...
        CANDIDATE_LIST_QUERY_KEY = config.getInitParameter("candidate_list_query_key");
        CREATE_CANDIDATE_PROCESSOR = config.getInitParameter("create_candidate_processor");
        POPULATE_CANDIDATE_PROCESSOR = config.getInitParameter("populate_candidate_processor");
        CHECK_COMPANY_USER_QUERY_KEY = config.getInitParameter("check_company_user_query_key");

        //Profile constants
        PROFILE_INFO = config.getInitParameter("profile_info_attribute");
        PROFILE_LOOKUP_COMMAND = config.getInitParameter("profile_lookup_command");
        PROFILE_PROBLEM_SET_QUERY_KEY = config.getInitParameter("profile_problem_set_query_key");
        PROFILE_TEST_SET_A_QUERY_KEY = config.getInitParameter("profile_test_set_a_query_key");
        PROFILE_TEST_SET_B_QUERY_KEY = config.getInitParameter("profile_test_set_b_query_key");
        PROFILE_COMPANY_PROBLEM_QUERY_KEY = config.getInitParameter("profile_company_problem_query_key");
        PROFILE_LANGUAGE_QUERY_KEY = config.getInitParameter("profile_language_query_key");
        ...
        UPDATE_PROFILE_PROCESSOR = config.getInitParameter("update_profile_processor");
        CREATE_PROFILE_PROCESSOR = config.getInitParameter("create_profile_processor");
        PROFILE_CHECK_NAME_QUERY_KEY = config.getInitParameter("profile_check_name_query_key");
        ...
        POPULATE_PROBLEM_DETAIL_PROCESSOR = config.getInitParameter("populate_problem_detail_processor");
        PROBLEM_INFO = config.getInitParameter("problem_info_attribute");
        PROBLEM_DETAIL_COMMAND = config.getInitParameter("problem_detail_command");
        PROBLEM_INFO_QUERY_KEY = config.getInitParameter("problem_info_query_key");
        PROBLEM_ALGORITHMIC_CATEGORY_QUERY_KEY = config.getInitParameter("problem_algorithmic_category_query_key");
        ...
        UPDATE_SESSION_PROCESSOR = config.getInitParameter("update_session_processor");
        PREVIEW_EMAIL_PAGE = JSP_ROOT+config.getInitParameter("preview_email_page");
        SESSION_SETUP_PAGE = JSP_ROOT+config.getInitParameter("session_setup_page");
        SESSION_INFO = config.getInitParameter("session_info_attribute");
        SESSION_LOOKUP_COMMAND = config.getInitParameter("session_lookup_command");
        SESSION_CANDIDATE_INFO_QUERY_KEY = config.getInitParameter("session_candidate_info_query_key");
        SESSION_PROFILE_INFO_QUERY_KEY = config.getInitParameter("session_profile_info_query_key");
        SESSION_CONFIRM_PAGE = JSP_ROOT+config.getInitParameter("session_confirm_page");
        CONFIRM_SESSION_PROCESSOR = config.getInitParameter("confirm_session_processor");
        SESSION_SEGMENT_COMMAND = config.getInitParameter("session_segment_command");
        SESSION_SEGMENT_TEST_SET_A_QUERY_KEY = config.getInitParameter("session_segment_test_set_a_query_key");
        SESSION_SEGMENT_TEST_SET_A_ID = config.getInitParameter("session_segment_test_set_a_id");
        SESSION_SEGMENT_TEST_SET_B_QUERY_KEY = config.getInitParameter("session_segment_test_set_b_query_key");
        SESSION_SEGMENT_TEST_SET_B_ID = config.getInitParameter("session_segment_test_set_b_id");
        TEST_SET_B_SEGMENT_INTERVAL = config.getInitParameter("test_set_b_segment_interval");
        SESSION_CHECK_COMMAND = config.getInitParameter("session_check_command");
        SESSION_DUPE_CHECK_QUERY_KEY = config.getInitParameter("session_dupe_check_query_key");
        SESSION_CHECK_CANDIDATE_TIME_QUERY_KEY = config.getInitParameter("session_check_candidate_time_query_key");

        //Preview Email Constants
        EMAIL_LOOKUP_COMMAND = config.getInitParameter("email_lookup_command");
        REP_EMAIL_INFO_QUERY_KEY = config.getInitParameter("rep_email_info_query_key");
        CANDIDATE_EMAIL_INFO_QUERY_KEY = config.getInitParameter("candidate_email_info_query_key");
        ...
        CONTACT_INFO_QUERY_KEY = config.getInitParameter("contact_info_query_key");
