...
<% if (CoderDemographicsTask.getIsRanked()) { %>
            <table id="linksTable" cellspacing="10" cellpadding="0" border="0">
                <tr>
