    ...
    <TR>
        <TD>
            <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="" WIDTH="100%">
             <TR><TD ALIGN="left" HEIGHT="44" WIDTH="348"><IMG SRC="/i/headinginside_comparena.gif" WIDTH="348" HEIGHT="44" BORDER="0"></TD>
    ...
    <TR>
        ...
        <TR>
            ...
            <TD HEIGHT="100%" CLASS="bodyText">
                        <BR><P>The Practice Rooms in the TopCoder High School Competition Arena are open to TopCoder High School members. As a member you can access the problems, code a solution, and submit the
