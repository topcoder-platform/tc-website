...
<!--end contextual links-->
          ...
          <P><B>Cold Fusion and Java</B></P>
		  <UL><LI>Application development company in central Connecticut</LI>
		  <LI>Will help to bring legacy applications currently in Cold Fusion into straight Java</LI>
		  <LI>Requires leadership in the near future as the staff increases</LI></UL>
		  <P><A HREF="/?t=jobs&amp;c=inquire&amp;Job=CEJC02131&amp;JobDesc=Cold%20Fusion%20and%20Java&amp;To=tcesr@topcoder.com" CLASS="bodyText">Feel qualified and are interested?</A></P>
          <P><BR/></P>
          </TD>
