...
<!--
    <font face="arial, verdana, helvetica, sans-serif" size="1" >
      ...
      <xsl:attribute name="HREF">/admin?overturn=<xsl:value-of select="ChallengeId"/>&amp;Task=challenge&amp;Command=getProblemChallengeList&amp;constraintid=<xsl:value-of select="/TC/CONSTRAINTID"/>&amp;results=<xsl:value-of select="/TC/CHALLENGE/Challenge/RoundId"/>&amp;roundid=<xsl:value-of select="/TC/CHALLENGE/Challenge/RoundId"/>&amp;roomid=<xsl:value-of select="/TC/CHALLENGE/Challenge/Contest/RoomId"/></xsl:attribute>
    </font>
  ...
  <img src="/images/spacer.gif" alt="" width="2" height="1" border="0"/>
    <font face="arial, verdana, helvetica, sans-serif" size="1" >
      <a href="JavaScript:doFilter(1)">Successful Challenges </a>
        <xsl:attribute name="HREF">/admin?overturn=<xsl:value-of select="ChallengeId"/>&amp;Task=challenge&amp;Command=getChallengeList&amp;constraintid=<xsl:value-of select="/TC/CONSTRAINTID"/>&amp;results=<xsl:value-of select="/TC/CHALLENGE/Challenge/RoundId"/>&amp;roundid=<xsl:value-of select="/TC/CHALLENGE/Challenge/RoundId"/>&amp;roomid=<xsl:value-of select="/TC/CHALLENGE/Challenge/Contest/RoomId"/></xsl:attribute>
