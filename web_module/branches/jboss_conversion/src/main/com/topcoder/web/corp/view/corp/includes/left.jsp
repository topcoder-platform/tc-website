...
<jsp:useBean id="sessionInfo" class="com.topcoder.web.common.SessionInfo" />
    ...
    <% if ((level1.equals("testing")) || (level1.equals("tournament")) || (level1.equals("placement")) || (level1.equals("tces")) || (level1.equals("privatelabel"))) { %>
                ...
                <tr><td id="<%=level1.equals("testing")?(level2.equals("overview")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/corp/nav_arrow_<%=level1.equals("testing")?"bottom":"right"%>.gif" width=10 height=10 border=0><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=testing&d3=index" target="_parent" class="<%=level1.equals("testing")?"leftOn":"left"%>">Screening</a></td></tr>
    ...
    <% } else if ((level1.equals("srm"))) { %>
                ...
                <tr><td id="<%=level1.equals("srm")?(level2.equals("index")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/corp/nav_arrow_<%=level1.equals("srm")?"bottom":"right"%>.gif" width=10 height=10 border=0><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=spon_prog&d3=srm_index" target="_parent" class="<%=level1.equals("srm")?"leftOn":"left"%>">Single Round Matches</a></td></tr>
	            <% if (level1.equals("srm")) { %>
	                <tr><td id="<%=level2.equals("web")?"leftSubnavOn":"leftSubnav"%>"><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=spon_prog&d3=srm_web" class="leftOn">TopCoder Web Site</a></td></tr>
	                <tr><td id="<%=level2.equals("applet")?"leftSubnavOn":"leftSubnav"%>"><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=spon_prog&d3=srm_applet" class="leftOn">Arena Applet</a></td></tr>
	                <tr><td id="<%=level2.equals("email")?"leftSubnavOn":"leftSubnav"%>"><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=spon_prog&d3=srm_email" target="_parent" class="leftOn">Opt-In Email</a></td></tr>
	            <% } %>
...
--%>
    ...
    <% } else { %>
                <tr><td id="leftNavTitle">Corporate Services:</td></tr>
                <tr><td id="leftNav"><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=tces_home" class="left">Employment Services</a></td></tr>
                <tr><td id="leftNav"><a href="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=Static&d1=corp&d2=spon_prog&d3=index" class="left">Sponsorship</a></td></tr>
    <% } %>
