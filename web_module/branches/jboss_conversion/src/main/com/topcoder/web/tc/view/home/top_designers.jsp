...
<table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="#555555">
    <tr valign="middle">
        ...
        <td class="statTextBig" width="15"><A href="javascript:infoWindow('/tc?amp;module=Static&amp;d1=statistics&amp;d2=info&amp;d3=topRatedDesigners')" class="statTextBig"><img src="/i/icon_help_blue.gif" alt="?" width="15" height="11" border="0"/></A></td>
...
<table border="0" cellspacing="0" cellpadding="3" width="100%" bgcolor="#333333">
    ...
    <rsc:iterator list="<%=coders%>" id="resultRow">
        <tr>
            ...
            <td align="left" class="<%=even?"formHandleEven":"formHandleOdd"%>" nowrap="nowrap"><tc-webtag:handle coderId='<%=resultRow.getLongItem("coder_id")%>' context="design"/></td>
