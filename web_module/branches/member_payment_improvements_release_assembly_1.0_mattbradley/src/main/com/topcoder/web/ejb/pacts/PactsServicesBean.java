...
public class PactsServicesBean extends BaseEJB implements PactsConstants {
    ...
    public Map findUsers(Map searchCriteria) throws SQLException {
        StringBuffer selectHeader = new StringBuffer(300);
        selectHeader.append("SELECT u.user_id, u.handle, UPPER(u.handle) AS uchandle, u.first_name, u.middle_name, u.last_name, nvl(ua.accrual_amount, 0) as accrual_amount, s.user_status_desc ");
        ...
        whereClauses.add("s.user_status_id = u.status");
