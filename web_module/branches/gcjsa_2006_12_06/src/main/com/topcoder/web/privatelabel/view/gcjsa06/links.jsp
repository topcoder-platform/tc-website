...
<div class="googleTopNav">
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=overview">Overview</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=schedule">Schedule</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=rules">Rules</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=login">Registration</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=instructions">Instructions</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <% } else { %>
    <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=faq">FAQ</a> &nbsp;|&nbsp;
    <% } %>
    ...
    <!-- Advancers tab
                ...
                <% } else { %>
                      <a class="navLink" href="/pl/?module=Static&d1=gcjsa06&d2=advancers">Advancers</a> &nbsp;|&nbsp;
                <% } %>
 -->
    <!-- Practice Arena  tab -->
...
<!--
<br><br>
<span class="bigRed"><A href="/pl/?&module=Static&d1=gcjsa06&d2=advWinners" class="bigRed">The results of the Championship Round</A> are in!</span>
-->