    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="headerR" nowrap="nowrap">
                <a href="<%--${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=ViewPastContests<tc-webtag:sort column="<%=contests.getColumnIndex("amount")%>" includeParams="true" excludeParams="<%=Constants.MODULE_KEY%>"/>--%>">Total Prizes</a>
            </td>
            <td class="headerC">
