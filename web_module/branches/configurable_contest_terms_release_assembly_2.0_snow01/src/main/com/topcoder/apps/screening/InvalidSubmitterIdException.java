 ...
 * This is an exception class inherited from IllegalArgumentException. It is thrown in response to a submitter
 ...
 * @version 1.0
 */
public class InvalidSubmitterIdException extends IllegalArgumentException {
     ...
     */
    public InvalidSubmitterIdException(String msg) {
        super(msg);
    }
     ...
     * @param msg An explanatory message for the exception.
     */
    public InvalidSubmitterIdException(long id, String msg) {
        super(msg);
        this.id = id;
    }
