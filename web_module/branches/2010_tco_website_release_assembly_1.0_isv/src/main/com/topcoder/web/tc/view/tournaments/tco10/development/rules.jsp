...
<tco10:pageSetup title="TCO 10 : Development Competition Rules" area="development" menu="rules"/>
    ...
    <div id="content">
        <div class="contentInner">
            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
<h2 class="pageTitle">Development Official Rules and Regulations</h2><!-- page title -->
                            <p>The 2010 TopCoder Open Development Competition ("Development Competition") will take place between March 29 and July 30, 2010. The Development Competition will include the following tracks of competition:  Assembly, Component Development, Prototypes and Testing Suites.  The Development Competition will consist of online qualifying competitions, with up to fifteen (15) of the highest scoring Competitors from the Development Competition winning a trip to the Tournament. The Development Competition is part of the Tournament, and by participating in the competition, you agree to these <tco10:developmentStaticPageLink page="rules">rules.</tco10:developmentStaticPageLink></p>

                            <h3 class="subTitle">Schedule</h3><!-- sub title-->
                            <p>Competitors can register for the Tournament and be eligible for the Development Competition between 9:00 UTC -4 on March 29, 2010 and 9:00 UTC -4 on July 30, 2010.  The Development Competition will take place between March 29, 2010 and July 30, 2010 ("Development Competition Period"). </p>
                            <p>During the Development Competition Period, Competitors who have registered for the Development Competition and who participate in Tournament-eligible Development competitions (as applicable) on the TopCoder website, will receive points as outlined in these Rules.  A Competitor's submission will not be scored separately for the Development Competition.  Only Tournament-eligible Development competitions in which registration has closed during the Development Competition Period shall be included in determining points for the Development Competition.</p>

                            <h3 class="subTitle">Competition Scoring</h3><!-- sub title-->
                            <p>Scoring in the Development Competition is determined based on the final placement for a Competitor's submission in a Tournament-eligible Development competition (as applicable) in accordance with the rules of such competition.  A Development competition is Tournament-eligible if the competition is identified as being included as part of the Tournament.  Only Competitors who are registered for the Tournament will be considered in determining place and placement points. Placement scoring mirrors the Digital Run placement scoring, and is as follows (where Placement Points for a contest equal the number of DR points that contest offers).  (Scores will be rounded to two decimal places.)</p>
                        ...
                        <div class="text">
                            ...
                            <p>Up to fifteen (15) Competitors with the highest cumulative placement score in the Development Competition in Tournament-eligible competitions will be invited to attend the onsite awards ceremony at the Tournament.</p>
                            ...
                            <p>The Development Competition will award up to $30,250. Any and all applicable taxes on prizes are the sole responsibility of the prizewinner.</p>
                        </div>
                        ...
                        <div class="text">
                            ...
                            <p class="note">Prior to Competitors receiving their cash prize, they must complete all work for all underlying Development competitions and Tournament and Development Competition-related work, such as final fixes.</p>
                        </div>
