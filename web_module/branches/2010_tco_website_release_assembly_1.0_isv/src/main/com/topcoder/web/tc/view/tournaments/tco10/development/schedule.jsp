            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <p>Competitors can register for the Tournament and be eligible for the Development Competition
                            between 9:00 UTC -4 on March 29, 2010 and 9:00 UTC -4 on July 30, 2010.  The Development
                            Competition will take place between March 29, 2010 and July 30, 2010. Only
                            Tournament-eligible design competitions in which registration has closed during the
                            Development Competition Period shall be included in determining points for the Development
                            Competition.</p>
                    </div>
