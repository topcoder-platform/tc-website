...
public abstract class DigitalRunStageReferencePayment extends BasePayment {
	...
	public DigitalRunStageReferencePayment(long coderId, double grossAmount, long stageId) {
		super(coderId, grossAmount);
		this.stageId = stageId;
	}

	public DigitalRunStageReferencePayment(long coderId, double grossAmount, long stageId, int placed) {
	...
	protected void fillPaymentReference(Payment p) {
		p.getHeader().setDigitalRunStageId(getStageId());
	}
