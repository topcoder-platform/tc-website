...
<div id="wrapper">
    ...
    <div id="main"><div id="mainwrapper">
        ...
        <div id="content">
            ...
            <p>The department offers the degrees of Bachelor of Science, Master of Science, and Ph.D. in Computer Science. Currently, we have about 750 undergraduate majors and 180 graduate students working toward their degrees.</p>
            <p>This September (2006), the Computer Science department moved to a new home in the <a target="_blank" href="<tc-webtag:linkTracking link='http://www.cs.purdue.edu/about_us/lawson/' refer='tchs08_purdue' />">Richard and Patricia Lawson Computer Science Building</a>. Construction of the 100,000 square foot, $20 million building started in October 2004. The building provides students and faculty with five state-of-the-art instructional labs, and four new research labs. The Lawson Building is also wired with special 10-gigabit high-speed cable, 100 times faster than the standard Ethernet available throughout most of Purdue's campus.</p>
