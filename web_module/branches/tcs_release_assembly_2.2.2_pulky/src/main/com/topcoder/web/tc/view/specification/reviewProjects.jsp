...
<c:set var="projectList" value="<%=(ResultSetContainer) request.getAttribute("projectList")%>"/>
...
<p>In the table below you will be able to see which projects are available for review, the type of project, the current
    ...
    project. If you click on an specification name you will be able to see all of the details associated with that
    specification review.</p>
...
<p>If you are not currently on the TopCoder Specification Review Board you may send an email to
    ...
    reviews. Please keep in mind only members that have completed specification projects are eligible to join the
    TopCoder Specification Review board.</p>

<p>In order to sign up for a review position, click on the "details" link for any specification with positions available,
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTable">
                        ...
                        <rsc:iterator list="<%=projectList%>" id="resultRow">
                            ...
                            <tr>
                                ...
                                <td class="statDk" align="center">Specification</td>
                                <td class="statDk"><a
                                        href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=ProjectDetail&<%=Constants.PROJECT_ID%>=<rsc:item row="<%=resultRow%>" name="project_id"/>">
                                ...
                                <td class="statDk" align="left" nowrap="nowrap">
                                    <a href="${sessionInfo.servletPath}?<%=Constants.MODULE_KEY%>=ReviewProjectDetail&<%=Constants.PROJECT_ID%>=<rsc:item row="<%=resultRow%>" name="project_id"/>&<%=Constants.PROJECT_TYPE_ID%>=7">details</a>
