<%--
  ...
  -
  - Description: This is the page for displaying the review details for Specification projects. It displays the list
...
<html>
<head>
<title>Open Specification Projects Available for Review</title>
...
<jsp:include page="/page_title.jsp">
    ...
    <jsp:param name="title" value="Review Opportunities"/>
            ...
            <table cellspacing="0" width="530" class="formFrame">
                ...
                <tr>
                    <td class="projectCells" align="left">Specification</td>
                    ...
                    <tr>
                        ...
                        <td class="projectCells" align="center" nowrap>
                            ...
                            <% } else if (((ReviewBoardApplication) reviewer).isSpotFilled()) { %>
                                <tc-webtag:handle coderId="<%=((ReviewBoardApplication)reviewer).getUserId()%>" context='specification'/>
                            <% } else if (isWaiting) { %>
