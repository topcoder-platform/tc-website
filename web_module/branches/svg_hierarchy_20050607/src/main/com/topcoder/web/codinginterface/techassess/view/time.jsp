...
<table cellspacing=0 cellpadding=0 class=timeTable>
   <tr>
      ...
      <td class=timeCellRight>Time Remaining<br />
        <span id="problemSetTimerCID<%=((ProblemSetInfo)problemSets.get(0)).getProblems()[0].getComponentID()%>PTID<%=((ProblemSetInfo)problemSets.get(0)).getTypeId()%>">Initializing</span></td>
      <% } %>
   </tr>
</table>
