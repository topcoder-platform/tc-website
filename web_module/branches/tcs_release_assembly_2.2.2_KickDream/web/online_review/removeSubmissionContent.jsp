	...
	<tr>
		<td align="center" class="lightBkgnd">
			<table border="0" cellpadding="0" cellspacing="4">
				<bean:define id="projectId" name="submission" property="project.id" />
				<bean:define id="submitterId" name="submission" property="submitter.id" />
				<bean:define id="url" value='<%="/removeSubmission.do?action=delete&id="+projectId+"&sid="+submitterId%>' />
				<form action='<html:rewrite page="<%=String.valueOf(url)%>" />' method="post">
				<tr>
					<td class="forumTextCenterOdd" align="center" colspan="2">
					    <textarea name="reason" rows="10" cols="50"></textarea></td>
				</tr>
				<tr>
					<td><html:submit styleClass="submitButton"><bean:message key="button.submit" /></html:submit></td>
					</form>
					<form action="javascript:history.back()">
					<td><html:submit styleClass="submitButton"><bean:message key="button.cancel"/></html:submit></td>
					</form>
				</tr>
			</table>
		</td>
