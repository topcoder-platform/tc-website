...
'<param name="movie" value="/flash/graphLoader20080605.swf?competitionType=long&coderID=<rsc:item set="<%=rsc%>" name="coder_id"/>&myRating=<%=rsc.getIntItem(0, "rating")%>" /> ' +
'<param name="menu" value="true" /> ' +
'<param name="quality" value="high" /> ' +
'<param name="bgcolor" value="#eeeeee" /> ' +
'<embed src="/flash/graphLoader20080605.swf?competitionType=long&coderID=<rsc:item set="<%=rsc%>" name="coder_id"/>&myRating=<%=rsc.getIntItem(0, "rating")%>" ' +
'menu="true"  ' +
'quality="high" ' +
'bgcolor="#eeeeee" ' +
'width="600" ' +
