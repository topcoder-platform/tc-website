...
<!-- Middle Column begins -->
        <td width="99%">
            <table border="0" cellpadding="0" cellspacing="15" width="100%">
                <tr><td class="normal" colspan="2"><img src="/images/headCompCatalogShort2.gif" alt="Component Catalogs" width="134" height="32" border="0" /></td></tr>
                <tr>
                    <td colspan="2">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr valign="middle">
                                <%
                                    switch (refCatalog) {
                                        case 0:
                                            %><td><img src="/images/java_logo.gif" alt="" border="0" /></td><%
                                            break;
                                        case 1:
...
<!-- Status Bar -->
                <tr valign="top">
					<td class="display" colspan="2"><strong>Status: </strong><font class="small">Click on an icon to view project schedules for each phase.</font></td>
				</tr>
...
<!-- Authors -->
                   ...
                   <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <img src="/images/download.jpg" alt="" border="0" /><br />
...
<!-- Current Forums begin -->
                <tr><td><img src="/images/headCurrentForums.gif" alt="Current Forums" width="170" height="18" border="0" />
...
<%  if (hasPreviousForums) { %>
                <tr><td><img src="/images/headPreviousForums.gif" alt="Previous Forums" width="170" height="18" border="0" />
...
<!-- Base Components Included -->
            <table border="0" cellpadding="0" cellspacing="15" width="100%">
                <tr><td><img src="/images/headBaseCompIncl.gif" alt="Base Components Included" width="170" height="18" border="0" /><br />
                		<hr width="100%" size="1" noshade="noshade" />
                	</td>
                </tr>
                <tr>
...
<!-- Documentation-->
            <table border="0" cellpadding="0" cellspacing="15" width="100%">
                <tr><td><img src="/images/headDocumentation.gif" alt="Documentation" width="170" height="18" border="0" />
