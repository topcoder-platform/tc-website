 ...
 * <code>Studio</code> meber in contests of a specified single type.</p>
 *
...
public class ContestStatistics implements Serializable {
    ...
    /**
     * <p>A <code>ContestType</code> referencing the type of the contests which these statistics correspond to.</p>
     */
    ...
    /**
     * <p>An <code>int</code> providing the ratio of the contests which <code>Studio</code> member submitted submisisons
     ...
     *
     * @param contestType a <code>ContestType</code> referencing the type of the contests which these statistics
     *        correspond to.
     */
     ...
     *         submisisons for per total number of contests the member registered to.
     */
     ...
     *        member submitted submisisons for per total number of contests the member registered to.
     */
    ...
    /**
     * <p>Gets the perecentage for the submisisons passed screening.</p>
     *
    ...
    /**
     * <p>Sets the perecentage for the submisisons passed screening.</p>
     *
     * @param passedScreeningPercentage an <code>int</code> providing the ratio of the submissions passed screening per
     *        total number of submissions submitted by <code>Studio</code> member for contests of specified type.
     */
