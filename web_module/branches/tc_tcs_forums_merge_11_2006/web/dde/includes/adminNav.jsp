...
<% } else { %>
			...
			<table width="3%" border="0" cellpadding="0" cellspacing="0" class="adminTopNav">
				<tr valign="middle">
					...
					<td width="156" align="center" class="adminTopNav"><a onmouseover="document.images['userAdmin'].src = userAdminon.src; window.status='User Administration'; return true;" onmouseout="document.images['userAdmin'].src = userAdminoff.src" class="topNavLinks" href="../admin/user_admin.jsp"><img src="/images/userAdmin_off.gif" alt="USER ADMIN" name="userAdmin" width="79" height="21" border="0" /></a></td>
					...
					<td width="106" align="center" class="adminTopNav"><a onmouseover="window.status='Scorecard Administration'; return true;" class="topNavLinks" href="../scorecard_admin/login.jsp">SCORECARD ADMIN</a></td>
<%--
					<td width="106" align="center" class="adminTopNav"><a onmouseover="document.images['scorecardAdmin'].src = scorecardAdminon.src; window.status='Scorecard Administration'; return true;" onmouseout="document.images['scorecardAdmin'].src = scorecardAdminoff.src" class="topNavLinks" href="../scorecard_admin/login.jsp"><img src="/images/scorecardAdmin_off.gif" alt="SCORECARD ADMIN" name="scorecardAdmin" width="79" height="21" border="0" /></a></td>
--%>
				</tr>
			</table>
