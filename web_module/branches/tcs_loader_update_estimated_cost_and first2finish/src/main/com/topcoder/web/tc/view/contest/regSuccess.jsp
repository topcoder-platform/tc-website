...
<%-- Center Column Begins --%>
        <td width="100%" align="center" class="bodyColumn">
            ...
            <p>
                <strong>You have successfully registered for this challenge.</strong>
               <br><br>
                View current <a href="/tc?module=ViewRegistrants&amp;pj=<%=request.getAttribute(Constants.PROJECT_ID)%>">challenge registrants</a>
            </p>
