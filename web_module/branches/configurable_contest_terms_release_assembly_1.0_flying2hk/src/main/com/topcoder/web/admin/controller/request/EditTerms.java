...
public class EditTerms extends Base {
    ...
    protected void businessProcessing() throws Exception {
        ...
        if (tId!=null) {
            ...
            setDefault(Constants.TERMS_OF_USE_URL, termsOfUse.getURL(Long.parseLong(tId), DBMS.OLTP_DATASOURCE_NAME));
            setDefault(Constants.TERMS_OF_USE_ELECTRONICALLY_SIGNABLE,
