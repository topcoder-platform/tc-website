...
<br /><br />
For each Stage, competitors will accumulate placement points according to the <A href="/tc?module=Static&d1=digital_run&d2=2008&d3=devOverview">points table</A>. In addition to the component earnings, the top five (5) finishers will win large prizes and the top 1/2 of the point-getters in each Stage will receive a smaller prize. A total of $76,000 will be awarded in bonus prizes each Stage and will be distributed as follows:
<br /><br />
<strong>Top Five Stage Prizes</strong><br />
<strong>1st</strong> - $15,000<br />
<strong>2nd</strong> - $10,000<br />
<strong>3rd</strong> - $6,000<br />
<strong>4th</strong> - $5,000<br />
<strong>5th</strong> - $3,000
<br /><br />
...
The remaining $37,000 will be distributed among the top half of point-getters (all competitors tied for the last spot included) and will be allocated based on the value of each placement point.
<br /><br />
...
<br /><br />
As an added prize, the top three (3) point-getters from each Stage will win a trip to the 2009 TCO finals to be recognized. At the TCO awards presentation, the overall highest point-getter for the entire year will be recognized as the winner of the TopCoder&#174; Development Cup.
<br /><br />
