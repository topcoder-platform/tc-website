    ...
    <jsp:param name="tabLev3" value=""/>
        ...
        <div class="sub_content">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="stat">
                ...
                <tr class="dark">
                    <td colspan="4">*All times are noted in Eastern Daylight Time (UTC/GMT -4). Click <a target="_blank" href="<tc-webtag:linkTracking link='http://www.timeanddate.com/worldclock/fixedtime.html?month=3&day=15&year=2007&hour=9&min=0&sec=0&p1=179' refer='tco08_componentRules' />">here</a> for your time zone.</td>
                </tr>
            </table>
            <br />
            ...
            Up to twelve (12) competitors in the design competition from the six (6) weeks of online competition will travel to the Mirage on Sunday, May 11, 2008 to compete in the onsite Championship Round of the CDDC being held on Monday, May 12, 2008. All design competitors must arrive at the Mirage no later than 5:00 PM PDT (UTC/GMT -7) on Sunday, May 11, 2008.</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="stat">
                ...
                <tr class="dark">
                    <td>Online participants who score at least 15 placement points for the Design or Development Competition (not combined)</td>
