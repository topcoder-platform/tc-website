                ...
                <tr valign="top">
                    <td height="100%" class="statTextBig">
                        ...
                        <jsp:include page="../includes/tchs03_tabs.jsp" >
                            <jsp:param name="isSchedulePage" value="true"/>
                        </jsp:include>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="10">
                            ...
                            <tr valign="top">
                                <td class="statTextBig">3:30pm - 4:30pm</td>
                                <td class="statTextBig">Awards Reception and Media Hour</td>
                                <td class="statTextBig">Dodd Research Center (behind library)</td>
                            </tr>
                        </table>
