...
<span class="bigTitle">Time Tracker Time Tests Competition</span>
<br><br>
...
The tests in this competition will verify login, time entry, time deletion, time edits, approving contractor's time and rejecting contractors time.
<br><br>
...
Documentation/Specification is available in the application forums <A href="http://<%=ApplicationServer.SOFTWARE_SERVER_NAME%>/forum/c_forum.jsp?f=21388934">here</A>.
<br><br>
...
<%--
To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Time Tracker Time Tests">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
