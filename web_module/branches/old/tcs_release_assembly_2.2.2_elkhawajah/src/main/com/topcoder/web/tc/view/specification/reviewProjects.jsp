                ...
                <rsc:iterator list="<%=projectList%>" id="resultRow">
                    ...
                    <tr>
                        ...
                        <td class="statDk" align="left" nowrap="nowrap">
                            <a href="<%=sessionInfo.getServletPath()%>?<%=Constants.MODULE_KEY%>=ReviewProjectDetail&<%=Constants.PROJECT_ID%>=<rsc:item row="<%=resultRow%>" name="project_id"/>&<%=Constants.PROJECT_TYPE_ID%>=6">details</a>
