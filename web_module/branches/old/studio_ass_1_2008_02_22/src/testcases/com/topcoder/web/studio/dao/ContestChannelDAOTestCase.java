...
/**
 * <p>A unit test for default implementation of {@link ContestChannelDAO} interface.</p>
 *
 * @author isv
 * @version 1.0
 * @since TopCoder Studio Modifications Assembly (Req# 5.2)
 */
public class ContestChannelDAOTestCase extends TCHibernateTestCase {

    /**
     * <p>The instance of {@link ContestChannelDAO} which is tested. This instance is initialized in {@link #setUp()}
     * method and released in {@link #tearDown()} method.</p>
     */
    private ContestChannelDAO testedInstance = null;

    /**
     * <p>Constructs new <code>ContestChannelDAOTestCase</code> instance with specified test name.</p>
     *
     * @param name a <code>String</code> providing the name of the test.
     */
    public ContestChannelDAOTestCase(String name) {
        setName(name);
    }
    ...
    public void setUp() {
        super.setUp();
        this.testedInstance = StudioDAOUtil.getFactory().getContestChannelDAO();
    }
    ...
    public void testDeclaration() {
        ...
        Class<ContestChannelDAO> testedClass = ContestChannelDAO.class;
