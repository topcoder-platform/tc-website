  ...
  <xsl:template match="/">
    <HTML>
      <HEAD>
        ...
        <TITLE>TopCoder :: Privacy Policy</TITLE>
...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="image">privacy</xsl:with-param>
...
<A HREF="/reg/index.jsp" CLASS="bodyText">Register</A>
<BR/><BR/>
...
<BR/><BR/>
                                    <B>Information About All TopCoder Visitors</B>
                                    <BR/>
