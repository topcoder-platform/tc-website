...
public class DBMS {
  ...
  public static final int QA_DB = INFORMIX;
  public static final int PROD_DB = INFORMIX;
  ...
  public static String                INFORMIX_CONNECT_STRING      = "jdbc:informix-sqli://172.16.1.151:1526/dev_oltp:INFORMIXSERVER=tc_dev_tcp;user=coder;password=coder";
  public static String                POSTGRES_DW_CONNECT_STRING   = "jdbc:postgresql://172.16.1.151:5432/b5house";
  public static String                INFORMIX_DW_CONNECT_STRING   = "jdbc:informix-sqli://172.16.1.151:1526/newdw:INFORMIXSERVER=tc_dev_tcp;user=coder;password=coder";
...
/*
  ...
  public static String                POSTGRES_DW_CONNECT_STRING   = "jdbc:postgresql://172.16.214.51:5432/qa_datawarehouse";
  public static String                INFORMIX_DW_CONNECT_STRING   = "jdbc:informix-sqli://172.16.214.51:1526/informixdw:INFORMIXSERVER=datawarehouse_tcp;user=coder;password=coder";
*/

  //** QA (EXODUS)**/
/*
  public static int                   DB                           = INFORMIX;
  public static String                POSTGRES_CONNECT_STRING      = "jdbc:postgresql://192.168.14.52:5432/qa_transactional";
  public static String                INFORMIX_CONNECT_STRING      = "jdbc:informix-sqli://192.168.14.52:2026/prodqaoltp:INFORMIXSERVER=datawarehouse_tcp;user=coder;password=coder";
...
/*
  ...
  public static String                INFORMIX_CONNECT_STRING      = "jdbc:informix-sqli://192.168.14.51:2020/informixoltp:INFORMIXSERVER=informixoltp_tcp;user=coder;password=coder";
  public static String                POSTGRES_DW_CONNECT_STRING   = "jdbc:postgresql://192.168.14.51:5432/tcdw";
  public static String                INFORMIX_DW_CONNECT_STRING   = "jdbc:informix-sqli://192.168.14.52:2022/informixdw:INFORMIXSERVER=datawarehouse_tcp;user=coder;password=coder";
*/
...
*/
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    while (true) {
      ...
      try {
        Driver driver = (Driver) Class.forName ( DBMS.POOL_DRIVER ).newInstance();
        result = driver.connect ( DBMS.QA_POSTGRES_POOL, null );
        if (result == null) throw new SQLException();
        break;
      } catch (SQLException e) {
        try {
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    while (true) {
      ...
      try {
        Driver driver = (Driver) Class.forName ( DBMS.POOL_DRIVER ).newInstance();
        result = driver.connect ( DBMS.JMA_POSTGRES_POOL, null );
        if (result == null) throw new SQLException();
        break;
      } catch (SQLException e) {
        try {
  ...
  ////////////////////////////////////////////////////////////////////////////////
    java.sql.Connection result = null;
    if ( DBMS.DB == DBMS.POSTGRES ) {
      result = getDWConnection ( DBMS.JMA_POSTGRES_DW_POOL );
    } else if ( DBMS.DB == DBMS.INFORMIX ) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
   java.sql.Connection result = null;
   if ( DBMS.DB == DBMS.POSTGRES ) {
     result = DriverManager.getConnection ( DBMS.JMA_POSTGRES_POOL_JTS );
   } else if ( DBMS.DB == DBMS.INFORMIX ) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  public static final java.sql.Connection getTransDWConnection() throws SQLException {
  ////////////////////////////////////////////////////////////////////////////////
    java.sql.Connection result = null;
    result = DriverManager.getConnection ( DBMS.JMA_POSTGRES_DW_POOL_JTS );
    return result;
  }
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    if ( DBMS.DB == DBMS.POSTGRES ) {
      ...
      result = DriverManager.getConnection ( DBMS.POSTGRES_CONNECT_STRING, "coder", "coder" );
    } 
    else
    {
      try {
  ...
  ////////////////////////////////////////////////////////////////////////////////
    ...
    if ( DBMS.DB == DBMS.POSTGRES ) {
      ...
      result = DriverManager.getConnection ( DBMS.POSTGRES_DW_CONNECT_STRING, "coder", "coder" );
    } 
    else
    {
      try {
