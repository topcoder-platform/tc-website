                      ...
                      <xsl:for-each select="/TC/SCHEDULE/Contests/Contest[ContestId=$contestId]">
                        ...
                        <TR BGCOLOR="#666666">
                          ...
                          <TD WIDTH="130" HEIGHT="18" VALIGN="middle" ALIGN="center" class="statText">
                            <B>
                              <xsl:choose>
                                <xsl:when test="ContestId='4105'">8:30 PM</xsl:when>
                                <xsl:when test="ContestId='4110'">7:30 PM</xsl:when>
                          ...
                          <TD WIDTH="130" HEIGHT="18" VALIGN="middle" ALIGN="center" class="statText">
                            <B>
                              <xsl:choose>
                                <xsl:when test="ContestId='4105'">10:00 PM <xsl:value-of select="ShortDaylight"/>.</xsl:when>
                                <xsl:when test="ContestId='4110'">9:00 PM <xsl:value-of select="ShortDaylight"/>.</xsl:when>
