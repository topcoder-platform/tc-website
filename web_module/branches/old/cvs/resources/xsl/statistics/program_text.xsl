...
<SPAN CLASS="bodySubhead">[ <font color="#333333">Code</font> ] </SPAN>
<BR/><BR/>
  ...
  <xsl:otherwise>
    <xsl:for-each select="/TC/STATLISTS/Main/Contest/Problem">
      <xsl:if test="ProblemId=../../ProblemId">
        ...
        <TR>
          <TD BACKGROUND="/i/steel_gray_bg.gif" CLASS="statTextBig" COLSPAN="7" HEIGHT="18">&#160; <xsl:value-of select="../../Handle"/>'s code for <xsl:value-of select="ClassName"/>
          </TD>
        </TR>
        <TR>
          <TD BACKGROUND="/i/steel_darkblue_bg.gif" COLSPAN="7"><IMG SRC="/i/clear.gif" ALT="" WIDTH="1" HEIGHT="1" BORDER="0"/></TD>    
        ...
        <TR>
          <TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="problemText" VALIGN="middle" ALIGN="left">
            <linefeed><detab><spc><xsl:value-of select="ProgramText"/></spc></detab></linefeed>
          </TD>
        </TR>
        <TR>
