        ...
        try {
            ...
            if (pinfo.hasTestSetA()) {
                ...
                for(int i = 0; i < stats.size(); i++) {
                    ...
                    dr.setProperty("pts", String.valueOf(testAResults.getItem(x, "points").getResultData() == null ? "0" : testAResults.getStringItem(x, "points")));
                    dr.setProperty("pm", String.valueOf(stats.getLongItem(i, "problem_id")));
            ...
            for (int i = 0; i < tinfo.getProblemSetBCount(); i++) {
                ...
                dr2.setProperty("pts", String.valueOf(rscB.getItem(i, "points").getResultData() == null ? "0" : rscB.getStringItem(i, "points")));
                Map m2 = dAccess.getData(dr2);
