...
<p>
The challenge is to write a web based tool (preferably using  Silverlight (<A target="_blank" href="http://www.microsoft.com/silverlight/">http://www.microsoft.com/silverlight/</A>) that can do the following:
</p>

<ol>
<li>Connect to a CSF Session Manager Web Service (for the purpose of this competition, you will use <A target="_blank" href="http://csfsession.networkmashups.com/session30/sessionmanageradmin.ashx">http://csfsession.networkmashups.com/session30/sessionmanageradmin.ashx</A>). <A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303394.aspx">More information on the session manager</A></li>
...
<ol>
<li><A target="_blank" href="http://csfsession.networkmashups.com/session30/sessionmanageradmin.ashx">Session Manager Admin</A> - This is the host for all sessions and the interface where you create, delete and search for sessions. <A target="_blank" href="http://csfsession.networkmashups.com/session30/sessionmanageradmin.ashx">More information</A> on this interface can be found on MSDN.</li>
<li><A target="_blank" href="http://csfsession.networkmashups.com/session30/sessionadmin.ashx">Session Admin</A> - The interface that allows you to manipulate each individual session. <A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303401.aspx">More information</A> about this interface can be found on MSDN. </li>
<li><A target="_blank" href="http://csfsession.networkmashups.com/session30/session.ashx">Session</A> - the interface of the session, which allows you to route a message and put a session into hibernate mode. <A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303452.aspx">More information</A> about this interface can be found on MSDN.</li>
</ol>
...
<ol>
<li><A target="_blank" href="http://sandboxapp.networkmashups.com/servicecatalogWSE/servicecatalog.ashx">Service Catalog</A> - a searchable catalog of service information. So when adding a service into the session, this catalog could be used to search for it and find it.</li>
<li><A target="_blank" href="http://csf.networkmashups.com/IdentityManager30/IdentityManager.ashx">Identity Management</A> - the component that provides the details about the persona participant. <A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303438.aspx">More information can be found here.</A></li>
</ol>

<h3>What is the "Session Manifest"?</h3>

<p>
<A target="_blank" href="/i/download/msSessionManifest/manifest.xml">manifest.xml</A> provides an idea about the format of Session manifest, details about participant manifest, types of participants, routing rules & policy details.
</p>

<p>
<A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303401.aspx">This API</A> is used to manipulate the Session manifest. 
</p>
...
<p>
<A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303401.aspx">Details about the API</A> that could be used to manipulate the Session manifest. 
</p>

<p>
All the services are registered in Service catalog and can be queried <A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303485.aspx">using the APIs</A>.
</p>
...
<A target="_blank" href="http://msdn2.microsoft.com/en-us/library/aa303446.aspx">More information</A>

<h3>Example Visualizations</h3>

<p>
<A target="_blank" href="/i/download/msSessionManifest/form1.jpg">form1.jpg</A>
<br><A target="_blank" href="/i/download/msSessionManifest/sessionDiagram.jpg">sessionDiagram.jpg</A>
</p>
