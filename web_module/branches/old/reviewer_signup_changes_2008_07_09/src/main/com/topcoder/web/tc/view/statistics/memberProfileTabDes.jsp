    ...
    <td colspan="2" align="center" style="border-top: 1px solid #999999;">
        <script language="JavaScript">
            var s = '<object ' +
                    ...
                    '<param name="movie" value="/flash/graphLoader20080605.swf?competitionType=des&coderID=<%=request.getParameter("cr")%>&myRating=<%=rscDesData.getIntItem(0, "rating")%>" />' +
                    '<param name="menu" value="true" /> ' +
                    '<param name="quality" value="high" /> ' +
                    '<param name="bgcolor" value="#EEEEEE" /> ' +
                    '<embed ' +
                    'src="/flash/graphLoader20080605.swf?competitionType=des&coderID=<%=request.getParameter("cr")%>&myRating=<%=rscDesData.getIntItem(0, "rating")%>" ' +
                    'menu="true" ' +
                    'quality="high" ' +
                    'bgcolor="#EEEEEE" ' +
                    'width="600" ' +
