...
<tr>
<td class="rtFooter">
<input type="image" src="http://forums.dev.topcoder.com/i/roundTables/post.gif" class="rtButton" alt="Post" onclick="form1.module.value='PostMessage'"/>
<input type="image" src="http://forums.dev.topcoder.com/i/roundTables/preview.gif" class="rtButton" alt="Preview" onclick="form1.module.value='PreviewMessage'"/>
