...
<link type="text/css" rel="stylesheet" href="http://forums.dev.topcoder.com/css/roundTables.css"/>
...
<tr valign="top">
   ...
   <td align="right" nowrap="nowrap" valign="top">
       ...
       <% if (ForumsUtil.userCanPost((Map) session.getAttribute("roleMap"), forum)) { %>
		<A href="?module=Post&<%=ForumConstants.POST_MODE%>=New&<%=ForumConstants.FORUM_ID%>=<jsp:getProperty name="forum" property="ID"/>" class="rtbcLink">Post New Thread</A>&#160;&#160;|&#160;
       <% } %>
...
<tc-webtag:iterator id="announcement" type="com.jivesoftware.forum.Announcement" iterator='<%=(Iterator)request.getAttribute("announcements")%>'>
    ...
    <td class="rtThreadCellWrap">
        <div><A href="?module=Announcement&<%=ForumConstants.ANNOUNCEMENT_ID%>=<jsp:getProperty name="announcement" property="ID"/>" class="rtLinkBold"><img src="http://forums.dev.topcoder.com/i/interface/announcement.gif" alt="" border="0" /> <%=announcement.getSubject()%></A></div>
    </td>
