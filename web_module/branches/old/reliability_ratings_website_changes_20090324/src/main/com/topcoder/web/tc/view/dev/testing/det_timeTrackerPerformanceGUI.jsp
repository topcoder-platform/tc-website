...
<span class="bigTitle">Time Tracker Performance and GUI Tests Competition</span>
<br><br>
...
The tests in this competition will verify various performance and GUI constraints.
<br><br>
...
Documentation/Specification is available in the application forums <A href="http://<%=ApplicationServer.SOFTWARE_SERVER_NAME%>/forum/c_forum.jsp?f=21388976">here</A>.
<br><br>
...
<%--
To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Time Tracker Performance and GUI Tests">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
