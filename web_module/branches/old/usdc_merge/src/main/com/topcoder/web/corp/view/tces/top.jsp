...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000">
    <tr valign="middle">
        ...
        <td width="206"><a href="?task=MainTask" target="_parent"><img src="/i/corp/logo_recruiting_reports.gif" width="206" height="49" border="0" vspace="5"/></a></td>
    ...
    <tr><td height="3" class="headStripe" colspan="5"><img src="/i/corp/clear.gif" alt="" height="3" alt="" border="0"></td></tr>
</table>
<!-- Header ends -->
