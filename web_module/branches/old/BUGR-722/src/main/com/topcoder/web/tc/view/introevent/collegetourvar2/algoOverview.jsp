    ...
    <ul>
        <li>
            <%
                ...
                Timestamp presentation = new Timestamp(start.getTime()-90*60*1000);

                Timestamp testEnd = (Timestamp)request.getAttribute("sysTestEnd");
                Timestamp food = new Timestamp(testEnd.getTime()+5*60*1000);
            %>
