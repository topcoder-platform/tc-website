            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr valign="top">
                    <td class="bodyText" width="100%">
                        ...
                        <p>New to TopCoder? <a href="http://<%=ApplicationServer.SERVER_NAME%>/reg/" class="bodyText">Register</a>
                            today!</p>
                        <% } else { %>
                        <p>If you are not <%=sessionInfo.getHandle()%>, and would like to create a new account
                            <a href="http://<%=ApplicationServer.SERVER_NAME%>/reg/" class="bodyText">click here</a>.
                            <% } %>
                        ...
                        <form method="post" name="frmLogin" action="<jsp:getProperty name="sessionInfo" property="secureAbsoluteServletPath"/>">
                            ...
                            <td class="statText" align="center">
                                <table border="0" cellpadding="3" cellspacing="0">
                                    <tr><td colspan="3">
                                        <img src="/i/corp/clear.gif" width="10" height="3" alt="" border="0"></td></tr>

                                    <tr valign="middle">
                                        <td nowrap class="loginText" align="right">User Name:</td>
                                        <td colspan="2" align="left">
                                            <input type="text" name="<%=Login.KEY_USER_HANDLE%>" value="" maxlength="15" size="12" onkeypress="submitEnter(event,document.frmLogin)">
                                        </td>
                                    </tr>
                                    ...
                                    <tr valign="middle">
                                        ...
                                        <td align="left">
                                            <input type="password" name="<%=Login.KEY_USER_PASS%>" value="" maxlength="30" size="12" onkeypress="submitEnter(event,document.frmLogin)">
                                        </td>
                                        <td nowrap class="loginText">
                                            &#160;&#160;<a href="JavaScript:document.frmLogin.submit()" class="loginText">Login&#160;&gt;</a>
                                        </td>
                                    </tr>
