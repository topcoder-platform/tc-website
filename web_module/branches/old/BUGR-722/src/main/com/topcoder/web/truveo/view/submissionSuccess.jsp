...
<c:set value="<%=gc.getTime()%>" var="bigStart"/>
        ...
        <div align="center">
            ...
            <c:when test="${contest.startTime > bigStart}">
                ...
                <div align="center">
                    <a href="${sessionInfo.servletPath}?module=ViewSubmission&amp;<%=Constants.CONTEST_ID%>=${contest.id}" onFocus="this.blur();"><img src="/i/events/truveo/interface/btnSubmitAnother.png" alt="submit another" /></a>
                </div>
            </div>
        </div>
