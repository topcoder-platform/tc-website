...
<html class="compDocs">
<head>
    <title>2003 TopCoder Open sponsored by Intel&#174; - Component Finals - aksonov</title><jsp:include page="/script.jsp" />
    ...
    <tr valign="top">
        ...
        <td width="99%">
            ...
            <jsp:include page="times.jsp">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tco03/comp_docs/aksonov/SequenceDiagram2.gif" alt="" width="1340" height="440" border="0"></div></td>
