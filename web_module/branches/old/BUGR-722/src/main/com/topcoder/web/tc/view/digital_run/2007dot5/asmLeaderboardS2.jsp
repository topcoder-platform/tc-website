...
<div align="right"><a href="/tc?module=Static&amp;d1=digital_run&amp;d2=2007dot5&amp;d3=asmLeaderboardS1">Stage 1 Leaderboard</a></div><br />
<table cellpadding="0" cellspacing="0" class="stat" width="100%">
<tbody>
    <tr>
        <td class="title" colspan="8">
            Assembly Cup Series Leaderboard (Stage 2)
        </td>
    </tr>
    <tr>
        <td class="headerC">
