...
You can become a TopCoder member by registering at <A href="/reg/">http://www.topcoder.com/reg/</A>. Contestants can then register for component competitions by visiting the TopCoder Developer Center <A href="/tc?module=ViewActiveContests&ph=112">here</A> and <A href="/tc?module=ViewActiveContests&ph=113">here</A>.  Documentation on the TopCoder Software process, including valuable tutorials and sample diagrams, is available at http://software.topcoder.com/components/methodology.jsp, http://www.topcoder.com/tc?module=Static&d1=dev&d2=support&d3=desDocumentation and  http://www.topcoder.com/tc?module=Static&d1=dev&d2=support&d3=devDocumentation.  You must be a TopCoder member in good standing and at least 18 years of age to participate.
<br><br>
