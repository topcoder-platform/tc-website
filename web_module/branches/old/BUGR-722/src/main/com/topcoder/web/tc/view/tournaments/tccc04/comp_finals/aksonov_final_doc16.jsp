    ...
    <tr valign="top">
        <td width="190">
            <jsp:include page="aksonov_files.jsp">
                ...
                <jsp:param name="doc" value="doc16" />
            </jsp:include>
        </td>
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/aksonov/diagrams_final/Catalog_Use_Case_Diagram_Managing_Products_and_Groups.gif" alt="" border="0"></div></td>
