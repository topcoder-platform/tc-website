...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
    ...
    <TR>
        ...
        <TR>
            ...
            <!--Body starts here-->
            <BR><BR>No purchase necessary to enter or win.
          <BR><BR><B>Single Round Match Description</B><UL><LI>Maximum of 20 coders per room</LI><LI>Ratings will be adjusted post-match</LI><LI>Members will be emailed prior to the match with date and time (opt-in)</LI><LI>Members will be emailed the match results (opt-in)</LI></UL>
	      The match will feature a mixed programming language format. For each individual problem, the coder will have the option of using either Java or C++ to code the solution. Syntactical knowledge of both languages will be helpful during the challenge phase of each round of competition.<BR><BR><B>Divisions and Ironman Room Assignments:</B><UL><LI>Members rated 1200 or better compete in Division-I</LI><LI>Members rated 1199 or lower compete in Division-II</LI></UL><UL><LI><B>When to start the Online Tournament Rounds</B><BR>
TopCoder members must register for each single round match from within the competition arena. 
              ...
              rating for each room is similar. The start time will vary from match to match, so be sure to check the <A CLASS="bodyText" HREF="/hs/schedule/schedule.jsp">calendar</A> for
          ...
          </LI><OL><LI><B>The Coding Phase</B> is a timed event where all
            ...
            </LI><LI><B>The Challenge Phase</B> is a timed event wherein each competitor
            ...
            </LI><LI><B>The Automated Testing Phase</B> is applied to all submitted code that has
            ...
            </LI></OL><BR><LI><B>Scoring during Online Tournament Rounds</B><BR>
          ...
          </LI></UL><BR><B>Conditions of Participation</B><BR>
...
<BR><BR><BR><B>Participants</B><BR>
                                    Anyone who is at least 13 years of age may participate in any single round match.<BR><BR><B>Other</B><BR>
       ...
       <A HREF=" http://www.topcoder.com "> http://www.topcoder.com </A>displayed for at least 3 months after the end of the
        competition.<BR><BR>

        This tournament is brought to you by
        TopCoder, Inc., 703 Hebron Ave, Glastonbury, CT 06033.<BR><BR><P><BR></P>
