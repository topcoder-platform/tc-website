...
<jsp:include page="/hs/includes/global/left_calendar.jsp" />
    ...
    <TR>
        ...
        <TR>
            ...
            <P>NOTE:  REGISTRATION FOR TOPCODER HIGH SCHOOL WILL BE ACTIVE IN JANUARY 2003.  IF YOU ARE CURRENTLY INTERESTED IN SIGNING UP YOUR HIGH SCHOOL TO PARTICIPATE, <A HREF="/hs/registration/registration_form.jsp">CLICK HERE</A> TO FILL OUT A FORM.</P>


         
            
            
           <!-- <P><B>If you are a FACULTY MEMBER who would like to sign up as the Coach for your high school's team, click here to register: <A HREF="/hs/registration/registration_coach.jsp">click here</A></B></P>
            <P><B>If you are a STUDENT who would like to sign up as a competitor, click here to register: <A HREF="/hs/registration/registration_student.jsp">click here</A></B></P>-->
            <!-- End Body-->            
            </TD>
             <TD>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
