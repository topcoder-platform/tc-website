...
<BR><P><B>February 2003</B></P><DIV ALIGN="right"><form name="selectform"><select onchange="window.location='/hs/schedule/'+this.options[this.selectedIndex].value" class="dropdown" size="1" name="quickstat">
