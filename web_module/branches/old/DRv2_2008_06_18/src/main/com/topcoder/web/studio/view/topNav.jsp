...
<div id="menubar">
    <div id="nav">
        <ul>
            ...
            <li<% if (node.equals("digitalrun")) {%> class="active"<% } %>><a href="/?module=Static&amp;d1=digitalrun&amp;d2=2008v2&amp;d3=overview" title="Contests" onfocus="this.blur();">The Digital Run</a></li>
