...
<td align="center" class="<%=even?"advDK":"advLT"%>" ><rsc:item name="seed" row="<%=resultRow%>"/></td>

<td class="<%=even?"advDK":"advLT"%>" nowrap=nowrap><tc:ratingImage link='<%=sLink + resultRow.getIntItem("user_id")%>' bg='W' cid='<%=resultRow.getIntItem("user_id")%>' /></td>
