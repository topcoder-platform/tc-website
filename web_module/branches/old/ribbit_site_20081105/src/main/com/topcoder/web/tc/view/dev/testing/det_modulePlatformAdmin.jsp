...
<p><span class="bigTitle">Module Platform Admin Testing Competition</span></p>
...
<pre>
[Member Handle]_moduleplatform_admin_testing_[root directory name].zip
</pre>
<p>
...
<pre>
[Member Handle]_moduleplatform_admin
    Application
        Src
            java
                test
                    admin- [test files in appropriate
                     package structure]
                docs
...
<p>Members interested in registering for this competition should email to <A href="mailto:mailto:TestingSubmissions@topcoder.com?subject=Register:%20Module%20Platform%20Admin%20Testing">TestingSubmissions@topcoder.com</A>.  In the email, include the following information:</p>
<ul>
<li>Handle</li>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit:%20Module%20Platform%20Admin%20Testing">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
