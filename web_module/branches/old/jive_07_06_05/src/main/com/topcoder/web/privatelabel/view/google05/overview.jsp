...
<table border=0 width=100% cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<td>
			...
			<br/><br/>
			Download the Google Code Jam 2005 Competition Manual <a href="/i/events/google2005/competitionManual2.pdf">here</a>.
			<br/><br/>
			...
			<br/><br/>
			Registration for the Google Code Jam 2005 opens on September 1st and ends on September 14th, 2005. Registration is unlimited, but only the top 500 scorers from the Qualification Round will advance to Round 1 of the Code Jam 2005 on September 20th.
			<br/><br/>
			...
			<br/><br/>
			The 500 participants in Round 1 will receive a "Google Code Jam 2005, Powered by TopCoder" t-shirt. The top five scorers in the Championship Round will receive the following cash prizes:
			<br/><br/>
			<div class=indented>
