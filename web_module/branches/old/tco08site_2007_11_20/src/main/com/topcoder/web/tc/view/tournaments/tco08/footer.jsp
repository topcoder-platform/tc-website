<div id="footer">
    ...
    <h3 id="powered"><a href="/" title="Powered by TopCoder"><img src="/i/tournament/logo_tc.png" width="169" height="26" alt="TopCoder" /></a></h3>
    ...
    <div id="footercontent">
        ...
        <p id="copyright">Copyright &#169; 2001-2007, TopCoder, Inc. All rights reserved.</p>
    </div><%-- #footercontent --%>
