...
<!-- Center Column Begins -->
      ...
      <br/><br/>
      In order to test your latest compiled code, click on the "Test" button in the coding window.  Doing so will launch the <A href="/tc?module=Static&d1=hs&d2=support&d3=problemArguments">Problem Arguments window</A> which will allow you to input the testing arguments for a specific test case.
      <br/><br/>
