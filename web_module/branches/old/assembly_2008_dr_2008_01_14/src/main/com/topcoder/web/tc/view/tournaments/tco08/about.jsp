...
<div id="wrapper">
    ...
    <jsp:param name="tabLev3" value=""/>
        ...
        <div align="center"><img src="/i/tournament/tco08/tco08overview.png" /></div>
        ...
        <p>The 2008 TopCoder Open (TCO) is a world-wide programming tournament open to all TopCoder members who are 18 and older.  There are five different competitions as part of the TCO:  <a href="/tc?module=Static&d1=tournaments&d2=tco08&d3=algorithm&d4=description">Algorithm Competition</a>, <a href="/tc?module=Static&d1=tournaments&d2=tco08&d3=component&d4=description">Component Design</a>, <a href="/tc?module=Static&d1=tournaments&d2=tco08&d3=component&d4=description">Component Development</a>, <a href="/tc?module=Static&d1=tournaments&d2=tco08&d3=marathon&d4=description">Marathon Competition</a> and <a href="/tc?module=Static&d1=tournaments&d2=tco08&d3=studio&d4=description">Studio Design Competition</a>.  Becoming a TopCoder member is easy and free. Register <a target="_blank" href="/reg">here</a>.  Taking part in the 2008 TCO gives you the opportunity to showcase your programming or design skills up against some of the best in the world.  We're also dishing out $260,000 in prizes.  Have a question about the event or about being a TopCoder member?  Just email <a href="mailto:service@topcoder.com?subject=2008 TopCoder Open Questions/TopCoder Membership">service@topcoder.com</a>.</p>
