...
#compile java files
echo 'Compiling...'
javac -deprecation com/topcoder/web/render/ejb/$directoryname/*.java -d /home/steveb/build/classes

mkdir -p /home/steveb/build/classes/META-INF

cp -f \
  com/topcoder/web/render/ejb/deploy/cm/ejb-jar.xml \
  com/topcoder/web/render/ejb/deploy/cm/weblogic-ejb-jar.xml \
