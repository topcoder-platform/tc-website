        ...
        <tr valign="top">
            ...
            <td width="100%" align="left" class="bodyColumn">
                ...
                <logic:notEqual name="systemTestCount" value="0">
                    <p align="center">System Tests Remaining: <strong><%=systemTestCount%>
                    </strong></p>
                </logic:notEqual>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="stat">
                    <tbody>
                        ...
                        <% } %>
                        <%boolean even = true;%>
                        <logic:iterate collection="<%=result%>" id="resultRow"
                                       type="com.topcoder.server.ejb.TestServices.LongTestQueueStatusItem">
                            <tr class="<%=even?"light":"dark"%>">
                                ...
                                <td class="value" nowrap="nowrap">
                                    <a href="?module=ViewStandings&amp;rd=<%=resultRow.getRoundId()%>">
                                        <mm:contest roundName="<%=resultRow.getRoundName()%>"
                                                    contestName="<%=resultRow.getContestName()%>"
                                                    roundTypeId="<%= (Integer) roundTypes.get(new Integer(resultRow.getRoundId())) %>"/>
                                    </a>
                                </td>
                                <td class="value" nowrap="nowrap">
                                ...
                                <td class="valueC">
                                    <tc-webtag:format object="<%=resultRow.getQueueDate()%>"
