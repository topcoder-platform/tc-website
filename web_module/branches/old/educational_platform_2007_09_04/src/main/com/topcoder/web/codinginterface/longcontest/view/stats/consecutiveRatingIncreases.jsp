...
<div class="fixedWidthBody">
    ...
    <div style="float:right;"><A href="/longcontest/?module=Static&d1=stats&d2=recordbook_home">back to table of
        contents</A></div>
<span class="bodyText">

<c:set var="allTypes" value="${wst == 9 }"/>

<tc-webtag:ifLink useLink="${allTypes}" text="Non-tournament"
                  link="/longcontest/stats/?module=Recordbook&c=marathon_consecutive_rating_increases&amp;wst=8"/> |
<tc-webtag:ifLink useLink="${not allTypes}" text="All"
                  link="/longcontest/stats/?module=Recordbook&c=marathon_consecutive_rating_increases&amp;wst=9"/>
<br><br>
...
<c:choose>
    ...
    <table class="stat" cellpadding="0" cellspacing="0"
           style="float: left; width: 510px; margin-right: 15px; margin-bottom: 15px;">
        <thead>
            <tr>
                <td class="title" colspan="6">Most Consecutive Marathon Rating Increases</td>
            </tr>
            <tr>
                        ...
                        <c:choose>
                            <c:when test="${row.map['is_current'] == 1 }">
                                ...
                                <div style="float: right; width: 30px;">
                                    <img src="/i/interface/emblem/andclimbing.png" alt="" align="absmiddle"
                                         onmouseover="popUp(this,'emblemPopup')" onMouseOut="popHide()"/>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div style="float: left; width: 30px;">
    ...
    <div class="popUp" id="emblemPopup">
        <div>And climbing</div>
    </div>
