        ...
        <TD CLASS="statTableSpacer" WIDTH="100%" VALIGN="top">
            ...
            <form action="<jsp:getProperty name="sessionInfo" property="servletPath"/>" method="GET" name="adminForm">
                ...
                <p>
                    ...
                    <tc-webtag:rscSelect name="<%=Constants.ROUND_ID%>" list="<%=rounds%>" fieldText="name"
                                         fieldValue="round_id"/>
                </p>
                ...
                <ul>
                    ...
                    <li><a href="javascript:submit('ViewAdminForceSubmit', 1);">Resubmit Example Competitor Code</a>
                    </li>
                </ul>
