...
<td width="100%" align="left" class="bodyColumn">
    ...
    <div align="right" style="margin: 6px 0px;">
        <a href="/longcontest/?module=Static&amp;d1=instructions"><img src="/i/interface/getStarted.png"
                                                                       alt="Need help? Learn how to get started"/></a>
    </div>
            ...
            <tr class="<%=even?"light":"dark"%>">
                <td class="value">
                    ...
                    <div style="float: right; margin-left: 4px;">
                        <ci:sponsorImage image="sponsorImage" alt="Sponsor" border="0" ifNull=""/>
                    </div>
                    <a href="/tc?module=MatchDetails&amp;<%=Constants.ROUND_ID%>=${contest.roundID}">
                        <mm:contest roundTypeId="${contest.roundTypeId}" contestName="${contest.contestName}"
                ...
                <td class="valueC" align="center">
                    <tc-webtag:beanWrite name="contest" property="submissionCount"/>
                </td>
