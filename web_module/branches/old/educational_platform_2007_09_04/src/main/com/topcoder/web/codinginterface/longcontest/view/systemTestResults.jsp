...
<TD CLASS="statTableSpacer" WIDTH="100%" VALIGN="top">
    ...
    <span class="bigHandle">Contest: <A href="?module=ViewOverview&rd=<rsc:item name="round_id" row="<%=infoRow%>"/>"
                                        class="bcLink">
        <rsc:item name="contest_name" row="<%=infoRow%>"/>
        &gt;
        <rsc:item name="round_name" row="<%=infoRow%>"/>
    </A></span><br>
                        ...
                        <rsc:iterator list="<%=cases%>" id="resultRow">
                            ...
                            <td class="tableHeader" align="right" nowrap="nowrap">
                                ...
                                <span style="font-weight: normal;">(<A
                                        href="<jsp:getProperty name="sessionInfo" property="absoluteServletPath"/>?module=ViewSystemTest&<%=Constants.TEST_CASE_ID%>=<rsc:item name="test_case_id" row="<%=resultRow%>"/>&<%=Constants.ROUND_ID%>=<%=request.getParameter(Constants.ROUND_ID)%>&<%=Constants.PROBLEM_ID%>=<%=request.getParameter(Constants.PROBLEM_ID)%>">details</A>)</span>
                            </td>
                        </rsc:iterator>
                    </tr>
                    <%boolean even = true;%>
