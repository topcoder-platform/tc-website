        ...
        <td class="statTableSpacer" width="100%" valign="top">
            ...
            <div class="fixedWidthBody">
                ...
                <form name="f" action='<jsp:getProperty name="sessionInfo" property="servletPath"/>' method="get">
                    ...
                    <div class="pagingBox">
                        <tc-webtag:prevPage servletPath="${sessionInfo.servletPath}" list="${list}"
                                            styleClass="bcLink"/>
                        |
                        <tc-webtag:nextPage servletPath="${sessionInfo.servletPath}" list="${list}"
                                            styleClass="bcLink"/>
                    </div>

                    <table class="stat" cellpadding="0" cellspacing="0" width="510" border="0">
                        <tr>
                            <td class="title" colspan="2">Marathon Match Competitors for ${schoolName } school</td>
                        </tr>
                        <tr>
