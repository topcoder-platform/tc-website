...
<head>
    ...
    <!--<script type="text/javascript" src="./js/lib/jquery-1.1.2.pack.js"></script>-->
            ...
            <div id="wrapper">
                ...
                <div id="content">
                    ...
                    <div id="contentSubmissions">
                        <h1 class="middle">All Submissions</h1>
                        <form id="submissionsForm" method="get" action="/">
                            <div id="submissions">
                                <studio_tags:pagination baseUrl="/?${modKey}=ViewSubmissions&amp;${contestId}=${contest.id}" itemsNumber="${totalItems}"/>
                                <br />
                                            ...
                                            <c:when test="${contest.status.id==11}">
                                                     <tr>
                                                        <td colspan="4">
                                                            ...
                                                            <p>
                                                            When a contest is abandoned, the client has made no effort to complete their responsibility                                                             toward the competition. This includes choosing winners, communication with TopCoder Studio and 
                                            ...
                                            <c:otherwise>
                                                <tr>
                                                    ...
                                                    <c:forEach items="${submissions}" var="resultRow">
                                                        <td>
                                                            <studio_tags:submissionPreview row="${resultRow}" showPlacement="false" viewSubmitters="${viewSubmitters}/>
                                                        </td>
                                                        <c:if test="${i % 4 == 0}">
                                                            </tr><tr>
                                                        </c:if>
                    ...
                    <div class="hide" id="contentImgFullSize">
                        <h1>Submission # <span class="subId">123456</span></h1>
                        <div class="leftAlign"><span><a id="backToSubmissions" href="#">&lt;&lt; Back to submissions</a></span></div>
                        <div class="rightAlign"><span><a id="downloadLink" href="?${modKey}=DownloadSubmission&amp;${subId}=">Download</a></span></div>
                        <div class="noControl">&nbsp;</div>
                        <div class="control">
                              ...
                              <span>Image <span class="curItem">1</span> of <span class="totalCount">9</span></span>
                        </div>
                        <div class="previewImg"><img src="i/preview_image_full_1.png" alt="123456" /></div>
                    </div>
