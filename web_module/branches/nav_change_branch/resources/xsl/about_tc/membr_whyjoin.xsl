...
<!--end contextual links-->
					...
					TopCoder's competitions are designed for technologists and are unique in several ways. The key to TopCoder's competition process is the immediacy and objectivity of each and every Single Round Match. With TopCoder, competitors do not await results and the announcement of winners from a panel of judges that take days or even weeks to arrive at a decision.</P>
					<P>The process is simple. There are three problem statements (per match) with ascending point value. The coder to submit the most accurate solution in the shortest amount of time is awarded the most potential points. The key is that a coder's submission is challenged not only by the TopCoder system, but first by the other participating coders in the match. A coder's entire potential point base (and possible win) can be altered should another coder find a means of "breaking" the submission	</P>
					<P><B>Learning</B><BR/>
					TopCoder attracts the best programmers in the US and soon, the world. While you may not be able to beat the best programmers (welcome to the club - neither can we!), many of our members learn a great deal from the top developers. There is nothing like honing one's skill in the heat of competition. Since TopCoder is split by division, you won't be in problems over your head. As you compete more and more, you will be able to draw from some of the best talent out there. Also, every problem we create goes into our practice rooms. Competitor solutions are available to every participating member. What better way to learn, than from the masters!</P>
