...
public class CopilotPayment extends ComponentProjectReferencePayment {
    ...
    /**
     * Create a payment for the winner (or another place!) of a copilot.
     *
     ...
     */
    public CopilotPayment(long coderId, double grossAmount, String client, long projectId, int placed) {
        super(COPILOT_PAYMENT, coderId, grossAmount, client, projectId, placed);
    }
     ...
     * @param placed the place of the coder in the contest.
     */
    public CopilotPayment(long coderId, double grossAmount, long projectId, int placed) {
     ...
     * @param projectId project that is being paid.
     */
    public CopilotPayment(long coderId, double grossAmount, String client, long projectId) {
     ...
     * @param projectId project that is being paid.
     */
    public CopilotPayment(long coderId, double grossAmount, long projectId) {
    ...
    /**
     * Processor for copilot payments. It just provides a method for generating a description for the
     * copilot.
     *
     * @author TCSASSEMBLY
     * @version 1.0
