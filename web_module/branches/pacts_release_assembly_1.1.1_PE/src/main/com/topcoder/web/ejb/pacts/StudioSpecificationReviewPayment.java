...
/**
 * <p>
 * Payment for Studio Specification Review.
 * </p>
 * 
 * <p>
...
public class StudioSpecificationReviewPayment extends StudioContestReferencePayment {
    ...
    /**
     * Create a new payment for a TC Studio Specification Review.
     *
    ...
    /**
     * Processor for studio contests. It generates a payment description like "Icons Design Contest - Specification Review", and
    ...
    protected static class Processor extends StudioContestReferencePayment.Processor {
        ...
        public String lookupDescription(BasePayment payment) throws SQLException {
            ...
            return getContestName(p.getContestId()) + " - Specification Review";
        }
