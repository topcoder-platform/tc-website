    ...
    implements Serializable
{
    ...
    void loadUser()
    {
      ...
      */
        ...
        // referral data only used in TCES
...
***********************************************/
    ...
    {
        Log.msg(VERBOSE,"TCES.getNextPage()");
        if (isStep(STEP_0))
        {
    ...
    public boolean setAttributes ( String name, String[] valArray )
    {
        ...
        if ( !name.equals("TermDesc") )
          Log.msg(VERBOSE,"TCES.setAttribute(\""+name+"\",\""+value+"\")");
        //if (isStep(STEP_0))
        //{
...
*/   
        ...
        throws TaskException
    {
        ...
        try
        {
            ...
            Log.msg(VERBOSE,"TCES.handleExists(\""+handle+"\"): "+exists);
        }
        catch (Exception e)
        {
            Log.msg(e.toString());
