        ...
        <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
          <TR>
            ...
            <TD CLASS="statTextBig" COLSPAN="2" VALIGN="top" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/>
							...
							<BR><BR><BR>
<FORM NAME="frmContactInfo" ACTION="/tcesctx?task=contact&command=submit" METHOD="POST">
<TABLE WIDTH="100%" BORDER=0>
	...
	<TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtFirstName" VALUE="" SIZE=10>
			<INPUT TYPE="TEXT" NAME="txtMiddleInitial" VALUE="" SIZE=1 MAXLENGTH=1>
			<INPUT TYPE="TEXT" NAME="txtLastName" VALUE="" SIZE=15>
		</TD>
	</TR>	
	...
	<TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtEmailAddress" VALUE="" SIZE=30>
		</TD>
	</TR>
	...
	<TR>
		<TD COLSPAN=3>
			<DIV CLASS="mcontent">
				<INPUT TYPE="RADIO" NAME="radCountry" VALUE="United States">
	...
	<TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtPhoneArea" VALUE="" SIZE=3 MAXLENGTH=3>&nbsp;<INPUT TYPE="TEXT" NAME="txtPhoneDigits" VALUE="" SIZE=10 MAXLENGTH=7>
		</TD>
	</TR>
	...
	<TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtAddressLine1" VALUE="" SIZE=25>&nbsp;<INPUT TYPE="TEXT" NAME="txtAddressLine2" VALUE="" SIZE=25>
		</TD>
	</TR>
	...
	<TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtCity" VALUE="" SIZE=15>
	    <SELECT NAME="selState">
			<OPTION VALUE="ZZ">Please select one</OPTION>
			...
			<INPUT TYPE="TEXT" NAME="txtZip" VALUE="" SIZE=10 MAXLENGTH=10>			
		</TD>
	</TR>
	...
	<TR>
		<TD COLSPAN=3>
			<DIV CLASS="mcontent">
				<INPUT TYPE="RADIO" NAME="radCountry" VALUE="">
	...
	<!--TR>
		...
		<TD>
			<INPUT TYPE="TEXT" NAME="txtPhoneText" VALUE="" SIZE=20>
		</TD>
	</TR-->
	...
	<!--TR>
		...
		<TD>
			<SELECT NAME="selContactMethod">
				<OPTION VALUE="email">Contact me via E-mail
				<OPTION VALUE="phone">Contact me via Phone
			</SELECT>
		</TD>
	</TR-->
