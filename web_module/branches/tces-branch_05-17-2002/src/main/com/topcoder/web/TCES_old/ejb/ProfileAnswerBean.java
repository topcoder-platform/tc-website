...
public class ProfileAnswerBean implements javax.ejb.SessionBean {
	...
	public void delete( Integer answer_id ) throws SQLException {
		Connection	conn = null;
	...
	public void setQuestionId( Integer answer_id, Integer question_id ) throws SQLException {
		putRecord( answer_id, question_id, null );
	}

	public Integer getQuestionId( Integer answer_id ) throws SQLException {
	...
	public void setText( Integer answer_id, String text ) throws SQLException {
		putRecord( answer_id, null, text );
	}

	public String getText( Integer answer_id ) throws SQLException {
		ProfileAnswerObject	obj = null;
		String	result;
	...
	private ProfileAnswerObject getRecord( Integer answer_id ) throws SQLException {
		Connection	conn = null;
		PreparedStatement	ps = null;
		ResultSet	rs = null;
		ProfileAnswerObject	obj = null;
		...
		try {
			...
			obj.answer_id = new Integer( rs.getInt( 1 ) );
			if( rs.wasNull() )
				obj.answer_id = null;
