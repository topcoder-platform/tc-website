...
/**
 * This is the remote interface for the JobRole class.
...
public interface JobRole extends javax.ejb.EJBObject {
	 ...
	 * @see com.topcoder.web.TCES.ejb.JobRoleObject
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	 */
	...
	/**
	 * List the primary keys of the job_role table.
	...
	/**
	 * List the content of the job_role table.
	 * @return a Hashtable containing the job_role_ids as java.lang.Integer keys and descriptions as java.lang.String values
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	 */
	...
	/**
	 * Set the description field in the job_role table corresponding to the given key.
	...
	/**
	 * Get the description field from the job_role table corresponding to the given key.
	 * @param job_role_id the table primary key
