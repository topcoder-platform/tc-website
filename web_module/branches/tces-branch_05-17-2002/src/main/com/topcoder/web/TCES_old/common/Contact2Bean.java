...
public class Contact2Bean implements javax.ejb.SessionBean {
	...
	public String getFirstName( Long profileId )
	  throws RemoteException, SQLException {
		if( coderBean == null )
		  coderBean = new com.topcoder.web.TCES.common.Coder();
	...
	public Lookup getStateList()
	  throws RemoteException, SQLException {
		if( stateBean == null )
		  stateBean = new com.topcoder.web.TCES.common.State();
	...
	public Lookup getCountryList()
	  throws RemoteException, SQLException {
		if( countryBean == null )
		  countryBean = new com.topcoder.web.TCES.common.Country();
	...
	public String getHandle( Long profileId )
	  throws RemoteException, SQLException {
		if( userBean == null )
		  userBean = new com.topcoder.web.TCES.common.User();
	...
	public boolean getSendNextCompetition( Long profileId )
	  throws RemoteException, SQLException {
		if( coderNotifyBean == null )
		  coderNotifyBean = new com.topcoder.web.TCES.common.CoderNotify();
	...
	public Lookup getEditorList()
	  throws RemoteException, SQLException {
		if( editorBean == null )
		  editorBean = new com.topcoder.web.TCES.common.Editor();
	...
	public Lookup getLanguagesList()
	  throws RemoteException, SQLException {
		if( languageBean == null )
		  languageBean = new com.topcoder.web.TCES.common.Language();
