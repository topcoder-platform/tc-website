...
/**
 * This is the remote interface for the PrefCoSize class.
...
public interface PrefCoSize extends javax.ejb.EJBObject {
	 ...
	 * @see com.topcoder.web.TCES.ejb.PrefCoSizeObject
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	 */
	...
	/**
	 * List the primary keys of the pref_co_size table.
	...
	/**
	 * Set the co_size_id field in the pref_co_size table corresponding to the given key.
	...
	/**
	 * Get the co_size_id field from the pref_co_size table corresponding to the given key.
	 * @param profile_id the table primary key
