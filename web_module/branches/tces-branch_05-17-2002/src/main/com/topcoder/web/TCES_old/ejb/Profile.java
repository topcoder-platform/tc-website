...
public interface Profile extends javax.ejb.EJBObject {
	...
	public void setCoderId( Long profile_id, Long coder_id ) throws RemoteException, SQLException;
	...
	public Long getCoderId( Long profile_id ) throws RemoteException, SQLException;
