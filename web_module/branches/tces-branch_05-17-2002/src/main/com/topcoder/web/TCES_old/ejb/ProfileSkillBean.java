...
public class ProfileSkillBean implements javax.ejb.SessionBean {
	...
	public void create( java.sql.Connection conn, Integer profile_skill_id, Integer profile_id, Integer skill_level_id, Integer skill_id, Integer proficiency ) throws SQLException {
	...
	public void create( Integer profile_skill_id, Integer profile_id, Integer skill_level_id, Integer skill_id, Integer proficiency ) throws SQLException {
		...
		try {
			conn = getConnection();
			create( profile_skill_id, profile_id, skill_level_id, skill_id, proficiency );
		} catch( SQLException e ) {
			if( conn != null )
