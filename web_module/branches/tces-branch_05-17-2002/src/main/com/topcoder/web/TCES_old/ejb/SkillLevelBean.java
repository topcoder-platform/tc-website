...
/**
 * This is the implementation of the SkillLevel class.
...
public class SkillLevelBean implements javax.ejb.SessionBean {
	...
	public void create( java.sql.Connection conn, Integer skill_level_id, String description ) throws SQLException {
	...
	public void create( Integer skill_level_id, String description ) throws SQLException {
		...
		try {
			conn = getConnection();
			create( skill_level_id, description );
		} catch( SQLException e ) {
			if( conn != null )
	...
	public Hashtable listContent() throws SQLException {
		...
		String	query = "SELECT SKILL_LEVEL_ID, description FROM SKILL_LEVEL";
