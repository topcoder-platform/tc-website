...
public interface ProfileQuestion extends javax.ejb.EJBObject {
	 ...
	 * @param question_style question_style
	...
	/**
	 * Set the question_type field in the profile_question table corresponding to the given key.
	 * @param question_id the table primary key
	 * @param question_type the new field value
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	 */
	...
	/**
	 * Get the question_type field from the profile_question table corresponding to the given key.
	 * @param question_id the table primary key
	 * @return the current field value
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	...
	/**
	 * Set the question_style field in the profile_question table corresponding to the given key.
	 * @param question_id the table primary key
	 * @param question_style the new field value
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
	 */
	...
	/**
	 * Get the question_style field from the profile_question table corresponding to the given key.
	 * @param question_id the table primary key
	 * @return the current field value
	 * @exception SQLException if a database error occurs
	 * @author Phil Selby, May 22nd, 2002
