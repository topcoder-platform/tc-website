    ...
    <div id="content">
        ...
        <div id="pageBody">
            ...
            <form name="advancersForm" action='<jsp:getProperty name="sessionInfo" property="servletPath"/>' method="get">
                <tc-webtag:hiddenInput name="<%=Constants.MODULE_KEY%>" value="AlgorithmSections"/>
                ...
                <div align="center">
                    ...
                    <c:if test="${rd == round1A_id}">
                        <p align="center">
                        Section A
                        | <A href="/tco08?module=AlgorithmSections&rd=${round1B_id}">Section B</A>
                        | <A href="/tco08?module=AlgorithmSections&rd=${round1C_id}">Section C</A>
                        </p>
                    </c:if>
                    <c:if test="${rd == round1B_id}">
                        <p align="center">
                        <A href="/tco08?module=AlgorithmSections&rd=${round1A_id}">Section A</A>
                        | Section B
                        | <A href="/tco08?module=AlgorithmSections&rd=${round1C_id}">Section C</A>
                        </p>
                    </c:if>
                    ...
                    <a href="/tco08?module=AlgorithmSections&rd=${rd}">Reset sorting</a>
    
                    <c:choose>
                        <c:when test="${full}">
                            | <a href="/tco08?module=AlgorithmSections&rd=${rd}&full=false">Pages</a>
                            | Full view
                        </c:when>
                        <c:otherwise>
                            | Page view
                            | <a href="/tco08?module=AlgorithmSections&rd=${rd}&full=true">Full view</a>
                        </c:otherwise>
                    </c:choose>
