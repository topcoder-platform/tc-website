...
<thead>
    ...
    <tr>
        <td class="headerC" nowrap="nowrap">
            <a href="/tco08?module=ViewRegistrants&amp;et=<%=eventType%><tc-webtag:sort column="<%=rsc.getColumnIndex("rank")%>"/>">TCCC Rank</a>
        </td>
...
--%>
        ...
        <td class="headerR">
            <a href="/tco08?module=ViewRegistrants&amp;et=<%=eventType%><tc-webtag:sort column="<%=rsc.getColumnIndex("rating")%>"/>">Rating</a>
        </td>
    </tr>
</thead>
<tbody>
