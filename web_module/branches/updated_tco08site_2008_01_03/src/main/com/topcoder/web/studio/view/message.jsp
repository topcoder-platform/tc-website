...
<div id="message" align="center">
    <div style="margin-bottom: 10px;">
        <a href="http://<%=ApplicationServer.SERVER_NAME%>/tc?module=Static&amp;d1=tournaments&amp;d2=tco08&amp;d3=about"><img src="/i/tournament/tccc07/message.png" alt="TCO08"/></a>
    </div>
        ...
        <% } else { %>
            ...
            <br />Would you like to <strong><a href="http://<%=ApplicationServer.SERVER_NAME%>/tco08?module=ViewRegistration&amp;et=7" class="tccc07MessageLink">register</a></strong>?
        <% } %>
        <br/><br/>
</div>
