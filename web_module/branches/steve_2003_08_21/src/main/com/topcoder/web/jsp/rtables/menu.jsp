...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD CLASS="registerNav" WIDTH="150" HEIGHT="21" BACKGROUND="/i/steel_gray_bg.gif" VALIGN="middle" ALIGN="center">

      <IMG SRC="/i/clear.gif" WIDTH="150" HEIGHT="1" BORDER="0"/><BR/>

      <A CLASS="registerNav" HREF="/registration/index.shtml">REGISTRATION</A>&#160;&#160;&#160;&#160;

    </TD>

    <TD WIDTH="5" HEIGHT="21" BACKGROUND="/i/steel_gray_bg.gif" ALIGN="right">

      <IMG SRC="/i/top_bar_left.gif" WIDTH="5" HEIGHT="21" BORDER="0"/>
    ...
    <TD CLASS="globalNav" WIDTH="100%" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000" VALIGN="middle" NOWRAP="">
      ...
      <A HREF="/about_tc/index.shtml" onMouseOver="changeImages('image1', 'image1on')" onMouseOut="changeImages('image1', 'image1off')">

        <IMG NAME="image1" SRC="/i/nav_about_off.gif" ALT="about TopCoder" WIDTH="104" HEIGHT="21" BORDER="0"/>

      </A>

      <IMG SRC="/i/nav_divider.gif" ALT="" WIDTH="14" HEIGHT="21" BORDER="0"/>

      <A HREF="/news_events/press_releases/index.shtml" onMouseOver="changeImages('image2', 'image2on')" onMouseOut="changeImages('image2', 'image2off')">
      ...
      <A HREF="/round_tables/index.shtml" onMouseOver="changeImages('image3', 'image3on')" onMouseOut="changeImages('image3', 'image3off')">
      ...
      <A HREF="/statistics/index.shtml" onMouseOver="changeImages('image4', 'image4on')" onMouseOut="changeImages('image4', 'image4off')">

        <IMG NAME="image4" SRC="/i/nav_stats_off.gif" ALT="Statistics" WIDTH="65" HEIGHT="21" BORDER="0"/>

      </A>

      <IMG SRC="/i/nav_divider.gif" ALT="" WIDTH="14" HEIGHT="21" BORDER="0"/>

      <A HREF="/schedule/index.shtml" onMouseOver="changeImages('image5', 'image5on')" onMouseOut="changeImages('image5', 'image5off')">

        <IMG NAME="image5" SRC="/i/nav_schedule_off.gif" ALT="Schedule" WIDTH="65" HEIGHT="21" BORDER="0"/>
