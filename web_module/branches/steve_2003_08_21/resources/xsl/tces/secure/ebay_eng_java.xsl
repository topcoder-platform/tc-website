...
<!-- Client Job List begins -->
                        ...
                        <h3>Staff Software Engineer, Java - 0300141</h3>
                        
                        
                        <p><strong>Job Description</strong><br />
                        We are seeking a highly motivated individual for a Staff Software Engineer, Java position reporting to the Director of Development. As part of a fast pace organization, 
                        the candidate will:
                        <ul>
                        <li>Define, design and implement complex, multi-tier distributed software applications. Segment and design system layers to support componentized and layered application 
                        development, including user interface, business functionality and database access.</li>
                        ...
                        <li>7+ years experience in requirements analysis, design, coding and unit testing of scalable, distributed, fault-tolerant applications in NT and UNIX environments.</li>
                        <li>Expertise in object oriented design methodology and application development in Java and J2EE, including servlets, JSP, Java Beans, EJB, RMI, JDBC.</li>
                        <li>Project experience with IBM WebSphere or other J2EE applications required.</li>
                        <li>Working knowledge of C++, relational databases (prefer Oracle), XML, ISAPI, HTTP/HTML, XSLT and basic NT/UNIX system administration.</li>
