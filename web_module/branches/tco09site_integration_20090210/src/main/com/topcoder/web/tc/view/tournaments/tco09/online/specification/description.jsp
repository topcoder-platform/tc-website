 ...
 *
 * This JSP shows specification track description page.
 *
 * Author TCSDEVELOPER
 * Version 1.0
                                                        ...
                                                        <div>   
                                                            <div class="pageContent">
                                                                <h2 class="title">Welcome to the ALL NEW TCO09 Specification Competition!</h2>
                                                                    <p>The 2009 TopCoder Open Specification Design &amp; Development Competition will begin on February 2, 2009 and will commence on April 20, 2009.  Two lucky competitors after online competitions will win a trip to the 2009 TopCoder Open in Las Vegas, Nevada to enjoy the event!</p>
                                                                        <div class="subtitle">
