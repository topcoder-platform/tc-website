    ...
    <tr valign="top">
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/MPhk/diagrams/Catalog_Sequence_Diagram_add_products_to_groups_in_the_product_group_manager.gif" alt="" border="0"></div></td>
