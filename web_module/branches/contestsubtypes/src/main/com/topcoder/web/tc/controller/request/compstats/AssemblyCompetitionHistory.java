...
/**
 * <p>A processor to be used for retrieving the competition history for <code>Assembly</code> track.</p>
 * 
 * @author isv
 * @version 1.0 (Release Assembly - TopCoder Assembly Track Subtypes Integration Assembly 1.0)
 */
public class AssemblyCompetitionHistory extends CompetitionHistory {
    
    /**
     * <p>Constructs new <code>AssemblyCompetitionHistory</code> instance. This implementation does nothing.</p>
     */
    public AssemblyCompetitionHistory() {
    }
