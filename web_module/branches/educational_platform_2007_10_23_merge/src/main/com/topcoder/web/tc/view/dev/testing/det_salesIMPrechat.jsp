...
<p>The application is broken into a number of logical sections. This testing competition will only verify the flows after logging in but before opening the chat, for both clients and managers.</p>
...
<tr><td valign="top">Client Actions</td>
      <td valign="top">2.1, 2.2, 2.9</td>
      <td valign="top">1-25, 26-45, 79</td>
      <td valign="top">Functionality specific to client. This includes client login, queuing, chat request accepted / rejected.</td>
</tr>
<tr><td valign="top">Manager Actions</td>
      <td valign="top">2.2, 2.8, 2.10, 2.11, 2.14</td>
      <td valign="top">26-45, 72-75, 80-84, 85-87, 106</td>
      <td valign="top">Functionality specific to manager. This includes manager login / logoff, queuing, status change, creation of group chat rooms, and receiving / accepting chat request.</td>
</tr>
</table>
</div>
...
<p>A number of pages will make use of AJAX interactions, such as the notification of chat request and display of position in the queue. The GUI will be updated dynamically by JavaScript upon the receipt of AJAX response. For these pages, it is sufficient to verify if the AJAX response contains the expected values.</p>
...
<table cellpadding="0" cellspacing="0" border="0" width="350">
   ...
   <tr>
      <td>Test Submission:</td><td align="center">07.14.2007</td><td align="center">07.28.2007</td>
   </tr>
   <tr>
      <td>Test Case Screening:</td><td align="center">07.28.2007</td><td align="center">07.29.2007</td>
   </tr>
   <tr>
      <td>Winner Selection:</td><td align="center">&#160;</td><td align="center">08.07.2007</td>
   </tr>
</table>
</div>
<br><br>
