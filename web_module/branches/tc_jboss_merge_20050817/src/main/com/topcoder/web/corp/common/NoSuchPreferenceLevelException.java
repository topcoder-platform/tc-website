 ...
 *
 * NoSuchPreferenceLevelException.java
 *
 * 1.0 07/14/2004
 */
 ...
 */
public class NoSuchPreferenceLevelException extends ScreeningException {
    ...
    /**
     * Constructs new <code>NoSuchPreferenceLevelException</code> with specified ID of a candidate and a company.
     *
     ...
     */
    public NoSuchPreferenceLevelException(long candidateId, long companyId) {
        super();
    ...
    /**
     * Constructs new <code>NoSuchPreferenceLevelException</code> with specified ID of a candidate and a company and a
     * <code>String</code> details providing the description of an occured exception.
     *
     * @param details a <code>String</code> details of created exception.
     * @param candidateId a <code>long</code> containing the ID of requested candidate.
     * @param companyId a <code>long</code> containing the ID of requested company.
     */
    public NoSuchPreferenceLevelException(String details, long candidateId, long companyId) {
        super(details);
        this.candidateId = candidateId;
        this.companyId = companyId;
    }
