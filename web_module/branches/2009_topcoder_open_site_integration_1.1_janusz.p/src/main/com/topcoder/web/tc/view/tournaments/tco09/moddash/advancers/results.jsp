 ...
 *
 * This JSP is responsible for rendering Mod Dash User Results view
 *
 * Author TCSDEVELOPER
 * Version 1.0
...
<td class="valueC"><tc-webtag:format object="<%= dateParser.parse(competitor.getString("created")) %>" format="'<strong>'MM.dd.yyyy'</strong><br />'HH:mm z"/></td>
