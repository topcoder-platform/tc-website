...
<br /><br />
The Prize Pool for the Design Cup will grow with every competition posted within that Stage's timeframe.  TopCoder will set a guaranteed minimum Prize Pool of $10,000 for the Design Cup per month (the pool will never be less than that amount).  Every contest launched has a specific amount of points associated to it.  Each point adds $1 to the Design Cup Prize Pool.  For example, if we launch a component design competition on July 12, 2008 with 800 Digital Run points then TopCoder will add $800 to the Design Cup for July 2008.  The more contests we launch, the larger the Design Cup Prize Pool will grow.
<br /><br />
For each Stage, competitors will accumulate placement points according to the <a href="/tc?module=Static&amp;d1=digital_run&amp;d2=2008v2&amp;d3=desOverview">points table</a>. In addition to the competition prize earnings, the top five (5) finishers will win large prizes and the top 1/2 of the point-getters in each Stage will receive a smaller prize. A total of 50% of the total Design Cup prize pool will be awarded in bonus prizes each Stage and will be distributed as follows: 
<br /><br />
...
The remaining 50% of the Design Cup prize pool will be distributed among the top &#189; of point-getters (all competitors tied for the last spot will be included) and will be allocated based on the value of each placement point.
<br /><br />
<%--
