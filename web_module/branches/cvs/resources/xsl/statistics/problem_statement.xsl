...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Problem Statement</xsl:with-param>
</xsl:call-template>
  ...
  <xsl:otherwise>
    <xsl:for-each select="/TC/STATLISTS/Main/Contest/Problem">
      <xsl:if test="ProblemId=../../ProblemId">
        ...
        <TR>
          <TD BACKGROUND="/i/steel_gray_bg.gif" CLASS="statTextBig" COLSPAN="7" HEIGHT="18">&#160;Problem Statment for <xsl:value-of select="ClassName"/>
          </TD>
        </TR>
        <TR>
          <TD BACKGROUND="/i/steel_darkblue_bg.gif" COLSPAN="7"><IMG SRC="/i/clear.gif" ALT="" WIDTH="1" HEIGHT="1" BORDER="0"/></TD>    
        ...
        <TR>
          <TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="problemText" VALIGN="middle" ALIGN="left">
            <linefeed><spc><xsl:value-of select="ProblemText"/></spc></linefeed>
          </TD>
        </TR>
        <TR>
