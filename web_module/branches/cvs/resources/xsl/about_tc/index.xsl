...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
				<TR>
					...
					Each Single Round Match offers a fun, time-based, and challenging set of problems that put a developer's skills to the test. TopCoder is in the process of 
					establishing <A HREF="/index?t=about_tc&amp;c=membr_divisions" CLASS="bodyText">Divisions</A>. Divisions will offer a more level field of competition for newer members in order to build ratings and move into potential 
					tournament opportunities.</LI><BR/><BR/>
