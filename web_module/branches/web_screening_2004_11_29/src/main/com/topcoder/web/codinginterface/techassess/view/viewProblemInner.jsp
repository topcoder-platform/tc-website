                ...
                <form action="<jsp:getProperty name="sessionInfo" property="servletPath"/>" method="post" name="problemForm" target="_top">
                    ...
                    <table cellspacing=0 cellpadding=0 border=0 class=codingButtons>
                       <tr>
                          ...
                          <td><a href="submit(<%=Constants.RP_SAVE%>)" target="_top"><img src="/i/corp/screening/buttonSave.gif" alt="" /></a></td>
                          <td><a href="submit(<%=Constants.RP_COMPILE%>)" target="_top"><img src="/i/corp/screening/buttonCompile.gif" alt="" /></a></td>
