...
<html>
  ...
  <frameset cols="0,*">
    ...
    <frame name="mainFrame" src="<jsp:getProperty name="sessionInfo" property="servletPath"/>?module=<%=Constants.RP_VIEW_PROBLEM_INNER%>&<%=Constants.MESSAGE_ID%>=<%=request.getParameter(Constants.MESSAGE_ID)%>" frameborder=0 noresize>
  </frameset>
</html>