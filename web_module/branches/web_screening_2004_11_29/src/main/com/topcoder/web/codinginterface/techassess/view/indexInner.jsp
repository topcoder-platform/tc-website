...
<%-- CONTENT --%>
            ...
            <table width="100%" cellspacing=0 cellpadding=0 class=tableFrame>
               ...
               <tc-webtag:listIterator id="problem" list="problemSets" type="com.topcoder.shared.netCommon.screening.response.data.ScreeningProblemSet">
                   <tr>
                      ...
                      <td class=tableTextOdd align=right><span id="problemTimer<%=((ProblemSetInfo)problem).getProblemLabels()[0].getComponentID()%>">Initializing</span></td>
                   </tr>
