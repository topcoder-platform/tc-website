...
<%
    ...
    NavTree nav = new NavTree();
	    ...
	    nav.addRoot(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_competitions')", "Competitions", "m_competitions"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_competitions_overview')", "Overview", "m_competitions_overview"));
					nav.search("m_competitions_overview").addChild(new NavNode("/wiki/x/DIKMAg", "General Info", "m_overview_general_info"));
					nav.search("m_competitions_overview").addChild(new NavNode("/wiki/x/MQD9Ag", "Reliability", "m_overview_reliability"));
					nav.search("m_competitions_overview").addChild(new NavNode("/wiki/x/lYE_/", "Ratings", "m_overview_rating"));
					nav.search("m_competitions_overview").addChild(new NavNode("/wiki/x/aoE_/", "How to Get Paid", "m_how_to_get_paid"));
					nav.search("m_competitions_overview").addChild(new NavNode("/wiki/x/2gRmAw", "Administrative Overview ", "m_administrative_overview"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_copilot_opportunities')", "Copilot Opportunities", "m_copilot_opportunities"));
					nav.search("m_copilot_opportunities").addChild(new NavNode("/wiki/display/tc/Copilot+Overview", "Overview", "copilots_overview"));
        			nav.search("m_copilot_opportunities").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_copilot_support')", "Track Information", "m_copilot_support"));
							nav.search("m_copilot_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Copilot+Opportunities", "How to Compete", "copilot_how_to_compete"));
							nav.search("m_copilot_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Copilot+Opportunities", "Documentation", "copilot_documentation"));
							nav.search("m_copilot_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Copilot+Opportunities", "Tutorial", "copilot_tutorial"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'competition_design')", "Design", "competition_design"));
				...
				nav.search("competition_design").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_conceptualization_competitions')", "Conceptualization", "m_conceptualization_competitions"));
         			nav.search("m_conceptualization_competitions").addChild(new NavNode("/wiki/display/tc/TopCoder+Conceptualization+Contests", "Overview", "conceptualization_overview"));
        			nav.search("m_conceptualization_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_conceptualization_support')", "Track Information", "m_conceptualization_support"));
							nav.search("m_conceptualization_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Conceptualization+Competitions", "How to Compete", "conceptualization_how_to_compete"));
							nav.search("m_conceptualization_support").addChild(new NavNode("/wiki/display/tc/Conceptualization+Documentation", "Documentation", "conceptualization_documentation"));
							nav.search("m_conceptualization_support").addChild(new NavNode("/wiki/display/tc/Conceptualization+Submission+Instructions", "Tutorial", "conceptualization_tutorial"));
  		 	   ...
  		 	   nav.search("competition_design").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_specification_competitions')", "Specification", "m_specification_competitions"));
					nav.search("m_specification_competitions").addChild(new NavNode("/wiki/display/tc/TopCoder+Specification+Contests", "Overview", "specification_overview"));
					nav.search("m_specification_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_specification_support')", "Track Information", "m_specification_support"));
							nav.search("m_specification_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Specification+Competitions", "How to Compete", "specification_how_to_compete"));
			   ...
			   nav.search("competition_design").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_architecture_competitions')", "Architecture", "m_architecture_competitions"));
					nav.search("m_architecture_competitions").addChild(new NavNode("/wiki/display/tc/Architecture+Overview", "Overview", "architecture_overview"));
					nav.search("m_architecture_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_architecture_support')", "Track Information", "m_architecture_support"));
							nav.search("m_architecture_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Architecture+Competitions", "How to Compete", "architecture_how_to_compete"));
			   ...
			   nav.search("competition_design").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_des_competitions')", "Component Design", "m_des_competitions"));
					nav.search("m_des_competitions").addChild(new NavNode("/wiki/display/tc/Component+Design+Overview", "Overview", "des_overview"));
					nav.search("m_des_competitions").addChild(new NavNode("javascript:void(0)",  "Javascript:toggleMenu(this.parentNode,'m_des_support')", "Track Information", "m_des_support"));
							nav.search("m_des_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Component+Design+Competitions", "How to Compete", "des_getting_started"));
							nav.search("m_des_support").addChild(new NavNode("/wiki/display/tc/Component+Design+Documentation", "Documentation", "des_documentation"));
							...
							nav.search("m_des_support").addChild(new NavNode("/wiki/display/tc/Component+Design+Data+Feeds", "Data Feeds", "des_data_feeds"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'competition_dev')", "Development", "competition_dev"));
				nav.search("competition_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_dev_competitions')", "Component Development", "m_dev_competitions"));
					nav.search("m_dev_competitions").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Component+Development+Competitions", "Overview", "dev_overview"));
					nav.search("m_dev_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_dev_support')", "Track Information", "m_dev_support"));
							nav.search("m_dev_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Component+Development+Competitions", "How to Compete", "dev_getting_started"));
							nav.search("m_dev_support").addChild(new NavNode("/wiki/display/tc/Component+Development+Documentation", "Documentation", "dev_documentation"));
							...
							nav.search("m_dev_support").addChild(new NavNode("/wiki/display/tc/Component+Development+Data+Feeds", "Data Feeds", "dev_data_feeds"));
				...
				nav.search("competition_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_assembly_competitions')", "Assembly", "m_assembly_competitions"));
					nav.search("m_assembly_competitions").addChild(new NavNode("/wiki/display/tc/Assembly", "Overview", "assembly_overview"));
					nav.search("m_assembly_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_assembly_support')", "Track Information", "m_assembly_support"));
							nav.search("m_assembly_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Assembly+Competitions", "How to Compete", "assembly_how_to_compete"));
							nav.search("m_assembly_support").addChild(new NavNode("/wiki/display/tc/Assembly+Competition+Tutorial", "Tutorial", "assembly_tutorial"));
							nav.search("m_assembly_support").addChild(new NavNode("/wiki/display/tc/Assembly+Competition+Documentation", "Documentation", "assembly_documentation"));
				...
				nav.search("competition_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_test_suites_competitions')", "Test Suites", "m_test_suites_competitions"));
					nav.search("m_test_suites_competitions").addChild(new NavNode("/wiki/display/tc/Test+Scenarios+and+Scripts", "Overview", "test_suites_overview"));
					nav.search("m_test_suites_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_test_suites_support')", "Track Information", "m_test_suites_support"));
							nav.search("m_test_suites_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Testing+Competitions", "How to Compete", "test_suites_how_to_compete"));
							nav.search("m_test_suites_support").addChild(new NavNode("/wiki/display/tc/Testing+Competition+Tutorial", "Tutorial", "test_suites_tutorial"));
							nav.search("m_test_suites_support").addChild(new NavNode("/wiki/display/tc/Testing+Competition+Documentation", "Documentation", "test_suites_documentation"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'competition_ui_dev')", "UI Development", "competition_ui_dev"));
  			    nav.search("competition_ui_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_ui_prototype_competitions')", "UI Prototype", "m_ui_prototype_competitions"));
					nav.search("m_ui_prototype_competitions").addChild(new NavNode("/wiki/display/tc/UI+Prototype+Competitions", "Overview", "ui_prototype_overview"));
					nav.search("m_ui_prototype_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_ui_prototype_support')", "Track Information", "m_ui_prototype_support"));
							nav.search("m_ui_prototype_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+UI+Prototype+Competitions", "How to Compete", "ui_prototype_how_to_compete"));
			    ...
			    nav.search("competition_ui_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_ria_build_competitions')", "RIA Build", "m_ria_build_competitions"));
					nav.search("m_ria_build_competitions").addChild(new NavNode("/wiki/display/tc/RIA+Build+Competitions", "Overview", "ria_build_overview"));
					nav.search("m_ria_build_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_ria_build_support')", "Track Information", "m_ria_build_support"));
							nav.search("m_ria_build_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+RIA+Builds", "How to Compete", "ria_build_how_to_compete"));
            	...
            	nav.search("competition_ui_dev").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_content_creation_competitions')", "Content Creation", "m_content_creation_competitions"));
                    nav.search("m_content_creation_competitions").addChild(new NavNode("/wiki/display/tc/Content+Contests+Overview", "Overview", "content_creation_overview"));
                    nav.search("m_content_creation_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_content_creation_support')", "Track Information", "m_content_creation_support"));
                                            nav.search("m_content_creation_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Content+Creation+Competitions", "How to Compete", "content_creation_how_to_compete"));
                    ...
                    nav.search("m_content_creation_competitions").addChild(new NavNode("http://"+ApplicationServer.SERVER_NAME+"/tc?module=CompList&amp;pt=" + 35, "Past Contests", "content_creation_past"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'competition_qa')", "QA and Maintenance", "competition_qa"));
				nav.search("competition_qa").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_test_scenarios_competitions')", "Test Scenarios", "m_test_scenarios_competitions"));
					nav.search("m_test_scenarios_competitions").addChild(new NavNode("/wiki/display/tc/Test+Scenarios+and+Scripts", "Overview", "test_scenarios_overview"));
					nav.search("m_test_scenarios_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_test_scenarios_support')", "Track Information", "m_test_scenarios_support"));
							nav.search("m_test_scenarios_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Testing+Competitions", "How to Compete", "test_scenarios_how_to_compete"));
							nav.search("m_test_scenarios_support").addChild(new NavNode("/wiki/display/tc/Testing+Competition+Tutorial", "Tutorial", "test_scenarios_tutorial"));
							nav.search("m_test_scenarios_support").addChild(new NavNode("/wiki/display/tc/Testing+Competition+Documentation", "Documentation", "test_scenarios_documentation"));
				...
				nav.search("competition_qa").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_bugraces_competitions')", "Bug Race", "m_bugraces_competitions"));
					nav.search("m_bugraces_competitions").addChild(new NavNode("/wiki/display/tc/Bug+Race+Competition+Overview", "Overview", "bugraces_overview"));
					nav.search("m_bugraces_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_bugraces_support')", "Track Information", "m_bugraces_support"));
							nav.search("m_bugraces_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Bug+Race+Competitions", "How to Compete", "bugraces_how_to_compete"));
					nav.search("m_bugraces_competitions").addChild(new NavNode("/wiki/display/tc/Active+Bug+Race+Competitions", "Active Contests", "bugraces_compete"));
					nav.search("m_bugraces_competitions").addChild(new NavNode("/wiki/x/FQG2AQ", "Review Opportunities", "bugraces_review"));
			...
			nav.search("m_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'competition_algo')", "Algorithm", "competition_algo"));
				nav.search("competition_algo").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_algo_competitions')", "Single Round Matches (SRM)", "m_algo_competitions"));
					nav.search("m_algo_competitions").addChild(new NavNode("/wiki/display/tc/Algorithm+Overview", "Overview", "algo_overview"));
         			nav.search("m_algo_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_algo_support')", "Track Information", "m_algo_support"));
							nav.search("m_algo_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Algorithm+Competitions", "How to Compete", "algo_how_to_compete"));
							nav.search("m_algo_support").addChild(new NavNode("/wiki/display/tc/Algorithm+Competition+FAQs", "FAQs", "algo_faqs"));
							nav.search("m_algo_support").addChild(new NavNode("/wiki/display/tc/Algorithm+Competition+Rating+System", "Rating System", "algo_rating_system"));
							nav.search("m_algo_support").addChild(new NavNode("/wiki/display/tc/Write+Problems+for+TopCoder", "Write Problems", "algo_write"));
        			nav.search("m_algo_competitions").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_algo_stats')", "Statistics", "m_algo_stats"));
							...
							nav.search("m_algo_stats").addChild(new NavNode("/wiki/display/tc/Algorithm+Problem+Set+Analysis", "Match Editorials", "algo_match_editorials"));
            				...
            				nav.search("m_algo_stats").addChild(new NavNode("/wiki/display/tc/Algorithm+Data+Feeds", "Data Feeds", "algo_data_feeds"));
				...
				nav.search("competition_algo").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_long_contests')", "Marathon Match", "m_long_contests"));
					nav.search("m_long_contests").addChild(new NavNode("/wiki/display/tc/Marathon+Match+Overview", "Overview", "long_overview"));
					nav.search("m_long_contests").addChild(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_long_support')", "Track Information", "m_long_support"));
							nav.search("m_long_support").addChild(new NavNode("/wiki/display/tc/How+to+Compete+in+Marathon+Match+Events", "How to Compete", "long_how_to_compete"));
   ...
   nav.addRoot(new NavNode("javascript:void(0)", "Javascript:toggleMenu(this.parentNode,'m_edu_content')", "Tutorials", "m_edu_content"));
	   ...
	   nav.search("m_edu_content").addChild(new NavNode("/wiki/dashboard.action", "Wiki", "wiki"));
...
<div id="navbar">
    ...
    <div style="float: left; padding: 10px 0px 0px 17px;">
        <%-- UML Tool --%>
        <a href="<tc-webtag:linkTracking link='/wiki/x/L4TD' refer='leftnav' />"><img src="/i/leftnav/umlTool.png" alt="UML Tool" /></a>
