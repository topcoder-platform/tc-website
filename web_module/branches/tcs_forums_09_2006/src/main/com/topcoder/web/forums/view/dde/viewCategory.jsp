...
<tc-webtag:useBean id="unreadCategories" name="unreadCategories" type="java.lang.String" toScope="request"/>
	...
	<%
	// dev forum case - make sure user is logged in
	if("2".equals(forumCategory.getProperty("forumType"))) {
		AuthToken authToken = TCAuthFactory.getAuthToken(request, response);
		if(authToken.isAnonymous()) {
			System.out.println("Anonymous user on development forums");
			request.setAttribute("message", "You must login to view the specification forum");
			%>
