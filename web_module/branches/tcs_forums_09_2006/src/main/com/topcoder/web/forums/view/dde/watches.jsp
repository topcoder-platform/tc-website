...
<div align="right">
<input type="image" src="http://forums.dev.topcoder.com/i/roundTables/update.gif" alt="Update" onclick="form1.<%=ForumConstants.WATCHLIST_STATUS%>.value='<%=ForumConstants.WATCHES_UPDATE%>'" />
</div>
