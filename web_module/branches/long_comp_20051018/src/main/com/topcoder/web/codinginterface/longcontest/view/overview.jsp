...
Avg. Submissions: <tc-webtag:format object="<%=new Double(infoRow.getDoubleItem("avg_submissions"))%>" format="#.##" ifNull="N/A"/><rsc:item name="avg_submissions" row="<%=infoRow%>"/></span><br>
