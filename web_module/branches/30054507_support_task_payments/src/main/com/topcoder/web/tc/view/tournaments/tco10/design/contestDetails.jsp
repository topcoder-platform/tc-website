                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <h2 class="pageTitle">
                            ...
                            <a href="${sessionInfo.servletPath}?module=ContestProjects&amp;eid=3432&amp;ct=476">View Components</a>
                        </h2>
                            ...
                            <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <c:forEach items="${results}" var="result">
                                    <tr>
                                        ...
                                        <td class="first last alignText">
                                            <a href="${sessionInfo.servletPath}?module=MemberResults&amp;eid=3432&amp;ct=476&amp;cr=${result.userID}">results</a>
                                        </td>
                                        <td class="last">&nbsp;</td>
                                    </tr>
                                </c:forEach>
