...
<!--            <A class="smallFoot"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/tc/?d1=review_board&amp;d2=competition</xsl:attribute>Review Boards</A>&#160;&#160;|&#160;&#160;-->
            ...
            <A class="smallFoot"><xsl:attribute name="href">http://<xsl:value-of select="/TC/CorpHost"/>/?module=Static&amp;d1=corp&amp;d2=tces_home</xsl:attribute>Employment Services</A>&#160;&#160;|&#160;&#160;
            <A class="smallFoot"><xsl:attribute name="href">http://<xsl:value-of select="/TC/CorpHost"/>/?module=Static&amp;d1=corp&amp;d2=spon_prog&amp;d3=index</xsl:attribute>Sponsorship</A><br/><br/>
