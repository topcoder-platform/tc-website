...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="item">
            <li class="dottedBottom"><a target="_blank"><xsl:attribute name="href"><xsl:value-of select="link"/><span style="font-size:14px;"></xsl:attribute><xsl:value-of select="title"/></span></a><br />
