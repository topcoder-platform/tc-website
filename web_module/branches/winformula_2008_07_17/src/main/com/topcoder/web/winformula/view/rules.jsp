...
<head>
    <title>ESPN Winning Formula Challange :: Powered by TopCoder - Rules</title>
    <%-- Meta Tags --%>
...
<body>
    ...
    <%-- Wrapper --%>
        ...
        <%-- Main Content --%>
            ...
            <p>Registration may occur at any time from 11:59 AM EDT on July 28, 2008 through 2:00PM EDT on Sept. 24, 2008.  The Competition will begin at 11:59 AM EDT on July 28, 2008 and will end at 12:01AM EDT on Dec. 11, 2008.</p>
            ...
            <p>By participating in the Competition, you agree to be bound by these Rules and to all decisions of TopCoder, which are final, binding and conclusive in all matters.</p>
