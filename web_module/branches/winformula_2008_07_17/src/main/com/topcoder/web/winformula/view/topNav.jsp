...
<div class="navBox">
    ...
    <a class="navTab" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Blog"><img src="/i/events/winformula/tbd.png" alt="Blog" onmouseover="this.src='/i/events/winformula/tbdOn.png';"  onmouseout="this.src='/i/events/winformula/tbd.png';" /></a>
    ...
    <a class="navTab" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=ManageAlgorithms"><img src="/i/events/winformula/tbd.png" alt="Manage My Algorithms" onmouseover="this.src='/i/events/winformula/tbdOn.png';"  onmouseout="this.src='/i/events/winformula/tbd.png';" /></a>
