        ...
        <%-- Main Navigation --%>
            <div id="lCorner-nav"><%-- Left Corner Navigation --%></div>
                <ul>
                    ...
                    <li id="nav-register"<% if (tabLev1.equals("register")) {%> class="on"<% } %>><a title="Register" onfocus="this.blur();" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=1001"><span class="hide">Register</span></a></li>
