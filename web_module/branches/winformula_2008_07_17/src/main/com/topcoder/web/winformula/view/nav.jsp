        ...
        <%-- Main Navigation --%>
            <div id="lCorner-nav"><%-- Left Corner Navigation --%></div>
                <ul>
                    ...
                    <li id="nav-blog"<% if (tabLev1.equals("blog")) {%> class="on"<% } %>><a title="Blog" onfocus="this.blur();" href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=blog"><span class="hide">Blog</span></a></li>
