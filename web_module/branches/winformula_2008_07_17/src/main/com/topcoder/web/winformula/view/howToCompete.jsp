        ...
        <%-- Main Content --%>
            ...
            <div class="full-content">
                ...
                <ol class="howCompete">
                    ...
                    <li><strong><a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=manageMyAlgorithms">Submit your algorithm</a></strong> (through week 11)<br />
                    ...
                    Prizes will be awarded to the season winner and possibly to the next five finishers. Weekly prizes will also be awarded, even for the &quot;preseason&quot; weeks. While the prize breakout is to be determined, there will be a total of $100,000 awarded!</li>
                </ol>
                <br />
