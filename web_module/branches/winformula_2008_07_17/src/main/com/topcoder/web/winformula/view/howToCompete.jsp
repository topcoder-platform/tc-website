        ...
        <%-- Main Content --%>
            ...
            <div class="full-content">
                ...
                <ol class="howCompete">
                    ...
                    <li><a href="register.htm"><strong>Register</strong></a><strong> for the Winning Formula Challenge</strong><br />
                    If you are already a TopCoder member, all you have to do is register for the Winning Formula Challenge! Register now to participate in this contest! <a href="register.htm">Contest registration &gt;&gt;</a></li>
                    <li><strong><a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=downloadData">Download ESPN's statistical data</a> and build your algorithm</strong><br />
                    Once you've registered, you'll need to download ESPN's statistical data on which your algorithm will be basing its predictions. Use this data to build your algorithm. <a href="download-data.htm">Download the data &gt;&gt;</a></li>
                    ...
                    You can submit your algorithm each week until the start of that week's first game. Weeks 1-4 are considered preseason and no points can be won. The season starts on week 5 and you may continue to update your algorithm through week 8. After week 8 you may not make any changes to your algorithm and your latest uploaded algorithm will be used for the remainder of the season (weeks 9-16). <a href="manage-algorithms.htm">Submit your algorithm &gt;&gt;</a></li>
