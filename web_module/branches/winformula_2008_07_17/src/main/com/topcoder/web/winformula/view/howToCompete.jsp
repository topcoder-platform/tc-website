        ...
        <%-- Main Content --%>
            ...
            <div class="full-content">
                ...
                <ol class="howCompete">
                    ...
                    <li><strong><a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=register">Register</a> for the Winning Formula Challenge</strong><br />
                    If you are already a TopCoder member, all you have to do is register for the Winning Formula Challenge! Register now to participate in this contest! <a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=register">Contest registration &gt;&gt;</a></li>
