        ...
        <%-- Main Content --%>
            ...
            <div class="full-content">
                ...
                <ol class="howCompete">
                    ...
                    <li><strong><a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=manageMyAlgorithms">Submit your algorithm</a> each week</strong> (through week 7)<br />
                    You can submit your algorithm each week until the start of that week's first game. Weeks 1-3 are considered preseason and no points can be won. The season starts on week 4 and you may continue to update your algorithm through week 7. After week 7 you may not make any changes to your algorithm and your latest uploaded algorithm will be used for the remainder of the season (weeks 8-15). <a href="http://<%=ApplicationServer.WINFORMULA_SERVER_NAME%>/?module=Static&amp;d1=manageMyAlgorithms">Submit your algorithm &gt;&gt;</a></li>
                    <li><strong><a href="#">Win Cash!</a></strong><br />
