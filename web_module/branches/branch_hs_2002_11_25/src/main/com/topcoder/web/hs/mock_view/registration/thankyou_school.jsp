...
<jsp:include page="/hs/includes/global/left_calendar.jsp" />
    ...
    <TR>
        ...
        <TR>
            ...
            <!-- Start Body-->
            <P><B>Thank you for signing up your school to join the TopCoder High School community.  We will contact a representative at your school shortly.</B></P>

<P><B>Best of luck to you in the High School Arena!
</B></P>
