...
<TABLE WIDTH="100%" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	<TR VALIGN="TOP">
		<TD BGCOLOR="#222255">
		<DIV CLASS="box_lt">
			<DIV CLASS=header><NOBR>PROJECT TASKS&nbsp;&nbsp;&nbsp;[<A HREF="javascript:submitPage('ProjectTask', 'new', '<%= project.getProject() %>', '<%= vp %>');">Add New Task</A>]</NOBR></DIV> 
		</DIV>
		</TD>
		<TD WIDTH="100%"></TD>
	</TR>
...
<TABLE WIDTH="100%" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	<TR VALIGN="TOP">
		<TD BGCOLOR="#222255">
		<DIV CLASS="box_lt">
			<DIV CLASS=header><NOBR>MANAGER NOTES&nbsp;&nbsp;&nbsp;[<A HREF="javascript:submitPage('ProjectUpdate', 'new', '<%= project.getProject() %>', '<%= vp %>');">Add New Update</A>]</NOBR></DIV> 
		</DIV>
		</TD>
		<TD WIDTH="100%"></TD>
	</TR>
				...
				<TR>
					<TD BGCOLOR="#555599">
						<DIV CLASS=subheader>
							...
							<NOBR><A HREF="javascript:submitPage('ProjectUpdate', 'view', '<%= pu.getProjectUpdate() %>', '<%= vp %>');"><%= pu.getUpdatedOnDateAtTime() %></A></NOBR>
						</DIV>
					</TD>
					<TD BGCOLOR="#CCCCFF">
						<DIV CLASS=subcontent>
...
<TABLE WIDTH="100%" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	<TR VALIGN="TOP">
		<TD BGCOLOR="#222255">
		<DIV CLASS="box_lt">
			<DIV CLASS=header><NOBR>DEVELOPER(S)&nbsp;&nbsp;&nbsp;[<A HREF="javascript:submitPage('ProjectDeveloper', 'new', '<%= project.getProject() %>', '<%= vp %>');">Add New Developer</A>]</NOBR></DIV> 
		</DIV>
		</TD>
		<TD WIDTH="100%"></TD>
	</TR>
...
%>
				<TR>
					<TD BGCOLOR="#555599">
						<DIV CLASS=subheader>
							<A HREF="javascript:submitPage('projectTaskUpdateList', 'view', '<%= pd.getProjectDeveloper() %>', '<%= vp %>');">
