...
<FORM ACTION="" METHOD="post" NAME="regForm">
 ...
 <INPUT TYPE="hidden" NAME="state" VALUE="<jsp:getProperty name="coach" property="StateCode"/>">
 <INPUT TYPE="hidden" NAME="school" VALUE="<jsp:getProperty name="coach" property="SchoolId"/>">
 ...
 <INPUT TYPE="hidden" NAME="editor" VALUE="<jsp:getProperty name="coach" property="EditorId"/>">
 <INPUT TYPE="hidden" NAME="language" VALUE="<jsp:getProperty name="coach" property="LanguageId"/>">
