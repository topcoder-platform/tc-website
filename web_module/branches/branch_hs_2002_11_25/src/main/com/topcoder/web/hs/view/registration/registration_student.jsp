...
<P>Welcome to TopCoder HighSchool.  Before you register, there are a few things we think
...
<P>This has several implications. Because we feel it is our obligation to let
...
<P>While we believe that sponsors have every right to expect that what we give
...
careful to choose sponsors that represent this philosophy.</P>

<P>We are also very strict about the way in which sponsors present themselves
...
<P>Please read the Terms of Use and Privacy Policy, and let me be the first to
say good luck in the arena.</P>

<P>Jack Hughes</P>

<P><I>Founder and Chairman, TopCoder, Inc.

</I></P>
  <div align="center">
  <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
  <tr>
    <td class="bodyTextBig" width="150" align="right" valign="middle"><img src="/i/clear.gif" width="150" height="2" border="0"></td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" class="bodyText" align="left" valign="middle">Required fields are in <b>bold</b></td>
  </tr>
  <tr valign="middle">
  ...
  <tr valign="middle">
    ...
    <tr>
      <td class="bodyText" align="right" valign="middle" ><b>First Name</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Last Name</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" >School&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" class="bodyText" align="left" valign="middle">
    <select name="school" class="dropdown" onChange="changeCountry()">
        <option value=""></option><option value="ZZ">Glastonbury</option></td>
  </tr>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" >State&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" align="left" valign="middle" class="bodyText">
        
    <select name="state" class="dropdown" onChange="changeCountry()">
        <option value=""></option><option value="ZZ"></option>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Handle</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Password</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Re-type Password</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Email</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colpsan="2" class="bodyText" align="left" valign="middle"><input type="text" name="email" value ="" size="30" maxlength="100"></td>
  </tr>
    <tr>
        <td></td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td><td colspan="2" class="errorText" align="left" valign="middle"></td>
    </tr>
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="middle" ><b>Re-type Email</b>&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colpsan="2" class="bodyText" align="left" valign="middle"><input type="text" name="confirmEmail" value ="" size="30" maxlength="100"></td>
  </tr>
  <tr>
    <td class="bodyText" align="right" valign="middle" >&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
  ...
  <tr>
    <td class="bodyText" align="right" valign="middle" >Quote&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" class="bodyText" align="left" valign="middle"><input type="text" name="quote" value ="" size="30" maxlength="255"></td>
  </tr>
  ...
  <tr>
    <td class="bodyText" align="right" valign="middle" >Default Editor&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" class="bodyText" align="left" valign="middle">
...
<option value="0">Standard</option>
  ...
  <tr>
    <td class="bodyText" align="right" valign="middle" >Default Language&nbsp;</td><td><img src="/i/clear.gif" width="1" height="1" border="0"></td>
    <td colspan="2" class="bodyText" align="left" valign="middle">
...
If you have any questions regarding these Terms, contact us at service@topcoder.com.
  ...
  <tr align="right" valign="middle">
    <td class="bodyText" align="right" valign="top"><b>I Agree to the Terms and Conditions stated above</b>&nbsp;</td>
        
    <td colspan="2" class="bodyText" align="left" valign="top"><input type="checkbox" name="terms" ><br><br></td>
  </tr>
  ...
  <tr valign="middle">
    ...
    <tr align="right" valign="middle">
        ...
        <A HREF="/?module=Static&d1=registration&d2=confirm_student" CLASS="statTextBig"><B>[ continue &gt;</B></A>
        </td>
    </tr>
  </table>
  </form>
