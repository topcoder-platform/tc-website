...
<TR>
    <TD COLSPAN="2" BACKGROUND="/i/hs/blue_heading_bg_deux.gif" CLASS="statText" HEIGHT="14" ><P><B>&nbsp;&nbsp;&nbsp;High School Tournament&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</B><BR></TD>
</TR>
<TR>
...
May, 2003<BR/>-->
    ...
    <!--Hartford Regional <BR>Hartford, CT<BR/><A CLASS="bodyText" HREF="/hs/schedule/sched_may_2003.jsp">Go to Summary</A></P>-->
<P><BR/></P>  
            <!--Body Ends Here-->
            </TD>
             <TD>
