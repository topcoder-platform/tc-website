...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
    ...
    <TR>
        ...
        <TR>
            ...
            <!--Body starts here-->
<BR><P><ul CLASS="bodyText"><li><A CLASS="bodyText" HREF="/hs/faq/manual_fig1.jsp"><b>Figure 1.</b> Login</A></li><li><A CLASS="bodyText" HREF="/hs/faq/manual_fig2.jsp"><b>Figure 2.</b> Lobby</A></li><li><b>Figure 3.</b> Problem Selection
                                        </li><li><A CLASS="bodyText" HREF="/hs/faq/manual_fig4.jsp"><b>Figure 4.</b> Coding Window - Coding Phase</A></li><li><A CLASS="bodyText" HREF="/hs/faq/manual_fig5.jsp"><b>Figure 5.</b> Status Window - Challenge Phase</A></li></ul></P><P CLASS="bodyText"><b>Figure 3: Problem Selection</b></P><IMG BORDER="0" HEIGHT="434" WIDTH="619" ALT="Problem Selection" SRC="/i/select_problem.gif"><ol CLASS="bodyText" type="1"><li><b>Rooms:</b> Lists all rooms including the <b>Practice Room</b>.</li><BR><li><b>Tools</b> - Consist of: 
            <ul><li><b>Status Window</b> - This window can remain open at all times to notify the member when a user's code has been submitted. See Fig. 5.</li><li><b>Contest Results</b> - Loads the contest statistics home page.</li></ul></li><BR><li><b>Select Problem:</b> After choosing a problem based on its point value, the <A CLASS="bodyText" HREF="/hs/faq/manual_fig4.jsp">Coding Window</A> will appear.</li></ol><P><BR></P>
              <!--Body Ends Here-->
            </TD>
             <TD>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
