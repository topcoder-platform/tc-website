...
<% } else { %>
     ...
     <TR>
 		...
 		<IMG SRC="/i/hs/11x9.gif" WIDTH="11" HEIGHT="9" ALT="" BORDER="0"/><A HREF="/?module=Static&d1=stats&d2=hs_rankings" CLASS="sidenav">High School Rankings</A><BR/>
 		<IMG SRC="/i/hs/11x9.gif" WIDTH="11" HEIGHT="9" ALT="" BORDER="0"/><A HREF="/?module=Statistics&c=rating_history&cr=<jsp:getProperty name="SessionInfo" property="UserId" />" CLASS="sidenav">Rating History</A><BR/>
 		...
 		<IMG SRC="/i/hs/11x9.gif" WIDTH="11" HEIGHT="9" ALT="" BORDER="0"/><A HREF="/?module=Static&d1=stats&d2=hs_round_stats" CLASS="sidenav">High School Round Stats</A><BR/>
