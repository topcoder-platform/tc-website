...
<% } else { %>
     ...
     <TR>
 		...
 		<IMG SRC="/i/hs/11x9.gif" WIDTH="11" HEIGHT="9" ALT="" BORDER="0"/><A HREF="?module=Statistics&c=school_round_stats&@@@" CLASS="sidenav<%=NavZone.getFolder(1).equals("school_round_stats")?"open":""%>">High School Round Stats</A><BR/>
