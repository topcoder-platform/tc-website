...
<jsp:include page="../includes/left_calendar.jsp" />
    ...
    <TR>
        ...
        <TR>
            ...
            <P>NOTE:  REGISTRATION FOR TOPCODER HIGH SCHOOL WILL BE ACTIVE IN JANUARY 2003.  IF YOU ARE CURRENTLY INTERESTED IN SIGNING UP YOUR HIGH SCHOOL TO PARTICIPATE, <A HREF="?module=Static&d1=registration&d2=registration_form">CLICK HERE</A> TO FILL OUT A FORM.</P>


         
            
            
           <!-- <P><B>If you are a FACULTY MEMBER who would like to sign up as the Coach for your high school's team, click here to register: <A HREF="?module=Static&d1=registration&d2=registration_coach">click here</A></B></P>
            <P><B>If you are a STUDENT who would like to sign up as a competitor, click here to register: <A HREF="?module=Static&d1=registration&d2=registration_student">click here</A></B></P>-->
            <!-- End Body-->            
            </TD>
             <TD>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
