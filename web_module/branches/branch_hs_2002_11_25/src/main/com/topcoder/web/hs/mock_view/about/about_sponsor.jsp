...
<TABLE CELLSPACING="0" CELLPADDING="0" BORDER="1" BORDERCOLOR="#cccccc" WIDTH="90%">
<TR>
    <TD CLASS="bodyText"><B>LEVEL</B></TD>
    <TD CLASS="bodyText"><B>SPONSORSHIP BENEFITS INCLUDE:</B></TD>
    <TD CLASS="bodyText"><B>INVESTMENT</B></TD>
</TR>
<TR>
    <TD CLASS="bodyText">Title Sponsor - limited to 1 company</TD>
    <TD CLASS="bodyText"><UL>
    <LI>Top billing as the title sponsor of the entire season on TCHS web site and onsite at the championship round</LI>
    <LI>First mention in all TCHS press releases</LI>
    <LI>Dedicated web page highlighting sponsor's corporate messages</LI>
    <LI>Link to sponsor's web site·	Predominate signage onsite during the championship rounds</LI>
    <LI>More...</LI></UL></TD>
...
<TR>
    ...
    <TD CLASS="bodyText"><UL>
    <LI>Promotion on TCHS web site as a sponsor of the regular season and championship rounds</LI>
    <LI>Link to sponsor's web site</LI>
    <LI>Mention in TCHS press releases</LI>
    <LI>One week as a featured sponsor within competition arena</LI>
    <LI>More...</LI></UL></TD>
    <TD CLASS="bodyText">$15,000</TD>
</TR>
<TR>
    <TD CLASS="bodyText">Community Supporter</TD>
    <TD CLASS="bodyText"><UL>
    <LI>Promotion on TCHS web site as a supporter of competitions</LI>
    <LI>Link to sponsor's web site</LI>
    <LI>More...</LI></UL></TD>
