       ...
       <logic:iterate name="resultSet" id="resultRow" type="ResultSetContainer.ResultSetRow">
	        <bean:define id="coderrank" name="resultRow" property='<%= "item[" + 2 /*"coder_score"*/ + "]" %>'/>
                 <TR>
                   ...
                   <TD CLASS="statText" VALIGN="middle" ALIGN="left">
					<A HREF="/?module=Statistics&c=school_rankings&@@@school_id@@@=<bean:write name="resultRow" property='<%= "item[" + 3 /* school_id */ + "]" %>'/>" CLASS="<bean:write name="nameColor" property='<%= "style[" + coderrank.toString() + "]" %>'/>"><bean:write name="resultRow" property='<%= "item[" + 4 /* school full_name */ + "]" %>'/></A>
                   </TD>
