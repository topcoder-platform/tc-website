                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTable">
                            ...
                            <rsc:iterator list="<%=results%>" id="resultRow">
                                <tr>
                                    <TD class="<%=even?"statLt":"statDk"%>"><A href="/longcontest/?module=ViewOverview&rd=<rsc:item row="<%=resultRow%>" name="round_id"/>"><rsc:item row="<%=resultRow%>" name="contest_name"/> > <rsc:item row="<%=resultRow%>" name="round_name"/></A>
                                    </TD>
