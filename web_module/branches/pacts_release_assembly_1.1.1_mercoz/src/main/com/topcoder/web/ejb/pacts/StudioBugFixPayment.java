...
/**
 * Payment for a studio bug fix winner.
 *
 ...
 * @author mercoz
 */
public class StudioBugFixPayment extends StudioContestReferencePayment {
    /**
     ...
     */
    public StudioBugFixPayment(long coderId, double grossAmount, long contestId, int placed) {
     ...
     * @param contestId referenced studio contest.
     */
    public StudioBugFixPayment(long coderId, double grossAmount, long contestId) {
