    ...
    <script language="javascript">
        ...
        <table border=0 cellpadding=0 cellspacing=0 width="100%" class=bodyText>
			<tr>
				...
				<span class=bodySubtitle>Technologies</span>
				<br/><br/>
				...
				<jsp:param name="phase" value="technologies"/>
				</jsp:include>
				</td>
			</tr>
		</table>
        ...
        <table border=0 cellpadding=3 cellspacing=0 width="100%" class=bodyText>
			<tr>
				...
				<tc-webtag:textArea name="<%=Constants.NOTE_PREFIX + Constants.TECH_NOTE_TYPE_ID%>" rows="3" cols="40"/>
				</td>
			</tr>
			<tr><td colspan=2 align=center><br/><br/><a href="javascript:goToPage('ContractingOS');"><img src="/i/submit.jpg" border=0/></a>
