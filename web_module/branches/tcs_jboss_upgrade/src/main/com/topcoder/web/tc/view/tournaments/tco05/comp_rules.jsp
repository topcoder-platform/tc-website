...
<br><br>
The 2005 TopCoder Open ("TCO") Component Design and Development Competition ("CDDC") will take place between June 29 and October 14, 2005.  It will consist of two competitions - the design competition and the development competition.  Each competition will consist of five (5) weeks of online competition and one (1) onsite final round, being the Championship round.  The prize purse for this tournament is $75,000 in cash, with $46,500 being awarded for the design competition and $28,500 for the development competition.  The eight (8) competitors in each competition with the highest cumulative placement scores after the online rounds of competition will advance to the onsite Championship round, being held at the Marriott in Santa Clara, CA, USA on October 12, 13 and 14, 2005.
<br><br>
...
<ul>
<li>Must be at least 18 years of age as of June 29, 2005; AND</li>
<li>If not a US resident, must be living in, and participating from, your country of residence; AND</li>
<li>Must not have been permanently suspended from participating in TopCoder Component projects.</li>
</ul>
TopCoder members who are 18 years of age or older as of June 28, 2005 are eligible to win cash prizes, unless otherwise prohibited. The TopCoder Open is void in the Quebec province of Canada, and elsewhere where prohibited by applicable law. Cash prizes will not be paid to residents of Cuba, Iran, Iraq, Libya, North Korea, Sudan, or Syria.
<br><br>
...
Employees of TopCoder, Inc. and of all official tournament sponsors, regardless of commitment date as sponsor, including any companies involved in the production (including prize suppliers), implementation and distribution of this tournament and their advertising or promotion agencies, parent companies, service providers, agents, officers, subsidiaries or affiliates, or any other persons or entities directly associated with the tournament and members of the immediate families and/or persons living in the same household as such persons, are ineligible to enter the tournament.  If a competitor's employer signs up as an official sponsor of the tournament on or after June 13, 2005, then that competitor will be disqualified from participating further in the tournament.  TopCoder members who are performing internships for any official tournament sponsor between June 13 and October 14, 2005 are also ineligible to compete.  
<br><br>
<a name="scoring"></a>
<a href="#top"><img src="/i/navigation/back_to_top.gif" alt="back to top" width="83" height="23" border="0" align="right"></a>
...
<br><br>
Both the design and development competitions will have five (5) weeks of online competition and one (1) onsite Championship round.  Each contestant participating in an online round must submit his/her design and/or development submission for components by the submission deadline as scheduled.  TopCoder members from around the world may be participating in the online rounds, but all start times, registration deadlines and submission deadlines will be communicated as Eastern Daylight Time, so contestants in different time zones must adjust accordingly.
<br><br>
...
<br><br>
During each week of competition, eligible competitors can submit design and development solutions for at least one eligible component by the submission deadline.  Submissions will be scored by the TopCoder Review Boards and will be subject to final review and appeal in the same manner as standard component design and development submissions.  Scoring of each submission by the TopCoder Review Boards is based on the criteria outlined in the <A href="http://www.topcoder.com/tc?module=Static&d1=dev&d2=support&d3=devReviewSample">Development Review Scorecard</A> for the Development Contest or the criteria outlined in the <A href="http://www.topcoder.com/tc?module=Static&d1=dev&d2=support&d3=desReviewSample">Design Review Scorecard</A> for the Design Contest.    Note that the scorecards to be used for the CDDC are the ones that are in effect as of June 29, 2005. <strong>ALL SUBMISSIONS MUST BE RECEIVED ACCORDING TO THE SUBMISSION DEADLINE TO BE CONSIDERED A VIABLE ENTRY.  THERE WILL BE NO EXCEPTIONS.</strong>  There will be no elimination of contestants during the online competition.
<br><br>
Up to the four (4) highest individual placement scores that each contestant receives for his/her submissions throughout the five (5) weeks of competition will be added together for a cumulative placement score.  The eight (8) competitors in each competition with the highest cumulative positive (i.e., greater than zero) placement score will advance to the onsite Championship round.  
<br><br>
...
<br><br>
The eight (8) advancers in each competition from the five (5) weeks of online competition will travel to the Santa Clara Marriott on Tuesday, October 11, 2005 to compete in the final competitive stage of the tournament being held on Wednesday, October 12, 2005.  All contestants must arrive at the Santa Clara Marriott no later than 4:00 PM PDT on Tuesday, October 11, 2005.  All contestants must confirm their attendance at the onsite Championship Round no later than 5:00 PM EDT on Monday, August 22, 2005 by emailing <A href="mailto:jdamato@topcoder.com&subject=TCO05 Attendance">jdamato@topcoder.com</A>.  That is, contestants must have acquired any necessary travel visas and know for certain that they can travel to the US by that date and time.  If a contestant is unable to attend the onsite round, he/she will forfeit his/her eligibility to receive any prizes awarded to onsite finalists, and his/her spot in the tournament will be given to the competitor with the next highest positive (i.e., greater than zero) cumulative placement score from the online competition.  
<br><br>
TopCoder will provide travel arrangements for each competitor up to a cost of $1,000 per person.  (That is, if a contestant's airfare is greater than $1,000, the difference between the cost of the airfare and $1,000 will be deducted from the contestant's total TCO prize money won.  If the contestant's total TCO prize money is not sufficient to cover the additional costs, they will be subtracted from the contestant's overall TCO winnings.)  TopCoder will also provide ground transportation to and from the airport, as well as hotel accommodations and certain meals for each contestant.  All other expenses are the responsibility of the contestant.  TopCoder will not provide travel or lodging accommodations for competitor guests at the 2005 TCO.
<br><br>
Online portion of Championship Round:  There will be an online portion of the Championship Round, which will follow the normal component design/development process (up to and including final review).  To ensure that the submitters receive no advantage from the Review Board, the reviews will only include required items.  No comments or recommendations will be included.
<br><br>
Onsite portion of Championship Round:  There will also be an onsite portion of the Championship Round.  During the onsite Championship Round, competitors will need to implement an enhancement to their development/design submission from the online portion of the Championship Round.  Competitors will be given a choice of three (3) enhancements that they can implement, however only one (1) will be scored.  The onsite portion of the Championship Round will last six (6) hours, from 10:00AM to 4:00PM on Wednesday, October 12, 2005.  There will be a mandatory 30-minute break from 12:00 - 12:30PM.  All competitors must step away from their workstations during the 30-minute break.  The onsite Review Board will review the submitted enhancements on Thursday, October 13, 2005.  There will be a one and a half (1.5) hour online appeals phase on Friday, October 14, 2005, after which the final scoring will be performed.  Competitors will not see the review scorecards until the appeals phase starts.  Appeals will not be responded to until the appeals phase is over.
<br><br>
The Championship Round will include eight (8) members in each competition.  Two winners will be crowned, one Design Champion and one Development Champion.  Each champion will be the competitor who receives the highest score for his/her enhancement during the onsite portion of the Championship Round.  
<br><br>
...
<ol>
<li>By cumulative placement score as of the end of the five (5) weeks of online competition (highest cumulative placement score wins).</li>
...
<a name="prizes"></a>
<a href="#top"><img src="/i/navigation/back_to_top.gif" alt="back to top" width="83" height="23" border="0" align="right"></a>
<span class="bodySubtitle">About the Prizes</span>
<br><br>
All contestants who submit components that pass screening during at least one week of online competition will receive a prize.  The tournament will award $75,000 in cash prizes, with $46,500 being awarded for the design competition and $28,500 for the development competition.  Any and all applicable taxes on prizes are the sole responsibility of the prizewinner.  Prizes will be distributed as follows:
<br><br>
<table width="500" align="center" border="0" cellpadding="6" cellspacing="2" class="sidebarBox">
   <tr>
      <td class="sidebarTitle" width="50%">Competitor(s)</td>
      <td class="sidebarTitle" width="25%">Design Prize</td>
      <td class="sidebarTitle" width="25%">Development Prize</td>
   </tr>
   <tr valign="top">
      <td class="sidebarText">1st place finisher* in the Championship Round</td>
      <td class="sidebarText">$20,000</td>
      <td class="sidebarText">$12,500</td>
   </tr>
   <tr valign="top">
   ...
   <tr valign="top">
      <td class="sidebarText">Participant whose rating increases the most throughout the online rounds of the CDDC**</td>
      <td class="sidebarText">$1,000</td>
      <td class="sidebarText">$1,000</td>
   </tr>
   <tr valign="top">
   ...
   <tr valign="top">
      ...
      <td class="sidebarText">Limited edition 2005 TopCoder Open t-shirt</td>
      <td class="sidebarText">Limited edition 2005 TopCoder Open t-shirt</td>
   </tr>
   <tr valign="top">
      <td class="sidebarText" colspan ="3">* Prize will be awarded after the conclusion of the Championship Round.  Winner must be present at the onsite round to receive prize.</td>
   </tr>
   <tr valign="top">
      <td class="sidebarText" colspan ="3">** To calculate the rating change, TopCoder will subtract each participant's rating at the time the first TCO online round was posted from each participant's rating after all TCO online rounds have finished (including final fixes).  The calculation will be performed only after all components that affect the final rating have been completed.  This includes all components posted at or before the last TCO online round is posted, regardless of whether the components are related to the TCO.  The participant with the highest positive rating difference will be awarded the prize.  If no participant has a positive rating increase during the course of the online rounds of the TCO, no prize money for this criteria will be awarded. In order to qualify for this prize, the participant must have a rating in the appropriate category (design or development) before the start of the first TCO online round.</td>
   </tr>
   <tr valign="top">
...
<br><br>
Contestants who advance to the onsite Championship Round must complete the following items and submit them to TopCoder by 5:00 PM EDT on Wednesday, September 7, 2005:
<ul>
<li>Competitor Questionnaire - the questions and responses will be published in the 2005 TopCoder Open program</li>
...
<li>Affidavit of Eligibility and Liability and Publicity Release</li>
   <ul>
   <li>TopCoder must receive the original copy of a notarized affidavit unless a notarized affidavit is already on file with TopCoder.  The document must be postmarked by September 7, 2005, and must be sent in such a manner that it will arrive at TopCoder no later than October 5, 2005.</li>
...
Failure to submit the above items on time will result in a forfeit of advancement as an onsite finalist.
<br><br>
...
<br><br>
<span class="bodySubtitle">Other</span><br><br>
