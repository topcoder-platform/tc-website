            ...
            <div id="mainbody" class="singleMainBody"><!-- below menu ,main content -->
                ...
                <div class="bigColumn">
                    <div class="text">
                        ...
                        <p>Want to attend the 2010 TopCoder Open? Here's some information to help you with your
                            plans.</p>
                        ...
                        <p>There are a plethora of hotels in Las Vegas that you can choose from. Here are a few that are
                            affordable and in the vicinity of the 2010 TopCoder Open.</p>
                        ...
                        <p class="imp-note">*Rate does not include taxes or fees and is subject to change at any
                            time.</p>
                    </div>
                </div>
