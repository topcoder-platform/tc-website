...
<!-- Center Column Begins -->
      ...
      <br/><br/>
      At any time, you may right-click on any of the handles in the list and you will have two functions available to you.  <b>Info</b> will display the Coder Info Window, which contains some basic information about that member.  <b>History</b> will display a chronological list of events that have taken place for that competitor during the given event.  The events listed are submissions, challenges, and individual system test results.  In the event that any of the system tests failed, the value following the colon is the (incorrect) value that the given submission returned for the given arguments.
      <br/><br/>
      ...
      During the challenge phase of a rated event, each competitor has the opportunity to view the source code of each of the other competitors' submissions (within your room).  The room summary window provides each competitor access to those submissions.  During the challenge phase, any registered competitor who views the source code of a same-room competitor will also see a "Challenge" button in the lower, left-hand corner of the source code window.  Clicking the "Challenge" button will open the <A href="/tc?module=Static&d1=hs&d2=support&d3=problemArguments">Arguments Window</A> and allow you to proceed with your challenge of that submission. 
      <br/><br/>
