...
<div id="wrapper">
    ...
    <jsp:param name="tabLev3" value=""/>
        ...
        <div id="content">
            ...
            Up to 100 competitors will compete and up to 50 will advance. The highest 50 scoring competitors across all rooms will advance to the Onsite Finals.</p>
            ...
            <p>The Championship Round will be a single round of fifty (50) coders.  The winning individual in the Championship Round will be the competitor with the highest score in the round. In the event of a tie in the Championship Round, the tie will be resolved in the following manner (in order):</p>
                <ul>
                    ...
                    <li>If a tie still remains in the Championship Round, then the prize will be distributed equally among the tied competitors.</li>
                </ul>
            ...
            <p>All contestants who advance to the onsite Championship round must complete the following items and submit them to TopCoder by 5:00 PM EST (UTC/GMT -5) on Monday, February 18, 2008:</p>
                <ul>
