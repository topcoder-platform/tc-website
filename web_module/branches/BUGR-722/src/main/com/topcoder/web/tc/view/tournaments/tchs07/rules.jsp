...
<div align="center" style="background: transparent;">
    <div class="content">
        ...
        <div class="contentSpacer">
          ...
          <ul>
          <li>Up to 100 spots will be open for individuals. The remaining 400 spots will be open for teams. If in either case there are not enough advancers to fill the 100 individual spots or 400 team spots, we will fill the remaining spots with competitors from the other group.</li>
          <li>If there are more than 500 qualified participants in any Region prior to Round 1, we will limit it to the top 500 teams/individuals in the following manner:
             <ul>
             <li>We will advance the teams with the best average team placement for the four (4) rated events in which they placed the best.</li>
             <li>We will advance the individuals with the best average individual placement for the four (4) rated events in which they placed the best.</li>
             </ul>
          </li>
          </ul>
          <h3>Online Regional Round #2</h3>
          <ul>
          <li>Up to 50 spots will be open for individuals.  The remaining 200 spots will be open for teams.  If in either case there are not enough advancers to fill the 50 individual spots or 200 team spots, we will fill the remaining spots with competitors from the other group.</li>
          </ul>
          <h3>Online Regional Round #3</h3>
          <ul>
          <li>Up to 20 spots will be open for individuals.  The remaining 80 spots will be open for teams.  If in either case there are not enough advancers to fill the 20 individual spots or 80 team spots, we will fill the remaining spots with competitors from the other group.</li>
          </ul>
          ...
          <ul>
          <li>Total points acquired (higher is better) during Online Regional Rounds #1, #2 and #3 of the 2007 TCHS Tournament</li>
          ...
          <table border="0" cellpadding="5" cellspacing="0" width="400">
            <tr>
             ...
             <tr>
                   <td class="sidebarText">Up to 250 competitors who compete in each Online Regional Round #2</td>
          ...
          * Prize will be awarded at the conclusion of the Championship Round. Winners must be <b>present</b> at the onsite rounds to receive prize. TopCoder reserves the right to increase the total prize purse or change the prize breakdown distribution at its sole discretion at any point during the tournament.
          ...
          <li>IRS Tax Form W-9 or W-8BEN, as appropriate
              <ul>
              <li>TopCoder must receive the original copy of a signed tax form unless a tax form is already on file with TopCoder. The document must be postmarked by April 25, 2007, and must be sent in such a manner that it will arrive at TopCoder no later than May 4, 2007.
              <li>If TopCoder already has a tax form on file for a contestant, the contestant does NOT need to send an additional tax form unless his/her address has changed.
              </ul>
          </li>
