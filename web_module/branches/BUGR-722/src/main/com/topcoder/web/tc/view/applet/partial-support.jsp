...
<div id='message'>
    ...
    <p>Java Web Start is the preferred method for running the TopCoder Arena but
        was not automatically detected on your machine. However, Web Start is bundled with all Java versions 1.4.1 and
        higher.
...
<div id='notes'>
    ...
    <p>Learn how to install and properly configure Java Web Start at
        <a target=_blank href='http://java.sun.com/products/javawebstart/'>http://java.sun.com/products/javawebstart/</a>
    </p>
