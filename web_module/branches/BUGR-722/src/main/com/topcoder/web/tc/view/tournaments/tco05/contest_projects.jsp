                ...
                <table width="510" align="center" border="0" cellpadding="5" cellspacing="0" class="bodyText">
                    <tr>
                        <td class="usdcTitle" nowrap=nowrap>
                            <a href="/tc?module=TCO05ContestDetails&ct=<rsc:item name="contest_id" row="<%=rscContest.getRow(0)%>" />">
                        ...
                        <tr>
                            <td class="sidebarText">
                                ...
                                *
                                <% } %>
                                <br>
                                <A href="/tc?module=TCO05ProjectDetails&ct=<rsc:item name="contest_id" row="<%=rscContest.getRow(0)%>" />&pj=<rsc:item name="project_id" row="<%=resultRow%>"/>">results</A>
                                <% if (isComplete) { %>
                                |
                            ...
                            <td class="sidebarText" align=center nowrap=nowrap>
                                <rsc:item name="end_date" format="MM.dd.yyyy" row="<%=resultRow%>"/> 9:00AM</td>
