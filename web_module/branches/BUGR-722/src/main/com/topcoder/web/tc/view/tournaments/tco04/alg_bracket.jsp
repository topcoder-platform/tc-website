...
<!-- Body-->
	<tr valign=top>
        ...
        <p class=pageTitle>Algorithm Onsite Bracket</p>
...
if ( MM_FlashCanPlay ) {
	...
	document.write(' <PARAM NAME=movie VALUE="/i/tournament/tco04/brackets/bracket_alg.swf"> <PARAM NAME=menu VALUE=false> <PARAM NAME=quality VALUE=high> <PARAM NAME=salign VALUE=T> <PARAM NAME=bgcolor VALUE=#FFFFFF>  '); 
	document.write(' <EMBED src="/i/tournament/tco04/brackets/bracket_alg.swf" menu=false quality=high salign=T bgcolor=#FFFFFF  ');
