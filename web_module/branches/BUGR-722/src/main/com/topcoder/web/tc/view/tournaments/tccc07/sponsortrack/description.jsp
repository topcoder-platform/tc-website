...
<p>We're giving employees and interns of the sponsors of the 2007 TopCoder Collegiate Challenge a tournament of their own. It's a chance to compete among your peers in the Sponsor Track Competition, open to all employees of companies sponsoring the TCCC.</p>
...
<p>Each online round of competition consists of three phases: Coding Phase, Challenge Phase, and System Testing Phase. (Note: The format of these competition rounds is similar to the format of TopCoder Single Round Matches.)</p>
<ul>
...
<p>See the <a href="/tc?module=Static&amp;d1=tournaments&amp;d2=tccc07&amp;d3=sponsortrack&amp;d4=rules">official rules and regulations</a> for more details.</p>

<p>When is the competition?  See the <a href="/tc?module=Static&amp;d1=tournaments&amp;d2=tccc07&amp;d3=sponsortrack&amp;d4=schedule">schedule</a> here.</p>
