...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="practice_room">
      		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" VALIGN="top" WIDTH="170">
        		...
        		<TR> 
          			<TD BGCOLOR="#43515E" VALIGN="top"> 
            			<TABLE BGCOLOR="#FFFFFF" WIDTH="170" CELLSPACING="0" CELLPADDING="2" BORDER="0">
              				<TR> 
                 ...
                 Not sure about joining? New sample problems are now available ... //&#160;<A HREF="/index?t=schedule&amp;c=practice_room" CLASS="moduleText">read&#160;more.</A> 
                				</TD>
