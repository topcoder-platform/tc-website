...
<A CLASS="statText">
  <xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=top_10_wins_regions</xsl:attribute>
  All Regions
</A> 
&#160;|&#160;
<A CLASS="statText">
  <xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=top_4_wins_se</xsl:attribute>
  Southeast
</A><BR/>
<A CLASS="statText">
  <xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=top_4_wins_w</xsl:attribute>
  West
</A>
&#160;|&#160;
<A CLASS="statText">
  <xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=top_4_wins_mw</xsl:attribute>
  Midwest
</A><BR/>
</P> -->	
</TABLE>  
