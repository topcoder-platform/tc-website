...
<p><span class="bigTitle">Registration Tool - Projects</span></p>
...
To simplify the competition, the testing project was split into two parts. This part will focus only in the use cases related to browsing projects and registering to them. <br />It is <strong>required</strong> to create additional tests on top of those. The first version of the application is already assembled and ready to be tested. The main tasks will involve:
</p>
...
<table cellpadding="4" cellspacing="0"> 
    <tbody> 
        ...
        <tr> 
            <td valign="top">Project browsing and registration</td> 
            <td valign="top">2.2, 2.3, 2.9, 2.14,2.15,2.16,2.21</td> 
            <td valign="top">14 - 33, 82 - 88, 131 - 144</td> 
            <td valign="top">All registration functionality. This includes project browsing, registering, changing roles and contacting registered members.</td> 
        </tr> 
    </tbody> 
</table>
</div>
...
<p>To sign up as a participant, send an email to <A href="mailto:TestingCompetitions@topcoder.com?subject=Register: Registration Tool: Projects">TestingCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
...
<p>Once you have test code you are ready to submit, you can do so by emailing your source code to <A href="mailto:TestingSubmissions@topcoder.com?subject=Submit: Registration Tool: Projects">TestingSubmissions@topcoder.com</A> by the submission deadline.  Once a submission is received, it will be screened.  All code that passes screening will be made available to the Assembly Competition teams.</p>
