<%--
  ...
  -
  - Description: This is the page for displaying the review details for Application Testing projects. It displays the list
...
<html>
<head>
<title>Open Application Testing Projects Available for Review</title>
...
<jsp:include page="/page_title.jsp">
    ...
    <jsp:param name="title" value="Review Opportunities"/>
            ...
            <table cellspacing="0" width="530" class="formFrame">
                ...
                <tr>
                    <td class="projectCells" align="left">Application Testing</td>
                    ...
                    <tr>
                        ...
                        <td class="projectCells" align="center" nowrap>
                            ...
                            <% } else if (((ReviewBoardApplication) reviewer).isSpotFilled()) { %>
                                <tc-webtag:handle coderId="<%=((ReviewBoardApplication)reviewer).getUserId()%>" context='app_testing'/>
                            <% } else if (isWaiting) { %>
...
<% } %>
                <tr>
                    <td class="bodyText">
                        <p align="left"><a href="/tc?module=ViewReviewProjects&amp;<%=Constants.PROJECT_TYPE_ID%>=13">View all projects</a></p>
                    </td>
                </tr>
            </table>
