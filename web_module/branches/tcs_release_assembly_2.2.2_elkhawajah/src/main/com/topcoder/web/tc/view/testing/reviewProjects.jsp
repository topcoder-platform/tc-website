<%--
  ...
  -
  - Description: This is the page for listing the active review projects for Application Testing project type. It displays the
...
<jsp:include page="/top.jsp">
    <jsp:param name="level1" value="app_testing"/>
</jsp:include>
...
<td width="180">
    ...
    <jsp:include page="/includes/global_left.jsp">
        <jsp:param name="node" value="app_testing_review"/>
    </jsp:include>
</td>
<!-- Left Column Ends -->
...
<p>In the table below you will be able to see which projects are available for review, the type of project, the current
    ...
    project. If you click on an application testing name you will be able to see all of the details associated with that
    application testing review.</p>

<p>If you are not currently on the TopCoder Application Testing Review Board you may send an email to
    <a href="mailto:service@topcodersoftware.com">service@topcodersoftware.com</a> requesting permission to perform
    reviews. Please keep in mind only members that have completed application testing projects are eligible to join the
    TopCoder Application Testing Review board.</p>

<p>In order to sign up for a review position, click on the "details" link for any application testing with positions available,
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="statTable">
                <tr>
                    <td class="tableTitle" colspan="11">Application Testing Review Opportunities</td>
                </tr>
                <tr>
                    <td class="tableHeader" align="center">Type</td>
                    <td class="tableHeader" align="center">Catalog</td>
                    <td class="tableHeader" width="100%">Application Testing</td>
                ...
                <rsc:iterator list="<%=projectList%>" id="resultRow">
                    ...
                    <tr>
                        <td class="statDk" align="center">Application Testing</td>
                        <td class="statDk" align="center">Application Testing</td>
                        <td class="statDk"><a
                        ...
                        <td class="statDk" align="left" nowrap="nowrap">
                            <a href="<%=sessionInfo.getServletPath()%>?<%=Constants.MODULE_KEY%>=ReviewProjectDetail&<%=Constants.PROJECT_ID%>=<rsc:item row="<%=resultRow%>" name="project_id"/>&<%=Constants.PROJECT_TYPE_ID%>=13">details</a>
