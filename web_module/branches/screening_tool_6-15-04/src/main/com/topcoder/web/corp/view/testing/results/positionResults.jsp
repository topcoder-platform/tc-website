        ...
        <td width="100%" align="center"><img src="/i/corp/clear.gif" width="200" height="11" alt="" border="0"><br>
            ...
            <table cellspacing="0" cellpadding="0" width="600" class="screeningFrame">
                <tr>
                    ...
                    <td class="screeningHeader" width="10%">
                        <A class=screeningHeader href="?<%=Constants.MODULE_KEY%>=<%=Constants.POSITION_RESULTS_PROCESSOR%>&<%=Constants.SORT_BY%>=state&<%=Constants.JOB_POSITION_ID%>=<%=request.getAttribute(Constants.JOB_POSITION_ID)%>">
                            State/<br/>Province
                        </A>
                    </td>
                    <td class="screeningHeader" width="10%">
                    ...
                    <td class="screeningHeader" width="10%" align=center>
                        <A class=screeningHeader href="">
                           Problem<br/>Results</A>
                    </td>
                    <td class="screeningHeader" width="10%" align=center>
