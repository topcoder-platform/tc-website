...
for (i = 1; i <= 50; i++)
{
    ...
    if(i%2==1)
    {
                    ...
                    document.write("<td class='screeningCellOdd'><A href='/corp/testing/results/positionResults.jsp'>architect</A></td>")
                    ...
                    document.write("<td class='screeningCellEven'><A href='/corp/testing/results/positionResults.jsp'>architect</A></td>")
