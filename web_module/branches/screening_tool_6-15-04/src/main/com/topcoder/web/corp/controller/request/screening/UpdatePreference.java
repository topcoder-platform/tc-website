...
public class UpdatePreference extends BaseProcessor {
     ...
     */
    private final static String SUCCESS_ATTRIBUTE_NAME = "successful";
    ...
    protected void businessProcessing() throws TCWebException {
        ...
        long uid = Long.parseLong((String) request.getAttribute(Constants.USER_ID));
        long cuid = Long.parseLong((String) request.getAttribute(Constants.CANDIDATE_ID));
        ...
        try {
            ...
            int level = Integer.parseInt((String) request.getAttribute(Constants.PREFERENCE_LEVEL));
     ...
     * info or not. The method executes a <code>candidateInfo</code> query and checks if this any data is returned in
