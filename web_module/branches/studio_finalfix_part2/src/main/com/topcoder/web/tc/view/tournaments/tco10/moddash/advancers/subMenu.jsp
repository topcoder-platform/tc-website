...
<div class="subMenu">
    <ul class="secondaryNav overviewNav"><!-- orange secondary navigation -->
        <li class="${descriptionClass}"><!-- first item -->
            <tco10:moddashStaticPageLink page="description">
        ...
        <li class="${scheduleClass}"><!--  item -->
            <tco10:moddashStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="schedule">
                <span class="left"></span>
        ...
        <li class="${rulesClass}"><!-- second item -->
            <tco10:moddashStaticPageLink styleClass="tertiaryNavBT competitionRulesBT" page="rules">
                <span class="left"></span>
        ...
        <li class="${advancersClass}"><!-- third item-->
            <tco10:moddashStaticPageLink page="leaderboard">
                <span class="left"></span>
        ...
        <li class="${finalResultsClass}"><!-- four item -->
            <tco10:moddashStaticPageLink styleClass="tertiaryNavBT SponsorsBT" page="finalResults">
                <span class="left"></span>
            ...
            <c:when test="${isAdvancers}">
                ...
                <ul class="advancers">
                    <li class="${leaderboardClass}">
                        <tco10:moddashStaticPageLink page="leaderboard">Leaderboard</tco10:moddashStaticPageLink>
                    </li>
                    <li class="${bracketClass}">
                        <tco10:moddashStaticPageLink page="bracket">Bracket</tco10:moddashStaticPageLink>
                    </li>
                </ul>
            </c:when>
            <c:otherwise>
