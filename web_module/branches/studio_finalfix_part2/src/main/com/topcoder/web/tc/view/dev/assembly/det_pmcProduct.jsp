...
<span class="bigTitle">PMC Product</span>
<br><br>
<div class="sectionHeader">Overview</div>
<span class="bodySubtitle">Application Overview</span><br>
The PMC Product is part of the Product Management Console, a Server Client Application that allows users to import, change and export products to an eCommerce Application from various existing corporate Divisions and Brands.
<br><br>
...
<br><br>
Specific tasks of the PMC product are:

<ul>
<li>Style Grouping<br>
Grouping different References to one product together</li>
<li>Search<br>
Searching throughout the different Divisions and Brands</li>
<li>Change Grid<br>
Hiding grid columns, sorting by columns, etc.</li>
<li>Show Help<br>
Open MS .Net help for the application</li>
<li>CYO<br>
Create your own product functions</li>
<li>Launch Date<br>
Create or change the launch date for certain products</li>
<li>Planning<br>
Create budget limits</li>
<li>Export Data<br>
Allow users to export data or mark data for third party databases.</li>
</ul>
<br><br>
Most of the code for the application is contained within components; however, some functions are required in the assembly code. Teams will be responsible for configuration of the components, configuration of the application and conversion of the prototype (to content templates) according to the specified application architecture designs. 
<br><br>
...
*Additional Checkpoint Bonuses - $800
<br><br>
...
<table cellpadding="0" cellspacing="0" border="0" width="300">
   ...
   <tr>
      <td>Competition Phase:</td><td align="right">01.28.2006</td><td align="right">02.15.2007</td>
   </tr>
   <tr>
...
<br><br>
<%--
To sign up, please send an email to <A href="mailto:AssemblyCompetitions@topcoder.com?subject=Register: PMC Product">AssemblyCompetitions@topcoder.com</A>.  In the email, include the following information:
<ul>
<li>Handle</li>
