...
/**
 * <p>
 * Unit test for {@link SecurityGroupConfigurationException} class.
 * </p>
 * 
 * @author leo_lol
 ...
 * @since 1.0
 */
public class SecurityGroupConfigurationExceptionTest {
    /**
     * <p>
     ...
     * <p>
     * Tests accuracy of
     * <code>SecurityGroupConfigurationException(String)</code> constructor.<br>
     * The detail error message should be properly set.
     * </p>
     */
    @Test
    public void testSecurityGroupConfigurationExceptionString() {
        SecurityGroupConfigurationException exception = new SecurityGroupConfigurationException(
                DETAIL_MESSAGE);
     ...
     * <p>
     * Tests accuracy of
     * <code>SecurityGroupConfigurationException(String, Throwable)</code>
     * constructor.<br>
     ...
     */
    @Test
    public void testSecurityGroupConfigurationExceptionStringThrowable() {
        SecurityGroupConfigurationException exception = new SecurityGroupConfigurationException(
     ...
     * <p>
     * Tests accuracy of
     * <code>SecurityGroupException(String, ExceptionData)</code> constructor.<br>
     * The detail error message and the exception data should be properly set.
     * </p>
     */
    @Test
    public void testSecurityGroupConfigurationExceptionStringExceptionData() {
        SecurityGroupConfigurationException exception = new SecurityGroupConfigurationException(
        ...
        assertNotNull("Application code should not null.", exception
                .getApplicationCode());
        assertEquals("Exception data is not set.", APPLICATION_CODE, exception
                .getApplicationCode());
    }
     ...
     * <p>
     * Tests accuracy of
     * <code>SecurityGroupException(String, Throwable, ExceptionData)</code>
     * constructor.<br>
     ...
     */
    @Test
    public void testSecurityGroupConfigurationExceptionStringThrowableExceptionData() {
        SecurityGroupConfigurationException exception = new SecurityGroupConfigurationException(
