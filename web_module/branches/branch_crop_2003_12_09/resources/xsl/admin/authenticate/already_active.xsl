...
<tr>
  <td width="619" align="left"><img src="/images/already_active.gif" width="619" height="20" /></td>
</tr>
</table><br/>
...
<b>
<font face="arial, verdana, helvetica, sans-serif" size="2" color="#ffffff">
<a href="JavaScript:doSubmitNavBar('authentication','login')">Click here to login to your member account.</a>
</font>
</b>
