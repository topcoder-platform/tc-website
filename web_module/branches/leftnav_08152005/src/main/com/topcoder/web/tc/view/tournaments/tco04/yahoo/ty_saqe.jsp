		...
		<td align="center">
			<table width="510" border=0 cellpadding=20 cellspacing=0>
				<tr>
                    ...
                    <p class=pageTitle>Technical Yahoo! - Search, Architect, QA Engineers</p>
					<p>	Yahoo! Inc.<br/>
						Location: Sunnyvale, California</p>

					<p>Yahoo! has developed one of the most successful search platforms in the world and we are looking for 
					the best of the best, engineering talent, to join this impressive and highly technical team.  We are 
					looking for engineering talent in the following areas:</p>
					
					<ul>
						<li>SW Engineering Mgmt</li>                 
						<li>Web Search</li>      
						<li>Relevance Engineering</li>      
						<li>Vertical Search Engineering</li>      
