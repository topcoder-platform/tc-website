        ...
        <tbody>
            <tr>
                <td id="navSpacer">
                    ...
                    <jsp:param name="tabLev1" value="instructions"/>
...
<div align="center"><img src="/i/tournament/tco07/arena1.png" alt="" border="0" /></div>
<p></p>
...
<div align="center"><img src="/i/tournament/tco07/arena2.png" alt="" border="0" /></div>
<p></p>

<p>Move to your assigned competition room as follows:<br>
<ul>
...
<div align="center"><img src="/i/tournament/tco07/arena3.png" alt="" border="0" /></div>
<p></p>
...
<p>When the competition begins, you may view the problem statements as follows:<br>
<ul>
...
<div align="center"><img src="/i/tournament/tco07/arena4.png" alt="" border="0" /></div>
<p></p>
...
<p><b>Visual Basic Code Template</b></p>
...
<div align="center"><img src="/i/tournament/tco07/arena5.gif" alt="" border="0" /></div>
<p></p>
...
<p><i>Important note: All code submissions must run in under two (2) seconds for ALL test cases, otherwise the code submission will be marked as incorrect, and you will not receive any points.</i></p>
...
<div align="center"><img src="/i/tournament/tco07/arena6.gif" alt="" border="0" /></div>
<p></p>
...
<div align="center"><img src="/i/tournament/tco07/arena7.gif" alt="" border="0" /></div>
<p></p>
...
<p><i>Any submission that fails any test case will be deemed incorrect, and will result in a loss of all points for that submission. In addition, any submission that runs longer than two (2) seconds for any test case will be deemed incorrect, and will result in a loss of all points.</i></p>
...
<p><strong><i>admins: [YOUR QUESTION]</i></strong><br>
An administrator will respond to your question in the chat area.</p>
<p>If you have a problem logging into the Arena or cannot access the chat interface, you may send an email to <A href="mailto:service@topcoder.com">service@topcoder.com</A> . Please include a detailed description of the problem that you are having.</p>
                    </div>
                </td>
            </tr>
        </table>
