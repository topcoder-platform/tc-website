...
<div id="header">
    ...
    <ul id="nav">
        ...
        <li><a href="${sessionInfo.servletPath}?module=ViewActiveContests" title="Contests" onfocus="this.blur();">Contests</a>
        </li>
        <li><a href="/forums" title="Forums" onfocus="this.blur();">Forums</a></li>
        <li><a href="${sessionInfo.servletPath}?module=MyStudioHome" title="My Studio" onfocus="this.blur();">My
            Studio</a></li>
        <li>
            <a href="${sessionInfo.servletPath}?module=Static&amp;d1=support&amp;d2=getStarted" title="Support" onfocus="this.blur();">Help</a>
        </li>
        <li>
            <a href="${sessionInfo.servletPath}?module=Static&amp;d1=contactUs" title="Contact Us" onfocus="this.blur();">Contact
                Us</a></li>
    </ul>
</div>
