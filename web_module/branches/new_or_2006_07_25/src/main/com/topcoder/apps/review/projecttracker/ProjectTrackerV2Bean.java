...
public class ProjectTrackerV2Bean implements SessionBean {
     ...
     */
    private long getScorecardId(Connection conn, long projectTypeId, int scorecardTypeId) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
    ...
    private void prepareProjectInfo(Connection conn, long compVersId, long projectId, long modUserId) throws SQLException {
        PreparedStatement ps = null;
        ResultSet rs = null;
        long componentId = -1;
        int version = -1;
    ...
    public long createProject(String projectName, String projectVersion, long compVersId, long projectTypeId,
        ...
        try {
            ...
            projectId = nextId(PROJECT_ID_SEQ);

            long modUserId = requestor.getUserId();
            long firstPhaseInstanceId = nextId(PROJECT_PBASE_ID_SEQ);
            ...
            for (int i = 0; i < phases.length; i++) {
                long phaseId = nextId(PROJECT_PBASE_ID_SEQ);
