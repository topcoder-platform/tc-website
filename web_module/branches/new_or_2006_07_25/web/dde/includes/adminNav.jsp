...
<%--
					<td width="106" align="center" class="adminTopNav"><a onmouseover="document.images['scorecardAdmin'].src = scorecardAdminon.src; window.status='Scorecard Administration'; return true;" onmouseout="document.images['scorecardAdmin'].src = scorecardAdminoff.src" class="topNavLinks" href="../scorecard_admin/scorecardAdmin.do?actionName=listScorecards"><img src="/images/scorecardAdmin_off.gif" alt="SCORECARD ADMIN" name="scorecardAdmin" width="79" height="21" border="0" /></a></td>
--%>
				</tr>
			</table>
