...
<span class="bodySubtitle">Contest: Time Tracker Client Admin Tests</span>
<br><br>
<table class="stat" cellpadding="0" cellspacing="0" width="100%">
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="299180" />
      </td>
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="21277971" />
      </td>
      <td class="valueC" nowrap="nowrap">
      No submission
      </td>
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="13327713" />
      </td>
      <td class="valueC" nowrap="nowrap">
      No submission
      </td>
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="21298044" />
      </td>
      <td class="valueC" nowrap="nowrap">
      No submission
      </td>
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="21365601" />
      </td>
      <td class="valueC" nowrap="nowrap">
      No submission
      </td>
   ...
   <tr class="<%=even?"dark":"light"%>">
      <td class="value">
      <tc-webtag:handle coderId="15477601" />
      </td>
      <td class="valueC" nowrap="nowrap">
      No submission
      </td>
