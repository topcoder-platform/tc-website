        ...
        <div class="secondary-body" id="register">
        	<div class="siteBoxHalf">
        		<div style="text-align: justify;">
        			...
        			<p>Registration and participation by developers in the Ribbit Killer App Challenge Competition (the &ldquo;Competition&rdquo;) constitutes agreement with these terms and conditions (&ldquo;Rules&rdquo; or &ldquo;Terms and Conditions&rdquo;) between you and TopCoder, Inc. (&ldquo;TopCoder&rdquo;).</p>
        			
        			<h3>About the Competition</h3>
        			
        			<h4>Entering the Competition </h4>
        			<p>This skill-based Competition is brought to you and sponsored by TopCoder, Inc.  This Competition is designed to encourage the development and use of certain technologies, and provides an opportunity for members of the TopCoder Community to create software that integrates Ribbit into a Media, Advertising, and/or Entertainment application.  This Competition is open to all participants who meet the following criteria.</p>
        			<p>In order to participate in the Competition, you must agree to be bound by these Official Rules &amp; Regulations (&ldquo;Rules&rdquo;) and to all decisions of TopCoder, which are final, binding and conclusive in all matters.  Participants must be registered members of TopCoder, and also register for the Competition.  Participants also must subscribe to the free Ribbit developer service, and agree to be bound to the Ribbit Developer Terms of Service (available at: <a href="http://developer.ribbit.com/legal/apitou/">http://developer.ribbit.com/legal/apitou/</a>) along with all documents incorporated into such terms by reference.</p>
        			
        			<p>Registration may occur at any time from 12:01 AM EDT on November 17, 2008 through 11:59PM EDT on March 12, 2008. The Competition will begin at 12:01 AM EDT on November 17, 2008 and will end at 11:59PM EDT on March 12, 2008 </p>
        			
        			<h4>Submission Requirements</h4>
        			<p>All Competitors registered for the Competition will see a Submit option. Clicking the Submit link will take the Competitor to a page that will allow the Competitor to upload a solution. </p>
        			...
        			<p>Once your app is live, submit it to the contest.</p>
        			...
        			<h4>How to participate</h4>
        				<ol>
        					...
        					<li>Enter your Submission into the Competition using the functionality at http://ribbit.com/killerappchallenge </li>
        					<li>Winners will be selected based on the judging criteria below. The winning Submissions will be announced [TBD].</li>
        				</ol>
        			...
        			<p>A panel of judges will score each app according to specific criteria in each contest category.</p>
        			<p>The criteria for each contest category is described in detail on each category page.  The category pages are:</p>
        				<ul>
        			...
        			<p>Participants retain all ownership rights in their submissions; provided, however, that as a condition of participation, participants hereby grant a perpetual, royalty-free, irrevocable, non-exclusive license to TopCoder (a) to use, reproduce and publish such Submissions or material in connection with the Competition; (b) to publicly display, and/or feature your entry and all its content in connection with the promotion of this Competition in all media (now known or later developed); and (c) store your Submission on TopCoder or the Competition sponsor&rsquo;s servers, for marketing purposes, and/or for the promotion of the Competition.  You agree to sign any necessary documentation that may be required by TopCoder or its designees to make use of the rights you granted above.  You also understand that understand and acknowledge that TopCoder, the Competition sponsor, and/or other entrants may have developed or commissioned materials similar or identical to your submission and you waive any claims you may have resulting from any similarities to your entry.</p>
        			...
        			<p>By entering the Competition, the Participant acknowledges that TopCoder and the Competition sponsor will collect, process and use the personal data provided by the Participant in connection with and for the purpose of administering of the Contest.  Data about usage of the Ribbit APIs and services also will be collected.  Ribbit may use third party providers for processing purposes and Ribbit will ensure that appropriate arrangements are in place with such third parties to ensure that the security of the Participant&rsquo;s personal data is adequately safeguarded. Participants&rsquo; personal data will be transferred to Ribbit, located in the US. </p>
					...
					<p>All trademarks, tradenames, and/or tradestyles used in this Competition are the sole property of the respective of such trademarks, tradenames, and/or tradestyles and are used herein solely for identification purposes.</p>
				</div>
			</div>
