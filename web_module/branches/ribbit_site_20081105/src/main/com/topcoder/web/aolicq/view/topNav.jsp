...
<%--<div class="navBox">
    ...
    <a class="navTab" href="http://<%=ApplicationServer.AOLICQ_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=<%=Constants.CONTEST_ID%>"><img src="/i/events/aolicq/submit.png" alt="submit" onmouseover="this.src='/i/events/aolicq/submitOn.png';"  onmouseout="this.src='/i/events/aolicq/submit.png';" /></a>
    <a class="navTab" href="http://<%=ApplicationServer.AOLICQ_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=<%=Constants.CONTEST_ID%>"><img src="/i/events/aolicq/register.png" alt="Register" onmouseover="this.src='/i/events/aolicq/registerOn.png';"  onmouseout="this.src='/i/events/aolicq/register.png';" /></a>
      ...
      <div id="header-container">
        <h1>Ribbit<sup>&reg;</sup></h1>
          <ul id="nav">
              ...
              <li id="register-nav"><a <% if (active_page.equals("register")) {%>class="active"<% } %> href="http://<%=ApplicationServer.AOLICQ_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=<%=Constants.CONTEST_ID%>">Register</a></li>
              ...
              <li id="submit-nav"><a href="http://<%=ApplicationServer.AOLICQ_SERVER_NAME%>/?module=ViewContestDetails&amp;ct=<%=Constants.CONTEST_ID%>">Submit</a></li>
          </ul>
