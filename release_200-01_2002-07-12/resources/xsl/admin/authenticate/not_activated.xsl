...
<tr>
  <td width="619" align="left"><img src="/images/not_activated.gif" width="619" height="20" /></td>
</tr>
</table><br/>
  ...
  <tr>
    <td>
      <FONT FACE='arial,verdana,helvetica,sans-serif' SIZE='2' COLOR='#ffffff'>
        <p>Your account has NOT been successfully activated.</p>
        <p>The activation code was not valid.  If you submitted your activation code from an email,
        please check to make sure the activation code does not span two lines.</p>
      </FONT>
    </td>
  </tr>
  <tr>
    <td valign="top" height="5"><img src="/images/spacer.gif" width="1" height="15" /></td>
  </tr>
  <tr>
