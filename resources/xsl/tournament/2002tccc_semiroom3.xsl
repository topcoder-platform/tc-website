...
<P>
Even though local favorite <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A>, an MIT graduate student, recovered from his food 
poisoning experience and had a larger cheering section, Cal-Berkeley's <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A>, who 
...
<P>
"I'm relieved," said <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A>, when asked about he felt after the match, and who 
...
tournament finalist <A HREF="/index?t=tournament&amp;c=2002tccc_favs#dmwright" CLASS="bodyGeneric">dmwright</A>, <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> remarked, "I beat him in the Regional Finals, 
so I'm not scared."
</P>

<P>
All four coders opened the Level One problem first.  <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> was the first competitor to 
complete it and gained 230.04 points.  The three others, almost sensing that <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> had 
just submitted, all finished their codes in the next few minutes.  <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> earned 228.66 
points, <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A> gained 221.02, while <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> was awarded 218.60.  
</P>

<P>
Coding by degree of difficulty, all four next opened the Level Two problem.  <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A>, 
who as just mentioned earned the lowest point total on the Level One problem, was 
the quickest to code the Level Two problem, earning 326.39 points.  <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A>, with 
317.48 points, once again had the second highest point total for a problem.  
<A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A> was the third quickest with 298.75, while <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> gained 238.07.  When asked 
about being the slowest to code the Level Two problem, after being the quickest to 
code the Level One problem, <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> simply replied, "I just w<A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A>d to be careful."
</P>

<P>
<A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> and <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> were the only two coders to submit code for the Level Three problem.  
<A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> earned 612.34 points on that problem, for a total of 1157.34 overall, and the 
room lead after the "Coding Phase".  <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> was second with 1074.47 points, after 
gaining 528.33 points on the Level Three problem.  <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A> and <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> were third and 
fourth, with 519.77 and 468.11 points, respectively.
</P>

<P>
During the "Challenge Phase", <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A> lost 50 points when his challenge of the 
Level Two submission of <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> failed.  <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> then changed the entire complexion of 
the match, when his successful challenge of the Level Three submission of <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A>, 
cost <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> the 612.34 points he earned on the problem, and dropped him from first 
to second place overall.  <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> then tried to put himself back in contention, by 
trying to challenge the Level Three submission of <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A>, who was now the room leader.  
That challenge failed, however, and cost <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> an additional 50 points.   
</P>

<P>
After the "Challenge Phase", the point totals were as follows: <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> (1074.47), <A HREF="/index?t=tournament&amp;c=2002tccc_cind#po" CLASS="bodyGeneric">po</A> 
(518.11), <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> (495.00), and <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#milhouse" CLASS="bodyGeneric">milhouse</A> (469.77). 
</P>

<P>
The Level One submission of <A HREF="/index?t=tournament&amp;c=2002tccc_eyeon#malpt" CLASS="bodyGeneric">malpt</A> and the Level Two submission of <A HREF="/index?t=tournament&amp;c=2002tccc_cind#ante" CLASS="bodyGeneric">ante</A> were the 
