...
<xsl:template name="ArenaApplet">
  ...
  <OBJECT> 
    <xsl:attribute name="classid">clsid:CAFEEFAC-0014-0001-0000-ABCDEFFEDCBA</xsl:attribute>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>-->
        <xsl:attribute name="codebase">http://java.sun.com/products/plugin/autodl/jinstall-1_4_1-windows-i586.cab#Version=1,4,1,0</xsl:attribute>
<!--      </xsl:otherwise>
    </xsl:choose>        -->
    ...
    <EMBED>
      <xsl:attribute name="type">application/x-java-applet;jpi-version=1.4.1</xsl:attribute>
      ...
      <xsl:attribute name="pluginspage">http://java.sun.com/products/plugin/index.html#download</xsl:attribute>
      <NOEMBED></NOEMBED>
    </EMBED> 
  </OBJECT>
</xsl:template>
