    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Store File Loader Development Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Development Application Project - Store File Loader</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr valign="top">
                                                <td class="bodyText">
                                                    ...
                                                    <p>
                                                        ...
                                                        these is a merchandise transfer and receiving application.   In order
                                                        to minimize the number of transferred cartons that are lost or stolen,
                                                        ...
                                                        mainframe database must be loaded into the new corporate Oracle database.
                                                    </p>

                                                    <p>
                                                        <strong>Business Requirements Specification </strong>
                                                        <br/>
                                                        View the <a target="_new" class="bodyText" href="/i/development/downloads/Store_File_Loader_App_Req_Spec2.pdf">Business Requirements Specification</a> for this project.
                                                    </p>
                                                    <!-- Technologies -->
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$50.00</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$138.00</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Development Reviewer -</td>
                                                            <td class="bodyText" align="right">$88.00</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="bodyText" nowrap="nowrap">Development Reviewer - </td>
                                                            <td class="bodyText" align="right">$88.00</td>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="200">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" align="right">$764.00</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="bodyText" cellspacing="0" cellpadding="0" border="0" width="400">
                                                        <tr>
                                                            ...
                                                            <td class="bodyText" nowrap="nowrap" align="left">06.11.2004</td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br/>
                                                        Register <a href="/index?t=development&amp;c=tcs_app_inquire&amp;Project=Store%20File%20Loader%20Development">here</a> to get selected as a development and to obtain the information necessary to submit a solution.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
