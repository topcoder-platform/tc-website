...
<!-- Title -->
						<h1 class="devSubhead"><strong>NNTP Client: Design</strong></h1>
...
<!-- Project Type -->
						...
						Component Design Project: Provide a complete design for the NNTP Client component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5800322">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5802110">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5800322&amp;c=tcs_inquire&amp;Project=NNTP%20Client:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
