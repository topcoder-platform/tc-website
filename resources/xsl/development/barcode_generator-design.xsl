...
<!-- Title -->
						<h1 class="devSubhead"><strong>Barcode Generator: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The barcode generator component translates a string into a Scalable Vector Graphics image for printing.  In addition to generating the SVG image the component provides checksum checking based on the barcode encoding algorithm.  The initial barcode format supported by this component is UPC/EAN format.  However the component does support pluggable algorithms.

In order to track legal documents, a legal firm must provide both a physical copy of the contract and scan the printed document into their computer system for tracking.  Printing a barcode on the physical paper allows for the paper to be identified electronically through scanning.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Barcode Generator component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5703341">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704578">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5703341&amp;c=tcs_inquire&amp;Project=Barcode%20Generator:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
