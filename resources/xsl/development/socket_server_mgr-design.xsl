				...
				<table border="0" cellspacing="0" cellpadding="0" bgcolor="#000033" background="/i/steel_darkblue_bg.gif" width="100%">
					<tr>
						...
						<td class="statText" colspan="2" valign="top" bgcolor="#000033" background="/i/steel_darkblue_bg.gif" width="100%"><img src="/i/clear.gif" alt="" width="240" height="1" border="0"/><br/>
							...
							<h1 class="devSubhead"><strong>Socket Server Manager: Design</strong></h1>
                                    
							<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=Socket Server Manager: Design" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>

							<p><strong>Overview</strong><br />
							The Socket Server Manager provides a common mechanism for administering socket connections. Socket management can quickly become an onerous task. This component encapsulates the details of how to open and close a socket and send and receive data. In addition, the component provides convenience methods, such as the ability to refresh the connection. Furthermore, the component enables users to create and manage multiple sockets each with its own functional purpose.
							</p>

							<p><strong>Project Type</strong><br />
							Component Design Project: Provide a complete design for the Socket Server Manager component.<br />
