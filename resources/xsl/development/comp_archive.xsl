    ...
    <xsl:template match="/">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                ...
                <!-- Gutter Begins -->
                <td width="15">
                    <img src="/i/clear.gif" width="15" height="10" alt="" border="0" />
                </td>
                <!-- Gutter Ends -->
                ...
                <td class="bodyText" width="100%">
                    ...
                    <table class="formFrame" cellspacing="0" cellpadding="3" width="100%">
                        <tr valign="middle">
                            <td class="projectTitles" colspan="6">
                                <a name="design"></a>Component Design Project Status
                            </td>
                        </tr>
                        <tr valign="middle">
                        ...
                        <xsl:for-each select="/TC/DEVELOPMENT/reviews/status">
                            <xsl:if test="./phase_id=$design-phase">
                                <tr>
                                    ...
                                    <td class="projectCells" align="center">
                                        <xsl:call-template name="formatmmddyyyy">
                                            <xsl:with-param name="DATE" select="initial_submission_date"/>
                                        </xsl:call-template>
                                    </td>
                                    <td class="projectCells" align="center">
                                        <xsl:call-template name="formatmmddyyyy">
                                            <xsl:with-param name="DATE" select="review_complete_date"/>
                                        </xsl:call-template>
                                    </td>
                                    <td class="projectCells" align="center">
                                        <xsl:call-template name="formatmmddyyyy">
                                            <xsl:with-param name="DATE" select="final_submission_date"/>
                                        </xsl:call-template>
                                    </td>
                                    <td class="projectCells" align="center">
                                        <xsl:call-template name="formatmmddyyyy">
                                            <xsl:with-param name="DATE" select="phase_complete_date"/>
                                        </xsl:call-template>
                                    </td>
                                </tr>
                            </xsl:if>
                    ...
                    <table class="formFrame" cellspacing="0" cellpadding="3" width="100%">
                        <tr valign="middle">
                            <td class="projectTitles" colspan="6">
                                <a name="development"></a>Component Development Project Status
                            </td>
                        </tr>
                        <tr valign="middle">
                            <td class="projectHeaders" align="center">Catalog</td>
                ...
                <td width="244">
                    <xsl:call-template name="public_dev_right">
                        <xsl:with-param name="projects" select="."/>
                    </xsl:call-template>
                </td>
                <!-- Right Column Ends -->
            </tr>
