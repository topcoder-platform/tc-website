...
<!-- Gutter Begins -->
		<td width="4" bgcolor="#CCCCCC"><img src="/i/clear.gif" width="4" height="5" border="0"/></td>
<!-- Gutter Ends -->
		...
		<td class="bodyText" width="100%" bgcolor="#CCCCCC"><img src="/i/clear.gif" width="240" height="1" vspace="5" border="0"/><br/>
			...
			<table border="0" cellspacing="0" cellpadding="0" bgcolor="#000033" background="/i/steel_darkblue_bg.gif" width="100%">
				<tr valign="top">
					...
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="100%" colspan="4"><img src="../i/clear.gif" alt="" width="240" height="1" border="0" /></td>
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="10"><img src="../i/clear.gif" alt="" width="10" height="1" border="0" /></td>
				</tr>

				<tr valign="top">
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="10"><img src="../i/clear.gif" alt="" width="10" height="1" border="0" /></td>
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" class="statText" width="100%" colspan="4"><strong><img src="../i/title_weekly_comp_winners.gif" alt="This Week's Component Project Winners" width="346" height="26" border="0" /></strong><br />
				...
				<tr valign="top">
					...
					<td background="../i/steel_darkblue_bg.gif" colspan="4">
						<table border="0" cellspacing="0" cellpadding="0" width="100%">
							<tr><td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" height="5" colspan="4"><img src="../i/clear.gif" alt="" height="5" border="0" /></td>
							...
							<tr valign="top">
								<td class="statText" rowspan="5" width="55"><img src="../i/penwiper_sm_blue.jpg" alt="" width="55" height="61" border="0" hspace="5"/></td>
					...
					<td background="../i/steel_darkblue_bg.gif" colspan="4">
						<table border="0" cellspacing="0" cellpadding="5" width="100%">
							<tr><td class="statTextSmall"><span class="statText"><a href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2300015" class="statText"><strong>Logging Interface Component</strong></a></span><br />
									The Loggin Interface Component blah, blah, blah<br />
				...
				<tr valign="middle">
					...
					<td background="../i/steel_darkblue_bg.gif" colspan="4">
						<table border="0" cellspacing="0" cellpadding="5" width="100%">
							<tr><td class="statTextSmall">"This is a good design attempt that does not introduce unnecessarily complex overhead to a simple project." <strong>&mdash;ilya</strong></td></tr>
						</table></td>
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="10"><img src="../i/clear.gif" alt="" width="10" height="1" border="0" /></td>
				</tr>
				...
				<tr valign="middle">
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="10"><img src="../i/clear.gif" alt="" width="10" height="1" border="0" /></td>
					<td background="../i/steel_darkblue_bg.gif" class="statTextSmall" height="18" colspan="4">&#160;&#160;* Earnings for this Project (before <a href="#" class="statTextSmall">royalties</a>)</td>
					<td background="../i/steel_darkblue_bg.gif" bgcolor="#000033" width="10"><img src="../i/clear.gif" alt="" width="10" height="1" border="0" /></td>
				</tr>
