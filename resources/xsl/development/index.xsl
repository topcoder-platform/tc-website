...
<P>The TopCoder Development area lists any near-term or in-progress projects at TopCoder that involve the use of the TopCoder member base. Projects are classified as "Application" or "Component" projects.  There has been significant change to the process of component development, all members interested in this need to first review the TopCoder Software Component Development Methodology detailed below.</P>
...
<P>Component projects require that interested members submit their solution to the posted project by the project due date.  Once all submissions have been received, a review team will select the winning solution.  Software components built through the competition based projects offer the additional benefit of being commercially marketed.  In addition to the initial payment received for providing the winning solution, members can also receive royalties on all sales of the component through TopCoder Software.
TopCoder Software Component Development Methodology
The Component Development Methodology combines the best of traditional software development methodologies with the power of community-based, distributed development. This methodology is designed for low-level base components, not for larger applications.  The steps of the process are as follows:</P>

<P><B>Component Design Project:</B></P>
<OL>
<LI>TopCoder Software product manager posts a design project on the Development section of the TopCoder website.  This posting includes a high-level functional description of the component, deliverables for the design proposal, a timeline for submissions and project payment information. A requirements specification document for the component will be sent to all members who inquire about the project. </LI>
...
<LI>The product manager will grant all eligible members access to an online forum on <A HREF="http://www.topcodersoftware.com" CLASS="statText">www.topcodersoftware.com</A>.  This forum is used for the designers to ask questions of the product manager about the requirements specification.  </LI>
