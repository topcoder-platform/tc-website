...
<!-- Title -->
						<h1 class="devSubhead"><strong>Universal Time: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Universal Time component abstracts the details of date/time retrieval from date/time data sources.  The component queries a configurable date/time data source to obtain the current date/time.  It then calculates the approximate latency involved in retrieving the timestamp in order to return an accurate time stamp.  Supported date/time sources include; NTP (Network Time Protocol) service, UNIX time service, windows time service, a database, local file system or others.

One service the Universal Time provides is the abstraction of the retrieval of a single date time source for an application
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Universal Time component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4311743">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4311743&amp;c=tcs_inquire&amp;Project=Universal%20Time:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
