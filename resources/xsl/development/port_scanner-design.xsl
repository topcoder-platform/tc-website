...
<!-- Title -->
						<h1 class="devSubhead"><strong>Port Scanner: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Port Scanner component determines the status of ports for a given set of IP addresses and within a port range.  By scanning ports, an administrator can monitor the network for potential vulnerabilities.  While port scanning utilities are available, implementing a Java version enables these utilities to be tied directly into a larger application.

The Port Scanner can be used by a network administrator to verify that no one is creating their own ftp servers and providing unauthorized access to internal file systems.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Port Scanner component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4228664">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4228664&amp;c=tcs_inquire&amp;Project=Port%20Scanner:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
