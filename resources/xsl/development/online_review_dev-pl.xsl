...
<!-- Definition of Completion -->
				...
				<p>
				The Initial Submission has been delivered by the Initial Submission Date.  The Submission has been reviewed by the board and if required changes have been re-submitted by the developer. Development payment is conditional on receiving a minimum score of fifty (50) by the Development Review Board.  The Integration Payment will be paid out following the completion of the integration period.  The Integration Payment is condition on acceptance of the fully functional application by the TopCoder Application Manager.
				</p>
