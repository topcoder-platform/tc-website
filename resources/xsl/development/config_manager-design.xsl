...
<!-- Title -->
							<h1 class="devSubhead"><strong>Configuration Manager Enhancement: Design</strong></h1>
                                    
							<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=Configuration Manager Enhancement: Design&amp;comp=500004&amp;date=2&#47;5" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>
...
<!-- Overview -->
							...
							Enhance the existing Configuration Manager to:
							<ul>
							  <li>Provide a pluggable data source.  The current version only supports file-based configuration in the form of .properties or .xml.  An example of an additional data source is a RDBMS.</li>
							  <li>Maintain file integrity.  When modifying a configuration file through the configuration manager, the order of the underlying file is not maintained.</li>
							  <li>Update the design documents to .zargo</li>
							  <li>Elaborate upon the existing javadocs, particularly the ConfigManager class.  Component usage and configuration should be fully explained in the javadocs.</li>
							</ul>
							</p>
...
<!-- Project Type -->
							...
							Component Design Project: Provide a complete design for the Configuration Manager Enhancement component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=500004">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Time Line -->
						...
						Initial Submission Due Date: 1.29.2003<br/>
						Winner Announced: 2.6.2003<br/>
						Final Submission Due Date: 2.10.2003<br/>
						Estimated Development End Date: 3.19.2003</p>
