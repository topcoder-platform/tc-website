...
<!-- Title -->
						<h1 class="devSubhead"><strong>Data Grouping: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Data Grouping component extracts, organizes and summarizes data sets by grouping data items together and performing aggregate functions on individual data items.  It groups data items together, before executing grouping functions.  Current functions supported include sum, count, average, min and max.

Sales reports are stored as an array of line items.  To determine the total sales for a product by region the data is grouped by product id, region id and the sales are totaled.  The data can then be displayed by the reporting software.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Data Grouping component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5710148">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5710148&amp;c=tcs_inquire&amp;Project=Data%20Grouping:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
