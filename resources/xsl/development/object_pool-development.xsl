...
<!-- Overview -->
						...
						The Object Pool component provides functionality to create and manage a "Pool" of Java objects.  Objects in the pool are created once and reused numerous times.  This eliminates the need for continual object initialization and destruction, saving resources and reducing compilation overhead.
While a pool can be used for any object type, it is most beneficial to use with objects that have a relatively high initialization overhead.  An example is the creation of database connection objects. 
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2300000">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=4220538">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=2300000&amp;c=tcs_inquire&amp;Project=Object%20Pool:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
