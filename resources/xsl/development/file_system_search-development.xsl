...
<!-- Overview -->
						...
						The File System Search Component searches a file-system by filename, directory name or contents of a file.  This search component allows developers to add comprehensive file-system search capabilities to applications.  



Similar implementations of this search functionality are the Microsoft Windows find feature and the Unix grep and find utilities.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3304435">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=4500789">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=3304435&amp;c=tcs_inquire&amp;Project=File%20System%20Search:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
