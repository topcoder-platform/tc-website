...
<!-- Title -->
						<h1 class="devSubhead"><strong>Lexical Analyzer: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Lexical Analyzer parses a data source according to a defined rule set.  The parsed data is then represented in object form to facilitate navigation and manipulation.

The Lexical Analyzer will be used to parse Java source code to determine method details.  The resulting data will be passed to the J-Unit Code Generator to create compilable unit test cases for all public methods in the class.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Lexical Analyzer component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5703741">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704468">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5703741&amp;c=tcs_inquire&amp;Project=Lexical%20Analyzer:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
