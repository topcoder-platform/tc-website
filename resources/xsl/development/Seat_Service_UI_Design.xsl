    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <head>
                ...
                <title>Seat Service User Interface Project at TopCoder</title>
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table cellspacing="0" class="formFrame" align="center" width="530">
                                            <tr>
                                                <td class="projectTitles" nowrap="nowrap">Design Application Project - Seat Service User Interface Design</td>
                                            </tr>
                                            <tr>
