                            ...
                            <table border="0" cellspacing="0" cellpadding="0"  width="100%">
                                <tr>
                                    ...
                                    <td class="bodyText" colspan="2" valign="top"  width="100%">
                                        ...
                                        <p>
                                            <strong>
                                                <a href="/index?&amp;t=development&amp;c=tcs_app_inquire&amp;Project=Admin%20Tool%20Enhancements">Inquire for the Group 1 Development Tasks of the Application Project</a> to get selected as a developer and to obtain the information necessary to submit a solution.
                                                <!--Inquiry is closed. -->
                                            </strong>
                                        </p>
                                        <p>
                                            <strong>
                                                <a href="/index?&amp;t=development&amp;c=tcs_app_inquire&amp;Project=Admin%20Tool%20Enhancements">Inquire for the Group 2 Development Tasks of the Application Project</a> to get selected as a developer and to obtain the information necessary to submit a solution.
                                                <!--Inquiry is closed. -->
                                            </strong>
                                        </p>
                                        <p>
