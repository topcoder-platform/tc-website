...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2809552">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=4220480">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=2809552&amp;c=tcs_inquire&amp;Project=Database%20Abstraction:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
