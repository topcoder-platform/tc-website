...
<!-- Title -->
						<h1 class="devSubhead"><strong>HTML Document Parser: Development</strong></h1>
                                    
<!-- Overview -->
						<p><strong>Overview</strong><br />
						The HTML Document Parser is used to obtain hypertext elements from an HTML document.  Hypertext elements include references to images, hyperlinks and forms embedded within an HTML source.
...
<!-- Project Type -->
						...
						Component Development Project: Provide a complete development solution for the HTML Document Parser component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4201369">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=5802160">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=4201369&amp;c=tcs_inquire&amp;Project=HTML%20Document%20Parser:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
