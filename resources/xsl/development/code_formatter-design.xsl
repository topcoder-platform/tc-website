...
<!-- Overview -->
						...
						The Code Formatter transforms source code to a new style based on defined formatting standards.  The API for the component takes source code and an XML file with the style information for the code transformation.  The component outputs a new version of the source code in the style described by the XML.  

A good example of the Code Formatter is in the distributed development environment TopCoder employs to build software components.  In order to best enforce coding standards, the Code Formatter is used as a plugin to the source control system and applied prior to check-ins.  This allows TopCoder to provide consistency in the format and style of our source code as well as allow developers to code in the format with which they are most comfortable. 
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3309474">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704731">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=3309474&amp;c=tcs_inquire&amp;Project=Code%20Formatter:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
