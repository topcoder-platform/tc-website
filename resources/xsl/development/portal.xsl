...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
  <TR>
    ...
    <TD CLASS="statText" COLSPAN="2" VALIGN="top" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%"><IMG SRC="/i/clear.gif" ALT="" WIDTH="240" HEIGHT="1" BORDER="0"/><BR/>
                                    ...
                                    <b>Portal</b>
                                    <BR/>
                                    <a href="Javascript:document.frmInquire.Project.value='Portal';document.frmInquire.To.value='development@topcoder.com';document.frmInquire.submit();" CLASS="statText"><b>Click here to inquire &gt;&gt;</b></a>
                                    <BR/>
<P>
<B>Purpose</B>
</P>
...
<P>
TopCoder plans on creating a Portal where corporate members of the TopCoder community will be able to access premium services.  The portal will be designed to provide content and information as well as provide the require authentication with the proper authorization for the corporate members.
</P>
...
<P>
The development team will consist of 5 rated TopCoder Members. <BR/><BR/>
Four Developers<BR/>
...
<UL>
   ...
   <LI> Account administration</LI>
      <UL>    	 
	    <LI> Corporate users will be able to create new accounts and grant the level of access required to complete the necessary tasks.</LI>
	    <LI> The admin level user will have access to all rules and permissions available and assign users as required. </LI>
      </UL>
   <LI> Registration</LI>
      <UL>
	     <LI> A new corporate registration section</LI>
	        <UL>
	          <LI> A primary contact will be the admin level account</LI>
            </UL>     
      </UL>
	<LI> Credit Card Processing</LI>
      <UL>
	    <LI>Payment for services will be handled electronically online</LI>
      </UL>
	<LI> TopCoder Employment Services</LI>
      <UL>
	    <LI>The current corporate site for TCES will be moved to work under the newly created Portal</LI>
      </UL>
</UL>  
</P>

<P>
<B>Phase 1: TopCoder Environment Training - Complete December 12, 2002</B>
</P>
...
<P>
<B>Phase 3: Quality Assurance Test - Complete January 17, 2003</B>
</P>
...
<P>
<B>Phase 4: Application Test - Complete January 20, 2003</B>
</P>
...
<P>
<B>Phase 5: Production Deployment - Complete January 22, 2003</B>
</P>
...
<P>
<B>Developers</B><BR/>
Each developer will be paid a total of $1,700 in the following installments as described above:<BR/><BR/>
(i) $125<BR/>
(ii) $225<BR/>
(iii) $225<BR/>
(iv) $225<BR/>
...
<P>
<B>QA Developer</B><BR/>
The QA Developer will be paid a total of $1,250 in the following installments as described above:<BR/><BR/>
(i) $150<BR/>
(ii) $150<BR/>
(iii) $150<BR/>
(iv) $150<BR/>
...
<P>
The project will begin on December 9, 2002. There will be a kick-off conference call to address the following: introduction of all team members, design considerations for the new systems, specific time lines, deliverables, development, and any outstanding issues. The project is scheduled to be complete by January 22nd. 
</P>

<P>
<B>Developers:</B><BR/>
Project Start Date: December 9, 2002<BR/>
Project End Date: January 22, 2003<BR/>
</P>
