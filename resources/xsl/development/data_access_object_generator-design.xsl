...
<!-- Title -->
						<h1 class="devSubhead"><strong>Data Access Object Generator: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Data Access Object (DAO) Generator component creates classes that can be used to access a persistent data-store.   Utilizing a generic DAO generator allows developers to concentrate on complex business logic using standard, light-weight classes rather than writing the classes from scratch.



In order to create reports, the DAO generator takes a list of SQL statements and generates a class to directly retrieve the necessary data from the database.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Data Access Object Generator component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4313168">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5704732">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=4313168&amp;c=tcs_inquire&amp;Project=Data%20Access%20Object%20Generator:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
