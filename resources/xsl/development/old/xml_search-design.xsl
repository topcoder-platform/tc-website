...
<!-- Title -->
						<h1 class="devSubhead"><strong>XML Search: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The XML Search component enables a fast, text-based approach for searching and retrieving data from an XML file.  The component is designed for speed.  As such, standard parsers are not used, nor is the XML structure validated.



An example of XML Search component use is providing information to a simple Help system. Help topics and details are stored in an XML file.  When a topic is requested that file can be searched and the details retrieved for display.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the XML Search component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3502170">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=3502170&amp;c=tcs_inquire&amp;Project=XML%20Search:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
