...
<!-- Title -->
						<h1 class="devSubhead"><strong>Service Manager: Development</strong></h1>
                                    
<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Service Manager component provides a standard implementation for defining and managing "service" type classes.  A service class can be defined as a class that performs specific tasks at timed, periodic or random intervals.  An example of a service includes a custom socket listener.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Development Project: Provide a complete development solution for the Service Manager component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3102817">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=5704470">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=3102817&amp;c=tcs_inquire&amp;Project=Service%20Manager:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
