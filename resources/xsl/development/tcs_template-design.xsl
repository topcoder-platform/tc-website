...
<!-- Title -->
						...
						<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=<<<COMPONENT_NAME>>>: Design&amp;comp=<<<COMPONENT_ID>>>" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>
...
<!-- Documentation -->
						...
						All <a class="statText" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=<<<TCS COMP ID>>>">documentation</a> for this project is available on the TopCoder Software web site.</p>
