...
<!-- Title -->
						<h1 class="devSubhead"><strong>Standard Class: Design</strong></h1>
                                    


<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Standard Class component defines an object representation of a class.  Class details include constructors, methods, method arguments and variables.  The component is not responsible for reading or parsing a class file to create a Standard Class instance.

The Standard Class component will be used when analyzing classes, either directly from compiled class files or from source files.  
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the Standard Class component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5800878">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   <p>
        						<strong>View the <a class="statText" target="_new"  href= "http://www.topcodersoftware.com/catalog/document?id=5802109">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5800878&amp;c=tcs_inquire&amp;Project=Standard%20Class:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
