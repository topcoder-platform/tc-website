...
<!-- Overview -->
						...
						The Java FTP component wraps standard FTP commands into an easy to use API.  FTP connections can be initiated in passive or active mode. Files can be transferred in ASCII or binary mode.  For FTP commands that are not supported by this component, a facility is available to enter those commands directly through the API.



A scheduled job requires the movement of the daily report spreadsheet to a web server.  The FTP component is used to programmatically transfer the file to the web server for distribution.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=5501537">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=5501537&amp;c=tcs_inquire&amp;Project=Java%20FTP:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
