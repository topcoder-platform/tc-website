...
hereby state: I am at least 18 years of age.  My date of birth is ________________.
My home telephone number is <xsl:value-of select="/TC/Affidavit/HomePhone"/>, and I reside at
...
I hereby represent that I am 18 years of age or older and have complied with, and will continue to comply with all the rules and regulations of this Contest and that I have perpetrated no fraud or deception in entering the Contest or in claiming any prize that may be awarded to me.  I hereby represent further
 that my performance in the Contest is a result of my efforts alone and all ideas for code or challenges submitted by me during the course of the Contest were mine alone.
    ...
    <tr>
      <td class="bodyText" colspan="3">
Further, I represent that the following information contained in TopCoder's member database represents my personal, identifying information, and that such 
information is true, accurate and comprehensive:
      </td>
    </tr>
<xsl:call-template name="Demog"/>
    ...
    <tr>
      <td class="bodyText" colspan="3">
I also represent that neither I nor any member of my immediate family or anyone living in my household are employees of TopCoder or those involved in the development, production (including prize suppliers), implementation or distribution of the Contest or their advertising, marketing, public relations and promotion agencies (the 'Sponsors'), or any of their parent corporations, subsidiaries, affiliates, agents, assigns, etc. or any entity connected with this Contest, and that neither I nor any immediate family member or anyone living in my household is connected with any of the above.
      </td>
    </tr>
    ...
    <tr>
      <td class="bodyText" colspan="3">
I understand that neither TopCoder, the Sponsors nor their parent corporations, subsidiaries, affiliates, agents, assigns, etc. or any entity connected with this Contest will be responsible for any costs (including, without limitation, any federal, state or local taxes) I may incur in connection with this Contest or any prize I may be awarded<xsl:if test="/TC/Affidavit/ContestId='50'">, including the applicable taxes associated with the benefit of a guest of my choice attending the Contest</xsl:if>.  However, I understand that TopCoder may make withholdings from any prize that I may be awarded in order to comply with applicable tax laws.  I agree to sign any applicable forms necessary to distribute the prize as required by tax authorities.
      </td>
    </tr>
    <tr>
      <td class="bodyText" colspan="3"><br /></td>
...
liability release prior to its execution, and that I fully understand its contents.
    ...
    <tr>
      <td class="bodyText" colspan="3">
It is understood and agreed that this is a complete RELEASE and DISCHARGE of all claims and rights of the undersigned against the TopCoder and the Sponsors
    ...
    <tr>
      <td class="bodyText" colspan="3">
        ...
        <table width="552" cellspacing="0" cellpadding="1" border="0" align="center">
          ...
          <tr>
            <td class="bodyText">(Signature of contestant)</td>
...
On this ___ day of ________, 200_, before me, __________________, (notary name) personally appeared ________________________________ (name of contestant) t
o me personally known, who, being by me duly sworn, did depose and say that he/she signed the foregoing instrument and he/she acknowledged the same to be h
