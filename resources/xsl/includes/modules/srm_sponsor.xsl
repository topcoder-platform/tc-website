...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="srm_sponsor">
            <img src="/i/es/diversified_data/srm_promo_home.gif" alt="" width="244" height="142" border="0" usemap="#srmanimation_home" /><br />
            ...
            <area shape="rect" alt="SRM Match 158" coords="0,93,243,141" href="/?RoundId=4598&amp;t=schedule&amp;c=srm" />
            </map>
  </xsl:template>
</xsl:stylesheet>
