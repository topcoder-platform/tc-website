  ...
  <xsl:template name="top_5_countries">
            <table width="100%" border="0" cellspacing="0" cellpadding="3" valign="top" bgcolor="#001935">
                <tr valign="middle">
                    ...
                    <td class="statTextBig" bgcolor="#093158" width="15"><A href="javascript:infoWindow('/tc/?&amp;module=Static&amp;d1=statistics&amp;d2=info&amp;d3=topCountries')" class="statTextBig"><img src="/i/icon_help_blue.gif" alt="?" width="15" height="11" /></A></td>
