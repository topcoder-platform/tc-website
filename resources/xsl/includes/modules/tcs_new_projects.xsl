...
<!-- Application Projects begins -->
            ...
            <table width="244" cellspacing="0" cellpadding="0" border="0" bgcolor="#093158">                
                ...
                <tr valign="top">
                    ...
                    <td background="" class="statText" colspan="2"><a href="?&amp;t=development&amp;c=online_review_dev-fe">Online Review Front End</a></td>
		    ...
		    <td width="5"><img src="/i/clear.gif" alt="" width="5" height="1" border="0" /></td>
                ...
                <tr valign="top">
                    <td background="" width="5" class="statText"><img src="/i/clear.gif" alt="" width="5" height="1" border="0" /></td>
                    <td background="" class="statText" colspan="2"><a  href="?&amp;t=development&amp;c=online_review_dev-pl">Online Review Persistence Layer</a></td>
                    <td background="" width="5" class="statText">06.16.2003</td>
		    <td width="5"><img src="/i/clear.gif" alt="" width="5" height="1" border="0" /></td>
                </tr>
