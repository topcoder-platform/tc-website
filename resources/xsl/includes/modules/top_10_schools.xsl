...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="top_10_schools">
            <table width="100%" border="0" cellspacing="0" cellpadding="3" valign="top" bgcolor="#001935">
                <tr valign="middle">
                    <td class="statTextBig" bgcolor="#093158" width="1%" nowrap="0">&#160;Schools</td>
                    <td class="statTextBig" bgcolor="#093158" width="15"><A href="javascript:infoWindow('/tc/?&amp;module=Static&amp;d1=statistics&amp;d2=info&amp;d3=topSchools')" class="statTextBig"><img src="/i/icon_help_blue.gif" alt="?" width="15" height="11" border="0" /></A></td>
                    <td class="statTextBig" align="right" bgcolor="#093158" width="99%"><a href="/stat?c=school_avg_rating" class="statTextBig">View all</a>&#160;</td>            
                </tr>
            </table>
