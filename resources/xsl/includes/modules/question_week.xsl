...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:template name="question_week">
      ...
      <table width="100%" border="0" cellpadding="10" cellspacing="0" class="bodyText">
         <tr><td class="bodyText">Question goes here</td></tr>
<!--         <tr><td class="bodyText" align="center"><a href="/">Submit</a> | <a href="/">View Results</a></td></tr>-->
         <tr><td class="bodyText" align="center"><a href="/"><img src="/i/submit.gif" width="101" height="20" border="0"/></a>
         <a href="/"><img src="/i/view_results.gif" width="101" height="20" border="0"/></a></td></tr>-->
      </table>
  </xsl:template>
</xsl:stylesheet>