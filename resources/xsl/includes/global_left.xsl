...
<xsl:template name="rtables_row">
                <tr><td id="leftNav"><img alt="" width="10" height="10" src="/i/nav_arrow_right.gif" border="0"/><A class="left"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/ForumsHost"/></xsl:attribute>Round Tables (Forums)</A></td></tr>
</xsl:template>
