...
<xsl:template name="rtables_row">
                <tr><td id="leftNav"><img alt="" width="10" height="10" src="/i/nav_arrow_right.gif" border="0"/><A class="left"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/rtables/index.jsp</xsl:attribute>Forums / Round Tables</A></td></tr>
</xsl:template>
            ...
            <!-- Project Submission -->
                            <tr>
                                <td id="leftSubnav">
                                    ...
                                    <A class="leftOn"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?t=development&amp;c=getting_started</xsl:attribute>Gettng Started</A>
                                </td>
                            </tr>
...
<!-- Contests -->
    ...
    <tr>
        <td id="leftSubnav">
            ...
            <xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?t=development&amp;c=des_bonus_contest_2</xsl:attribute>
            <img width="10" height="10" alt="" border="0" src="/i/nav_arrow_bottom.gif">
                 <xsl:attribute name="src">
                    <xsl:choose>
