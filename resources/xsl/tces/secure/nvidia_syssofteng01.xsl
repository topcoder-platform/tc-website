...
System Software Engineers support NVIDIA's new high performance chipset business. They are
	...
	write software for Networking, Audio, IDE, SMBus and other hardware, and implement support for
	modern PC standards such as ACPI and OnNow.</P>
<P><B>Qualifications:  GPA 3.8</B></P>
<UL>
<LI>Candidates should have a solid engineering background and understanding of good code methodology.</LI>
...
<P ALIGN="center"><A HREF="/jobposting?&amp;t=JobHitTask&amp;jid=63&amp;jt=2" CLASS="bodyText">Apply now!</A> | <A HREF="/?&amp;t=tces&amp;c=nvidia_openings&amp;a=secure" CLASS="bodyText">Back to Jobs</A></P>
