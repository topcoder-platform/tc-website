            ...
            <table border="0" cellspacing="0" cellpadding="10" width="100%">
                <tr valign="top">
                    <td class="prText" width="100%"><img src="/i/clear.gif" alt="" width="400" height="1" border="0"/><br />
                        <div align="center">
                        <p><span class="bodyTitle">TopCoder Software Wins Three New Customer Contracts</span><br />
                        <span class="bodySubTitle"><em>Thomson Prometric, ING and Burlington Coat Factory Select TopCoder Software for Enterprise Solutions</em></span></p>
                        </div>
                        
                        <p><strong>GLASTONBURY, Conn., August 10, 2004&#151;</strong>
						TopCoder, Inc., the leader in online programming competition, skills assessment and competitive software development, today announced that TopCoder Software has won three new accounts -Thompson Prometric, ING and Burlington Coat Factory. The three latest projects will utilize TopCoder Software's competitive application development model which harnesses the talent of more than 40,000 developers from around the world to design, develop and deploy software. TopCoder Software components and applications are proven solutions that deliver cost savings of up to 40 percent and time savings of up to 50 percent over traditional development models.
						<br/><br/>
						...
						<br/><br/>
						<span class="bodySubtitle">About ING</span><br/>
