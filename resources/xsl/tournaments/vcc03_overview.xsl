...
<!-- Tab bar sub links-->
            ...
            <p>Everyone knows that programmers from Chennai are the masters of software development. Verizon has set out to find the best programmers in Chennai. 
            ...
            <p>Verizon will use the results of this event for the purpose of finding new employees for the Chennai VDSI Center. If you want to raise your profile by 
            besting your peers, then this is the event for you. Verizon has teamed with TopCoder, the leader in online and offline programming competitions and skills 
            assessment, to execute this exciting event.
            </p>
            ...
            The tournament is a timed contest allowing all participants to solve the same problems. The contests are challenging and exciting for contestants and 
            spectators. The format is simple:
            </p>
            <p><span class="bodySubtitle">Download the Arena</span><br />
            TopCoder's Competition Arena (a Java Applet) provides an interface to the competition. Here, contestants will read the problem statements, code 
            solutions, compile and test those solutions and submit their code for points. Once you've downloaded the arena, you can practice with many sample 
            problems, prior to the big match.
            </p>
            ...
            in the shortest period of time, the competitors interact with one another. The "Leader Board" tells the tale as competitors vie for the highest point total.
            </p>
            <p><span class="bodySubtitle">Challenge Phase</span><br />
            During the Challenge Phase, competitors view each other's code and try and "break'" that code by producing test cases that are not satisfied by the 
            software written. The most direct form of engaging competition for a programmer is to be given another's code to break. In this phase, precious points 
            ...
            <p><span class="bodySubtitle">Can you make it to August 29th?</span><br />
            Registration for the Verizon Coding Challenge opens on August 4th and closes on August 15th. Make sure to register, as Verizon will choose up to 500 
            programmers to compete in the first round. The first round will be held at XXX p.m. on August 20th. 
            </p>
            <p>The top 250 scorers from that round will advance to the second round on August 25th. The top 25 performers in the second round will be invited to 
            compete for the large cash prizes onsite at VDSI Chennai.
            </p>
            ...
            <table width="100%" border="0" cellpadding="6" cellspacing="2" class="sidebarBox">
                ...
                <tr valign="top">
                    ...
                    <td class="sidebarText">XXX</td>
                    <td class="sidebarText">Round 1 - 500</td>
                </tr>

                <tr valign="top">
                    <td class="sidebarText">Monday, August 25</td>
                    <td class="sidebarText">XXX</td>
                    <td class="sidebarText">Round 2 - 250</td>
                </tr>

                <tr valign="top">
                    <td class="sidebarText">Friday, August 29</td>
                    <td class="sidebarText">XXX</td>
                    <td class="sidebarText">Chapionship - 25</td>
                </tr>
            </table>
            
            <p><span class="bodySubtitle">Prizes</span><br />
            The 500 participants from Round 1 will receive a "Verizon Coding Challenge" T-shirt to wear with pride. The shirt will be a symbol 
            of each participant's competitive spirit. You will be recognized as leaders in Chennai's software development community. The top 25 
            finishers will be presented a "Certificate of Merit" by Verizon for outstanding performance in the tournament. The top four scorers 
            ...
            <p>To find out more detailed information on the Verizon Coding Challenge, including a list of the prizes, please read the Official Rules 
            and Regulations. Terms and Conditions. 
            </p>
            <p><br /></p>
