...
<!-- TCO Header -->
            <div align="center"><img src="/i/tournament/tco03/tco_promo_big2.gif" alt="2003 TopCoder Open" width="620" height="240" border="0" vspace="15" /></div>
...
<!-- Tab bar links-->
            <xsl:call-template name="tco03_links">
                <xsl:with-param name="selectedTab">coding_overview</xsl:with-param>
            </xsl:call-template>
