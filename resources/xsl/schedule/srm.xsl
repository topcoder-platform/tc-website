              ...
              <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
                <TR>
                 ...
                 <xsl:when test="$roundId&lt;4230">
                      ...
                      The match will feature a mixed programming language format.  For each individual problem, the coder will have the option of using either Java, C++, C# or VB to code the solution.  Syntactical knowledge of all three languages will be helpful during the challenge phase of each round of competition.<BR/><BR/>
