                    ...
                    <TABLE WIDTH="428" BORDER="0" CELLPADDING="0" CELLSPACING="0" ALIGN="center">
                      ...
                      <TR>
                        <TD COLSPAN="3" ALIGN="left" class="bodyText">
                            ...
                            <xsl:if test="/TC/SCHEDULE/Round/Details/forumd_id!=''">
                                <center><BR/><A class="left"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/ForumsHost"/>/?module=ThreadList&amp;forumID=<xsl:value-of select="/TC/SCHEDULE/Round/Details/forumd_id"/></xsl:attribute>Discuss this match</A><br/><br/></center>
                            </xsl:if>
