...
<A CLASS="bodyText"><xsl:attribute name="HREF">http://<xsl:value-of select="/TC/Host"/>/?&amp;t=authentication&amp;c=login</xsl:attribute><B><FONT COLOR="#CC0000">&#62;&#62; There are 136 open spots!</FONT></B><BR/>
