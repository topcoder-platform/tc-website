        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr>
                <td width="170" bgcolor="#000000" valign="top"><!-- <IMG SRC="/i/clear.gif" WIDTH="170" HEIGHT="1" BORDER="0" VSPACE="5"><br /> -->
                    ...
                    <font size="1" color="#000000" face="tahoma">HiddenWord</font>
                </td>
                <!-- Left Column Ends -->
                ...
                <td width="100%" valign="top" align="center" bgcolor="#FFFFFF">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            ...
                            <td valign="top" width="1" bgcolor="#000000">
                                <a href="/?&amp;t=tournaments&amp;c=tccc03_sched">
                                    <img src="/i/tournament/tccc03/tccc03_home.gif" alt="" width="138" height="90" border="0"/>
                                </a>
                            </td>
                            <td valign="top" bgcolor="#000000" class="statText">
                                <br/>
                                <strong>When:</strong> Feb. 18th - April 5th, 2003
                                <br/>
                                <strong>Where:</strong> the University Park Hotel @ MIT in Cambridge, MA
                                <br/>
                                <strong>Total Purse:</strong> $100,000
                                <br/>
                                <br/>
                                <font color="#CC0000">
                                    <strong>200 TopCoder Members will win money!</strong>
                                </font>
                                <br/>
                                <a class="statText">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=tournaments&amp;c=tccc03_sched
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            ...
                            <td valign="top" colspan="3" class="bodyText">
                                <a class="bodyGeneric">
                                    ...
                                    <strong>Single Round Match 131</strong>
                                </a>
                                <br/>
                            ...
                            <td valign="top" width="6">
                                <img src="/i/clear.gif" alt="" width="6" height="1" border="0"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td valign="middle" align="center" bgcolor="#CCCCCC" width="33%" nowrap="0" height="15">
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/stat?&amp;c=round_overview#leaders
                                    </xsl:attribute>
                                    Div. Leaders
                                </a>
                            </td>
                            <td valign="middle" align="center" bgcolor="#CCCCCC" width="43%" nowrap="0">
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/stat?&amp;c=round_overview#problem_stats
                                    </xsl:attribute>
                                    Problem Stats
                                </a>
                            </td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                            ...
                            <td valign="middle" class="statText" width="100%">
                                <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#001935">
                                    ...
                                    <xsl:for-each select="/TC/HOME/GainersAndLosers/Coder">
                                        <tr>
                                            <td height="14" valign="middle" width="20%" class="statTextBig" nowrap="0">&#160;&#160;&#160;
                                                <xsl:value-of select="division"/>
                                            </td>
                                            <td valign="middle" width="10%" class="statText">&#160;&#160;
                                                <xsl:value-of select="change_type"/>:
                                            </td>
                                            <td valign="middle" width="35%" class="statText" nowrap="0">&#160;&#160;
                                                <a>
                                                    <xsl:attribute name="HREF">stat?c=member_profile&amp;cr=
                                                        <xsl:value-of select="coder_id"/>
                                                    </xsl:attribute>
                                            ...
                                            <td valign="middle" width="15%" class="statText" align="center">
                                                <xsl:value-of select="change"/>
                                            </td>
                                            <td valign="middle" width="20%" class="statText" nowrap="0">&#160;
                        ...
                        <tr>
                            <td colspan="3" valign="top" width="100%">
                                <img src="/i/clear.gif" alt="" width="1" height="8" border="0"/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            <td valign="top" width="8">
                                <img src="/i/clear.gif" alt="" width="8" height="8" border="0"/>
                            </td>
                            <td valign="top" colspan="7">
                                <img src="/i/label_coder_view.gif" alt="Coder's Point of View" width="148" height="26" border="0"/>
                            </td>
                            <td valign="top" width="8">
                                <img src="/i/clear.gif" alt="" width="8" height="1" border="0"/>
                            </td>
                        ...
                        <tr>
                            <td valign="top" class="bodyText" width="100%">
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=srm131_prob
                                    </xsl:attribute>
                                ...
                                <p>
                                    ...
                                    for SRM 131 including top ranked competitors Yarin, John Dethridge, SnapDragon,
                                    and ZorbaTHut.  Competition was fierce, with the top scoring spot changing hands
                                    multiple times in the coding, challenge, and system test phases.  In the end,
                                    Yarin prevailed with SnapDragon and John Dethridge close behind.
                                    ...
                                    <a class="bodyGeneric">
                                        <xsl:attribute name="HREF">http://
                                            <xsl:value-of select="/TC/Host"/>/?&amp;t=statistics&amp;c=srm131_prob
                                        </xsl:attribute>Get the analysis
                                    </a>
                                </p>
                            </td>
                            <td valign="top" width="8">
                        ...
                        <tr>
                            ...
                            <td valign="top" width="100%" colspan="7" bgcolor="#43515E">
                                <img src="/i/clear.gif" alt="" width="1" height="1" border="0"/>
                            </td>
                            <td valign="top" width="8">
                                <img src="/i/clear.gif" alt="" width="8" height="1" border="0"/>
                        ...
                        <tr>
                            <td valign="top" colspan="8">
                                <img src="/i/clear.gif" alt="" width="1" height="4" border="0"/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            <td valign="top" width="5" rowspan="2">
                                <img src="/i/clear.gif" alt="" width="5" height="1" border="0"/>
                            </td>
                            <td valign="middle" width="40%" bgcolor="#FFFFFF" height="26">
                                <img src="/i/label_feat.gif" alt="Weekly Feature" width="184" height="26" border="0"/>
                            </td>
                            <td width="60%" bgcolor="#FFFFFF">
                                <img src="/i/clear.gif" alt="" width="1" height="1" border="0"/>
                            </td>
                            <td valign="top" width="7" rowspan="2">
                                <img src="/i/clear.gif" alt="" width="7" height="1" border="0"/>
                            </td>
                        </tr>
                        <tr>
                            <td valign="middle" bgcolor="#CCCCCC" align="center" height="15">
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=features&amp;c=index
                                    </xsl:attribute>
                            ...
                            <td valign="middle" bgcolor="#CCCCCC" align="center">
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=features&amp;c=feat_topics
                                    </xsl:attribute>Want to write?
                                </a>
                            </td>
                        </tr>
                    </table>
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            ...
                            <td valign="top" width="55" align="left" class="bodyText">
                                ...
                                <!-- <img src="/i/m/the_gigi_mug.gif" alt="" width="55" height="61" border="0" hspace="6" vspace="1"/> -->
                                <br/>
                                By&#160;the_gigi
                                <br/>
                                <i>[TC] Member</i>
                                <br/>
                                <br/>
                                <a href="/?&amp;t=features&amp;c=feat_topics">
                                    <img src="/i/writers_wanted.gif" alt="" width="55" height="61" border="0" hspace="6" vspace="15"/>
                                </a>
                            </td>
                            <td valign="top" width="8">
                                <img src="/i/clear.gif" alt="" width="8" height="1" border="0"/>
                            ...
                            <td valign="top" width="100%" align="left" class="bodyText">
                                ...
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=features&amp;c=feat_012203
                                    </xsl:attribute>
                                    <strong>Who needs another UI framework?</strong>
                                </a>
                                <br/>
                                <i>Unorthodox UI Framework</i>
                                <br/>
                        ...
                        <tr>
                            <td valign="top" colspan="5">
                                <img src="/i/clear.gif" alt="" width="1" height="12" border="0"/>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" width="8">
                            ...
                            <td valign="top" bgcolor="#43515E" colspan="3">
                                <img src="/i/clear.gif" alt="" width="1" height="1" border="0"/>
                            </td>
                            <td valign="top" width="7">
                                <img src="/i/clear.gif" alt="" width="10" height="1" border="0"/>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            <td valign="top" colspan="3">
                                <img src="/i/clear.gif" alt="" width="1" height="2" border="0"/>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" width="6">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#FFFFFF">
                        <tr>
                            ...
                            <td valign="top" colspan="3" width="100%" bgcolor="#43515E">
                                <img src="/i/clear.gif" alt="" width="6" height="1" border="0"/>
                            </td>
                            <td valign="top" width="6">
                                <img src="/i/clear.gif" alt="" width="6" height="1" border="0"/>
                        ...
                        <tr>
                            <td valign="top" width="8">
                                <img src="/i/clear.gif" alt="" width="8" height="26" border="0"/>
                            </td>
                            <td valign="top" width="50%" align="left" class="bodyText">
                                <font size="2" color="#000000" face="tahoma, verdana">
                                    <strong>[TC] Sponsorships</strong>
                                </font>
                                <br/>TopCoder offers sponsorship programs for the weekly
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=about_tc&amp;c=spons_srm
                                    </xsl:attribute>
                                    Single Round Matches
                                </a> as well as for
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=about_tc&amp;c=spons_tourny
                                    </xsl:attribute>Tournaments
                                </a>. Read more about our
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=about_tc&amp;c=spons_target
                                    </xsl:attribute>sponsorship programs
                                </a>.
                                <br/>
                            </td>
                            ...
                            <td valign="top" width="50%" align="left" class="bodyText">
                                <font size="2" color="#000000" face="tahoma, verdana">
                                    <strong>[TC] Employment Services</strong>
                                </font>
                                <br/>TopCoder works with companies to connect them with top-rated developers. Read more about our
                                <a class="bodyGeneric">
                                    <xsl:attribute name="HREF">http://
                                        <xsl:value-of select="/TC/Host"/>/?&amp;t=tces&amp;c=index
                                    </xsl:attribute>employment services
                                </a>.
                                <br/>
                            </td>
                            <td valign="top" width="6">
                ...
                <td valign="top" class="statText" width="244">
                    ...
                    <a href="/?&amp;t=development&amp;c=bonus_contest_0303">
                        <img src="/i/tcs_board.gif" alt="TCS" width="244" height="156" vspace="1" border="0"/>
                    </a>
                    <!-- Software Promo Ends -->
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#333333">
                        <tr>
                            <td height="20" class="moduleTitle">
                                <img src="/i/module_labels_tcs_coders.gif" alt="TopCoder Software Leaders" width="244" height="20" border="0"/>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#001935">
                        <tr valign="middle">
                            <td width="10" height="15" background="/i/steel_bluebv_bg.gif">
                                <img src="/i/clear.gif" width="10" height="15" border="0"/>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="statText">
                                <a class="coderTextBlue" href="/stat?c=member_profile&amp;cr=279551">scamp</a>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="statText">
                                <a class="coderTextYellow" href="/stat?c=member_profile&amp;cr=296145">srowen</a>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="statText">
                                <a class="coderTextGreen" href="/stat?c=member_profile&amp;cr=299180">isv</a>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="statText">
                                <a class="coderTextGreen" href="/stat?c=member_profile&amp;cr=251162">SamBob</a>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td class="statText">
                                <a class="coderTextYellow" href="/stat?c=member_profile&amp;cr=150940">orb</a>
                            </td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" valign="top" bgcolor="#001935">
                        <tr>
                            <td height="17" class="moduleTitle" bgcolor="#333333">
                                <img src="/i/module_labels_10_coders.gif" alt="Competition Leaders" width="244" height="20" border="0"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" bgcolor="#001935" width="100%">
                        <tr>
                            <td align="left" class="statText">
                                <img src="/i/clear.gif" width="20" height="4" border="0"/>
                            </td>
                            <td></td>
                            <td></td>
                            <td align="left" class="statText">
                                <img src="/i/clear.gif" width="10" height="4" border="0"/>
                            </td>
                        </tr>

                        <tr>
                            <td align="center" class="statTextBig" colspan="4">More Leaders</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="/stat?c=coder_ratings" class="statText">view all</a>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="/stat?c=school_avg_rating" class="statText">view all</a>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="/stat?c=state_avg_rating" class="statText">view all</a>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <a href="/stat?c=country_avg_rating" class="statText">view all</a>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            <td align="left" class="statText">
                                <img src="/i/clear.gif" width="20" height="10" border="0"/>
                            </td>
                            <td></td>
                            <td></td>
                            <td align="left" class="statText">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" bgcolor="#001935" width="100%">
                        <tr>
                            <td colspan="3" bgcolor="#333333">
                                <img src="/i/label_quick_stats_home.gif" alt="Statistics" width="244" height="20" border="0"/>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="5">
                                <img src="/i/clear.gif" width="6" height="1" border="0"/>
                            </td>
                            <td>
                                <img src="/i/clear.gif" alt="" width="1" height="3" border="0"/>
                            </td>
                            <td rowspan="5">
                                <img src="/i/clear.gif" width="6" height="1" border="0"/>
                            </td>
                        ...
                        <tr>
                            <td class="statText">Select a Statistic from the menu below.</td>
                        </tr>
                        <tr>
                            <td>
                                <img src="/i/clear.gif" alt="" width="1" height="3" border="0"/>
                        ...
                        <tr>
                            <td>
                                <a href="/stat?c=member_profile&amp;cr=304168">
                                    <img src="/i/codermonth_dec.gif" alt="Coder of the Month" width="244" height="116" vspace="10" border="0"/>
                                </a>
                            </td>
                        </tr>
                    </table>
