...
<p>
This problem is a simplified form of my favorite &ldquo;hand-waving&rdquo;
...
<p>
One further remark on the &ldquo;hand-waving&rdquo; algorithm.
...
&ldquo;hand-waving&rdquo; algorithm is the way to go.
</p>
...
famous story about Gauss, you&rsquo;ll recall is D*(D+1)/2.  You could use
...
<i>abstract syntax tree</i>) and then &ldquo;pretty-printing&rdquo;
...
&ldquo;optimal&rdquo; for the desired alternative means as big as
...
&ldquo;keep K&rdquo;) begin and end?  To see where it begins, notice
