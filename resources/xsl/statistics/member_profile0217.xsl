...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#000033" BACKGROUND="/i/steel_darkblue_bg.gif" WIDTH="100%">
  ...
  <TR>
    <TD BACKGROUND="/i/steel_darkblue_bg.gif" CLASS="statText" ROWSPAN="11" VALIGN="top">
      <xsl:choose>
      <xsl:when test="/TC/STATLISTS/Coder/HasImage='true'">
        <IMG WIDTH="126" HEIGHT="140" ALIGN="left" BORDER="0"><xsl:attribute name="SRC">/i/m/<xsl:value-of select="/TC/STATLISTS/Coder/Handle"/>_big.jpg</xsl:attribute></IMG>
      </xsl:when>
      <xsl:otherwise>
        <xsl:choose>
