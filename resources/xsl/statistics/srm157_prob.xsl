            ...
            <body>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                        ...
                        <!-- Gutter Begins -->
                        <td width="4">
                            <img src="/i/table_top_fill.gif" width="4" height="26" alt="" border="0"/>
                        </td>
                        <!-- Gutter Ends -->
                                ...
                                <tr valign="top">
                                    <td class="bodyText" width="100%">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                            <tr valign="middle">
                                                <td class="statTextLarge" bgcolor="#999999" width="50%">
                                                    <font size="3">Single Round Match 157</font>
                                                </td>
                                                <td class="bodyText" bgcolor="#999999" width="50%" align="right">
                                                    <a href="/index?t=statistics&amp;c=editorial_archive" class="bodyText">
                                            ...
                                            <tr valign="middle">
                                                ...
                                                <td class="bodyText" align="right">
                                                    <a href="mailto:editorial@topcoder.com">Comments / Ideas?</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <h2>Match summary</h2>
                                        <p>
                                            Winner in Division-I by a very small margin was
                                            <b>radeye</b>, after having successfully
                                            ...
                                            on these two were
                                            <b>SnapDragon</b>, which earned him a second place. Notably
                                            is also that
                                            <b>tomek's</b> streak of correct submissions ended in this SRM.
                                        </p>
                                        ...
                                        <p>
                                            ...
                                            <p>
                                                ...
                                                between 06:00:00 and 17:59:59) we increase one counter,
                                                <b>t1</b>,
                                                for the other seconds we increase another counter,
                                                <b>t2</b>.
                                                For the difference approach, see
                                                <b>radeye</b>'s solution.
                                            </p>
                                            <p>
                                                The amount earned is then (
                                                <b>t1</b> + 1.5*
                                                <b>t2</b>)*wage/3600.
                                                ...
                                                (2*
                                                <b>t1</b> + 3*
                                                <b>t2</b>)*wage/7200. When doing this calculation,
                                            ...
                                            <p>If sand1 or sand2 is 0, then one of the hourglasses
                                                ...
                                                to just flip hourglass 1. Since we are trying
                                                <i>all</i> possible ways
                                            ...
                                            <p>A slight problem at the moment is that the number of recursive
                                                ...
                                                solution by
                                                <b>writer</b> in the practice room for details.
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                table is valid, we just fill
                                                <i>rowspan</i> rows and
                                                <i>colspan</i> columns
                                            ...
                                            <p>
                                                <img src="/i/srm157.gif" align="right"></img>Now for the second and more interesting part. Consider an optimal
                                                ...
                                                touch each other (or the walls) both vertically and horizontally.
                                            </p>
                                            ...
                                            <p>This should be enough to get it to run in time (barely). There are
                                                ...
                                                all these optimization steps have been included.
                                            </p>
                                            <p>This was the complicated solution. A much easier solution
                                                ...
                                                Check my (
                                                <b>Yarin</b>) solution in the practice room for
                                            ...
                                            <p>
                                                ...
                                                <br/>
                                                By&#160;
                                                <a class="bodyText" href="/stat?c=member_profile&amp;cr=269554">
                                                    <strong>Yarin</strong>
                                                </a>
                                                <br/>
