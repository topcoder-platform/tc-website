...
<p>In division 1 after a little time spending on solving easy problem coders divided into two groups. 
The first one opened the medium problem (600 points), the second opened the hard (800 points). At first 
glance the second group has achieved more success, but a lot of hard problem solutions were wrong.
<b>bladerunner</b> took the 1st place with the help of 7 successful challenges, <b>lovro</b> is the 
second and <b>Savior</b> finished the third. <b>sabbir_yousuf</b> become yellow by taking the 4th place. 
<b>dexter_bg</b> get the 55 line with 325 points without any problem passed.</p>

<p>In Division 2, the top performer is <b>Protean</b>, followed by <b>crem</b> and <b>xaep</b>. 
More than 70 coders finishes with all three problems.</p>
