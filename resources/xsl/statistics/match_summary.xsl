...
<P>In Room 4, <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">tck</A> was the winner with 1296.97 final points. That was 26.44 points more than <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">DjinnKahn</A>, who finished with 1270.53. <B>DjinnKahn</B> happened to be the top-seeded coder in the room.  <B>tck</B> earned 208.09 on the Level One problem, 322.05 on the Level Two problem, and 766.83 on the Level Three problem.</P>
<P><A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">paisa</A> was the winner in Room 7 with 1349.42 final points. <B>paisa</B> earned 206.29 points on the Level One problem, 315.97 on the Level Two problem, and 827.16 on the Level Three problem.  <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">Vaduz</A> tried to challenge the Level One submission of <B>paisa</B>, while <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">redman</A> tried to challenge the Level Three submission.  Both coders failed in their attempts and lost 50 points each.</P>
<P><A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">jdev</A> triumphed in Room 10 with 674.29 final points. <B>jdev</B> coded the Level One problem for 179.61 points and the Level Three problem for 494.68 points.  <B>jdev</B> opened the Level Two problem, but didn't submit any code for it.</P>
<P>Lastly, in Room 15, <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">sandeepgupta</A> was the winner with 1214.24 final points.  In the "Coding Phase", <B>sandeepgupta</B> earned 1164.24 points, and was in second place in the room, 19.77 points behind <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">Bender</A>, who had 1184.01. <B>sandeepgupta</B> then won the room in the "Challenge Phase" by gaining 50 points from a successful challenge of the Level Three submission of <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=1" CLASS="bodyGeneric">Bob9000</A>.</P>
                 </TD>
            </TR>             
...
<P><A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=2" CLASS="bodyGeneric">shengbo2k</A> won Room 37 with 1232.23 final points. <B>shengbo2k</B> earned 237.54 points on the Level One problem, 464.82 on the Level Two problem, and 529.87 points on the Level Three problem.</P>
<P>In Room 42, <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=2" CLASS="bodyGeneric">pozdol</A> was the winner with 1257.87 final points. <B>pozdol</B> earned 220.63 points on the Level One problem, 455.57 on the Level Two problem, and 581.67 on the Level Three problem.  <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=2" CLASS="bodyGeneric">ahmedf</A> tried to challenge the Level Two submission of <B>pozdol</B> in the "Challenge Phase", but to no avail.</P>
<P><A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=2" CLASS="bodyGeneric">loopy</A> was the top-scorer for all of the first time coders, winning Room 63 with 1325.26 final points.  <B>loopy</B> earned 237.95 points on the Level One problem, 471.73 on the Level Two problem, and 615.58 on the Level Three problem.  In the "Challenge Phase", <A HREF="/stat?c=round_stats&amp;rd=4145&amp;dn=2" CLASS="bodyGeneric">marz</A> challenged the Level Three submission of <B>loopy</B>, but the challenge failed.</P>
          </TD>
            </TR>            
          </TABLE>
          <P><br/></P>
