...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
				<TR>
                   ...
                   <TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
                        ...
                        <TR><TD CLASS="bodyText">Jack Hughes, a fellow programmer, came up with the idea for TopCoder. You can get his perspective as well as more About TopCoder if you <A HREF="/tc?module=Static&amp;d1=about_tc&amp;d2=index" CLASS="bodyText">click here</A>. As for what TopCoder is to become, that is in part up to you. We are asking for input from the developer community in order to make this site the best it can be. <A HREF="/?t=contacts&amp;c=index" CLASS="bodyText">Contact us</A> with any suggestions you may have. If you're a member, you can also introduce your ideas in one of our <A TARGET="_top" HREF="/rtables/index.jsp" CLASS="bodyText">roundtable discussions</A>.</TD></TR>
                        <TR><TD VALIGN="bottom" ALIGN="left"><A HREF="#top" CLASS="bodyText">[back to top]</A></TD></TR>
                        <TR><TD HEIGHT="20" VALIGN="top"><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="20" BORDER="0"/></TD></TR>
                        ...
                        <TR><TD CLASS="bodyText">The coder.  Our Terms of Use agreement basically specifies that the coder who submits any source code to TopCoder owns the code.  We simply require that we can display the source code for the normal course of the tournaments.  The actual source code is viewable during certain parts of the competition to competitors and spectators. You can read the complete Terms of Use agreement <A HREF="/tc?module=Static&amp;d1=about_tc&amp;d2=terms" CLASS="bodyText">here</A>.</TD></TR>
                        <TR><TD VALIGN="bottom" ALIGN="left"><A HREF="#top" CLASS="bodyText">[back to top]</A></TD></TR>
                        <TR><TD HEIGHT="20" VALIGN="top"><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="20" BORDER="0"/></TD></TR>
                        ...
                        <TR><TD CLASS="bodyText">Effective February, 2002, we will be instituting Divisions I and II. These do not differentiate between Students or Professionls. Instead, members are placed in a Division based upon their rating.</TD></TR>
                        <TR><TD VALIGN="bottom" ALIGN="left"><A HREF="#top" CLASS="bodyText">[back to top]</A></TD></TR>
                        <TR><TD HEIGHT="20" VALIGN="top"><IMG SRC="/i/clear.gif" WIDTH="1" HEIGHT="20" BORDER="0"/></TD></TR>
