...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Visual Guide - Login</xsl:with-param>
</xsl:call-template>
...
<P CLASS="bodyText"><b>Figure 1: Login</b></P>
<IMG SRC="/i/login_screen.gif" ALT="Login" WIDTH="619" HEIGHT="468" BORDER="0"/>

                       <P CLASS="bodyText">
A Login Timeout screen may appear due to a 
          server problem or high network traffic. If this occurs, the user must login again. <BR/>
                                    <BR/>
                                    <b>*Note:</b>  In the event that this should happen during 
