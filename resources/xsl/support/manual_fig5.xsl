...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Visual Guide - Status Window - Challenge Phase</xsl:with-param>
</xsl:call-template>
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" BGCOLOR="#FFFFFF" WIDTH="100%">
 ...
 <ul CLASS="bodyText">
                                        ...
                                        <li>
                                            <b>Figure 5.</b> Status Window - Challenge Phase
                                        </li>
                                    </ul>
</P>

<P CLASS="bodyText"><b>Figure 5: Status Window - Challenge Phase</b></P>
<IMG SRC="/i/status_window.gif" ALT="Status Window" WIDTH="619" HEIGHT="434" BORDER="0"/>
