...
function placeFocus()
{
    ...
    for (var i = 0; i < document.forms.length; i++)
    {
        ...
        if (document.forms[i].name != 'searchForm' && document.forms[i].name != 'inlinecommentform' && document.forms[i].name != 'simpleSearchForm')
        {
...
/**
* Only the parameters name and value are required. If no expiration is specific, the cookie will be valid until the end of the session.
*
*/
