...
<p>
    ...
    is<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object2
           SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_2d87ftn.gif>which
    is derivable everywhere except at
    the<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object3
            SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_3gps8mf.gif>customer
    ...
    constant<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object5
                 SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_5gnj4sd.gif>can
    be viewed as constraining the solution point to be in a separate plane,
    parallel to the one containing the customers, at a
    distance<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object6
                 SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_6g6m85p.gif>away
    (this is easier to visualize by considering the 2-dimensional problem). Also
    when<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object7
             SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_7hhth5j.gif>becomes
    ...
    decreasing<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object8
                   SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_8dzmsdg.gif>values
    to progressively move from the centroid to the Weber point, but as I couldn't
    find a method for
    changing<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object9
                 SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_9dhqrgd.gif>which
    was both fast and always convergent I settled on a fixed
    small<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object10
              SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_104cvj7z.gif>value.
</P>
...
<P ALIGN=CENTER STYLE="MARGIN-BOTTOM: 0pt">
    <IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object11
         SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_11txtfw9.gif>
    <IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object12
         SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_12f752ns.gif>
    <IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object13
         SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_13mqqqdf.gif>
</P>

<p>
    with<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object14
             SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_14f47x3p.gif>being
    the distance from the solution point to the i'th customer
    (with<IMG ALIGN=ABSMIDDLE HSPACE=8 NAME=Object15
              SRC=/i/longcontest/match_editorials/intel_mtcs_7/ajd92kcbbbb_15dj8pmt.gif>added
...
<ul>
    <li>calculate at each step both the next Newton point and the next Weiszfeld point, while keeping track of the
        distance to the closest customer
    </li>
