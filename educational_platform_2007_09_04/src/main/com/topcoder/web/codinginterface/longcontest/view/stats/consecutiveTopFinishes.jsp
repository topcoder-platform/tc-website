...
<tc-webtag:ifLink useLink="${n != 5}" text="Top 5"
                  link="/longcontest/stats/?module=Recordbook&c=marathon_consecutive_top_finishes&wst=10"/> |
<tc-webtag:ifLink useLink="${n != 10}" text="Top 10"
                  link="/longcontest/stats/?module=Recordbook&c=marathon_consecutive_top_finishes&wst=11"/>
<br><br>
...
Only rated matches are included.
    ...
    <table class="stat" cellpadding="0" cellspacing="0"
        ...
        <thead>
            <tr>
                <td class="title" colspan="6">Consecutive Top ${n} finishes</td>
            </tr>
            <tr>
