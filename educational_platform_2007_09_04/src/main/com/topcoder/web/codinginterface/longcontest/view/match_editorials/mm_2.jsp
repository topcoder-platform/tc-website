...
<span class="bodySubtitle"><A
        href="/longcontest/?module=ViewProblemStatement&compid=5910&rd=10082">MasterMind</A></span>
<br><br>
...
<ul>
    <li>Make some initial guesses: Many competitors chose to make solid color
        ...
        competitors (notably venco) chose to essentially skip this phase.
    </li>
    <li>
...
<ol>
    <li>
        Take several (2-8) pegs off the board so that the error is reduced as mach as possible.
    </li>
