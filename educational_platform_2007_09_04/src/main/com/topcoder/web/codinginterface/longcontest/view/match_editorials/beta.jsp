...
<span class="bodySubtitle"><A
        href="/longcontest/?module=ViewProblemStatement&compid=5503&rd=9874">CostlySorting</A></span>
<br><br>
...
is described <a
        href="http://<%=ApplicationServer.FORUMS_SERVER_NAME%>/?module=Thread&threadID=508413&start=75&mc=118#521087">here</a>.
<br><br>
...
theory. On average, a split yields <tt>-p lg(p) - (1-p) lg(1-p)</tt> bits of information.With k bits of information, you
can
