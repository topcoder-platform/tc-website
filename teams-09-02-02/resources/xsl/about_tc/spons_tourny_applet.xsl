...
<xsl:call-template name="BodyTop">
  ...
  <xsl:with-param name="title">&#160;Tournament Package - TC Arena Applet</xsl:with-param>
</xsl:call-template>
...
<!--end contextual links-->
					<P>The Arena Applet is where the action takes place. Coders square off against each other in "rooms" based upon their current rating. A sample of 
					how a sponsor is presented in the applet is shown below and on the following sample pages.</P>
					<UL>
					<LI>Lobby - entry way and chat area for both competitors and spectators<BR/><A HREF="/index?t=about_tc&amp;c=spons_applet_l" CLASS="bodyText">View large sample</A></LI><BR/>
					<LI>Coding - where competitors view problems, submit solutions, and challenge code<BR/><A HREF="/index?t=about_tc&amp;c=spons_applet_c" CLASS="bodyText">View large sample</A></LI><BR/>
					<LI>Status - informs both spectators and coders of who's doing what<BR/><A HREF="/index?t=about_tc&amp;c=spons_applet_s" CLASS="bodyText">View large sample</A></LI><BR/>
					<LI>Leader Board - Dynamic listing of room leaders and current points<BR/><A HREF="/index?t=about_tc&amp;c=spons_applet_lb" CLASS="bodyText">View large sample</A></LI></UL><BR/>
					<DIV ALIGN="left"><IMG SRC="/i/about/sample_sponsor.gif" ALT="" WIDTH="300" HEIGHT="50" BORDER="0"/></DIV>
					<P>Please note, TopCoder is about competition and therefore does not incorporate animated graphics of any sort into the TC Arena Applet.</P>
					<P>TopCoder Marketing will produce all necessary graphics &#40;working with a sponsor's internal marketing team or agency of record&#41; needed for the medium.</P>
