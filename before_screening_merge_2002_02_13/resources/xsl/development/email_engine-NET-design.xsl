...
<!-- Title -->
							<h1 class="devSubhead"><strong>.NET Email Engine: Design</strong></h1>
                                    
							<p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=.NET%20Email%20Engine:%20Design&amp;comp=4208949" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>

<!-- Overview -->
							<p><strong>Component Overview</strong><br />
							The Email Engine component provides basic and advanced email functionality.  As with any email software, the component supports one or more primary (TO), carbon copy (CC) and blind carbon copy (BCC) recipients, a subject line and file attachment capabilities.
                            <br/>
                            As its name suggests, the Email Engine is used to send email messages.  This is not a GUI-based component such as Outlook Express or Yahoo Mail that manages user email accounts.  Rather, the Email Engine is a set of API's that enables a developer to send emails directly from application code.
							</p>

							<p><strong>Project Overview</strong><br />
                            An Email Engine component currently exists for java.  The purpose of this project is to design a functionally identical component using the .NET Framework.
							</p>
							
<!-- Project Type -->
							<p><strong>Project Type</strong><br />
							Component Design Project: Provide a complete design for the .NET Email Engine component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=4208949&amp;date=2&#47;5">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
                            ...
                            <p><a href="/?&amp;t=development&amp;c=tcs_inquire&amp;Project=.NET%20Email%20Engine:%20Design&amp;comp=4208949&amp;date=2&#47;5" class="statText"><strong>Inquire about this project &gt;&gt;</strong></a></p>
						<p><br /></p>
					</td>
