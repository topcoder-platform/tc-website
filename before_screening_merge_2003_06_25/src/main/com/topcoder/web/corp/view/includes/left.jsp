...
<!-- Recruiting begins -->
                <tr><td id="<%=level1.equals("recruiting")?(level2.equals("overview")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("recruiting")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=recruiting&d3=index" class="<%=level1.equals("recruiting")?"leftOn":"left"%>">Recruiting</a></td> </tr>
            <% if (level1.equals("recruiting")) { %>
                ...
                <tr><td id="leftNavApplet"><img alt="" width="10" height="10" src="/i/clear.gif" border="0"/><A href="/tces/?task=MainTask" class="left">Launch Recruiting Reports</A></td></tr>
            <% } %>
<!-- Recruiting ends -->

<!-- Testing begins-->
                <tr><td id="<%=level1.equals("testing")?(level2.equals("overview")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("testing")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=testing&d3=index" target="_parent" class="<%=level1.equals("testing")?"leftOn":"left"%>">Testing</a></td></tr>
            <% if (level1.equals("testing")) { %>
                ...
                <tr><td id="leftNavApplet"><img alt="" width="10" height="10" src="/i/clear.gif" border="0"/><A href="/testing/" class="left">Launch Testing App Tool</A></td></tr>
            <% } %>
<!-- Testing ends -->

<!-- Manage Users begins -->
                <tr><td id="<%=level1.equals("manageUsers")?"leftNavSelect":"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("manageUsers")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=UserList" class="<%=level1.equals("manageUsers")?"leftOn":"left"%>">Manage Users</a></td></tr>
<!-- Manage Users ends -->
<!-- TCES ends -->
...
<!-- Sponsorship begins -->
            <table width="180" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=srm_index" target="_parent" class="left">Single Round Matches</a></td></tr>
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=tourny_index" target="_parent" class="left">Tournaments</a></td></tr>
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=pbtc_index" target="_parent" class="left">Powered by TopCoder<br><img src="/i/clear.gif" width="10" height="3" alt="" border="0">Competitions</a></td></tr>
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=private_index" target="_parent" class="left">Private Label Competitions</a></td></tr>
<!-- Sponsorship ends -->
...
<!-- SRM begins-->
            <table width="180" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr><td id="<%=level1.equals("srm")?(level2.equals("index")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("srm")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=spon_prog&d3=srm_index" target="_parent" class="<%=level1.equals("srm")?"leftOn":"left"%>">Single Round Matches</a></td></tr>
...
<!-- Tournament begins -->
            <table width="180" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr><td id="<%=level1.equals("tourny")?(level2.equals("index")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("tourny")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=spon_prog&d3=tourny_index" target="_parent" class="<%=level1.equals("tourny")?"leftOn":"left"%>">Tournaments</a></td></tr>
...
<!-- Private Label begins -->
            <table width="180" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=tourny_index" target="_parent" class="left">Tournaments</a></td></tr>
                <tr><td id="leftNav"><img src="/i/nav_arrow_right.gif" width="10" height="10" alt="" border="0"><a href="?module=Static&d1=corp&d2=spon_prog&d3=pbtc_index" target="_parent" class="left">Powered by TopCoder<br><img src="/i/clear.gif" width="10" height="3" alt="" border="0">Competitions</a></td></tr>
                <tr><td id="<%=level1.equals("private_label")?(level2.equals("index")?"leftNavSelect":"leftNavOn"):"leftNav"%>"><img src="/i/nav_arrow_<%=level1.equals("private_label")?"bottom":"right"%>.gif" width="10" height="10" alt="" border="0"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=private_label&d3=index" target="_parent" class="<%=level1.equals("private_label")?"leftOn":"left"%>">Private Label Competitions</a></td></tr>
<!-- Private Label ends -->
