<%@ page import="com.topcoder.web.aolicq.Constants, com.topcoder.web.aolicq.model.SubmissionType" %>
            ...
            <div id="content">
                ...
                <div align="center">
                    <p align="center" style="width:500px; margin-top: 20px;">
                        ...
                        <br /><br />
                        <div align="center">
                        <a href="${sessionInfo.servletPath}?module=ViewFinalSubmission&amp;<%=Constants.CONTEST_ID%>=${contest.id}" onFocus="this.blur();"><img src="/i/events/aolicq/interface/btnSubmitAnother.png" alt="submit another" /></a>
                        </div>
                    </p>
                </div>
