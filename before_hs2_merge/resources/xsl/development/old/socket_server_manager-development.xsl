...
<!-- Title -->
						<h1 class="devSubhead"><strong>Socket Server Manager: Development</strong></h1>
                                    
<!-- Overview -->
						<p><strong>Overview</strong><br />
						The Socket Server Manager provides a common mechanism for administering socket connections.  Socket management can quickly become an onerous task.  This component encapsulates the details of opening and closing a socket and sending and receiving data.  In addition, the component provides convenience methods such as the ability to refresh the connection.  Furthermore, the component enables users to create and manage multiple sockets each with its own functional purpose.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Development Project: Provide a complete development solution for the Socket Server Manager component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3201991">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=5704603">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=3201991&amp;c=tcs_inquire&amp;Project=Socket%20Server%20Manager:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
