...
<!-- Overview -->
						...
						The Spell Check component provides spelling validation to Java applications.  The notion of spell checking is not new. However, providing a low-level spell checking component available through an API has numerous uses.  On most websites and custom applications, spell checking is not available.  For example, the www.topcodersoftware.com forums allow members to post comments, but there was no utility to run spell check before posting.  This component integrates with those offerings to provide spell check functionality.
						</p>
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=2806547">documentation</a> for this project is available on the TopCoder Software web site.</p>
...
<!-- Register at TCS -->
						   ...
						   <p>
        						<strong>View the <a class="statText" target="_new" href= "http://www.topcodersoftware.com/catalog/document?id=4300003">Requirement Specification</a> for this component project &gt;&gt;</strong>
                            </p>
						   <p>
						        <strong>
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=113&amp;comp=2806547&amp;c=tcs_inquire&amp;Project=Spell%20Check:%20Development&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
