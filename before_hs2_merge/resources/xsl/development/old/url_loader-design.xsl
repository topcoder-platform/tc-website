...
<!-- Overview -->
						...
						The URL Loader component enables users to request the aysnchronous, multi-threaded retrieval of one or more web-based resources.  The requesting application can then query the URL Loader component to check on the status of the process.  The component is utilized in the TopCoder contest applet to retrieve web-based resources without affecting the core functionality.  A future use of the component may include integration with a larger "Link Validator" component.
						</p>

<!-- Project Type -->
						<p><strong>Project Type</strong><br />
						Component Design Project: Provide a complete design for the URL Loader component.<br />
...
<!-- Documentation -->
						...
						All <a class="statText" target="_new" href="http://www.topcodersoftware.com/pages/c_component.jsp?comp=3300871">documentation</a> for this project is available on the TopCoder Software web site.</p>
						   ...
						   <p>
        						...
        						<a class="statText">
        						    <xsl:attribute name="href">
        						        <xsl:value-of select="concat('/?&amp;t=development&amp;version=1&amp;phase=112&amp;comp=3300871&amp;c=tcs_inquire&amp;Project=URL%20Loader:%20Design&amp;date=', $month, '&#47;', $day, '&#47;', $year)"/>
                                    </xsl:attribute>
