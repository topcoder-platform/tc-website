    ...
    <TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
      <TR>
        ...
        <TD CLASS="registerNav" WIDTH="114" HEIGHT="21" BACKGROUND="/i/steel_gray_bg.gif">
                <xsl:choose>
                  <xsl:when test="/TC/LoggedIn='true'"><A HREF="/reg/index.jsp" CLASS="registerNav" TARGET="_parent"><IMG SRC="/i/menu_profile_on.gif" ALT="Update Profile" WIDTH="114" HEIGHT="21" BORDER="0"/></A></xsl:when>
                  <xsl:otherwise><A CLASS="registerNav" HREF="/reg/index.jsp" TARGET="_parent"><IMG SRC="/i/menu_reg_off.gif" ALT="Register" WIDTH="114" HEIGHT="21" BORDER="0"/></A></xsl:otherwise>
                </xsl:choose>
        </TD>
        ...
        <TD CLASS="globalNav" WIDTH="100%" HEIGHT="21" BACKGROUND="/i/top_bar_bg.gif" BGCOLOR="#CC0000" NOWRAP="0">
          <A HREF="/index?t=schedule&amp;c=index" onMouseOver="changeImages('image2', 'image2on')" onMouseOut="changeImages('image2', 'image2off')" TARGET="_parent">
            <IMG NAME="image2" SRC="/i/menu_sched_off.gif" ALT="Schedule" WIDTH="69" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/index?t=about_tc&amp;c=membr_teams" onMouseOver="changeImages('image3', 'image3on')" onMouseOut="changeImages('image3', 'image3off')" TARGET="_parent">
            <IMG NAME="image3" SRC="/i/menu_teams_off.gif" ALT="Teams" WIDTH="49" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/?t=statistics&amp;c=index" onMouseOver="changeImages('image4', 'image4on')" onMouseOut="changeImages('image4', 'image4off')" TARGET="_parent">
            <IMG NAME="image4" SRC="/i/menu_stats_off.gif" ALT="Statistics" WIDTH="69" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/rtables/index.jsp" onMouseOver="changeImages('image5', 'image5on')" onMouseOut="changeImages('image5', 'image5off')" TARGET="_parent">
            <IMG NAME="image5" SRC="/i/menu_rounds_off.gif" ALT="Round Tables" WIDTH="90" HEIGHT="21" BORDER="0"/>
          </A>          
          <A HREF="/index?t=development&amp;c=index" onMouseOver="changeImages('image6', 'image6on')" onMouseOut="changeImages('image6', 'image6off')" TARGET="_parent">
            <IMG NAME="image6" SRC="/i/menu_dev_off.gif" ALT="Development" WIDTH="88" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/index?t=jobs&amp;c=index" onMouseOver="changeImages('image7', 'image7on')" onMouseOut="changeImages('image7', 'image7off')" TARGET="_parent">
            <IMG NAME="image7" SRC="/i/menu_jobs_off.gif" ALT="Jobs" WIDTH="40" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/index?t=news_events&amp;c=index" onMouseOver="changeImages('image8', 'image8on')" onMouseOut="changeImages('image8', 'image8off')" TARGET="_parent">
            <IMG NAME="image8" SRC="/i/menu_press_off.gif" ALT="News &amp; Events" WIDTH="82" HEIGHT="21" BORDER="0">
          ...
          <A HREF="/index?t=support&amp;c=index" onMouseOver="changeImages('image9', 'image9on')" onMouseOut="changeImages('image9', 'image9off')" TARGET="_parent">
            <IMG NAME="image9" SRC="/i/menu_support_off.gif" ALT="Support/FAQs" WIDTH="90" HEIGHT="21" BORDER="0">
