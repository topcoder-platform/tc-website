...
<P>The Google search-engine folks have a different reason for sponsoring a programming contest Ñ they have a problem that needs solving. They want to know what interesting things you can do with 900,000 of Google's web pages (http://www.google.com/programming-contest/). The grand prize of $10,000 sounds okay, too.</P>
