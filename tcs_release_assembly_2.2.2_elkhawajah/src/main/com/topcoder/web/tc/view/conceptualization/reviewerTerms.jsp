<%--
  ...
  -
  - Description: Displays the Terms Of User for Conceptualization Project Review and provides a form for the user to accept
...
<td width="180">
    <jsp:include page="/includes/global_left.jsp">
        <jsp:param name="node" value="conceptualization"/>
    </jsp:include>
</td>
<%-- Left Column Ends --%>
