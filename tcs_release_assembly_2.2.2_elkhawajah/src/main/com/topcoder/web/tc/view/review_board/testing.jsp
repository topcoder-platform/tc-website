<%--
  ...
  -
  - Description: This is the page for listing the members of the Application Testing review board. It displays the list of
...
<html>
<head>
    <title>Application Testing Review Board at TopCoder</title>
    ...
    <tr valign="top">
        ...
        <td width="180">
            <jsp:include page="/includes/global_left.jsp">
                <jsp:param name="node" value="app_testing_review_board"/>
            </jsp:include>
        </td>
        <!-- Left Column Ends -->
        ...
        <td class="bodyText" width="100%">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="bodyText"><img src="/i/clear.gif" width="240" height="1" border="0" alt=""><br>
                        ...
                        <p>TopCoder Software utilizes past software application testing winners and accomplished TopCoder
                            competitors to staff the Application Testing Review Board. These reviewers verify that each application testing
                            submission meets the required functionality, coding style, adheres to the application testing
                            requirements and contains a suitable test suite.</p>

                        <p>The following members have agreed to participate on the TopCoder Application Testing Review Board:</p>
                    </td>
                </tr>
            </table>
                ...
                <rsc:iterator list="<%=memberList%>" id="resultRow">
                    ...
                    <td>
                        <div align="center">
                            ...
                            <span class="bodyText">
                                <tc-webtag:handle coderId='<%=resultRow.getIntItem("user_id")%>' context="app_testing"/>
                            </span>
                        </div>
                    </td>
            ...
            <p align="middle"><a href="mailto:service@topcodersoftware.com" class="bodyText">Have a question about the
                TopCoder Application Testing Review Board?</a></p>
            <p><br/></p>
        </td>
        <!-- Center Column Ends -->
        ...
        <td width="170"><img src="/i/clear.gif" width="170" height="1" border="0" alt=""><br/>
            <jsp:include page="/public_right.jsp">
                ...
                <jsp:param name="level2" value="app_testing"/>
            </jsp:include>
        </td>
        <!-- Right Column Ends -->
