...
<logic:present name="projectInfo">
				...
				<tr>
                    ...
                    <td class="forumTextOdd">
                        <span class="bodySubtitle">Alert!</span>
                        <br><br>
                        TopCoder has determined your submission does not meet the required standards. Please correct all fatal errors and resubmit before
                        the project deadline to be considered for the screening process. If you believe we have misjudged your submission,
                        send an email to <a href="mailto:service@topcoder.com">service@topcoder.com</a> stating your appeal.
                        <br><br>
                    </td>
				</tr>
				<tr>
