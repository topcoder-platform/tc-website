...
%>
                    <td width="190" align ="left">
                        <img src="/i/spacer.gif" alt="" width="170" height="10" border="0" class="corpRight"><br>

<!-- Corporate Home begins-->
<% if (level1.equals("tces_home")) { %>
                        <div class="corpRight"><a href="mailto:tces@topcoder.com"><img src="/i/promo_contact_tces.gif" alt="Contact TCES" width="170" height="76" border="0"></a></div>
                        <div class="corpRight"><a href="/i/downloads/tc_demo_tces.pdf"><img src="/i/promos/tc_demo_tces.gif" alt="Download TCES Demographics" width="170" height="218" border="0"></a></div>
<% } %>
<!-- Corporate Home ends -->
...
<% if (level1.equals("testing")) { %>
    <% if ((level2.equals("overview")) || (level2.equals("attributes")) || (level2.equals("management"))) { %>
                        <div class="corpRight"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=testing&d3=pricing" target="_parent"><img src="/i/buy_now.gif" alt="Buy Now" width="170" height="50" border="0" class="corpRight"></a></div>
    <% } %>
                        <div class="corpRight"><a href="mailto:tces@topcoder.com"><img src="/i/promo_contact_tces.gif" alt="Contact TCES" width="170" height="76" border="0"></a></div>
                        <div class="corpRight"><a href="/i/downloads/tc_demo_tces.pdf"><img src="/i/promos/tc_demo_tces.gif" alt="Download TCES Demographics" width="170" height="218" border="0"></a></div>
<% } %>
...
<% if (level1.equals("recruiting")) { %>
    <% if ((level2.equals("overview")) || (level2.equals("reporting"))) { %>
                        <div class="corpRight"><a href="<%=request.getAttribute(Constants.KEY_LINK_PREFIX)%>?module=Static&d1=corp&d2=recruiting&d3=pricing" target="_parent"><img src="/i/buy_now.gif" alt="Buy Now" width="170" height="50" border="0" class="corpRight"></a></div>
    <% } %>
                        <div class="corpRight"><a href="mailto:tces@topcoder.com"><img src="/i/promo_contact_tces.gif" alt="Contact TCES" width="170" height="76" border="0"></a></div>
                        <div class="corpRight"><a href="/i/downloads/tc_demo_tces.pdf"><img src="/i/promos/tc_demo_tces.gif" alt="Download TCES Demographics" width="170" height="218" border="0"></a></div>
<% } %>
