...
public final class ProjectBean {
    ...
    public static ProjectServices getProjectServices() throws Exception {
        if (exception != null) { throw exception; } else { return projectServices; }
    }
    ...
    public Project getProjectById(int projectId) {
        try { return getProjectServices().getProjectById(projectId); } catch (Exception e) { e.printStackTrace(); return null; }
    }    

    public ProjectTask getProjectTaskById(int projectTaskId) {
        try { return getProjectServices().getProjectTaskById(projectTaskId); } catch (Exception e) { e.printStackTrace(); return null; }
    }

    public ProjectIssue getProjectIssueById(int projectIssueId) {
        try { return getProjectServices().getProjectIssueById(projectIssueId); } catch (Exception e) { e.printStackTrace(); return null; }
    }

    public ProjectUserUpdate getProjectUserUpdateById(int projectUserUpdateId) {
        try { return getProjectServices().getProjectUserUpdateById(projectUserUpdateId); } catch (Exception e) { e.printStackTrace(); return null; }
    }    
/*    
...
*/
    public ProjectUser getProjectUserById(int projectUserId) {
        try { return getProjectServices().getProjectUserById(projectUserId); } catch (Exception e) { e.printStackTrace(); return null; }
    }

    public ProjectUserTask getProjectUserTaskById(int projectUserTaskId) {
        try { return getProjectServices().getProjectUserTaskById(projectUserTaskId); } catch (Exception e) { e.printStackTrace(); return null; }
    }

    public UserMessage getUserMessageById(int messageId) {
        try { return getProjectServices().getUserMessageById(messageId); } catch (Exception e) { e.printStackTrace(); return null; }
    }    
    
    public void setReceiverUserMessageFolder(int messageId, int folderId) {
        try { getProjectServices().setReceiverUserMessageFolder(messageId, folderId); } catch (Exception e) { e.printStackTrace(); }
    }

    public void setSenderUserMessageFolder(int messageId, int folderId) {
        try { getProjectServices().setSenderUserMessageFolder(messageId, folderId); } catch (Exception e) { e.printStackTrace(); }
    }

    public void setMessageReadDate(int messageId, Date dateIn) {
        try { getProjectServices().setMessageReadDate(messageId, dateIn); } catch (Exception e) { e.printStackTrace(); }
    }
