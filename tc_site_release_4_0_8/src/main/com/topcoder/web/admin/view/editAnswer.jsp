            ...
            <tr valign="top">
                ...
                <td>
                    <form action="<jsp:getProperty name="sessionInfo" property="servletPath"/>" method=post name="surveyForm">
                        ...
                        <table>
                            <tr><td><tc-webtag:errorIterator id="err" name="<%=Constants.SORT%>"><%=err%></tc-webtag:errorIterator></td></tr>
                            <tr><td><tc-webtag:textInput name="<%=Constants.SORT%>" size="3" maxlength="5" onKeyPress="submitEnter(event)"/></td></tr>
                            <tr><td><tc-webtag:errorIterator id="err" name="<%=Constants.ANSWER_TEXT%>"><%=err%></tc-webtag:errorIterator></td></tr>
                            <tr><td><tc-webtag:textArea name="<%=Constants.ANSWER_TEXT%>" rows="2" cols="80"/></td></tr>
