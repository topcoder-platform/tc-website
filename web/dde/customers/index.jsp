...
<!-- ABB begins -->
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr valign="top">
                    ...
                    <A href="<tc-webtag:linkTracking link="<%=ApplicationServer.SOFTWARE_SERVER_NAME%>/pdfs/tcs/casestudies/abb_casestudy.pdf" refer="customer_index"/>" target="_blank">case study</A>
                     </td>
                </tr>
            </table>
<!-- ABB ends -->
