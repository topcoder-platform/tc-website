...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr><td width="100%" class="footer">
        ...
        <a href="http://<%=ApplicationServer.TC_SERVER%>/tc?module=Static&d1=pressroom&d2=index" class="footerLinks">Press Room</a>&#160;&#160;|&#160;&#160;
        <a href="http://<%=ApplicationServer.TC_SERVER%>/tc?module=Static&d1=about&d2=contactus" class="footerLinks">Contact Us</a>&#160;&#160;|&#160;&#160;
