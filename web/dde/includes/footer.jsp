<div id="links">
		<div class="wrapper">
			...
			<div class="col">
				...
				<ul>
					<li><a href="#">TopCoder Cockpit</a></li>
					<li><a href="#">Contest Administration</a></li>
					<li><a href="#">Pipeline</a></li>
					<li><a href="#">Control Panel</a></li>
					<li><a href="#">UML Tool</a></li>
					<li><a href="#">TopCoder Forums</a></li>
					<li><a href="#">Component Catalog</a></li>
					<li><a href="#">TopCoder Wiki</a></li>
				</ul>
			</div><!-- .col ends -->
			...
			<div class="col">
				...
				<ul>
					<li><a href="#">TopCoder Direct</a></li>
					<li><a href="#">TopCoder Cockpit</a></li>
					<li><a href="#">Studio TopCoder</a></li>
				</ul>
			</div><!-- .col ends -->
