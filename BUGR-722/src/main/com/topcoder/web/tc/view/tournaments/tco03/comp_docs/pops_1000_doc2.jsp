    ...
    <tr valign="top">
        ...
        <td width="99%">
            ...
            <jsp:include page="times.jsp">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tco03/comp_docs/pops/1000/AddaMethodAspectwithmethodfiltertoanexistingobject.gif" alt="" width="2502" height="714" border="0"></div></td>
