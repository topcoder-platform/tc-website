...
<h2 class="compDocs">2004 TCCC Component Finals - aksonov</h2>

<table border="0" cellspacing="0" cellpadding="0">
    <tr valign="top">
        <td width="190">
            <jsp:include page="aksonov_files.jsp">
                <jsp:param name="time" value="final" />
                <jsp:param name="doc" value="doc14" />
            </jsp:include>
        </td>
        ...
        <td width="99%">
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="99%"><div class="compDocs"><img src="/i/tournament/tccc04/comp_docs/aksonov/diagrams_final/Catalog_Sequence_Diagram_Setgetcustomproductorgroupattributes.gif" alt="" border="0"></div></td>
