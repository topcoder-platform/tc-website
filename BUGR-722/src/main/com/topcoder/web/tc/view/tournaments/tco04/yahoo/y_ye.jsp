		...
		<td align="center">
			<table width="510" border=0 cellpadding=20 cellspacing=0>
				<tr>
                    ...
                    <p class=pageTitle>Yahoo! Inc. - positions available throughout Yahoo! Engineering</p>
					<p>	Yahoo! Inc.<br/>
					...
					<ul>
						...
						<li>Ops Engineers</li>     
						<li>QA Engineers</li>     
						<li>Data Mining & Data Warehousing & SAS Engineers</li>     
						<li>Storage Architects</li>     
						<li>Storage Sys Admins</li>     
						<li>DNS Architect</li>     
						<li>DNS Sys Admin</li>     
						<li>Data Analysts</li>     
						<li>Oracle DBA</li>     
