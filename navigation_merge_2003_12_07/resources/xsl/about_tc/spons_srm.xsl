...
<!--end contextual links-->
					...
					The Arena Applet is where all of the excitement takes place. <B>Competitors spend an average 2.5 hours online</B> before, during and after a match! During the three phases (Coding, Challenge, and System Test) coders go head-to-head vying for points, and ratings.</LI><BR/>
					<LI><A HREF="/index?t=about_tc&amp;c=spons_srm_email" CLASS="bodyText">Opt-In Email</A><BR/>
					Over 70&#37; of the membership opts-in for match notification. The email program is designed to inform members of the match sponsors, key points about them, and the appropriate URL references per sponsor.</LI></UL></P>
